...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_AccessibilityTemplates/UserScaledElementTemplates.lua#L44)
function UserScaledElementMixin:GetDesiredHeight(registrationInfo) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_AccessibilityTemplates/UserScaledElementTemplates.lua#L48)
function UserScaledElementMixin:GetScaledDesiredHeight(scale, registrationInfo) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_AccessibilityTemplates/UserScaledElementTemplates.lua#L53)
function UserScaledElementMixin:OnTextScaleUpdated(scale, registrationInfo) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_AccessibilityTemplates/UserScaledElementTemplates.lua#L67)
function UserScaledButtonFitToTextMixin:OnLoad() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_AccessibilityTemplates/UserScaledElementTemplates.lua#L72)
function UserScaledButtonFitToTextMixin:ReanchorTextForScale(scale, registrationInfo) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_AccessibilityTemplates/UserScaledElementTemplates.lua#L79)
function UserScaledButtonFitToTextMixin:SetText(text) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_AccessibilityTemplates/UserScaledElementTemplates.lua#L84)
function UserScaledButtonFitToTextMixin:OnTextScaleUpdated(scale, registrationInfo) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_AccessibilityTemplates/UserScaledElementTemplates.lua#L90)
function UserScaledButtonFitToTextMixin:TryRecalculateDesiredWidth(scale) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_AccessibilityTemplates/UserScaledElementTemplates.lua#L100)
function UserScaledFrameByHeightMixin:OnLoad_UserScaledByHeight() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_AccessibilityTemplates/UserScaledElementTemplates.lua#L138)
