...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AccessibilityTemplates/UserScaledElementTemplates.lua#L43)
function UserScaledElementMixin:GetDesiredHeight(registrationInfo) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AccessibilityTemplates/UserScaledElementTemplates.lua#L47)
function UserScaledElementMixin:GetScaledDesiredHeight(scale, registrationInfo) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AccessibilityTemplates/UserScaledElementTemplates.lua#L52)
