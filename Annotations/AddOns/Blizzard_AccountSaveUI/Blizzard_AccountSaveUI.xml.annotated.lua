...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_AccountSaveUI/Blizzard_AccountSaveUI.xml#L10)
--- child of AccountSaveFrame
--- @class AccountSaveFrame_Border : Frame, DialogBorderOpaqueTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_AccountSaveUI/Blizzard_AccountSaveUI.xml#L17)
--- child of AccountSaveFrame
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_AccountSaveUI/Blizzard_AccountSaveUI.xml#L41)
--- child of AccountSaveFrame
--- @class AccountSaveFrame_LockEditBox : EditBox

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_AccountSaveUI/Blizzard_AccountSaveUI.xml#L67)
--- child of AccountSaveFrame
--- @class AccountSaveFrame_SaveButton : Button, UIPanelButtonTemplate, UIButtonMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_AccountSaveUI/Blizzard_AccountSaveUI.xml#L4)
