...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AccountStore/Blizzard_AccountStoreCardTemplates.xml#L33)
--- child of AccountStoreBaseCardTemplate
--- @class AccountStoreBaseCardTemplate_New : Frame, NewFeatureLabelTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AccountStore/Blizzard_AccountStoreCardTemplates.xml#L41)
--- child of AccountStoreBaseCardTemplate
--- @class AccountStoreBaseCardTemplate_Name : FontString, GameFontNormalMed3

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AccountStore/Blizzard_AccountStoreCardTemplates.xml#L48)
--- child of AccountStoreBaseCardTemplate
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AccountStore/Blizzard_AccountStoreCardTemplates.xml#L68)
--- Template
--- @class AccountStoreCreatureCardTemplate : Button, AccountStoreBaseCardTemplate, AccountStoreCreatureCardMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AccountStore/Blizzard_AccountStoreCardTemplates.xml#L82)
--- Template
--- @class AccountStoreIconCardTemplate : Button, AccountStoreBaseCardTemplate, AccountStoreIconCardMixin
--- @field Icon Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AccountStore/Blizzard_AccountStoreCardTemplates.xml#L105)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AccountStore/Blizzard_AccountStoreCardTemplates.xml#L120)
--- Template
