...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_AccountStore/Blizzard_AccountStoreItemRack.lua#L26)
function AccountStoreItemRackMixin:SetItems(items) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_AccountStore/Blizzard_AccountStoreItemRack.lua#L31)
function AccountStoreItemRackMixin:Refresh() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_AccountStore/Blizzard_AccountStoreItemRack.lua#L54)
