...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_AchievementUI/Cata/Blizzard_AchievementUI.xml#L20)
--- child of HybridScrollBarTemplate (created in template HybridScrollBarBackgroundTemplate)
--- @type Texture
HybridScrollBarTemplateTop = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_AchievementUI/Cata/Blizzard_AchievementUI.xml#L27)
--- child of HybridScrollBarTemplate (created in template HybridScrollBarBackgroundTemplate)
--- @type Texture
HybridScrollBarTemplateBottom = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_AchievementUI/Cata/Blizzard_AchievementUI.xml#L34)
--- child of HybridScrollBarTemplate (created in template HybridScrollBarBackgroundTemplate)
--- @type Texture
HybridScrollBarTemplateMiddle = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_AchievementUI/Cata/Blizzard_AchievementUI.xml#L43)
--- child of HybridScrollBarTemplate (created in template HybridScrollBarBackgroundTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_AchievementUI/Cata/Blizzard_AchievementUI.xml#L614)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_AchievementUI/Cata/Blizzard_AchievementUI.xml#L623)
--- child of AchievementFrameComparisonSummaryPlayerStatusBar (created in template AchievementHeaderStatusBarTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_AchievementUI/Cata/Blizzard_AchievementUI.xml#L633)
--- child of AchievementFrameComparisonSummaryPlayerStatusBar (created in template AchievementHeaderStatusBarTemplate)
--- @type Texture
AchievementFrameComparisonSummaryPlayerStatusBarLeft = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_AchievementUI/Cata/Blizzard_AchievementUI.xml#L644)
--- child of AchievementFrameComparisonSummaryPlayerStatusBar (created in template AchievementHeaderStatusBarTemplate)
--- @type Texture
AchievementFrameComparisonSummaryPlayerStatusBarRight = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_AchievementUI/Cata/Blizzard_AchievementUI.xml#L655)
--- child of AchievementFrameComparisonSummaryPlayerStatusBar (created in template AchievementHeaderStatusBarTemplate)
--- @type Texture
AchievementFrameComparisonSummaryPlayerStatusBarMiddle = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_AchievementUI/Cata/Blizzard_AchievementUI.xml#L664)
--- child of AchievementFrameComparisonSummaryPlayerStatusBar (created in template AchievementHeaderStatusBarTemplate)
--- @type Texture
