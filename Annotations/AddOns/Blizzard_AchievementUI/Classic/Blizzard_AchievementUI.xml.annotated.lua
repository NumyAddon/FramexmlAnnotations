...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_AchievementUI/Classic/Blizzard_AchievementUI.xml#L771)
--- child of AchievementTemplateIcon (created in template AchievementIconFrameTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_AchievementUI/Classic/Blizzard_AchievementUI.xml#L781)
--- child of AchievementTemplateIcon (created in template AchievementIconFrameTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_AchievementUI/Classic/Blizzard_AchievementUI.xml#L795)
--- child of AchievementTemplateIcon (created in template AchievementIconFrameTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_AchievementUI/Classic/Blizzard_AchievementUI.xml#L809)
--- child of AchievementTemplateIcon (created in template AchievementIconFrameTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_AchievementUI/Classic/Blizzard_AchievementUI.xml#L1440)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_AchievementUI/Classic/Blizzard_AchievementUI.xml#L1530)
--- child of ComparisonPlayerTemplateShield
--- @class ComparisonPlayerTemplate_ComparisonPlayerTemplateShield_ComparisonPlayerTemplateShieldPoints : FontString, GameFontNormal
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_AchievementUI/Classic/Blizzard_AchievementUI.xml#L1344)
--- child of SummaryAchievementTemplate (created in template ComparisonPlayerTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_AchievementUI/Classic/Blizzard_AchievementUI.xml#L1361)
--- child of SummaryAchievementTemplate (created in template ComparisonPlayerTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_AchievementUI/Classic/Blizzard_AchievementUI.xml#L1380)
--- child of SummaryAchievementTemplate (created in template ComparisonPlayerTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_AchievementUI/Classic/Blizzard_AchievementUI.xml#L1408)
--- child of SummaryAchievementTemplate (created in template ComparisonPlayerTemplate)
--- @type ComparisonPlayerTemplate_ComparisonPlayerTemplateDateCompleted

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_AchievementUI/Classic/Blizzard_AchievementUI.xml#L1420)
--- child of SummaryAchievementTemplate (created in template ComparisonPlayerTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_AchievementUI/Classic/Blizzard_AchievementUI.xml#L1867)
--- child of SummaryStatTemplate (created in template StatTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_AchievementUI/Classic/Blizzard_AchievementUI.xml#L1868)
--- child of SummaryStatTemplate (created in template StatTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_AchievementUI/Classic/Blizzard_AchievementUI.xml#L1879)
--- child of SummaryStatTemplate (created in template StatTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_AchievementUI/Classic/Blizzard_AchievementUI.xml#L1890)
--- child of SummaryStatTemplate (created in template StatTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_AchievementUI/Classic/Blizzard_AchievementUI.xml#L1904)
--- child of SummaryStatTemplate (created in template StatTemplate)
--- @type StatTemplate_StatTemplateTitle

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_AchievementUI/Classic/Blizzard_AchievementUI.xml#L1911)
--- child of SummaryStatTemplate (created in template StatTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_AchievementUI/Classic/Blizzard_AchievementUI.xml#L60)
--- child of AchievementFrameCategoriesContainerScrollBar (created in template HybridScrollBarTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_AchievementUI/Classic/Blizzard_AchievementUI.xml#L650)
--- child of AchievementFrameComparisonSummaryPlayerStatusBar (created in template AchievementHeaderStatusBarTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_AchievementUI/Classic/Blizzard_AchievementUI.xml#L660)
--- child of AchievementFrameComparisonSummaryPlayerStatusBar (created in template AchievementHeaderStatusBarTemplate)
--- @type Texture
AchievementFrameComparisonSummaryPlayerStatusBarLeft = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_AchievementUI/Classic/Blizzard_AchievementUI.xml#L671)
--- child of AchievementFrameComparisonSummaryPlayerStatusBar (created in template AchievementHeaderStatusBarTemplate)
--- @type Texture
AchievementFrameComparisonSummaryPlayerStatusBarRight = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_AchievementUI/Classic/Blizzard_AchievementUI.xml#L682)
--- child of AchievementFrameComparisonSummaryPlayerStatusBar (created in template AchievementHeaderStatusBarTemplate)
--- @type Texture
AchievementFrameComparisonSummaryPlayerStatusBarMiddle = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_AchievementUI/Classic/Blizzard_AchievementUI.xml#L691)
--- child of AchievementFrameComparisonSummaryPlayerStatusBar (created in template AchievementHeaderStatusBarTemplate)
--- @type Texture
