...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_ActionBar/Cata/ExtraActionBar.xml#L38)
--- child of ExtraActionButtonTemplate
--- @class ExtraActionButtonTemplate_cooldown : Cooldown, CooldownFrameTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_ActionBar/Cata/ExtraActionBar.xml#L15)
--- child of ExtraActionButtonTemplate
--- @class ExtraActionButtonTemplate_HotKey : FontString, NumberFontNormalGray

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_ActionBar/Cata/ExtraActionBar.xml#L21)
--- child of ExtraActionButtonTemplate
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_ActionBar/Cata/ExtraActionBar.xml#L63)
--- child of ExtraActionBarFrame
--- @class ExtraActionBarFrame_intro : AnimationGroup

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_ActionBar/Cata/ExtraActionBar.xml#L71)
--- child of ExtraActionBarFrame
