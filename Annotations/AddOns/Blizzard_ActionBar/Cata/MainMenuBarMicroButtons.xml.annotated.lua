...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Cata/MainMenuBarMicroButtons.xml#L563)
--- child of  (created in template GlowBoxArrowTemplate)
--- @type GlowBoxArrowTemplate_GlowBoxArrowTemplateArrow

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Cata/MainMenuBarMicroButtons.xml#L570)
--- child of  (created in template GlowBoxArrowTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Cata/MainMenuBarMicroButtons.xml#L595)
--- child of MicroButtonAlertTemplate (created in template GlowBoxTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Cata/MainMenuBarMicroButtons.xml#L608)
--- child of MicroButtonAlertTemplate (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_GlowBoxTemplateGlowTopLeft

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Cata/MainMenuBarMicroButtons.xml#L613)
--- child of MicroButtonAlertTemplate (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_GlowBoxTemplateGlowTopRight

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Cata/MainMenuBarMicroButtons.xml#L619)
--- child of MicroButtonAlertTemplate (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_GlowBoxTemplateGlowBottomLeft

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Cata/MainMenuBarMicroButtons.xml#L625)
--- child of MicroButtonAlertTemplate (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_GlowBoxTemplateGlowBottomRight

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Cata/MainMenuBarMicroButtons.xml#L631)
--- child of MicroButtonAlertTemplate (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_GlowBoxTemplateGlowTop

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Cata/MainMenuBarMicroButtons.xml#L637)
--- child of MicroButtonAlertTemplate (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_GlowBoxTemplateGlowBottom

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Cata/MainMenuBarMicroButtons.xml#L643)
--- child of MicroButtonAlertTemplate (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_GlowBoxTemplateGlowLeft

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Cata/MainMenuBarMicroButtons.xml#L649)
--- child of MicroButtonAlertTemplate (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_GlowBoxTemplateGlowRight

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Cata/MainMenuBarMicroButtons.xml#L657)
--- child of MicroButtonAlertTemplate (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_GlowBoxTemplateShadowTopLeft

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Cata/MainMenuBarMicroButtons.xml#L662)
--- child of MicroButtonAlertTemplate (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_GlowBoxTemplateShadowTopRight

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Cata/MainMenuBarMicroButtons.xml#L668)
--- child of MicroButtonAlertTemplate (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_GlowBoxTemplateShadowBottomLeft

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Cata/MainMenuBarMicroButtons.xml#L674)
--- child of MicroButtonAlertTemplate (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_GlowBoxTemplateShadowBottomRight

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Cata/MainMenuBarMicroButtons.xml#L680)
--- child of MicroButtonAlertTemplate (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_GlowBoxTemplateShadowTop

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Cata/MainMenuBarMicroButtons.xml#L686)
--- child of MicroButtonAlertTemplate (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_GlowBoxTemplateShadowBottom

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Cata/MainMenuBarMicroButtons.xml#L692)
--- child of MicroButtonAlertTemplate (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_GlowBoxTemplateShadowLeft

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Cata/MainMenuBarMicroButtons.xml#L698)
--- child of MicroButtonAlertTemplate (created in template GlowBoxTemplate)
