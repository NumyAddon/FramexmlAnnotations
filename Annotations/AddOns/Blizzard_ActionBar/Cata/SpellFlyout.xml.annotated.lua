...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_ActionBar/Cata/SpellFlyout.xml#L408)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_ActionBar/Cata/SpellFlyout.xml#L291)
--- child of SpellFlyoutButton1 (created in template ActionButtonTemplate)
--- @type Texture
SpellFlyoutButton1Icon = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_ActionBar/Cata/SpellFlyout.xml#L304)
--- child of SpellFlyoutButton1 (created in template ActionButtonTemplate)
--- @type Texture
SpellFlyoutButton1Flash = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_ActionBar/Cata/SpellFlyout.xml#L309)
--- child of SpellFlyoutButton1 (created in template ActionButtonTemplate)
--- @type Texture
SpellFlyoutButton1FlyoutBorderShadow = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_ActionBar/Cata/SpellFlyout.xml#L317)
--- child of SpellFlyoutButton1 (created in template ActionButtonTemplate)
--- @type ActionButtonTemplate_ActionButtonTemplateName
SpellFlyoutButton1Name = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_ActionBar/Cata/SpellFlyout.xml#L323)
--- child of SpellFlyoutButton1 (created in template ActionButtonTemplate)
--- @type Texture
SpellFlyoutButton1Border = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_ActionBar/Cata/SpellFlyout.xml#L423)
--- child of SpellFlyoutButton1 (created in template ActionButtonTemplate)
--- @type Texture
