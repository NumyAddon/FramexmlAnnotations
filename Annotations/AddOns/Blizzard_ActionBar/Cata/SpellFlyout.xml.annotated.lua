...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_ActionBar/Cata/SpellFlyout.xml#L387)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_ActionBar/Cata/SpellFlyout.xml#L300)
--- child of SpellFlyoutButton1 (created in template ActionButtonTemplate)
--- @type Texture
SpellFlyoutButton1Icon = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_ActionBar/Cata/SpellFlyout.xml#L313)
--- child of SpellFlyoutButton1 (created in template ActionButtonTemplate)
--- @type Texture
SpellFlyoutButton1Flash = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_ActionBar/Cata/SpellFlyout.xml#L320)
--- child of SpellFlyoutButton1 (created in template ActionButtonTemplate)
--- @type ActionButtonTemplate_ActionButtonTemplateName
SpellFlyoutButton1Name = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_ActionBar/Cata/SpellFlyout.xml#L326)
--- child of SpellFlyoutButton1 (created in template ActionButtonTemplate)
--- @type Texture
SpellFlyoutButton1Border = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_ActionBar/Cata/SpellFlyout.xml#L405)
--- child of SpellFlyoutButton1 (created in template ActionButtonTemplate)
--- @type Texture
