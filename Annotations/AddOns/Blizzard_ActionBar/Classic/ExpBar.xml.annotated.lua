...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_ActionBar/Classic/ExpBar.xml#L23)
--- child of ExpStatusBarTemplate
--- @class ExpStatusBarTemplate_ExhaustionTick : Button, ExhaustionTickMixin
--- @field hideAtBarEdge boolean # false
--- @field yOffset number # 0
--- @field Normal Texture
--- @field Highlight Texture

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_ActionBar/Classic/ExpBar.xml#L3)
--- Template
