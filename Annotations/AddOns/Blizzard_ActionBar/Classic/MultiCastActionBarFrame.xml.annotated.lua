...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L15)
--- child of MultiCastSpellButtonShine (created in template AutoCastShineTemplate)
--- @type Texture
MultiCastSpellButtonShine1 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L22)
--- child of MultiCastSpellButtonShine (created in template AutoCastShineTemplate)
--- @type Texture
MultiCastSpellButtonShine2 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L29)
--- child of MultiCastSpellButtonShine (created in template AutoCastShineTemplate)
--- @type Texture
MultiCastSpellButtonShine3 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L36)
--- child of MultiCastSpellButtonShine (created in template AutoCastShineTemplate)
--- @type Texture
MultiCastSpellButtonShine4 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L43)
--- child of MultiCastSpellButtonShine (created in template AutoCastShineTemplate)
--- @type Texture
MultiCastSpellButtonShine5 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L50)
--- child of MultiCastSpellButtonShine (created in template AutoCastShineTemplate)
--- @type Texture
MultiCastSpellButtonShine6 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L57)
--- child of MultiCastSpellButtonShine (created in template AutoCastShineTemplate)
--- @type Texture
MultiCastSpellButtonShine7 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L64)
--- child of MultiCastSpellButtonShine (created in template AutoCastShineTemplate)
--- @type Texture
MultiCastSpellButtonShine8 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L71)
--- child of MultiCastSpellButtonShine (created in template AutoCastShineTemplate)
--- @type Texture
MultiCastSpellButtonShine9 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L78)
--- child of MultiCastSpellButtonShine (created in template AutoCastShineTemplate)
--- @type Texture
MultiCastSpellButtonShine10 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L85)
--- child of MultiCastSpellButtonShine (created in template AutoCastShineTemplate)
--- @type Texture
MultiCastSpellButtonShine11 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L92)
--- child of MultiCastSpellButtonShine (created in template AutoCastShineTemplate)
--- @type Texture
MultiCastSpellButtonShine12 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L99)
--- child of MultiCastSpellButtonShine (created in template AutoCastShineTemplate)
--- @type Texture
MultiCastSpellButtonShine13 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L106)
--- child of MultiCastSpellButtonShine (created in template AutoCastShineTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L120)
--- child of MultiCastSpellButtonShine (created in template AutoCastShineTemplate)
--- @type Texture
MultiCastSpellButtonShine16 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L94)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L100)
--- child of MultiCastSpellButton (created in template ActionButtonTemplate)
--- @type ActionButtonTemplate_ActionButtonTemplateCooldown
MultiCastSpellButtonCooldown = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L23)
--- child of MultiCastSpellButton (created in template ActionButtonTemplate)
--- @type Texture
MultiCastSpellButtonIcon = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L26)
--- child of MultiCastSpellButton (created in template ActionButtonTemplate)
--- @type Texture
MultiCastSpellButtonFlash = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L27)
--- child of MultiCastSpellButton (created in template ActionButtonTemplate)
--- @type ActionButtonTemplate_ActionButtonTemplateFlyoutBorder
MultiCastSpellButtonFlyoutBorder = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L32)
--- child of MultiCastSpellButton (created in template ActionButtonTemplate)
--- @type ActionButtonTemplate_ActionButtonTemplateFlyoutBorderShadow
MultiCastSpellButtonFlyoutBorderShadow = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L39)
--- child of MultiCastSpellButton (created in template ActionButtonTemplate)
--- @type ActionButtonTemplate_ActionButtonTemplateFlyoutArrow
MultiCastSpellButtonFlyoutArrow = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L40)
--- child of MultiCastSpellButton (created in template ActionButtonTemplate)
--- @type ActionButtonTemplate_ActionButtonTemplateHotKey
MultiCastSpellButtonHotKey = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L46)
--- child of MultiCastSpellButton (created in template ActionButtonTemplate)
--- @type ActionButtonTemplate_ActionButtonTemplateCount
MultiCastSpellButtonCount = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L53)
--- child of MultiCastSpellButton (created in template ActionButtonTemplate)
--- @type ActionButtonTemplate_ActionButtonTemplateName
MultiCastSpellButtonName = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L59)
--- child of MultiCastSpellButton (created in template ActionButtonTemplate)
--- @type Texture
MultiCastSpellButtonBorder = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L110)
--- child of MultiCastSpellButton (created in template ActionButtonTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ActionBar/Classic/MultiCastActionBarFrame.xml#L96)
--- child of MultiCastSummonSpellButton (created in template MultiCastSpellButton)
--- @type Texture
