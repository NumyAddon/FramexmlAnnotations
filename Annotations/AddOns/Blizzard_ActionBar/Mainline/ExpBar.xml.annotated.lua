...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_ActionBar/Mainline/ExpBar.xml#L20)
--- child of ExpStatusBarTemplate
--- @class ExpStatusBarTemplate_ExhaustionTick : Button, ExhaustionTickMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_ActionBar/Mainline/ExpBar.xml#L3)
--- Template
