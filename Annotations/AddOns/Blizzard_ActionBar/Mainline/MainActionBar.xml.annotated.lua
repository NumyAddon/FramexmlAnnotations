...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_ActionBar/Mainline/MainActionBar.xml#L3)
--- Explicitly protected
--- Template
--- @class MainBarActionBarButtonTemplate : CheckButton, ActionBarButtonTemplate
--- @field showButtonArt boolean # true

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_ActionBar/Mainline/MainActionBar.xml#L10)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_ActionBar/Mainline/MainActionBar.xml#L20)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_ActionBar/Mainline/MainActionBar.xml#L92)
--- child of MainActionBar
--- @class MainActionBar_EndCaps : Frame, MainMenuBarEndCaps

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_ActionBar/Mainline/MainActionBar.xml#L111)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_ActionBar/Mainline/MainActionBar.xml#L128)
--- child of MainActionBar_ActionBarPageNumber
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_ActionBar/Mainline/MainActionBar.xml#L102)
--- child of MainActionBar_ActionBarPageNumber
--- @class MainActionBar_ActionBarPageNumber_Text : FontString, GameFontNormal

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_ActionBar/Mainline/MainActionBar.xml#L93)
--- child of MainActionBar
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_ActionBar/Mainline/MainActionBar.xml#L53)
--- child of MainActionBar
--- @class MainActionBar_BorderArt : Texture
--- @field ignoreInLayout boolean # true

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_ActionBar/Mainline/MainActionBar.xml#L29)
...
--- @field manageEndCaps any # MAIN_ACTION_BAR_MANAGE_END_CAPS
...
MainActionBar["manageEndCaps"] = MAIN_ACTION_BAR_MANAGE_END_CAPS
