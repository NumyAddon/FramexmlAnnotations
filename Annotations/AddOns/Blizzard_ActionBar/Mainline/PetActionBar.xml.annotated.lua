...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_ActionBar/Mainline/PetActionBar.xml#L15)
--- child of PetActionButtonTemplate
--- @class PetActionButtonTemplate_SpellHighlightAnim : AnimationGroup

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_ActionBar/Mainline/PetActionBar.xml#L3)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_ActionBar/Mainline/PetActionBar.xml#L33)
...
--- @field customGamepadModeVisibilityHandling boolean # true
PetActionBar = {}
...
PetActionBar["customGamepadModeVisibilityHandling"] = true
