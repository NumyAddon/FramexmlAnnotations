...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Mainline/SpellFlyout.xml#L51)
--- child of SpellFlyoutButtonTemplate
--- @class SpellFlyoutButtonTemplate_GlyphActivateAnim : AnimationGroup

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Mainline/SpellFlyout.xml#L67)
--- child of SpellFlyoutButtonTemplate
--- @class SpellFlyoutButtonTemplate_AbilityHighlightAnim : AnimationGroup

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Mainline/SpellFlyout.xml#L3)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Mainline/SpellFlyout.xml#L76)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Mainline/SpellFlyout.xml#L408)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Mainline/SpellFlyout.xml#L291)
--- child of SpellFlyoutButtonTemplate (created in template ActionButtonTemplate)
--- @type Texture
SpellFlyoutButtonTemplateIcon = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Mainline/SpellFlyout.xml#L304)
--- child of SpellFlyoutButtonTemplate (created in template ActionButtonTemplate)
--- @type Texture
SpellFlyoutButtonTemplateFlash = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Mainline/SpellFlyout.xml#L309)
--- child of SpellFlyoutButtonTemplate (created in template ActionButtonTemplate)
--- @type Texture
SpellFlyoutButtonTemplateFlyoutBorderShadow = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Mainline/SpellFlyout.xml#L317)
--- child of SpellFlyoutButtonTemplate (created in template ActionButtonTemplate)
--- @type ActionButtonTemplate_ActionButtonTemplateName
SpellFlyoutButtonTemplateName = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Mainline/SpellFlyout.xml#L323)
--- child of SpellFlyoutButtonTemplate (created in template ActionButtonTemplate)
--- @type Texture
SpellFlyoutButtonTemplateBorder = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Mainline/SpellFlyout.xml#L423)
--- child of SpellFlyoutButtonTemplate (created in template ActionButtonTemplate)
--- @type Texture
SpellFlyoutButtonTemplateNormalTexture = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Mainline/SpellFlyout.xml#L89)
--- child of SpellFlyout
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ActionBar/Mainline/SpellFlyout.xml#L74)
