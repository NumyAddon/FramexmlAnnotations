...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_ActionBar/Shared/SpellFlyout.xml#L39)
--- child of SpellFlyoutPopupButtonTemplate
--- @class SpellFlyoutPopupButtonTemplate_GlyphActivateAnim : AnimationGroup

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_ActionBar/Shared/SpellFlyout.xml#L55)
--- child of SpellFlyoutPopupButtonTemplate
--- @class SpellFlyoutPopupButtonTemplate_AbilityHighlightAnim : AnimationGroup

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_ActionBar/Shared/SpellFlyout.xml#L3)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_ActionBar/Shared/SpellFlyout.xml#L62)
