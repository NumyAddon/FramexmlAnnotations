...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_ActionBar/WoWLabs/PingKeybindReminder.xml#L15)
--- child of KeybindReminderTemplate
--- @class KeybindReminderTemplate_UnboundText : FontString, SystemFont_Shadow_Large2

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_ActionBar/WoWLabs/PingKeybindReminder.xml#L26)
--- child of KeybindReminderTemplate
--- @class KeybindReminderTemplate_KeyBind : FontString, SystemFont_Shadow_Large2

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_ActionBar/WoWLabs/PingKeybindReminder.xml#L32)
--- child of KeybindReminderTemplate
