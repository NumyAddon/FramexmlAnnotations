...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AdventureMap/AM_QuestDialog.lua#L72)
function AdventureMapQuestChoiceDialogMixin:OnHide() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AdventureMap/AM_QuestDialog.lua#L79)
function AdventureMapQuestChoiceDialogMixin:Finalize() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AdventureMap/AM_QuestDialog.lua#L89)
function AdventureMapQuestChoiceDialogMixin:Refresh() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AdventureMap/AM_QuestDialog.lua#L101)
function AdventureMapQuestChoiceDialogMixin:RefreshRewards() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AdventureMap/AM_QuestDialog.lua#L147)
function AdventureMapQuestChoiceDialogMixin:AddReward(label, texture, overlayTexture, count, font, tooltipText) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AdventureMap/AM_QuestDialog.lua#L184)
function AdventureMapQuestChoiceDialogMixin:RefreshDetails() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AdventureMap/AM_QuestDialog.lua#L252)
function AdventureMapQuestChoiceDialogMixin:AcceptQuest() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AdventureMap/AM_QuestDialog.lua#L258)
