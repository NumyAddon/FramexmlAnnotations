...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_AdventureMap/AM_QuestDialog.xml#L120)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_AdventureMap/AM_QuestDialog.xml#L126)
--- child of AdventureMapQuestChoiceDialog_Details_Child
--- @class AdventureMapQuestChoiceDialog_Details_Child_DescriptionText : FontString, QuestFont

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_AdventureMap/AM_QuestDialog.xml#L133)
--- child of AdventureMapQuestChoiceDialog_Details_Child
--- @class AdventureMapQuestChoiceDialog_Details_Child_ObjectivesHeader : FontString, QuestTitleFont

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_AdventureMap/AM_QuestDialog.xml#L140)
--- child of AdventureMapQuestChoiceDialog_Details_Child
--- @class AdventureMapQuestChoiceDialog_Details_Child_ObjectivesText : FontString, QuestFont

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_AdventureMap/AM_QuestDialog.xml#L116)
