...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AdventureMap/AM_QuestOfferDataProvider.lua#L131)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AdventureMap/AM_QuestOfferDataProvider.lua#L65)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AdventureMap/AM_QuestOfferDataProvider.lua#L80)
function AdventureMap_QuestOfferDataProviderMixin:OnQuestAccepted(pin) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AdventureMap/AM_QuestOfferDataProvider.lua#L88)
function AdventureMap_QuestOfferDataProviderMixin:OnQuestPinAreaEnclosedChanged(areaEnclosed) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AdventureMap/AM_QuestOfferDataProvider.lua#L96)
function AdventureMap_QuestOfferDataProviderMixin:OnQuestOfferPinClicked(pin) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AdventureMap/AM_QuestOfferDataProvider.lua#L123)
function AdventureMap_QuestOfferDataProviderMixin:OnCanvasScaleChanged() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AdventureMap/AM_QuestOfferDataProvider.lua#L133)
function AdventureMap_QuestOfferPinMixin:OnLoad() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AdventureMap/AM_QuestOfferDataProvider.lua#L138)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AdventureMap/AM_QuestOfferDataProvider.lua#L151)
function AdventureMap_QuestOfferPinMixin:OnMouseEnter() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_AdventureMap/AM_QuestOfferDataProvider.lua#L161)
