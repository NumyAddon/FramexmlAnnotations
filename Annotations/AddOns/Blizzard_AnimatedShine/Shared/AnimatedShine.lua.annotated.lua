...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_AnimatedShine/Shared/AnimatedShine.lua#L33)
function AnimatedShineMixin:Stop() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_AnimatedShine/Shared/AnimatedShine.lua#L41)
