...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_ArtifactUI/Blizzard_ArtifactUI.xml#L5)
--- Template
--- @class ArtifactFrameTabButtonTemplate : Button, PanelTabButtonTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_ArtifactUI/Blizzard_ArtifactUI.xml#L14)
--- @class ArtifactFrameUnderlay : Frame, ArtifactFrameUnderlayMixin
ArtifactFrameUnderlay = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_ArtifactUI/Blizzard_ArtifactUI.xml#L34)
--- child of ArtifactFrame
--- @class ArtifactFrame_VisitForgeOverlay : Frame
--- @field Background Texture
--- @field Text FontString

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_ArtifactUI/Blizzard_ArtifactUI.xml#L54)
--- child of ArtifactFrame
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_ArtifactUI/Blizzard_ArtifactUI.xml#L143)
--- child of ArtifactFrame_ForgeBadgeFrame
--- @class ArtifactFrame_ForgeBadgeFrame_ForgeLevelLabel : FontString, SystemFont_Shadow_Med2

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_ArtifactUI/Blizzard_ArtifactUI.xml#L110)
--- child of ArtifactFrame
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_ArtifactUI/Blizzard_ArtifactUI.xml#L175)
--- child of ArtifactFrame
--- @class ArtifactFrameTab1 : Button, ArtifactFrameTabButtonTemplate
ArtifactFrameTab1 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_ArtifactUI/Blizzard_ArtifactUI.xml#L180)
--- child of ArtifactFrame
--- @class ArtifactFrameTab2 : Button, ArtifactFrameTabButtonTemplate
ArtifactFrameTab2 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_ArtifactUI/Blizzard_ArtifactUI.xml#L186)
--- child of ArtifactFrame
--- @class ArtifactFrame_PerksTab : Frame, ArtifactPerksTabTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_ArtifactUI/Blizzard_ArtifactUI.xml#L187)
--- child of ArtifactFrame
--- @class ArtifactFrame_AppearancesTab : Frame, ArtifactAppearancesTabTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_ArtifactUI/Blizzard_ArtifactUI.xml#L189)
--- child of ArtifactFrame
--- @class ArtifactFrame_CloseButton : Button, UIPanelCloseButton

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_ArtifactUI/Blizzard_ArtifactUI.xml#L26)
