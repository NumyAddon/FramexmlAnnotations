...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_AuctionHouseUI/Blizzard_AuctionHouseItemList.xml#L5)
--- Template
--- @class AuctionHouseItemListLineTemplate : Button, AuctionHouseItemListLineMixin
--- @field SelectedHighlight Texture
--- @field HighlightTexture Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_AuctionHouseUI/Blizzard_AuctionHouseItemList.xml#L27)
--- Template
--- @class AuctionHouseFavoritableLineTemplate : Button, AuctionHouseItemListLineTemplate, AuctionHouseFavoritableLineMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_AuctionHouseUI/Blizzard_AuctionHouseItemList.xml#L29)
--- Template
--- @class AuctionHouseItemListHeadersTemplate : Frame

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_AuctionHouseUI/Blizzard_AuctionHouseItemList.xml#L50)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_AuctionHouseUI/Blizzard_AuctionHouseItemList.xml#L56)
--- child of AuctionHouseItemListTemplate
--- @class AuctionHouseItemListTemplate_HeaderContainer : Frame, AuctionHouseItemListHeadersTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_AuctionHouseUI/Blizzard_AuctionHouseItemList.xml#L62)
--- child of AuctionHouseItemListTemplate
--- @class AuctionHouseItemListTemplate_ScrollBox : Frame, WowScrollBoxList

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_AuctionHouseUI/Blizzard_AuctionHouseItemList.xml#L69)
--- child of AuctionHouseItemListTemplate
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_AuctionHouseUI/Blizzard_AuctionHouseItemList.xml#L93)
--- child of AuctionHouseItemListTemplate
