...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_AuctionHouseUI/Classic/Blizzard_AuctionHouseCategoriesList.xml#L4)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_AuctionHouseUI/Classic/Blizzard_AuctionHouseCategoriesList.xml#L69)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_AuctionHouseUI/Classic/Blizzard_AuctionHouseCategoriesList.xml#L71)
--- child of AuctionHouseCategoriesListTemplate
--- @class AuctionHouseCategoriesListTemplate_ScrollBox : Frame, WowScrollBoxList

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_AuctionHouseUI/Classic/Blizzard_AuctionHouseCategoriesList.xml#L77)
--- child of AuctionHouseCategoriesListTemplate
--- @class AuctionHouseCategoriesListTemplate_ScrollBar : EventFrame, WowClassicScrollBar

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_AuctionHouseUI/Classic/Blizzard_AuctionHouseCategoriesList.xml#L60)
--- Template
