...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_AuctionHouseUI/Classic/Blizzard_AuctionHouseMultisell.xml#L47)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_AuctionHouseUI/Classic/Blizzard_AuctionHouseMultisell.xml#L70)
--- child of AuctionHouseMultisellProgressFrame
--- @class AuctionHouseMultisellProgressFrame_CancelButton : Button

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_AuctionHouseUI/Classic/Blizzard_AuctionHouseMultisell.xml#L4)
