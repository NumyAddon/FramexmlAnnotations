...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_BNet/BNet.xml#L55)
--- child of BNToastFrame_TooltipFrame
--- @class BNToastFrame_TooltipFrame_Text : FontString, FriendsFont_Small

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_BNet/BNet.xml#L48)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_BNet/BNet.xml#L9)
--- child of BNToastFrame
--- @class BNToastFrameIconTexture : Texture
BNToastFrameIconTexture = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_BNet/BNet.xml#L16)
--- child of BNToastFrame
--- @class BNToastFrameTopLine : FontString, FriendsFont_Normal
BNToastFrameTopLine = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_BNet/BNet.xml#L24)
--- child of BNToastFrame
--- @class BNToastFrameMiddleLine : FontString, FriendsFont_Normal
BNToastFrameMiddleLine = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_BNet/BNet.xml#L31)
--- child of BNToastFrame
--- @class BNToastFrameBottomLine : FontString, FriendsFont_Normal
BNToastFrameBottomLine = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_BNet/BNet.xml#L38)
--- child of BNToastFrame
--- @class BNToastFrameDoubleLine : FontString, FriendsFont_Normal
BNToastFrameDoubleLine = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_BNet/BNet.xml#L17)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_BNet/BNet.xml#L3)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_BNet/BNet.xml#L87)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_BNet/BNet.xml#L83)
