...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_BNet/BNet.xml#L9)
--- child of BNToastFrame
--- @class BNToastFrame_BNToastFrameIconTexture : Texture
BNToastFrameIconTexture = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_BNet/BNet.xml#L16)
--- child of BNToastFrame
--- @class BNToastFrame_BNToastFrameTopLine : FontString, FriendsFont_Normal
BNToastFrameTopLine = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_BNet/BNet.xml#L24)
--- child of BNToastFrame
--- @class BNToastFrame_BNToastFrameMiddleLine : FontString, FriendsFont_Normal
BNToastFrameMiddleLine = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_BNet/BNet.xml#L31)
--- child of BNToastFrame
--- @class BNToastFrame_BNToastFrameBottomLine : FontString, FriendsFont_Normal
BNToastFrameBottomLine = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_BNet/BNet.xml#L38)
--- child of BNToastFrame
--- @class BNToastFrame_BNToastFrameDoubleLine : FontString, FriendsFont_Normal
BNToastFrameDoubleLine = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_BNet/BNet.xml#L17)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_BNet/BNet.xml#L3)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_BNet/BNet.xml#L87)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_BNet/BNet.xml#L83)
