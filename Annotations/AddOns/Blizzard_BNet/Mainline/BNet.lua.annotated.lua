...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_BNet/Mainline/BNet.lua#L130)
function BNToastMixin:BlockFailed(blockType) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_BNet/Mainline/BNet.lua#L138)
function BNToastMixin:OnCustomMessageChanged(toastData) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_BNet/Mainline/BNet.lua#L144)
function BNToastMixin:OnVariablesLoaded() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_BNet/Mainline/BNet.lua#L149)
function BNToastMixin:EnableToasts() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_BNet/Mainline/BNet.lua#L159)
function BNToastMixin:DisableToasts() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_BNet/Mainline/BNet.lua#L170)
function BNToastMixin:UpdateToastEvent(cvar, value) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_BNet/Mainline/BNet.lua#L185)
