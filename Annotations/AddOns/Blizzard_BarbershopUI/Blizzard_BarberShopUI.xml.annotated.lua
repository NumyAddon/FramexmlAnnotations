...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_BarbershopUI/Blizzard_BarberShopUI.xml#L3)
--- Template
--- @class BarberShopButtonTemplate : Button, SharedButtonLargeTemplate, BarberShopButtonMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_BarbershopUI/Blizzard_BarberShopUI.xml#L38)
