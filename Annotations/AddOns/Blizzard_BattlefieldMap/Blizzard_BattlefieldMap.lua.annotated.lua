...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_BattlefieldMap/Blizzard_BattlefieldMap.lua#L27)
function BattlefieldMapTabMixin:OnEvent(event) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_BattlefieldMap/Blizzard_BattlefieldMap.lua#L41)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_BattlefieldMap/Blizzard_BattlefieldMap.lua#L220)
function BattlefieldMapMixin:AddStandardDataProviders() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_BattlefieldMap/Blizzard_BattlefieldMap.lua#L278)
function BattlefieldMapMixin:RefreshAlpha() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_BattlefieldMap/Blizzard_BattlefieldMap.lua#L284)
function BattlefieldMapMixin:UpdateUnitsVisibility() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_BattlefieldMap/Blizzard_BattlefieldMap.lua#L298)
function BattlefieldMapMixin:OnUpdate(elapsed) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_BattlefieldMap/Blizzard_BattlefieldMap.lua#L346)
