...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_BattlefieldMap/Blizzard_BattlefieldMap.xml#L284)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_BattlefieldMap/Blizzard_BattlefieldMap.xml#L226)
--- child of  (created in template UIDropDownMenuTemplate)
--- @type Texture
Left = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_BattlefieldMap/Blizzard_BattlefieldMap.xml#L239)
--- child of  (created in template UIDropDownMenuTemplate)
--- @type Texture
Middle = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_BattlefieldMap/Blizzard_BattlefieldMap.xml#L248)
--- child of  (created in template UIDropDownMenuTemplate)
--- @type Texture
Right = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_BattlefieldMap/Blizzard_BattlefieldMap.xml#L257)
--- child of  (created in template UIDropDownMenuTemplate)
--- @type UIDropDownMenuTemplate_UIDropDownMenuTemplateText
Text = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_BattlefieldMap/Blizzard_BattlefieldMap.xml#L271)
--- child of  (created in template UIDropDownMenuTemplate)
--- @type Texture
Icon = {}
