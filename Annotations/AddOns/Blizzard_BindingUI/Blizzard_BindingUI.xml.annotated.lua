...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_BindingUI/Blizzard_BindingUI.xml#L985)
--- child of KeyBindingFrameBindingButtonTemplate (created in template UIMenuButtonStretchTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_BindingUI/Blizzard_BindingUI.xml#L992)
--- child of KeyBindingFrameBindingButtonTemplate (created in template UIMenuButtonStretchTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_BindingUI/Blizzard_BindingUI.xml#L999)
--- child of KeyBindingFrameBindingButtonTemplate (created in template UIMenuButtonStretchTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_BindingUI/Blizzard_BindingUI.xml#L1006)
--- child of KeyBindingFrameBindingButtonTemplate (created in template UIMenuButtonStretchTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_BindingUI/Blizzard_BindingUI.xml#L1013)
--- child of KeyBindingFrameBindingButtonTemplate (created in template UIMenuButtonStretchTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_BindingUI/Blizzard_BindingUI.xml#L1021)
--- child of KeyBindingFrameBindingButtonTemplate (created in template UIMenuButtonStretchTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_BindingUI/Blizzard_BindingUI.xml#L1029)
--- child of KeyBindingFrameBindingButtonTemplate (created in template UIMenuButtonStretchTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_BindingUI/Blizzard_BindingUI.xml#L1037)
--- child of KeyBindingFrameBindingButtonTemplate (created in template UIMenuButtonStretchTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_BindingUI/Blizzard_BindingUI.xml#L1045)
--- child of KeyBindingFrameBindingButtonTemplate (created in template UIMenuButtonStretchTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_BindingUI/Blizzard_BindingUI.xml#L174)
