...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_BlackMarketUI/Blizzard_BlackMarketUI.xml#L105)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_BlackMarketUI/Blizzard_BlackMarketUI.xml#L124)
--- child of HotItemCurrentBidMoneyFrame (created in template SmallMoneyFrameTemplate)
--- @type SmallMoneyFrameTemplate_SilverButton
HotItemCurrentBidMoneyFrameSilverButton = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_BlackMarketUI/Blizzard_BlackMarketUI.xml#L143)
--- child of HotItemCurrentBidMoneyFrame (created in template SmallMoneyFrameTemplate)
--- @type SmallMoneyFrameTemplate_GoldButton
HotItemCurrentBidMoneyFrameGoldButton = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_BlackMarketUI/Blizzard_BlackMarketUI.xml#L85)
--- child of HotItemCurrentBidMoneyFrame (created in template SmallMoneyFrameTemplate)
--- @type Texture
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_BlackMarketUI/Blizzard_BlackMarketUI.xml#L1354)
--- child of BlackMarketFrame_MoneyFrameBorder (created in template ThinGoldEdgeTemplate)
--- @type Texture
BlackMarketFrameLeft = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_BlackMarketUI/Blizzard_BlackMarketUI.xml#L1362)
--- child of BlackMarketFrame_MoneyFrameBorder (created in template ThinGoldEdgeTemplate)
--- @type Texture
BlackMarketFrameRight = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_BlackMarketUI/Blizzard_BlackMarketUI.xml#L1370)
--- child of BlackMarketFrame_MoneyFrameBorder (created in template ThinGoldEdgeTemplate)
--- @type Texture
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_BlackMarketUI/Blizzard_BlackMarketUI.xml#L17)
--- child of BlackMarketBidPriceGold (created in template MoneyFrameEditBoxTemplate)
--- @type Texture
BlackMarketBidPriceGoldLeft = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_BlackMarketUI/Blizzard_BlackMarketUI.xml#L25)
--- child of BlackMarketBidPriceGold (created in template MoneyFrameEditBoxTemplate)
--- @type Texture
BlackMarketBidPriceGoldRight = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_BlackMarketUI/Blizzard_BlackMarketUI.xml#L33)
--- child of BlackMarketBidPriceGold (created in template MoneyFrameEditBoxTemplate)
--- @type Texture
BlackMarketBidPriceGoldMiddle = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_BlackMarketUI/Blizzard_BlackMarketUI.xml#L79)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_BlackMarketUI/Blizzard_BlackMarketUI.xml#L96)
--- child of BlackMarketBidPrice (created in template MoneyInputFrameTemplate)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_BlackMarketUI/Blizzard_BlackMarketUI.xml#L111)
--- child of BlackMarketBidPrice (created in template MoneyInputFrameTemplate)
