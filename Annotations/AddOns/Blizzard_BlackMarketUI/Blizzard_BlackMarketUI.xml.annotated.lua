...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_BlackMarketUI/Blizzard_BlackMarketUI.xml#L1318)
--- child of BlackMarketFrame_MoneyFrameBorder (created in template ThinGoldEdgeTemplate)
--- @type Texture
BlackMarketFrameLeft = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_BlackMarketUI/Blizzard_BlackMarketUI.xml#L1326)
--- child of BlackMarketFrame_MoneyFrameBorder (created in template ThinGoldEdgeTemplate)
--- @type Texture
BlackMarketFrameRight = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_BlackMarketUI/Blizzard_BlackMarketUI.xml#L1334)
--- child of BlackMarketFrame_MoneyFrameBorder (created in template ThinGoldEdgeTemplate)
--- @type Texture
