...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_BuffFrame/BuffFrameTemplates.xml#L33)
--- child of AuraButtonArtTemplate
--- @class AuraButtonArtTemplate_Symbol : FontString, TextStatusBarText

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_BuffFrame/BuffFrameTemplates.xml#L38)
--- child of AuraButtonArtTemplate
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_BuffFrame/BuffFrameTemplates.xml#L47)
--- Template
--- @class AuraButtonCodeTemplate : Button, AuraButtonArtTemplate, AuraButtonMixin

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_BuffFrame/BuffFrameTemplates.xml#L54)
--- Template
--- @class AuraButtonTemplate : Button, AuraButtonCodeTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_BuffFrame/BuffFrameTemplates.xml#L64)
--- Template
--- @class AuraContainerWarningFaderTemplate : AnimationGroup, AuraContainerWarningFaderMixin
--- @field Animation Animation

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_BuffFrame/BuffFrameTemplates.xml#L82)
--- child of AuraContainerTemplate
--- @class AuraContainerTemplate_WarningFader : AnimationGroup, AuraContainerWarningFaderTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_BuffFrame/BuffFrameTemplates.xml#L68)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_BuffFrame/BuffFrameTemplates.xml#L90)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_BuffFrame/BuffFrameTemplates.xml#L119)
--- child of AuraFrameTemplate
--- @class AuraFrameTemplate_AuraContainer : Frame, AuraContainerTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_BuffFrame/BuffFrameTemplates.xml#L112)
--- Template
--- @class AuraFrameTemplate : Frame, AuraFrameMixin
--- @field AuraContainer AuraFrameTemplate_AuraContainer

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_BuffFrame/BuffFrameTemplates.xml#L130)
--- Template
--- @class AuraFrameEventListenerTemplate : Frame, AuraFrameTemplate, AuraFrameEventListenerMixin

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_BuffFrame/BuffFrameTemplates.xml#L137)
--- Template
