...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_BuffFrame/BuffFrameTemplates.xml#L39)
--- child of AuraButtonArtTemplate
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_BuffFrame/BuffFrameTemplates.xml#L48)
--- Template
--- @class AuraButtonCodeTemplate : Button, AuraButtonArtTemplate, AuraButtonMixin

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_BuffFrame/BuffFrameTemplates.xml#L55)
--- Template
--- @class AuraButtonTemplate : Button, AuraButtonCodeTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_BuffFrame/BuffFrameTemplates.xml#L65)
--- Template
--- @class AuraContainerWarningFaderTemplate : AnimationGroup, AuraContainerWarningFaderMixin
--- @field Animation Animation

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_BuffFrame/BuffFrameTemplates.xml#L83)
--- child of AuraContainerTemplate
--- @class AuraContainerTemplate_WarningFader : AnimationGroup, AuraContainerWarningFaderTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_BuffFrame/BuffFrameTemplates.xml#L69)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_BuffFrame/BuffFrameTemplates.xml#L91)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_BuffFrame/BuffFrameTemplates.xml#L120)
--- child of AuraFrameTemplate
--- @class AuraFrameTemplate_AuraContainer : Frame, AuraContainerTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_BuffFrame/BuffFrameTemplates.xml#L113)
--- Template
--- @class AuraFrameTemplate : Frame, AuraFrameMixin
--- @field AuraContainer AuraFrameTemplate_AuraContainer

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_BuffFrame/BuffFrameTemplates.xml#L131)
--- Template
--- @class AuraFrameEventListenerTemplate : Frame, AuraFrameTemplate, AuraFrameEventListenerMixin

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_BuffFrame/BuffFrameTemplates.xml#L138)
--- Template
