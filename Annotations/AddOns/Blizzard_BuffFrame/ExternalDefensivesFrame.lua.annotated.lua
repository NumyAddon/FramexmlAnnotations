...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_BuffFrame/ExternalDefensivesFrame.lua#L10)
function ExternalDefensivesFrameMixin:OnExternalDefensivesEnabledCVarChanged() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_BuffFrame/ExternalDefensivesFrame.lua#L14)
function ExternalDefensivesFrameMixin:ShouldBeShown() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_BuffFrame/ExternalDefensivesFrame.lua#L22)
