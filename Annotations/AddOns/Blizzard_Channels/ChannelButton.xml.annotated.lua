...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Channels/ChannelButton.xml#L62)
--- Template
--- @class ChannelButtonTextTemplate : Button, ChannelButtonTemplate, ChannelButtonTextMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Channels/ChannelButton.xml#L63)
--- Template
--- @class ChannelButtonVoiceTemplate : Button, ChannelButtonTemplate, ChannelButtonVoiceMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Channels/ChannelButton.xml#L64)
--- Template
