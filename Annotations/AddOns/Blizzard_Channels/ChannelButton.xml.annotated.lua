...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Channels/ChannelButton.xml#L5)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Channels/ChannelButton.xml#L17)
--- Template
--- @class ChannelButtonBaseTemplate : Button, ChannelButtonBaseMixin
--- @field NormalTexture Texture
--- @field HighlightTexture Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Channels/ChannelButton.xml#L36)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Channels/ChannelButton.xml#L62)
--- Template
--- @class ChannelButtonTextTemplate : Button, ChannelButtonTemplate, ChannelButtonTextMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Channels/ChannelButton.xml#L63)
--- Template
--- @class ChannelButtonVoiceTemplate : Button, ChannelButtonTemplate, ChannelButtonVoiceMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Channels/ChannelButton.xml#L64)
--- Template
