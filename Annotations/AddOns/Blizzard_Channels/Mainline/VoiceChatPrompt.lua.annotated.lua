...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_Channels/Mainline/VoiceChatPrompt.lua#L70)
function VoiceChatActivateChannelPromptMixin:OnHide() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_Channels/Mainline/VoiceChatPrompt.lua#L74)
function VoiceChatActivateChannelPromptMixin:OnEvent(event, ...) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_Channels/Mainline/VoiceChatPrompt.lua#L80)
function VoiceChatActivateChannelPromptMixin:OnVoiceChannelActivated(channelID) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_Channels/Mainline/VoiceChatPrompt.lua#L87)
function VoiceChatActivateChannelPromptMixin:Setup(channel) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_Channels/Mainline/VoiceChatPrompt.lua#L96)
function VoiceChatActivateChannelPromptMixin:ShowPrompt(channel) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_Channels/Mainline/VoiceChatPrompt.lua#L109)
function VoiceChatActivateChannelPromptMixin:CheckActivateChannel(channel) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_Channels/Mainline/VoiceChatPrompt.lua#L126)
function VoiceChatActivateChannelPromptMixin:ShouldPromptForChannelActivate(channel) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_Channels/Mainline/VoiceChatPrompt.lua#L130)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_Channels/Mainline/VoiceChatPrompt.lua#L151)
function VoiceChatChannelActivatedNotificationMixin:OnVoiceChannelActivated(channelID) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_Channels/Mainline/VoiceChatPrompt.lua#L160)
function VoiceChatChannelActivatedNotificationMixin:ListenForChannelActivation(channel) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_Channels/Mainline/VoiceChatPrompt.lua#L165)
