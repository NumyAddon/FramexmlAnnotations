...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Channels/VoiceActivityManager.lua#L1)
--- @class VoiceActivityManagerMixin
VoiceActivityManagerMixin = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Channels/VoiceActivityManager.lua#L3)
function VoiceActivityManagerMixin:OnLoad() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Channels/VoiceActivityManager.lua#L30)
function VoiceActivityManagerMixin:OnEvent(event, ...) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Channels/VoiceActivityManager.lua#L48)
function VoiceActivityManagerMixin:OnVoiceChannelMemberSpeakingStateChanged(memberID, channelID, isSpeaking) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Channels/VoiceActivityManager.lua#L60)
function VoiceActivityManagerMixin:OnVoiceChatChannelMemberEnergyChanged(memberID, channelID, speakingEnergy) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Channels/VoiceActivityManager.lua#L68)
function VoiceActivityManagerMixin:OnVoiceChatChannelTransmitChanged(channelID, isTransmitting) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Channels/VoiceActivityManager.lua#L84)
function VoiceActivityManagerMixin:OnVoiceChatCommunicationModeChanged(communicationMode) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Channels/VoiceActivityManager.lua#L107)
function VoiceActivityManagerMixin:OnMemberRemoved(memberID, channelID) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Channels/VoiceActivityManager.lua#L111)
function VoiceActivityManagerMixin:OnChannelRemoved(channelID) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Channels/VoiceActivityManager.lua#L115)
function VoiceActivityManagerMixin:OnChannelDeactivated(channelID) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Channels/VoiceActivityManager.lua#L121)
function VoiceActivityManagerMixin:CreateNotification(memberID, channelID, frameTemplate, isLocalPlayer, parentFrame) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Channels/VoiceActivityManager.lua#L132)
function VoiceActivityManagerMixin:CheckForAlertOnAdd(notification) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Channels/VoiceActivityManager.lua#L145)
function VoiceActivityManagerMixin:CheckForAlertOnRemove(notification) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Channels/VoiceActivityManager.lua#L154)
function VoiceActivityManagerMixin:ShowNotifications(memberID, channelID) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Channels/VoiceActivityManager.lua#L173)
function VoiceActivityManagerMixin:LinkFrameNotificationAndGuid(frame, notification, guid) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Channels/VoiceActivityManager.lua#L183)
function VoiceActivityManagerMixin:GetShowingInternalNotificationForGuid(guid) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Channels/VoiceActivityManager.lua#L195)
function VoiceActivityManagerMixin:ShowInternalNotifications(memberID, channelID, isLocalPlayer) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Channels/VoiceActivityManager.lua#L209)
function VoiceActivityManagerMixin:ShowExternalNotifications(memberID, channelID, isLocalPlayer) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Channels/VoiceActivityManager.lua#L233)
