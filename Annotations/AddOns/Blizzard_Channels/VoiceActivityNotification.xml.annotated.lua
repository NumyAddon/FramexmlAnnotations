...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Channels/VoiceActivityNotification.xml#L5)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Channels/VoiceActivityNotification.xml#L31)
--- Template
--- @class VoiceActivityNotificationBaseTemplate : Button, VoiceActivityNotificationBaseMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Channels/VoiceActivityNotification.xml#L82)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Channels/VoiceActivityNotification.xml#L68)
--- child of VoiceActivityNotificationTemplate
--- @class VoiceActivityNotificationTemplate_Name : FontString, GameFontNormal

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Channels/VoiceActivityNotification.xml#L41)
--- Template
