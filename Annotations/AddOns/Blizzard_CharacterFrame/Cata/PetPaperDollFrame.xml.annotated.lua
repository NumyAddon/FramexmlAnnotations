...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_CharacterFrame/Cata/PetPaperDollFrame.xml#L9)
--- child of CompanionButtonTemplate
--- @class CompanionButtonTemplate_CompanionButtonTemplateActiveTexture : Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_CharacterFrame/Cata/PetPaperDollFrame.xml#L43)
--- child of CompanionButtonTemplate
