...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L127)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L136)
--- child of DressUpFrame
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L175)
--- child of DressUpModelFrame
--- @class DressUpModelFrameRotateLeftButton : Button
DressUpModelFrameRotateLeftButton = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L148)
--- child of DressUpFrame
--- @class DressUpModelFrame : DressUpModel
DressUpModelFrame = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L217)
--- child of DressUpFrame
--- @class DressUpFramePortrait : Texture
DressUpFramePortrait = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L225)
--- child of DressUpFrame
--- @class DressUpFrameTitleText : FontString, GameFontHighlight
DressUpFrameTitleText = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L231)
--- child of DressUpFrame
--- @class DressUpFrameDescriptionText : FontString, GameFontNormalSmall
DressUpFrameDescriptionText = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L239)
--- child of DressUpFrame
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L251)
--- child of DressUpFrame
--- @class DressUpFrameBackgroundBot : Texture
DressUpFrameBackgroundBot = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L257)
--- child of DressUpFrame
--- @class DressUpFrameBackgroundBot : Texture
DressUpFrameBackgroundBot = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L746)
--- child of DressUpFrameInset (created in template InsetFrameTemplate)
--- @type Texture
DressUpFrameInsetBg = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L787)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L768)
--- child of DressUpFrame (created in template ButtonFrameTemplate)
--- @type ButtonFrameTemplate_BtnCornerLeft
DressUpFrameBtnCornerLeft = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L773)
--- child of DressUpFrame (created in template ButtonFrameTemplate)
--- @type ButtonFrameTemplate_BtnCornerRight
DressUpFrameBtnCornerRight = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L778)
--- child of DressUpFrame (created in template ButtonFrameTemplate)
--- @type ButtonFrameTemplate_ButtonBottomBorder
DressUpFrameButtonBottomBorder = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L604)
--- child of DressUpFrame (created in template PortraitFrameTemplate)
--- @type PortraitFrameTemplate_CloseButton
DressUpFrameCloseButton = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L510)
--- child of DressUpFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type Texture
DressUpFrameBg = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L516)
--- child of DressUpFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type PortraitFrameTemplateNoCloseButton_TitleBg
DressUpFrameTitleBg = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L524)
--- child of DressUpFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type Texture
DressUpFramePortrait = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L532)
--- child of DressUpFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type PortraitFrameTemplateNoCloseButton_PortraitFrame
DressUpFramePortraitFrame = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L537)
--- child of DressUpFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type PortraitFrameTemplateNoCloseButton_TopRightCorner
DressUpFrameTopRightCorner = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L542)
--- child of DressUpFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type PortraitFrameTemplateNoCloseButton_TopLeftCorner
DressUpFrameTopLeftCorner = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L547)
--- child of DressUpFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type PortraitFrameTemplateNoCloseButton_TopBorder
DressUpFrameTopBorder = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L553)
--- child of DressUpFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type PortraitFrameTemplateNoCloseButton_TitleText
DressUpFrameTitleText = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L562)
--- child of DressUpFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type PortraitFrameTemplateNoCloseButton_TopTileStreaks
DressUpFrameTopTileStreaks = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L568)
--- child of DressUpFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type PortraitFrameTemplateNoCloseButton_BotLeftCorner
DressUpFrameBotLeftCorner = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L573)
--- child of DressUpFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type PortraitFrameTemplateNoCloseButton_BotRightCorner
DressUpFrameBotRightCorner = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L578)
--- child of DressUpFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type PortraitFrameTemplateNoCloseButton_BottomBorder
DressUpFrameBottomBorder = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L584)
--- child of DressUpFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type PortraitFrameTemplateNoCloseButton_LeftBorder
DressUpFrameLeftBorder = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Classic/DressUpFrames.xml#L590)
--- child of DressUpFrame (created in template PortraitFrameTemplateNoCloseButton)
