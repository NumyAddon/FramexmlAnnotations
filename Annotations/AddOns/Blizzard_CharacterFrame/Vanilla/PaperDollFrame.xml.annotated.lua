...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_CharacterFrame/Vanilla/PaperDollFrame.xml#L85)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_CharacterFrame/Vanilla/PaperDollFrame.xml#L97)
--- child of PaperDollItemSlotButtonTemplate (created in template ItemButtonTemplate)
--- @type ItemButtonTemplate_ItemButtonTemplateStock

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_CharacterFrame/Vanilla/PaperDollFrame.xml#L108)
--- child of PaperDollItemSlotButtonTemplate (created in template ItemButtonTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_CharacterFrame/Vanilla/PaperDollFrame.xml#L127)
--- child of PaperDollItemSlotButtonTemplate (created in template ItemButtonTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_CharacterFrame/Vanilla/PaperDollFrame.xml#L135)
--- child of PaperDollItemSlotButtonTemplate (created in template ItemButtonTemplate)
--- @type Texture
