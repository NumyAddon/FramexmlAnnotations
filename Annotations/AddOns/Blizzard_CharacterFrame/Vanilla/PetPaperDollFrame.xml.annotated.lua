...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_CharacterFrame/Vanilla/PetPaperDollFrame.xml#L97)
--- child of AttributeFrameTemplateStat
--- @class AttributeFrameTemplate_Stat_Text : FontString, GameFontHighlightSmall

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_CharacterFrame/Vanilla/PetPaperDollFrame.xml#L90)
--- child of PetStatFrame1 (created in template AttributeFrameTemplate)
--- @type AttributeFrameTemplate_Stat
PetStatFrame1Stat = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_CharacterFrame/Vanilla/PetPaperDollFrame.xml#L82)
--- child of PetStatFrame1 (created in template AttributeFrameTemplate)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_CharacterFrame/Vanilla/PetPaperDollFrame.xml#L60)
--- child of StatFrameTemplateStat
--- @class StatFrameTemplate_Stat_Text : FontString, GameFontHighlightSmall

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_CharacterFrame/Vanilla/PetPaperDollFrame.xml#L53)
--- child of PetAttackFrame (created in template StatFrameTemplate)
--- @type StatFrameTemplate_Stat
PetAttackFrameStat = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_CharacterFrame/Vanilla/PetPaperDollFrame.xml#L45)
--- child of PetAttackFrame (created in template StatFrameTemplate)
