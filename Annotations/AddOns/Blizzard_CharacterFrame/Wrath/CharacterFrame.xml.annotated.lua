...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_CharacterFrame/Wrath/CharacterFrame.xml#L9)
--- child of CharacterFrameTab1 (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
CharacterFrameTab1LeftDisabled = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_CharacterFrame/Wrath/CharacterFrame.xml#L22)
--- child of CharacterFrameTab1 (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_CharacterFrame/Wrath/CharacterFrame.xml#L40)
--- child of CharacterFrameTab1 (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
CharacterFrameTab1Left = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_CharacterFrame/Wrath/CharacterFrame.xml#L49)
--- child of CharacterFrameTab1 (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
CharacterFrameTab1Middle = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_CharacterFrame/Wrath/CharacterFrame.xml#L58)
--- child of CharacterFrameTab1 (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
CharacterFrameTab1Right = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_CharacterFrame/Wrath/CharacterFrame.xml#L113)
--- child of CharacterFrameTab1 (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
