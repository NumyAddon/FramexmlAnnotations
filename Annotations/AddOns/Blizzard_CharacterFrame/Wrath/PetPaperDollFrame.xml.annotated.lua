...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Wrath/PetPaperDollFrame.xml#L93)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Wrath/PetPaperDollFrame.xml#L84)
--- child of PetStatFrame1 (created in template StatFrameTemplate)
--- @type StatFrameTemplate_StatFrameTemplateStat
PetStatFrame1Stat = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Wrath/PetPaperDollFrame.xml#L76)
--- child of PetStatFrame1 (created in template StatFrameTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Wrath/PetPaperDollFrame.xml#L1320)
--- child of PetPaperDollFrameTab1 (created in template TabButtonTemplate)
--- @type Texture
PetPaperDollFrameTab1LeftDisabled = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Wrath/PetPaperDollFrame.xml#L1333)
--- child of PetPaperDollFrameTab1 (created in template TabButtonTemplate)
--- @type Texture
PetPaperDollFrameTab1MiddleDisabled = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Wrath/PetPaperDollFrame.xml#L1342)
--- child of PetPaperDollFrameTab1 (created in template TabButtonTemplate)
--- @type Texture
PetPaperDollFrameTab1RightDisabled = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Wrath/PetPaperDollFrame.xml#L1351)
--- child of PetPaperDollFrameTab1 (created in template TabButtonTemplate)
--- @type Texture
PetPaperDollFrameTab1Left = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Wrath/PetPaperDollFrame.xml#L1360)
--- child of PetPaperDollFrameTab1 (created in template TabButtonTemplate)
--- @type Texture
PetPaperDollFrameTab1Middle = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Wrath/PetPaperDollFrame.xml#L1369)
--- child of PetPaperDollFrameTab1 (created in template TabButtonTemplate)
--- @type Texture
PetPaperDollFrameTab1Right = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_CharacterFrame/Wrath/PetPaperDollFrame.xml#L1400)
--- child of PetPaperDollFrameTab1 (created in template TabButtonTemplate)
--- @type Texture
