...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_CharacterFrame/Wrath/PetPaperDollFrame.xml#L55)
--- child of PetStatFrame1 (created in template StatFrameTemplate)
--- @type StatFrameTemplate_StatFrameTemplateStat
PetStatFrame1Stat = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_CharacterFrame/Wrath/PetPaperDollFrame.xml#L47)
--- child of PetStatFrame1 (created in template StatFrameTemplate)
