...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ChatFrame/Classic/BattlegroundChatFilters.lua#L62)
function BattlegroundChatFiltersMixin:OnEvent(event, ...) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ChatFrame/Classic/BattlegroundChatFilters.lua#L70)
function BattlegroundChatFiltersMixin:OnUpdate(elapsed) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ChatFrame/Classic/BattlegroundChatFilters.lua#L144)
function BattlegroundChatFiltersMixin:StartBGChatFilter() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ChatFrame/Classic/BattlegroundChatFilters.lua#L154)
