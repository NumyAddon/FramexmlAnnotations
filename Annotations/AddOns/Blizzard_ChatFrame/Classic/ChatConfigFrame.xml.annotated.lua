...
--- child of ConfigFilterButtonTemplate (created in template ConfigCategoryButtonTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ChatFrame/Classic/ChatConfigFrame.xml#L48)
--- child of ChatConfigTextBoxTemplateWithButton (created in template ChatConfigTextBoxTemplate)
--- @type ChatConfigTextBoxTemplate_ChatConfigTextBoxTemplateText
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ChatFrame/Classic/ChatConfigFrame.xml#L75)
--- child of ChatConfigBoxWithHeaderAndClassColorsTemplate (created in template ChatConfigBoxWithHeaderTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ChatFrame/Classic/ChatConfigFrame.xml#L206)
--- child of ChatConfigCheckboxTemplateCheck (created in template ChatConfigCheckButtonTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ChatFrame/Classic/ChatConfigFrame.xml#L206)
--- child of ChatConfigCheckboxSmallTemplateCheck (created in template ChatConfigCheckButtonTemplate)
--- @type ChatConfigCheckButtonTemplate_ChatConfigCheckButtonTemplateText

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ChatFrame/Classic/ChatConfigFrame.xml#L248)
--- child of ChatConfigCheckboxSmallTemplate (created in template ChatConfigCheckboxTemplate)
--- @type ChatConfigCheckboxTemplate_ChatConfigCheckboxTemplateCheck
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ChatFrame/Classic/ChatConfigFrame.xml#L206)
--- child of ChatConfigCheckboxWithSwatchTemplateCheck (created in template ChatConfigCheckButtonTemplate)
--- @type ChatConfigCheckButtonTemplate_ChatConfigCheckButtonTemplateText

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ChatFrame/Classic/ChatConfigFrame.xml#L248)
--- child of ChatConfigCheckboxWithSwatchTemplate (created in template ChatConfigCheckboxTemplate)
--- @type ChatConfigCheckboxTemplate_ChatConfigCheckboxTemplateCheck
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ChatFrame/Classic/ChatConfigFrame.xml#L265)
--- child of ChatConfigWideCheckboxWithSwatchTemplate (created in template ChatConfigCheckboxWithSwatchTemplate)
--- @type ChatConfigCheckboxWithSwatchTemplate_ChatConfigCheckboxWithSwatchTemplateColorSwatch
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ChatFrame/Classic/ChatConfigFrame.xml#L265)
--- child of ChatConfigCheckboxWithSwatchAndClassColorTemplate (created in template ChatConfigCheckboxWithSwatchTemplate)
--- @type ChatConfigCheckboxWithSwatchTemplate_ChatConfigCheckboxWithSwatchTemplateColorSwatch
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ChatFrame/Classic/ChatConfigFrame.xml#L211)
--- child of ChatWindowTab (created in template ChatTabArtTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ChatFrame/Classic/ChatConfigFrame.xml#L231)
--- child of ChatWindowTab (created in template ChatTabArtTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ChatFrame/Classic/ChatConfigFrame.xml#L238)
--- child of ChatWindowTab (created in template ChatTabArtTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ChatFrame/Classic/ChatConfigFrame.xml#L245)
--- child of ChatWindowTab (created in template ChatTabArtTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ChatFrame/Classic/ChatConfigFrame.xml#L252)
--- child of ChatWindowTab (created in template ChatTabArtTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ChatFrame/Classic/ChatConfigFrame.xml#L267)
--- child of ChatWindowTab (created in template ChatTabArtTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ChatFrame/Classic/ChatConfigFrame.xml#L274)
--- child of ChatWindowTab (created in template ChatTabArtTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ChatFrame/Classic/ChatConfigFrame.xml#L113)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ChatFrame/Classic/ChatConfigFrame.xml#L118)
--- child of TextToSpeechFrameAdjustRateSlider (created in template TextToSpeechSliderTemplate)
--- @type TextToSpeechSliderTemplate_TextToSpeechSliderTemplateLow

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ChatFrame/Classic/ChatConfigFrame.xml#L127)
--- child of TextToSpeechFrameAdjustRateSlider (created in template TextToSpeechSliderTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ChatFrame/Classic/ChatConfigFrame.xml#L1084)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ChatFrame/Classic/ChatConfigFrame.xml#L1294)
--- child of CombatConfigColorsColorizeUnitName
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ChatFrame/Classic/ChatConfigFrame.xml#L1856)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ChatFrame/Classic/ChatConfigFrame.xml#L468)
