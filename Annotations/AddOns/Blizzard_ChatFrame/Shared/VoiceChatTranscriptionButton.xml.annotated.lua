...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ChatFrame/Shared/VoiceChatTranscriptionButton.xml#L21)
--- child of VoiceChatTranscriptionTemplate
--- @class VoiceChatTranscriptionTemplate_Button : Button, VoiceChatTranscriptionButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ChatFrame/Shared/VoiceChatTranscriptionButton.xml#L17)
--- Template
