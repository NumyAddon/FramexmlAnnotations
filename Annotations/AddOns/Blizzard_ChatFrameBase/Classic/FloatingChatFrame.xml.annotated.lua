...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ChatFrameBase/Classic/FloatingChatFrame.xml#L122)
--- child of DockManagerTemplateOverflowButtonList (created in template DockManagerOverflowListTemplate)
--- @type DockManagerOverflowListTemplate_DockManagerOverflowListTemplateNumTabs
...
--- child of ChatTabTemplateDropDown (created in template UIDropDownMenuTemplate)
...
--- child of FloatingChatFrameTemplateEditBox (created in template ChatFrameEditBoxTemplate)
