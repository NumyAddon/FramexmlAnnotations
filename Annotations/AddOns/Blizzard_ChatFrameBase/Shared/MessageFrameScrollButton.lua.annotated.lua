...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_ChatFrameBase/Shared/MessageFrameScrollButton.lua#L8)
function MessageFrameScrollButtonMixin:OnUpdate(elapsed) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_ChatFrameBase/Shared/MessageFrameScrollButton.lua#L23)
function MessageFrameScrollButtonMixin:ScrollDown() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_ChatFrameBase/Shared/MessageFrameScrollButton.lua#L32)
