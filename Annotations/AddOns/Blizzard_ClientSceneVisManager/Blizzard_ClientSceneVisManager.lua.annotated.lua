...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_ClientSceneVisManager/Blizzard_ClientSceneVisManager.lua#L16)
function ClientSceneVisManagerMixin:OnEvent(event, ...) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_ClientSceneVisManager/Blizzard_ClientSceneVisManager.lua#L20)
