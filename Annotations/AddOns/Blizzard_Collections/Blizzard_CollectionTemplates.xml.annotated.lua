...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_Collections/Blizzard_CollectionTemplates.xml#L12)
--- child of CollectionsProgressBarTemplate
--- @class CollectionsProgressBarTemplate_text : FontString, TextStatusBarText

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_Collections/Blizzard_CollectionTemplates.xml#L5)
--- Template
--- @class CollectionsProgressBarTemplate : StatusBar
--- @field text CollectionsProgressBarTemplate_text
--- @field border Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_Collections/Blizzard_CollectionTemplates.xml#L107)
--- child of CollectionsSpellButtonTemplate
--- @class CollectionsSpellButtonTemplate_cooldown : Cooldown, CooldownFrameTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_Collections/Blizzard_CollectionTemplates.xml#L113)
--- child of CollectionsSpellButtonTemplate
--- @class CollectionsSpellButtonTemplate_cooldownWrapper : Frame
--- @field slotFavorite Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_Collections/Blizzard_CollectionTemplates.xml#L65)
--- child of CollectionsSpellButtonTemplate
--- @class CollectionsSpellButtonTemplate_name : FontString, GameFontNormal

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_Collections/Blizzard_CollectionTemplates.xml#L74)
--- child of CollectionsSpellButtonTemplate
--- @class CollectionsSpellButtonTemplate_new : FontString, GameFontHighlight

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_Collections/Blizzard_CollectionTemplates.xml#L127)
--- child of CollectionsSpellButtonTemplate
--- @class CollectionsSpellButtonTemplate_IconFadeIn : AnimationGroup

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_Collections/Blizzard_CollectionTemplates.xml#L39)
--- Template
