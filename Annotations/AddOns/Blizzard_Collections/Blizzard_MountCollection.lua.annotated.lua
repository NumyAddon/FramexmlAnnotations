...
MountJournalSummonRandomFavoriteButtonMixin = {};--- @class MountJournalSummonRandomFavoriteButtonMixin
...
--------------------------------------------------
MountJournalToggleDynamicFlightFlyoutButtonMixin = CreateFromMixins(ButtonStateBehaviorMixin);--- @class MountJournalToggleDynamicFlightFlyoutButtonMixin : ButtonStateBehaviorMixin
