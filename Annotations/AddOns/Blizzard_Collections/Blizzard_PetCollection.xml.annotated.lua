...
--- child of CompanionLoadOutTemplateSpell1 (created in template CompanionLoadOutSpellTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Collections/Blizzard_PetCollection.xml#L147)
--- child of CompanionLoadOutTemplateSpell2 (created in template CompanionLoadOutSpellTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Collections/Blizzard_PetCollection.xml#L147)
--- child of CompanionLoadOutTemplateSpell3 (created in template CompanionLoadOutSpellTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Collections/Blizzard_PetCollection.xml#L1504)
