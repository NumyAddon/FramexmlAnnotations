...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_Collections/Blizzard_Wardrobe.xml#L1211)
--- child of WardrobeTransmogFrame_SpecDropdown (created in template UIMenuButtonStretchTemplate)
--- @type Texture
WardrobeTransmogFrameTopLeft = {}
...
--- child of WardrobeTransmogFrame
--- @class WardrobeTransmogFrame_SpecDropdown : DropdownButton, UIMenuButtonStretchTemplate
--- @field Icon Texture
