...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Commentator/Blizzard_Commentator.lua#L257)
function CommentatorMixin:ModifyCameraSpeed(speed) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Commentator/Blizzard_Commentator.lua#L262)
function CommentatorMixin:SetFrameLock(enabled) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Commentator/Blizzard_Commentator.lua#L267)
function CommentatorMixin:ToggleFrameLock() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Commentator/Blizzard_Commentator.lua#L271)
function CommentatorMixin:Start() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Commentator/Blizzard_Commentator.lua#L276)
function CommentatorMixin:Shutdown() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Commentator/Blizzard_Commentator.lua#L286)
function CommentatorMixin:Reset() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Commentator/Blizzard_Commentator.lua#L294)
function CommentatorMixin:OnCommentatorEnterWorld() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Commentator/Blizzard_Commentator.lua#L328)
function CommentatorMixin:InitUnitFrames() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Commentator/Blizzard_Commentator.lua#L379)
function CommentatorMixin:ClearUnitFrames() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Commentator/Blizzard_Commentator.lua#L384)
function CommentatorMixin:ReinitializeUnitFrames() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Commentator/Blizzard_Commentator.lua#L389)
function CommentatorMixin:CheckObserverState() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Commentator/Blizzard_Commentator.lua#L434)
function CommentatorMixin:SetObserverState(state) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Commentator/Blizzard_Commentator.lua#L442)
function CommentatorMixin:OnObserverStateChanged(oldState, newState) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Commentator/Blizzard_Commentator.lua#L473)
function CommentatorMixin:CheckScoreboard() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Commentator/Blizzard_Commentator.lua#L494)
function CommentatorMixin:GetNameplateTemplate() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Commentator/Blizzard_Commentator.lua#L498)
function CommentatorMixin:ExitInstance() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Commentator/Blizzard_Commentator.lua#L506)
function CommentatorMixin:JoinInstance() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Commentator/Blizzard_Commentator.lua#L510)
