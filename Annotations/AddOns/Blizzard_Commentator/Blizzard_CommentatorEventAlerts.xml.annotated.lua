...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_Commentator/Blizzard_CommentatorEventAlerts.xml#L5)
--- Template
--- @class CommentatorEventAlertsFrameFrameTemplate : Frame, RaidBossEmoteFrameTemplate, CommentatorEventAlertsMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_Commentator/Blizzard_CommentatorEventAlerts.xml#L9)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_Commentator/Blizzard_CommentatorEventAlerts.xml#L15)
--- child of CommentatorEventAlertsFrame (created in template RaidBossEmoteFrameTemplate)
--- @type RaidBossEmoteFrameTemplate_Slot2
CommentatorEventAlertsFrameSlot2 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_Commentator/Blizzard_CommentatorEventAlerts.xml#L12)
