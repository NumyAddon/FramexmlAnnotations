...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Commentator/Blizzard_CommentatorNamePlate.xml#L3)
--- Template
--- @class CommentatorNPRadialCooldownTemplate : Cooldown

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Commentator/Blizzard_CommentatorNamePlate.xml#L42)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Commentator/Blizzard_CommentatorNamePlate.xml#L29)
--- child of CommentatorNamePlateTemplate
--- @class CommentatorNamePlateTemplate_CCText : FontString, CommentatorFontSmall

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Commentator/Blizzard_CommentatorNamePlate.xml#L9)
--- Template
