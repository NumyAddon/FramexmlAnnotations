...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Commentator/Blizzard_CommentatorSpell.xml#L31)
--- Template
--- @class CommentatorDebuffTemplate : Frame, CommentatorSpellBaseTemplate, CommentatorDebuffMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Commentator/Blizzard_CommentatorSpell.xml#L58)
--- child of CommentatorSpellTemplate
--- @class CommentatorSpellTemplate_Charges : Cooldown, CooldownFrameTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Commentator/Blizzard_CommentatorSpell.xml#L44)
--- child of CommentatorSpellTemplate
--- @class CommentatorSpellTemplate_ChargesText : FontString, NumberFontNormal

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Commentator/Blizzard_CommentatorSpell.xml#L32)
--- Template
