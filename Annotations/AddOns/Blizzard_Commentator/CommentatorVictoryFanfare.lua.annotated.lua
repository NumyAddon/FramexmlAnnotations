...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_Commentator/CommentatorVictoryFanfare.lua#L33)
function CommentatorVictoryFanfareFrameMixin:OnEvent(event) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_Commentator/CommentatorVictoryFanfare.lua#L40)
function CommentatorVictoryFanfareFrameMixin:PlayVictoryFanfare(text, team) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_Commentator/CommentatorVictoryFanfare.lua#L59)
