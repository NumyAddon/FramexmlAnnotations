...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L2233)
--- child of CommunitiesFrame_GuildNameAlertFrame (created in template GlowBoxTemplate)
--- @type Texture
CommunitiesFrameBg = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L2246)
--- child of CommunitiesFrame_GuildNameAlertFrame (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_GlowTopLeft
CommunitiesFrameGlowTopLeft = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L2251)
--- child of CommunitiesFrame_GuildNameAlertFrame (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_GlowTopRight
CommunitiesFrameGlowTopRight = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L2257)
--- child of CommunitiesFrame_GuildNameAlertFrame (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_GlowBottomLeft
CommunitiesFrameGlowBottomLeft = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L2263)
--- child of CommunitiesFrame_GuildNameAlertFrame (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_GlowBottomRight
CommunitiesFrameGlowBottomRight = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L2269)
--- child of CommunitiesFrame_GuildNameAlertFrame (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_GlowTop
CommunitiesFrameGlowTop = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L2275)
--- child of CommunitiesFrame_GuildNameAlertFrame (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_GlowBottom
CommunitiesFrameGlowBottom = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L2281)
--- child of CommunitiesFrame_GuildNameAlertFrame (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_GlowLeft
CommunitiesFrameGlowLeft = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L2287)
--- child of CommunitiesFrame_GuildNameAlertFrame (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_GlowRight
CommunitiesFrameGlowRight = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L2295)
--- child of CommunitiesFrame_GuildNameAlertFrame (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_ShadowTopLeft
CommunitiesFrameShadowTopLeft = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L2300)
--- child of CommunitiesFrame_GuildNameAlertFrame (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_ShadowTopRight
CommunitiesFrameShadowTopRight = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L2306)
--- child of CommunitiesFrame_GuildNameAlertFrame (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_ShadowBottomLeft
CommunitiesFrameShadowBottomLeft = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L2312)
--- child of CommunitiesFrame_GuildNameAlertFrame (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_ShadowBottomRight
CommunitiesFrameShadowBottomRight = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L2318)
--- child of CommunitiesFrame_GuildNameAlertFrame (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_ShadowTop
CommunitiesFrameShadowTop = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L2324)
--- child of CommunitiesFrame_GuildNameAlertFrame (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_ShadowBottom
CommunitiesFrameShadowBottom = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L2330)
--- child of CommunitiesFrame_GuildNameAlertFrame (created in template GlowBoxTemplate)
--- @type GlowBoxTemplate_ShadowLeft
CommunitiesFrameShadowLeft = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L2336)
--- child of CommunitiesFrame_GuildNameAlertFrame (created in template GlowBoxTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L567)
--- child of CommunitiesFrame
--- @class CommunitiesFrame_InviteButton : Button, CommunitiesInviteButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L583)
--- child of CommunitiesFrame
--- @class CommunitiesFrame_CommunitiesControlFrame : Frame, CommunitiesControlFrameTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L589)
--- child of CommunitiesFrame
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L598)
--- child of CommunitiesFrame
--- @class CommunitiesFrame_GuildMemberDetailFrame : Frame, CommunitiesGuildMemberDetailFrameTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L805)
--- child of CommunitiesFrameInset (created in template InsetFrameTemplate)
--- @type Texture
CommunitiesFrameInsetBg = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L846)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L832)
--- child of CommunitiesFrame (created in template ButtonFrameTemplate)
--- @type ButtonFrameTemplate_BtnCornerRight
CommunitiesFrameBtnCornerRight = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L837)
--- child of CommunitiesFrame (created in template ButtonFrameTemplate)
--- @type ButtonFrameTemplate_ButtonBottomBorder
CommunitiesFrameButtonBottomBorder = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L663)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L575)
--- child of CommunitiesFrame (created in template PortraitFrameTemplateNoCloseButton)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L591)
--- child of CommunitiesFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type PortraitFrameTemplateNoCloseButton_PortraitFrame
CommunitiesFramePortraitFrame = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L596)
--- child of CommunitiesFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type PortraitFrameTemplateNoCloseButton_TopRightCorner
CommunitiesFrameTopRightCorner = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L601)
--- child of CommunitiesFrame (created in template PortraitFrameTemplateNoCloseButton)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L612)
--- child of CommunitiesFrame (created in template PortraitFrameTemplateNoCloseButton)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L627)
--- child of CommunitiesFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type PortraitFrameTemplateNoCloseButton_BotLeftCorner
CommunitiesFrameBotLeftCorner = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L632)
--- child of CommunitiesFrame (created in template PortraitFrameTemplateNoCloseButton)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/CommunitiesFrame.xml#L649)
--- child of CommunitiesFrame (created in template PortraitFrameTemplateNoCloseButton)
