...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Communities/CommunitiesSettings.xml#L304)
--- child of CommunitiesSettingsDialog
--- @class CommunitiesSettingsDialog_LookingForDropdown : DropdownButton, ClubFinderLookingForDropdownTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Communities/CommunitiesSettings.xml#L309)
--- child of CommunitiesSettingsDialog
--- @class CommunitiesSettingsDialog_LanguageDropdown : DropdownButton, CommunitiesLanguageDropdown

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Communities/CommunitiesSettings.xml#L314)
--- child of CommunitiesSettingsDialog
--- @class CommunitiesSettingsDialog_Description : ScrollFrame, InputScrollFrameTemplate
--- @field maxLetters number # 250

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Communities/CommunitiesSettings.xml#L332)
--- child of CommunitiesSettingsDialog
--- @class CommunitiesSettingsDialog_Delete : Button, UIPanelButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Communities/CommunitiesSettings.xml#L341)
--- child of CommunitiesSettingsDialog
--- @class CommunitiesSettingsDialog_Accept : Button, UIPanelButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Communities/CommunitiesSettings.xml#L352)
--- child of CommunitiesSettingsDialog
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Communities/CommunitiesSettings.xml#L370)
--- Template
