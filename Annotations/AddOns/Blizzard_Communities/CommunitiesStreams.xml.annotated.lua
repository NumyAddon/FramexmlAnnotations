...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Communities/CommunitiesStreams.xml#L442)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Communities/CommunitiesStreams.xml#L985)
--- child of CommunitiesMassNotificationsSettingsButtonTemplate (created in template UIMenuButtonStretchTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Communities/CommunitiesStreams.xml#L992)
--- child of CommunitiesMassNotificationsSettingsButtonTemplate (created in template UIMenuButtonStretchTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Communities/CommunitiesStreams.xml#L999)
--- child of CommunitiesMassNotificationsSettingsButtonTemplate (created in template UIMenuButtonStretchTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Communities/CommunitiesStreams.xml#L1006)
--- child of CommunitiesMassNotificationsSettingsButtonTemplate (created in template UIMenuButtonStretchTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Communities/CommunitiesStreams.xml#L1013)
--- child of CommunitiesMassNotificationsSettingsButtonTemplate (created in template UIMenuButtonStretchTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Communities/CommunitiesStreams.xml#L1021)
--- child of CommunitiesMassNotificationsSettingsButtonTemplate (created in template UIMenuButtonStretchTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Communities/CommunitiesStreams.xml#L1029)
--- child of CommunitiesMassNotificationsSettingsButtonTemplate (created in template UIMenuButtonStretchTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Communities/CommunitiesStreams.xml#L1037)
--- child of CommunitiesMassNotificationsSettingsButtonTemplate (created in template UIMenuButtonStretchTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Communities/CommunitiesStreams.xml#L1045)
--- child of CommunitiesMassNotificationsSettingsButtonTemplate (created in template UIMenuButtonStretchTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Communities/CommunitiesStreams.xml#L468)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Communities/CommunitiesStreams.xml#L284)
--- child of  (created in template UIDropDownMenuTemplate)
--- @type UIDropDownMenuTemplate_UIDropDownMenuTemplateButton
--- @field NormalTexture Texture
--- @field HighlightTexture Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Communities/CommunitiesStreams.xml#L226)
--- child of  (created in template UIDropDownMenuTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Communities/CommunitiesStreams.xml#L239)
--- child of  (created in template UIDropDownMenuTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Communities/CommunitiesStreams.xml#L257)
--- child of  (created in template UIDropDownMenuTemplate)
--- @type UIDropDownMenuTemplate_UIDropDownMenuTemplateText

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Communities/CommunitiesStreams.xml#L271)
--- child of  (created in template UIDropDownMenuTemplate)
--- @type Texture
