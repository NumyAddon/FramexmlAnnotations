...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/GuildNews.xml#L397)
--- child of CommunitiesGuildNewsFiltersFrame
--- @class CommunitiesGuildNewsFiltersFrame_CloseButton : Button, UIPanelCloseButton

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/GuildNews.xml#L402)
--- child of CommunitiesGuildNewsFiltersFrame
--- @class CommunitiesGuildNewsFiltersFrame_GuildAchievement : CheckButton, CommunitiesGuildNewsCheckButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/GuildNews.xml#L407)
--- child of CommunitiesGuildNewsFiltersFrame
--- @class CommunitiesGuildNewsFiltersFrame_Achievement : CheckButton, CommunitiesGuildNewsCheckButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/GuildNews.xml#L412)
--- child of CommunitiesGuildNewsFiltersFrame
--- @class CommunitiesGuildNewsFiltersFrame_DungeonEncounter : CheckButton, CommunitiesGuildNewsCheckButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/GuildNews.xml#L417)
--- child of CommunitiesGuildNewsFiltersFrame
--- @class CommunitiesGuildNewsFiltersFrame_EpicItemLooted : CheckButton, CommunitiesGuildNewsCheckButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/GuildNews.xml#L422)
--- child of CommunitiesGuildNewsFiltersFrame
--- @class CommunitiesGuildNewsFiltersFrame_EpicItemPurchased : CheckButton, CommunitiesGuildNewsCheckButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/GuildNews.xml#L427)
--- child of CommunitiesGuildNewsFiltersFrame
--- @class CommunitiesGuildNewsFiltersFrame_EpicItemCrafted : CheckButton, CommunitiesGuildNewsCheckButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/GuildNews.xml#L432)
--- child of CommunitiesGuildNewsFiltersFrame
--- @class CommunitiesGuildNewsFiltersFrame_LegendaryItemLooted : CheckButton, CommunitiesGuildNewsCheckButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/GuildNews.xml#L389)
--- child of CommunitiesGuildNewsFiltersFrame
--- @class CommunitiesGuildNewsFiltersFrame_Title : FontString, GameFontNormal

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/GuildNews.xml#L1137)
--- child of CommunitiesGuildNewsFiltersFrame (created in template TranslucentFrameTemplate)
--- @type Texture
CommunitiesGuildNewsFiltersFrameBg = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/GuildNews.xml#L1146)
--- child of CommunitiesGuildNewsFiltersFrame (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_TopLeftCorner
CommunitiesGuildNewsFiltersFrameTopLeftCorner = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/GuildNews.xml#L1151)
--- child of CommunitiesGuildNewsFiltersFrame (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_TopRightCorner
CommunitiesGuildNewsFiltersFrameTopRightCorner = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/GuildNews.xml#L1156)
--- child of CommunitiesGuildNewsFiltersFrame (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_BottomLeftCorner
CommunitiesGuildNewsFiltersFrameBottomLeftCorner = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/GuildNews.xml#L1161)
--- child of CommunitiesGuildNewsFiltersFrame (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_BottomRightCorner
CommunitiesGuildNewsFiltersFrameBottomRightCorner = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/GuildNews.xml#L1166)
--- child of CommunitiesGuildNewsFiltersFrame (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_TopBorder
CommunitiesGuildNewsFiltersFrameTopBorder = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/GuildNews.xml#L1172)
--- child of CommunitiesGuildNewsFiltersFrame (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_BottomBorder
CommunitiesGuildNewsFiltersFrameBottomBorder = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/GuildNews.xml#L1178)
--- child of CommunitiesGuildNewsFiltersFrame (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_LeftBorder
CommunitiesGuildNewsFiltersFrameLeftBorder = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/GuildNews.xml#L1184)
--- child of CommunitiesGuildNewsFiltersFrame (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_RightBorder
CommunitiesGuildNewsFiltersFrameRightBorder = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_Communities/GuildNews.xml#L385)
