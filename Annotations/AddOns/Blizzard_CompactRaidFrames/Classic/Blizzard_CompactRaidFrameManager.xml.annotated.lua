...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_CompactRaidFrames/Classic/Blizzard_CompactRaidFrameManager.xml#L827)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_CompactRaidFrames/Classic/Blizzard_CompactRaidFrameManager.xml#L834)
--- child of CompactRaidFrameManagerDisplayFrameFilterOptionsFilterRoleTank (created in template UIMenuButtonStretchTemplate)
--- @type Texture
CompactRaidFrameManagerDisplayFrameFilterOptionsFilterRoleTankTopRight = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_CompactRaidFrames/Classic/Blizzard_CompactRaidFrameManager.xml#L841)
--- child of CompactRaidFrameManagerDisplayFrameFilterOptionsFilterRoleTank (created in template UIMenuButtonStretchTemplate)
--- @type Texture
CompactRaidFrameManagerDisplayFrameFilterOptionsFilterRoleTankBottomLeft = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_CompactRaidFrames/Classic/Blizzard_CompactRaidFrameManager.xml#L848)
--- child of CompactRaidFrameManagerDisplayFrameFilterOptionsFilterRoleTank (created in template UIMenuButtonStretchTemplate)
--- @type Texture
CompactRaidFrameManagerDisplayFrameFilterOptionsFilterRoleTankBottomRight = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_CompactRaidFrames/Classic/Blizzard_CompactRaidFrameManager.xml#L855)
--- child of CompactRaidFrameManagerDisplayFrameFilterOptionsFilterRoleTank (created in template UIMenuButtonStretchTemplate)
--- @type Texture
CompactRaidFrameManagerDisplayFrameFilterOptionsFilterRoleTankTopMiddle = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_CompactRaidFrames/Classic/Blizzard_CompactRaidFrameManager.xml#L863)
--- child of CompactRaidFrameManagerDisplayFrameFilterOptionsFilterRoleTank (created in template UIMenuButtonStretchTemplate)
--- @type Texture
CompactRaidFrameManagerDisplayFrameFilterOptionsFilterRoleTankMiddleLeft = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_CompactRaidFrames/Classic/Blizzard_CompactRaidFrameManager.xml#L871)
--- child of CompactRaidFrameManagerDisplayFrameFilterOptionsFilterRoleTank (created in template UIMenuButtonStretchTemplate)
--- @type Texture
CompactRaidFrameManagerDisplayFrameFilterOptionsFilterRoleTankMiddleRight = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_CompactRaidFrames/Classic/Blizzard_CompactRaidFrameManager.xml#L879)
--- child of CompactRaidFrameManagerDisplayFrameFilterOptionsFilterRoleTank (created in template UIMenuButtonStretchTemplate)
--- @type Texture
CompactRaidFrameManagerDisplayFrameFilterOptionsFilterRoleTankBottomMiddle = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_CompactRaidFrames/Classic/Blizzard_CompactRaidFrameManager.xml#L887)
--- child of CompactRaidFrameManagerDisplayFrameFilterOptionsFilterRoleTank (created in template UIMenuButtonStretchTemplate)
--- @type Texture
