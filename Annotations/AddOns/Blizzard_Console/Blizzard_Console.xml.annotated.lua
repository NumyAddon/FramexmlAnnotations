...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_Console/Blizzard_Console.xml#L64)
--- child of 
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_Console/Blizzard_Console.xml#L149)
--- child of 
--- @class DeveloperConsole_Filters_Background : Frame, DeveloperConsoleBackgroundTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_Console/Blizzard_Console.xml#L157)
--- child of 
--- @class DeveloperConsole_Filters_ProgressBar_FadeAnim : AnimationGroup

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_Console/Blizzard_Console.xml#L151)
--- child of 
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_Console/Blizzard_Console.xml#L193)
--- child of 
--- @class DeveloperConsole_Filters_EditBox_ClearTextButton : Button, UIPanelCloseButtonNoScripts

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_Console/Blizzard_Console.xml#L166)
--- child of 
--- @class DeveloperConsole_Filters_EditBox : EditBox
--- @field ClearTextButton DeveloperConsole_Filters_EditBox_ClearTextButton

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_Console/Blizzard_Console.xml#L130)
--- child of 
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_Console/Blizzard_Console.xml#L225)
--- child of 
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_Console/Blizzard_Console.xml#L290)
--- child of 
--- @class DeveloperConsole_MessageFrame_CopyNoticeFrame_Label : FontString, SystemFont_Shadow_Large

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_Console/Blizzard_Console.xml#L296)
--- child of 
--- @class DeveloperConsole_MessageFrame_CopyNoticeFrame_Anim : AnimationGroup

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_Console/Blizzard_Console.xml#L282)
--- child of 
