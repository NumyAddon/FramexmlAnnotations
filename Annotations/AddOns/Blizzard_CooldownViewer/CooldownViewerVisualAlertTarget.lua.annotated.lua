...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_CooldownViewer/CooldownViewerVisualAlertTarget.lua#L54)
function CooldownViewerVisualAlertTargetMixin:CheckCreateAlertOverlay() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_CooldownViewer/CooldownViewerVisualAlertTarget.lua#L84)
