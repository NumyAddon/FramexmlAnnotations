...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_CooldownViewer/GroupBuffFilter.xml#L4)
--- Template
--- @class GroupBuffFilterItemTemplate : Frame, GroupBuffFilterItemMixin
--- @field Icon Texture
--- @field Highlight Texture

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_CooldownViewer/GroupBuffFilter.xml#L29)
--- child of GroupBuffFilterSectionTemplate
--- @class GroupBuffFilterSectionTemplate_Header : Button, ListHeaderThreeSliceTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_CooldownViewer/GroupBuffFilter.xml#L36)
--- child of GroupBuffFilterSectionTemplate
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_CooldownViewer/GroupBuffFilter.xml#L22)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_CooldownViewer/GroupBuffFilter.xml#L59)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_CooldownViewer/GroupBuffFilter.xml#L57)
--- Template
--- @class GroupBuffFilterTemplate : Frame, GroupBuffFilterMixin
--- @field Scroll GroupBuffFilterTemplate_Scroll

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_CooldownViewer/GroupBuffFilter.xml#L89)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_CooldownViewer/GroupBuffFilter.xml#L86)
