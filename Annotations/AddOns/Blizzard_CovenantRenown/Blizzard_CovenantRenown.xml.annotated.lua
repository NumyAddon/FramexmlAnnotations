...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_CovenantRenown/Blizzard_CovenantRenown.xml#L31)
--- child of CovenantRenownRewardTemplate
--- @class CovenantRenownRewardTemplate_Name : FontString, GameFontNormalMed2

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_CovenantRenown/Blizzard_CovenantRenown.xml#L5)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_CovenantRenown/Blizzard_CovenantRenown.xml#L126)
--- child of CovenantRenownFrame
--- @class CovenantRenownFrame_NineSlice : Frame, NineSlicePanelTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_CovenantRenown/Blizzard_CovenantRenown.xml#L127)
--- child of CovenantRenownFrame
--- @class CovenantRenownFrame_LevelSkipButton : Button, RewardTrackSkipLevelUpButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_CovenantRenown/Blizzard_CovenantRenown.xml#L132)
--- child of CovenantRenownFrame
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_CovenantRenown/Blizzard_CovenantRenown.xml#L171)
--- child of CovenantRenownFrame
--- @class CovenantRenownFrame_CelebrationModelScene : ModelScene, ScriptAnimatedModelSceneTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_CovenantRenown/Blizzard_CovenantRenown.xml#L177)
--- child of CovenantRenownFrame
--- @class CovenantRenownFrame_TrackFrame : Frame, RewardTrackFrameTemplate
--- @field elementTemplate string # "RenownLevelTemplate"

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_CovenantRenown/Blizzard_CovenantRenown.xml#L188)
--- child of CovenantRenownFrame
--- @class CovenantRenownFrame_LevelModelScene : ModelScene, ScriptAnimatedModelSceneTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_CovenantRenown/Blizzard_CovenantRenown.xml#L194)
--- child of CovenantRenownFrame
--- @class CovenantRenownFrame_FinalToast : Frame, CovenantCelebrationBannerTemplate
--- @field SlabTexture Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_CovenantRenown/Blizzard_CovenantRenown.xml#L110)
--- child of CovenantRenownFrame
--- @class CovenantRenownFrame_Header : FontString, Fancy32Font

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_CovenantRenown/Blizzard_CovenantRenown.xml#L118)
--- child of CovenantRenownFrame
--- @class CovenantRenownFrame_PreviewText : FontString, GameFontHighlight

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_CovenantRenown/Blizzard_CovenantRenown.xml#L66)
