...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_CovenantRenown/Blizzard_CovenantRenown.xml#L126)
--- child of CovenantRenownFrame
--- @class CovenantRenownFrame_NineSlice : Frame, NineSlicePanelTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_CovenantRenown/Blizzard_CovenantRenown.xml#L127)
--- child of CovenantRenownFrame
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_CovenantRenown/Blizzard_CovenantRenown.xml#L171)
--- child of CovenantRenownFrame
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_CovenantRenown/Blizzard_CovenantRenown.xml#L194)
--- child of CovenantRenownFrame
--- @class CovenantRenownFrame_FinalToast : Frame, CovenantCelebrationBannerTemplate
--- @field SlabTexture Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_CovenantRenown/Blizzard_CovenantRenown.xml#L110)
--- child of CovenantRenownFrame
--- @class CovenantRenownFrame_Header : FontString, Fancy32Font

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_CovenantRenown/Blizzard_CovenantRenown.xml#L118)
--- child of CovenantRenownFrame
--- @class CovenantRenownFrame_PreviewText : FontString, GameFontHighlight

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_CovenantRenown/Blizzard_CovenantRenown.xml#L66)
