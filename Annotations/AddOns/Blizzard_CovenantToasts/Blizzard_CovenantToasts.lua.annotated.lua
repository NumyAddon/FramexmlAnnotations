...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_CovenantToasts/Blizzard_CovenantToasts.lua#L21)
function CovenantCelebrationBannerMixin:OnHide() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_CovenantToasts/Blizzard_CovenantToasts.lua#L25)
function CovenantCelebrationBannerMixin:SetCovenantTextureKit(covenantTextureKit) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_CovenantToasts/Blizzard_CovenantToasts.lua#L39)
