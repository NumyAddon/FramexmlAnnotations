...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_DamageMeter/DamageMeter.xml#L3)
--- Template
--- @class DamageMeterTemplate : Frame, EditModeDamageMeterSystemTemplate, DamageMeterMixin

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_DamageMeter/DamageMeter.xml#L11)
