...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_DamageMeter/DamageMeterEntry.xml#L37)
--- child of DamageMeterEntryTemplate_StatusBar
--- @class DamageMeterEntryTemplate_StatusBar_Value : FontString, NumberFontNormal

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_DamageMeter/DamageMeterEntry.xml#L40)
--- child of DamageMeterEntryTemplate_StatusBar
--- @class DamageMeterEntryTemplate_StatusBar_Name : FontString, NumberFontNormal

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_DamageMeter/DamageMeterEntry.xml#L19)
--- child of DamageMeterEntryTemplate
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_DamageMeter/DamageMeterEntry.xml#L49)
--- Template
--- @class DamageMeterSourceEntryTemplate : Button, DamageMeterEntryTemplate, DamageMeterSourceEntryMixin

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_DamageMeter/DamageMeterEntry.xml#L50)
--- Template
