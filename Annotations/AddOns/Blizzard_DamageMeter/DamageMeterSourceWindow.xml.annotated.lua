...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_DamageMeter/DamageMeterSourceWindow.xml#L24)
--- child of DamageMeterSourceWindowTemplate
--- @class DamageMeterSourceWindowTemplate_ScrollBox : Frame, WowScrollBoxList

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_DamageMeter/DamageMeterSourceWindow.xml#L29)
--- child of DamageMeterSourceWindowTemplate
--- @class DamageMeterSourceWindowTemplate_ScrollBar : EventFrame, MinimalScrollBar

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_DamageMeter/DamageMeterSourceWindow.xml#L35)
--- child of DamageMeterSourceWindowTemplate
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_DamageMeter/DamageMeterSourceWindow.xml#L3)
--- Template
