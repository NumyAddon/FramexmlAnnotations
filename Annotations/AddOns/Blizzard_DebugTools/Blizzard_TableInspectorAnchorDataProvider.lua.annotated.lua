...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_DebugTools/Blizzard_TableInspectorAnchorDataProvider.lua#L11)
function TableInspectorAnchorDataProviderMixin:RefreshData(focusedTable) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_DebugTools/Blizzard_TableInspectorAnchorDataProvider.lua#L24)
function TableInspectorAnchorDataProviderMixin:HideAllLines() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_DebugTools/Blizzard_TableInspectorAnchorDataProvider.lua#L30)
function TableInspectorAnchorDataProviderMixin:Clear() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_DebugTools/Blizzard_TableInspectorAnchorDataProvider.lua#L35)
function TableInspectorAnchorDataProviderMixin:GetLines(filter) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_DebugTools/Blizzard_TableInspectorAnchorDataProvider.lua#L52)
function TableInspectAnchorLineMixin:Initialize(point, relativeTo, relativePoint, xOffset, yOffset) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_DebugTools/Blizzard_TableInspectorAnchorDataProvider.lua#L60)
