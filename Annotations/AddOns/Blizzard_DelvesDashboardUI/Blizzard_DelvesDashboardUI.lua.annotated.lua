...
--[[ Delves Dashboard ]]
DelvesDashboardFrameMixin = {};--- @class DelvesDashboardFrameMixin
...
ReputationThresholdMixin = {};--- @class ReputationThresholdMixin
...
ReputationThresholdRewardMixin = {};--- @class ReputationThresholdRewardMixin
...
CompanionConfigButtonPanelMixin = {};--- @class CompanionConfigButtonPanelMixin
...
CompanionConfigButtonPanelModelSceneMixin = CreateFromMixins(NoCameraControlModelSceneMixin);--- @class CompanionConfigButtonPanelModelSceneMixin : NoCameraControlModelSceneMixin
...
GreatVaultButtonPanelMixin = {};--- @class GreatVaultButtonPanelMixin
...
--[[ Great Vault Button ]]
GreatVaultButtonMixin = CreateFromMixins(WeeklyRewardMixin);--- @class GreatVaultButtonMixin : WeeklyRewardMixin
...
DelvesDashboardButtonPanelFrameMixin = {};--- @class DelvesDashboardButtonPanelFrameMixin
...
DelvesThresholdBarMixin = {};--- @class DelvesThresholdBarMixin
