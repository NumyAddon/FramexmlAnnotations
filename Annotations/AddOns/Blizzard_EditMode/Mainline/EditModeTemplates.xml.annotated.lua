...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Mainline/EditModeTemplates.xml#L40)
--- Template
--- @class EditModeManagerSettingCheckButtonTemplate : Frame, EditModeCheckButtonTemplate, EditModeManagerSettingCheckButtonMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Mainline/EditModeTemplates.xml#L54)
--- Template
--- @class EditModeManagerSettingsOptionsContainerTemplate : Frame, GridLayoutFrame

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Mainline/EditModeTemplates.xml#L70)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Mainline/EditModeTemplates.xml#L171)
--- Template
--- @class EditModeGridLineTemplate : Line, EditModeGridLineMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Mainline/EditModeTemplates.xml#L177)
--- Template
