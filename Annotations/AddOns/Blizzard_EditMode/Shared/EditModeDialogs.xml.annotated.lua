...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_EditMode/Shared/EditModeDialogs.xml#L270)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_EditMode/Shared/EditModeDialogs.xml#L275)
--- child of EditModeSystemSettingsDialog
--- @class EditModeSystemSettingsDialog_CloseButton : Button, UIPanelCloseButton
--- @field ignoreInLayout boolean # true

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_EditMode/Shared/EditModeDialogs.xml#L283)
--- child of EditModeSystemSettingsDialog
--- @class EditModeSystemSettingsDialog_Settings : Frame, VerticalLayoutFrame
--- @field spacing number # 2

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_EditMode/Shared/EditModeDialogs.xml#L300)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_EditMode/Shared/EditModeDialogs.xml#L308)
--- child of EditModeSystemSettingsDialog_Buttons
--- @class EditModeSystemSettingsDialog_Buttons_Divider : Texture
--- @field layoutIndex number # 2

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_EditMode/Shared/EditModeDialogs.xml#L292)
--- child of EditModeSystemSettingsDialog
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_EditMode/Shared/EditModeDialogs.xml#L262)
--- child of EditModeSystemSettingsDialog
--- @class EditModeSystemSettingsDialog_Title : FontString, GameFontHighlightLarge

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_EditMode/Shared/EditModeDialogs.xml#L251)
