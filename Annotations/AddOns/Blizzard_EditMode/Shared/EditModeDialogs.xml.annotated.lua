...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeDialogs.xml#L250)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeDialogs.xml#L273)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeDialogs.xml#L278)
--- child of EditModeSystemSettingsDialog
--- @class EditModeSystemSettingsDialog_CloseButton : Button, UIPanelCloseButton
--- @field ignoreInLayout boolean # true

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeDialogs.xml#L286)
--- child of EditModeSystemSettingsDialog
--- @class EditModeSystemSettingsDialog_Settings : Frame, VerticalLayoutFrame
--- @field spacing number # 2

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeDialogs.xml#L303)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeDialogs.xml#L311)
--- child of EditModeSystemSettingsDialog_Buttons
--- @class EditModeSystemSettingsDialog_Buttons_Divider : Texture
--- @field layoutIndex number # 2

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeDialogs.xml#L295)
--- child of EditModeSystemSettingsDialog
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeDialogs.xml#L265)
--- child of EditModeSystemSettingsDialog
--- @class EditModeSystemSettingsDialog_Title : FontString, GameFontHighlightLarge

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeDialogs.xml#L254)
