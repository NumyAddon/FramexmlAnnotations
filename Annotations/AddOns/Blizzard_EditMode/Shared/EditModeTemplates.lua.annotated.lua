...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeTemplates.lua#L146)
--- @class EditModeGridLineMixin
EditModeGridLineMixin = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeTemplates.lua#L167)
--- @class MagnetismPreviewLineMixin
MagnetismPreviewLineMixin = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeTemplates.lua#L239)
--- @class EditModeCheckButtonMixin
EditModeCheckButtonMixin = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeTemplates.lua#L318)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeTemplates.lua#L140)
function EditModeSettingCheckboxMixin:OnCheckButtonClick() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeTemplates.lua#L155)
function EditModeGridLineMixin:SetupLine(centerLine, verticalLine, xOffset, yOffset) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeTemplates.lua#L171)
function MagnetismPreviewLineMixin:Setup(magneticFrameInfo, lineAnchor) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeTemplates.lua#L241)
function EditModeCheckButtonMixin:EditModeCheckButton_OnLoad() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeTemplates.lua#L255)
function EditModeCheckButtonMixin:EditModeCheckButton_OnShow() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeTemplates.lua#L261)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeTemplates.lua#L293)
function EditModeCheckButtonMixin:RunMouseOverCallback(isMouseOver) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeTemplates.lua#L299)
function EditModeCheckButtonMixin:SetMouseOverCallback(callback) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeTemplates.lua#L304)
function EditModeCheckButtonMixin:ShouldEnable() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeTemplates.lua#L320)
