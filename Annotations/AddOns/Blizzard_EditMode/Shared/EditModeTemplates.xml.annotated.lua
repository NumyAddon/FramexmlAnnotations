...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeTemplates.xml#L120)
--- child of EditModeSettingSliderTemplate
--- @class EditModeSettingSliderTemplate_Slider : Frame, MinimalSliderWithSteppersTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeTemplates.xml#L111)
--- child of EditModeSettingSliderTemplate
--- @class EditModeSettingSliderTemplate_Label : FontString, GameFontHighlightMedium

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeTemplates.xml#L107)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeTemplates.xml#L138)
--- child of EditModeSettingCheckboxTemplate
--- @class EditModeSettingCheckboxTemplate_Button : CheckButton

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeTemplates.xml#L157)
--- child of EditModeSettingCheckboxTemplate
--- @class EditModeSettingCheckboxTemplate_Label : FontString, GameFontHighlightMedium

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeTemplates.xml#L132)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeTemplates.xml#L167)
--- Template
--- @class EditModeGridLineTemplate : Line, EditModeGridLineMixin
--- @field isGridLine boolean # true

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EditMode/Shared/EditModeTemplates.xml#L173)
--- Template
