...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_EncounterTimeline/EncounterTimeline.xml#L22)
--- child of EncounterTimeline
--- @class EncounterTimeline_ShowAnimation : AnimationGroup
--- @field Alpha Alpha

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_EncounterTimeline/EncounterTimeline.xml#L25)
--- child of EncounterTimeline
