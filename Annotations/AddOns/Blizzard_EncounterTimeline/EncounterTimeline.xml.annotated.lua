...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_EncounterTimeline/EncounterTimeline.xml#L10)
--- child of EncounterTimeline
--- @class EncounterTimeline_TrackView : Frame, EncounterTimelineTrackViewTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_EncounterTimeline/EncounterTimeline.xml#L15)
--- child of EncounterTimeline
--- @class EncounterTimeline_TimerView : Frame, EncounterTimelineTimerViewTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_EncounterTimeline/EncounterTimeline.xml#L3)
