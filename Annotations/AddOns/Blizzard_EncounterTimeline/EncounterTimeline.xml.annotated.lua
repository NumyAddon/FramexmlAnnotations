...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_EncounterTimeline/EncounterTimeline.xml#L17)
--- child of EncounterTimeline
--- @class EncounterTimeline_ShowAnimation : AnimationGroup
--- @field Alpha Alpha

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_EncounterTimeline/EncounterTimeline.xml#L20)
--- child of EncounterTimeline
