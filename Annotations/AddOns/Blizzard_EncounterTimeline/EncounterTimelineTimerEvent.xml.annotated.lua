...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EncounterTimeline/EncounterTimelineTimerEvent.xml#L31)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EncounterTimeline/EncounterTimelineTimerEvent.xml#L35)
--- child of EncounterTimelineTimerEventTemplate
--- @class EncounterTimelineTimerEventTemplate_IconContainer : Frame, EncounterTimelineEventIconTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EncounterTimeline/EncounterTimelineTimerEvent.xml#L54)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EncounterTimeline/EncounterTimelineTimerEvent.xml#L57)
--- child of EncounterTimelineTimerEventTemplate_Bar
--- @class EncounterTimelineTimerEventTemplate_Bar_Name : FontString, NumberFontNormal

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EncounterTimeline/EncounterTimelineTimerEvent.xml#L39)
--- child of EncounterTimelineTimerEventTemplate
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EncounterTimeline/EncounterTimelineTimerEvent.xml#L4)
--- Template
