EncounterTimelineViewElementBaseMixin = CreateFromMixins(EncounterTimelineViewSettingsAccessorMixin);--- @class EncounterTimelineViewElementBaseMixin : EncounterTimelineViewSettingsAccessorMixin
...
EncounterTimelineViewElementMixin = CreateFromMixins(EncounterTimelineViewElementBaseMixin);--- @class EncounterTimelineViewElementMixin : EncounterTimelineViewElementBaseMixin
