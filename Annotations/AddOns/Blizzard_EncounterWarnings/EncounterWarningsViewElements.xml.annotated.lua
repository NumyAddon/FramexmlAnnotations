...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_EncounterWarnings/EncounterWarningsViewElements.xml#L5)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_EncounterWarnings/EncounterWarningsViewElements.xml#L12)
--- child of EncounterWarningsSwingAnimationGroupTemplate
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_EncounterWarnings/EncounterWarningsViewElements.xml#L18)
--- child of EncounterWarningsSwingAnimationGroupTemplate
--- @class EncounterWarningsSwingAnimationGroupTemplate_RightIconTranslation : Animation, PointsOffsetAnimationTemplate
--- @field offsetFromX number # 30
--- @field offsetToX number # 20

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_EncounterWarnings/EncounterWarningsViewElements.xml#L3)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_EncounterWarnings/EncounterWarningsViewElements.xml#L26)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_EncounterWarnings/EncounterWarningsViewElements.xml#L62)
--- Template
