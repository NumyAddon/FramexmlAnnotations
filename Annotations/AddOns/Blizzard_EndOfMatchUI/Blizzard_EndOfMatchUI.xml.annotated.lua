...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EndOfMatchUI/Blizzard_EndOfMatchUI.xml#L4)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EndOfMatchUI/Blizzard_EndOfMatchUI.xml#L36)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EndOfMatchUI/Blizzard_EndOfMatchUI.xml#L48)
--- Template
--- @class EndOfMatchButtonGoldButtonBaseTemplate : Button, BigGoldRedThreeSliceButtonTemplate, EndOfMatchButtonBaseMixin
--- @field isLarge boolean # false

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EndOfMatchUI/Blizzard_EndOfMatchUI.xml#L85)
--- child of EndOfMatchFrame
--- @class EndOfMatchFrame_ScreenOverlayContainer : Frame
--- @field ScreenOverlay Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EndOfMatchUI/Blizzard_EndOfMatchUI.xml#L98)
--- child of EndOfMatchFrame
--- @class EndOfMatchFrame_DetailsContainer : Frame, VerticalLayoutFrame

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EndOfMatchUI/Blizzard_EndOfMatchUI.xml#L103)
--- child of EndOfMatchFrame
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EndOfMatchUI/Blizzard_EndOfMatchUI.xml#L142)
--- child of EndOfMatchFrame
--- @class EndOfMatchFrame_CenterActionsContainer : Frame, HorizontalLayoutFrame
--- @field spacing number # 16

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EndOfMatchUI/Blizzard_EndOfMatchUI.xml#L152)
--- child of EndOfMatchFrame
--- @class EndOfMatchFrame_ActionsContainer : Frame, HorizontalLayoutFrame
--- @field spacing number # 16

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_EndOfMatchUI/Blizzard_EndOfMatchUI.xml#L60)
