...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_EngravingUI/Blizzard_EngravingUI.xml#L226)
--- child of EngravingFrameFilterDropDown (created in template UIDropDownMenuTemplate)
--- @type Texture
EngravingFrameFilterDropDownLeft = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_EngravingUI/Blizzard_EngravingUI.xml#L239)
--- child of EngravingFrameFilterDropDown (created in template UIDropDownMenuTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_EngravingUI/Blizzard_EngravingUI.xml#L257)
--- child of EngravingFrameFilterDropDown (created in template UIDropDownMenuTemplate)
--- @type UIDropDownMenuTemplate_UIDropDownMenuTemplateText
EngravingFrameFilterDropDownText = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_EngravingUI/Blizzard_EngravingUI.xml#L271)
--- child of EngravingFrameFilterDropDown (created in template UIDropDownMenuTemplate)
--- @type Texture
