...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_EngravingUI/Blizzard_EngravingUI.xml#L796)
--- child of EngravingFrameSideInset (created in template InsetFrameTemplate)
--- @type Texture
EngravingFrameSideInsetBg = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_EngravingUI/Blizzard_EngravingUI.xml#L804)
--- child of EngravingFrameSideInset (created in template InsetFrameTemplate)
--- @type InsetFrameTemplate_InsetFrameTemplateInsetTopLeftCorner
EngravingFrameSideInsetInsetTopLeftCorner = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_EngravingUI/Blizzard_EngravingUI.xml#L809)
--- child of EngravingFrameSideInset (created in template InsetFrameTemplate)
