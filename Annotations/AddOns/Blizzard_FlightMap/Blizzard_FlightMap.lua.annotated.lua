...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FlightMap/Blizzard_FlightMap.lua#L3)
--- @class FlightMapMixin
FlightMapMixin = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FlightMap/Blizzard_FlightMap.lua#L5)
function FlightMapMixin:SetupTitle() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FlightMap/Blizzard_FlightMap.lua#L12)
function FlightMapMixin:ResetTitleAndPortraitIcon() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FlightMap/Blizzard_FlightMap.lua#L16)
function FlightMapMixin:UpdateTitleAndPortraitIcon(titleText, portraitIcon) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FlightMap/Blizzard_FlightMap.lua#L21)
function FlightMapMixin:OnLoad() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FlightMap/Blizzard_FlightMap.lua#L37)
