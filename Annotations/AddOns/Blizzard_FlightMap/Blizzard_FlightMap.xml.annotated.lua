...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_FlightMap/Blizzard_FlightMap.xml#L660)
--- child of FlightMapFrame_BorderFrame (created in template PortraitFrameTemplate)
--- @type PortraitFrameTemplate_CloseButton
FlightMapFrameCloseButton = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_FlightMap/Blizzard_FlightMap.xml#L627)
--- child of FlightMapFrame_BorderFrame (created in template PortraitFrameTexturedBaseTemplate)
--- @type Texture
FlightMapFrameBg = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_FlightMap/Blizzard_FlightMap.xml#L11)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_FlightMap/Blizzard_FlightMap.xml#L36)
--- child of FlightMapFrame
--- @class FlightMapFrame_ScrollContainer : ScrollFrame, MapCanvasFrameScrollContainerTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_FlightMap/Blizzard_FlightMap.xml#L5)
