...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Flyout/Flyout.xml#L43)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Flyout/Flyout.xml#L41)
--- Template
--- @class FlyoutPopupTemplate : Frame, FlyoutPopupMixin
--- @field Background FlyoutPopupTemplate_Background

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Flyout/Flyout.xml#L62)
--- Template
