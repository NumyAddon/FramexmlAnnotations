...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_FrameEffects/GlowEmitter.lua#L28)
--- @class GlowEmitterFactory : EffectFactoryMixin
GlowEmitterFactory = CreateFromMixins(EffectFactoryMixin)

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_FrameEffects/GlowEmitter.lua#L1)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_FrameEffects/GlowEmitter.lua#L30)
