...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameEffects/GlowEmitter.xml#L43)
--- child of GlowEmitterTemplate
--- @class GlowEmitterTemplate_FaintFadeAnim : AnimationGroup

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameEffects/GlowEmitter.xml#L50)
--- child of GlowEmitterTemplate
--- @class GlowEmitterTemplate_NPE_RedButton_GreenGlow : AnimationGroup

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameEffects/GlowEmitter.xml#L57)
--- child of GlowEmitterTemplate
--- @class GlowEmitterTemplate_GreenGlow : AnimationGroup

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameEffects/GlowEmitter.xml#L5)
--- Template
