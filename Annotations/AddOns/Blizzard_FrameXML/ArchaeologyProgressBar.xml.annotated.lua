...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/ArchaeologyProgressBar.xml#L81)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/ArchaeologyProgressBar.xml#L29)
--- child of ArcheologyDigsiteProgressBar
--- @class ArcheologyDigsiteProgressBar_BarTitle : FontString, GameFontWhiteSmall

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/ArchaeologyProgressBar.xml#L69)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/ArchaeologyProgressBar.xml#L62)
--- child of ArcheologyDigsiteProgressBar
--- @class ArcheologyDigsiteProgressBar_Flash : Texture
--- @field AnimIn ArcheologyDigsiteProgressBar_Flash_AnimIn

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/ArchaeologyProgressBar.xml#L9)
--- child of ArcheologyDigsiteProgressBar
--- @class ArcheologyDigsiteProgressBar_AnimIn : AnimationGroup

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/ArchaeologyProgressBar.xml#L13)
--- child of ArcheologyDigsiteProgressBar
--- @class ArcheologyDigsiteProgressBar_AnimOut : AnimationGroup, ArcheologyDigsiteProgressBarAnimOutMixin

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/ArchaeologyProgressBar.xml#L19)
--- child of ArcheologyDigsiteProgressBar
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/ArchaeologyProgressBar.xml#L3)
