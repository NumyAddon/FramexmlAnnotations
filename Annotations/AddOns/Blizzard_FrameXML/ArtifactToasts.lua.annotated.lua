...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/ArtifactToasts.lua#L9)
function ArtifactLevelUpToastMixin:OnEvent(event, ...) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/ArtifactToasts.lua#L22)
function ArtifactLevelUpToastMixin:EvaluateTrigger() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/ArtifactToasts.lua#L50)
function ArtifactLevelUpToastMixin:PlayBanner(data) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/ArtifactToasts.lua#L68)
function ArtifactLevelUpToastMixin:StopBanner() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/ArtifactToasts.lua#L73)
