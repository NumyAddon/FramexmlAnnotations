...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/AzeriteItemToasts.xml#L5)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/AzeriteItemToasts.xml#L186)
--- child of AzeriteLevelUpToast
--- @class AzeriteLevelUpToast_IconEffect : ModelScene, NonInteractableModelSceneMixinTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/AzeriteItemToasts.xml#L197)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/AzeriteItemToasts.xml#L211)
--- child of AzeriteLevelUpToast_UnlockItemsFrame
--- @class AzeriteLevelUpToast_UnlockItemsFrame_EssenceStaminaFrame : Frame
--- @field layoutIndex number # 11
--- @field Icon Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/AzeriteItemToasts.xml#L222)
--- child of AzeriteLevelUpToast_UnlockItemsFrame
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/AzeriteItemToasts.xml#L192)
--- child of AzeriteLevelUpToast
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/AzeriteItemToasts.xml#L163)
--- child of AzeriteLevelUpToast
--- @class AzeriteLevelUpToast_ItemName : FontString, QuestFont_Enormous

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/AzeriteItemToasts.xml#L176)
--- child of AzeriteLevelUpToast
--- @class AzeriteLevelUpToast_TextLabel : FontString, GameFontNormal

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/AzeriteItemToasts.xml#L260)
--- child of AzeriteLevelUpToast
--- @class AzeriteLevelUpToast_SubTextLabel : FontString, GameFontHighlight

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/AzeriteItemToasts.xml#L269)
--- child of AzeriteLevelUpToast
--- @class AzeriteLevelUpToast_ShowAnim : AnimationGroup
--- @field GlowLineBottomTranslation Translation
--- @field BGScaleAnim Scale

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/AzeriteItemToasts.xml#L33)
