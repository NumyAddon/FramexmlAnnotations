...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/AzeriteItemToasts.xml#L3)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/AzeriteItemToasts.xml#L184)
--- child of AzeriteLevelUpToast
--- @class AzeriteLevelUpToast_IconEffect : ModelScene, NonInteractableModelSceneMixinTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/AzeriteItemToasts.xml#L195)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/AzeriteItemToasts.xml#L209)
--- child of AzeriteLevelUpToast_UnlockItemsFrame
--- @class AzeriteLevelUpToast_UnlockItemsFrame_EssenceStaminaFrame : Frame
--- @field layoutIndex number # 11
--- @field Icon Texture

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/AzeriteItemToasts.xml#L220)
--- child of AzeriteLevelUpToast_UnlockItemsFrame
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/AzeriteItemToasts.xml#L190)
--- child of AzeriteLevelUpToast
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/AzeriteItemToasts.xml#L161)
--- child of AzeriteLevelUpToast
--- @class AzeriteLevelUpToast_ItemName : FontString, QuestFont_Enormous

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/AzeriteItemToasts.xml#L174)
--- child of AzeriteLevelUpToast
--- @class AzeriteLevelUpToast_TextLabel : FontString, GameFontNormal

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/AzeriteItemToasts.xml#L258)
--- child of AzeriteLevelUpToast
--- @class AzeriteLevelUpToast_SubTextLabel : FontString, GameFontHighlight

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/AzeriteItemToasts.xml#L267)
--- child of AzeriteLevelUpToast
--- @class AzeriteLevelUpToast_ShowAnim : AnimationGroup
--- @field GlowLineBottomTranslation Translation
--- @field BGScaleAnim Scale

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/AzeriteItemToasts.xml#L31)
