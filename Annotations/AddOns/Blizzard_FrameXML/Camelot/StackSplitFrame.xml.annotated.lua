...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_FrameXML/Camelot/StackSplitFrame.xml#L10)
--- child of StackSplitFrame_LeftJumpHint (created in template InputIconTextureFrameTemplate)
--- @type Texture
StackSplitFrameNormalTexture = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_FrameXML/Camelot/StackSplitFrame.xml#L11)
--- child of StackSplitFrame_LeftJumpHint (created in template InputIconTextureFrameTemplate)
--- @type Texture
StackSplitFrameHoverTexture = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_FrameXML/Camelot/StackSplitFrame.xml#L12)
--- child of StackSplitFrame_LeftJumpHint (created in template InputIconTextureFrameTemplate)
--- @type Texture
StackSplitFramePressedTexture = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_FrameXML/Camelot/StackSplitFrame.xml#L13)
--- child of StackSplitFrame_LeftJumpHint (created in template InputIconTextureFrameTemplate)
--- @type Texture
StackSplitFrameActiveTexture = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_FrameXML/Camelot/StackSplitFrame.xml#L14)
--- child of StackSplitFrame_LeftJumpHint (created in template InputIconTextureFrameTemplate)
--- @type Texture
StackSplitFrameDisabledTexture = {}
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_FrameXML/Camelot/StackSplitFrame.xml#L10)
--- child of StackSplitFrame_RightJumpHint (created in template InputIconTextureFrameTemplate)
--- @type Texture
StackSplitFrameNormalTexture = {}
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_FrameXML/Camelot/StackSplitFrame.xml#L10)
--- child of StackSplitFrame_FocusJumpHint (created in template InputIconTextureFrameTemplate)
--- @type Texture
StackSplitFrameNormalTexture = {}
