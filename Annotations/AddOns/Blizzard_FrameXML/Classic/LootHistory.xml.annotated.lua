...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_FrameXML/Classic/LootHistory.xml#L113)
--- child of 
--- @class LootHistoryItemTemplate_ToggleButton_Highlight : Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_FrameXML/Classic/LootHistory.xml#L94)
--- child of LootHistoryItemTemplate
--- @class LootHistoryItemTemplate_ToggleButton : Button

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_FrameXML/Classic/LootHistory.xml#L59)
--- child of LootHistoryItemTemplate
--- @class LootHistoryItemTemplate_ItemName : FontString, GameFontNormalSmall

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_FrameXML/Classic/LootHistory.xml#L65)
--- child of LootHistoryItemTemplate
--- @class LootHistoryItemTemplate_WinnerRoll : FontString, GameFontNormalSmall

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_FrameXML/Classic/LootHistory.xml#L77)
--- child of LootHistoryItemTemplate
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_FrameXML/Classic/LootHistory.xml#L167)
--- child of LootHistoryPlayerTemplate
--- @class LootHistoryPlayerTemplate_RollIcon : Frame
--- @field Texture Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_FrameXML/Classic/LootHistory.xml#L145)
--- child of LootHistoryPlayerTemplate
--- @class LootHistoryPlayerTemplate_RollText : FontString, GameFontNormalSmall

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_FrameXML/Classic/LootHistory.xml#L151)
--- child of LootHistoryPlayerTemplate
