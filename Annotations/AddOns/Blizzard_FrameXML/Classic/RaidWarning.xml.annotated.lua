...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_FrameXML/Classic/RaidWarning.xml#L38)
--- child of RaidWarningFrame
--- @class RaidWarningFrameSlot1 : FontString, GameFontNormalHuge
RaidWarningFrameSlot1 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_FrameXML/Classic/RaidWarning.xml#L44)
--- child of RaidWarningFrame
--- @class RaidWarningFrameSlot2 : FontString, GameFontNormalHuge
RaidWarningFrameSlot2 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_FrameXML/Classic/RaidWarning.xml#L29)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_FrameXML/Classic/RaidWarning.xml#L59)
