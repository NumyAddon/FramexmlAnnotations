...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_FrameXML/Classic/RaidWarning.xml#L9)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_FrameXML/Classic/RaidWarning.xml#L15)
--- child of RaidBossEmoteFrameTemplate
--- @class RaidBossEmoteFrameTemplate_RaidBossEmoteFrameTemplateSlot2 : FontString, GameFontNormalHuge

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_FrameXML/Classic/RaidWarning.xml#L3)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_FrameXML/Classic/RaidWarning.xml#L38)
--- child of RaidWarningFrame
--- @class RaidWarningFrame_RaidWarningFrameSlot1 : FontString, GameFontNormalHuge
RaidWarningFrameSlot1 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_FrameXML/Classic/RaidWarning.xml#L44)
--- child of RaidWarningFrame
--- @class RaidWarningFrame_RaidWarningFrameSlot2 : FontString, GameFontNormalHuge
RaidWarningFrameSlot2 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_FrameXML/Classic/RaidWarning.xml#L29)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_FrameXML/Classic/RaidWarning.xml#L59)
