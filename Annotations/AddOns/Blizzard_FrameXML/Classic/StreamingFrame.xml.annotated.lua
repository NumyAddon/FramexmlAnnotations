...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_FrameXML/Classic/StreamingFrame.xml#L12)
--- child of StreamingIcon
--- @class StreamingIcon_FadeOUT : AnimationGroup

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_FrameXML/Classic/StreamingFrame.xml#L19)
--- child of StreamingIcon
--- @class StreamingIcon_Loop : AnimationGroup

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_FrameXML/Classic/StreamingFrame.xml#L3)
