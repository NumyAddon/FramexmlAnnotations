...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_FrameXML/GhostFrame.xml#L249)
--- child of GhostFrame (created in template UIPanelLargeSilverButton)
--- @type Texture
GhostFrameRight = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_FrameXML/GhostFrame.xml#L257)
--- child of GhostFrame (created in template UIPanelLargeSilverButton)
--- @type Texture
GhostFrameMiddle = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_FrameXML/GhostFrame.xml#L268)
--- child of GhostFrame (created in template UIPanelLargeSilverButton)
--- @type Texture
GhostFrameLeft = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_FrameXML/GhostFrame.xml#L276)
--- child of GhostFrame (created in template UIPanelLargeSilverButton)
--- @type Texture
GhostFrameRight = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_FrameXML/GhostFrame.xml#L284)
--- child of GhostFrame (created in template UIPanelLargeSilverButton)
--- @type Texture
GhostFrameMiddle = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_FrameXML/GhostFrame.xml#L4)
