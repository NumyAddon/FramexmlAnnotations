...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L113)
--- child of GuildInviteFrame
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L126)
--- child of GuildInviteFrame
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L11)
--- child of GuildInviteFrame
--- @class GuildInviteFrame_GuildInviteFrameBackground : Texture
GuildInviteFrameBackground = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L20)
--- child of GuildInviteFrame
--- @class GuildInviteFrame_GuildInviteFrameTabardBackground : Texture
GuildInviteFrameTabardBackground = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L29)
--- child of GuildInviteFrame
--- @class GuildInviteFrame_GuildInviteFrameTabardEmblem : Texture
GuildInviteFrameTabardEmblem = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L35)
--- child of GuildInviteFrame
--- @class GuildInviteFrame_GuildInviteFrameInviterName : FontString, GameFontHighlightSmall
GuildInviteFrameInviterName = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L41)
--- child of GuildInviteFrame
--- @class GuildInviteFrame_GuildInviteFrameInviteText : FontString, GameFontHighlightSmall
GuildInviteFrameInviteText = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L47)
--- child of GuildInviteFrame
--- @class GuildInviteFrame_GuildInviteFrameGuildName : FontString, GameFontNormal
GuildInviteFrameGuildName = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L52)
--- child of GuildInviteFrame
--- @class GuildInviteFrame_GuildInviteFrameWarningText : FontString, GameFontHighlight
GuildInviteFrameWarningText = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L61)
--- child of GuildInviteFrame
--- @class GuildInviteFrame_GuildInviteFrameTabardBorder : Texture
GuildInviteFrameTabardBorder = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L71)
--- child of GuildInviteFrame
--- @class GuildInviteFrame_GuildInviteFrameTabardRing : Texture
GuildInviteFrameTabardRing = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L1154)
--- child of GuildInviteFrame (created in template TranslucentFrameTemplate)
--- @type Texture
GuildInviteFrameBg = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L1163)
--- child of GuildInviteFrame (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_TranslucentFrameTemplateTopLeftCorner
GuildInviteFrameTopLeftCorner = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L1168)
--- child of GuildInviteFrame (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_TranslucentFrameTemplateTopRightCorner
GuildInviteFrameTopRightCorner = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L1173)
--- child of GuildInviteFrame (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_TranslucentFrameTemplateBottomLeftCorner
GuildInviteFrameBottomLeftCorner = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L1178)
--- child of GuildInviteFrame (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_TranslucentFrameTemplateBottomRightCorner
GuildInviteFrameBottomRightCorner = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L1183)
--- child of GuildInviteFrame (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_TranslucentFrameTemplateTopBorder
GuildInviteFrameTopBorder = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L1189)
--- child of GuildInviteFrame (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_TranslucentFrameTemplateBottomBorder
GuildInviteFrameBottomBorder = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L1195)
--- child of GuildInviteFrame (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_TranslucentFrameTemplateLeftBorder
GuildInviteFrameLeftBorder = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L1201)
--- child of GuildInviteFrame (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_TranslucentFrameTemplateRightBorder
GuildInviteFrameRightBorder = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L4)
