...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L1024)
--- child of GuildInviteFrame (created in template TranslucentFrameTemplate)
--- @type Texture
GuildInviteFrameBg = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L1033)
--- child of GuildInviteFrame (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_TopLeftCorner
GuildInviteFrameTopLeftCorner = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L1038)
--- child of GuildInviteFrame (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_TopRightCorner
GuildInviteFrameTopRightCorner = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L1043)
--- child of GuildInviteFrame (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_BottomLeftCorner
GuildInviteFrameBottomLeftCorner = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L1048)
--- child of GuildInviteFrame (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_BottomRightCorner
GuildInviteFrameBottomRightCorner = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L1053)
--- child of GuildInviteFrame (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_TopBorder
GuildInviteFrameTopBorder = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L1059)
--- child of GuildInviteFrame (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_BottomBorder
GuildInviteFrameBottomBorder = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L1065)
--- child of GuildInviteFrame (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_LeftBorder
GuildInviteFrameLeftBorder = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/GuildInviteFrame.xml#L1071)
--- child of GuildInviteFrame (created in template TranslucentFrameTemplate)
