...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_FrameXML/IconIntroAnimation.lua#L88)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_FrameXML/IconIntroAnimation.lua#L71)
function IconIntroTrackerMixin:ResetAll() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_FrameXML/IconIntroAnimation.lua#L90)
function IconIntroFlyinAnimMixin:OnAnimPlay() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_FrameXML/IconIntroAnimation.lua#L115)
