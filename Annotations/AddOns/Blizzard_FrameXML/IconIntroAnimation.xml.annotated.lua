...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_FrameXML/IconIntroAnimation.xml#L5)
--- child of IconIntroAnimTemplate
--- @class IconIntroAnimTemplate_flyin : AnimationGroup, IconIntroFlyinAnimMixin
--- @field wait Alpha

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_FrameXML/IconIntroAnimation.xml#L19)
--- child of IconIntroAnimTemplate
--- @class IconIntroAnimTemplate_glow : AnimationGroup

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_FrameXML/IconIntroAnimation.xml#L3)
--- Template
