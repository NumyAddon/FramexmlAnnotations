...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/IconIntroAnimation.xml#L38)
--- child of IconIntroTemplateIconTrail3 (created in template IconIntroAnimTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/IconIntroAnimation.xml#L40)
--- child of IconIntroTemplateIconTrail3 (created in template IconIntroAnimTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_FrameXML/IconIntroAnimation.xml#L44)
--- child of IconIntroTemplateIconTrail3 (created in template IconIntroAnimTemplate)
--- @type Texture
