...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/LossOfControlFrame.xml#L64)
--- child of LossOfControlFrame
--- @class LossOfControlFrame_Cooldown : Cooldown, CooldownFrameTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/LossOfControlFrame.xml#L78)
--- child of LossOfControlFrame_TimeLeft
--- @class LossOfControlFrame_TimeLeft_NumberText : FontString, GameFontNormalHuge

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/LossOfControlFrame.xml#L91)
--- child of LossOfControlFrame_TimeLeft
--- @class LossOfControlFrame_TimeLeft_SecondsText : FontString, GameFontNormalHuge

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/LossOfControlFrame.xml#L74)
--- child of LossOfControlFrame
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/LossOfControlFrame.xml#L55)
--- child of LossOfControlFrame
--- @class LossOfControlFrame_AbilityName : FontString, MovieSubtitleFont

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/LossOfControlFrame.xml#L10)
--- child of LossOfControlFrame
--- @class LossOfControlFrame_Anim : AnimationGroup

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/LossOfControlFrame.xml#L4)
