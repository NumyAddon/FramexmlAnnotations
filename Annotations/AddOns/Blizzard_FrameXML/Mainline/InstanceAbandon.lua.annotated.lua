...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/InstanceAbandon.lua#L1)
--- @class InstanceAbandonMixin
InstanceAbandonMixin = { }

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/InstanceAbandon.lua#L63)
