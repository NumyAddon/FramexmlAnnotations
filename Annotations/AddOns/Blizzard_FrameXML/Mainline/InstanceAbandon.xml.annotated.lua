...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/InstanceAbandon.xml#L188)
--- child of InstanceAbandonPopup (created in template StaticPopupTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/InstanceAbandon.xml#L206)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/InstanceAbandon.xml#L193)
--- child of InstanceAbandonPopup (created in template StaticPopupTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/InstanceAbandon.xml#L232)
--- child of InstanceAbandonPopup (created in template StaticPopupTemplate)
