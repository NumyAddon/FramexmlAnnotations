...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/InstanceAbandon.xml#L196)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/InstanceAbandon.xml#L214)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/InstanceAbandon.xml#L201)
--- child of InstanceAbandonPopup (created in template StaticPopupTemplate)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/InstanceAbandon.xml#L105)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/InstanceAbandon.xml#L124)
--- child of InstanceAbandonPopupMoneyFrame (created in template SmallMoneyFrameTemplate)
--- @type SmallMoneyFrameTemplate_SilverButton
InstanceAbandonPopupMoneyFrameSilverButton = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/InstanceAbandon.xml#L143)
--- child of InstanceAbandonPopupMoneyFrame (created in template SmallMoneyFrameTemplate)
--- @type SmallMoneyFrameTemplate_GoldButton
InstanceAbandonPopupMoneyFrameGoldButton = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/InstanceAbandon.xml#L85)
--- child of InstanceAbandonPopupMoneyFrame (created in template SmallMoneyFrameTemplate)
--- @type Texture
InstanceAbandonPopupMoneyFrameTrialErrorButton = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/InstanceAbandon.xml#L240)
--- child of InstanceAbandonPopup (created in template StaticPopupTemplate)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/InstanceAbandon.xml#L17)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/InstanceAbandon.xml#L25)
--- child of InstanceAbandonPopupMoneyInputFrameGold (created in template MoneyFrameEditBoxTemplate)
--- @type Texture
InstanceAbandonPopupMoneyInputFrameGoldRight = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/InstanceAbandon.xml#L33)
--- child of InstanceAbandonPopupMoneyInputFrameGold (created in template MoneyFrameEditBoxTemplate)
--- @type Texture
InstanceAbandonPopupMoneyInputFrameGoldMiddle = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/InstanceAbandon.xml#L79)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/InstanceAbandon.xml#L96)
--- child of InstanceAbandonPopupMoneyInputFrame (created in template MoneyInputFrameTemplate)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/InstanceAbandon.xml#L111)
--- child of InstanceAbandonPopupMoneyInputFrame (created in template MoneyInputFrameTemplate)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/InstanceAbandon.xml#L248)
--- child of InstanceAbandonPopup (created in template StaticPopupTemplate)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/InstanceAbandon.xml#L94)
--- child of InstanceAbandonPopup (created in template StaticPopupTemplate)
--- @type StaticPopupTemplate_Text
InstanceAbandonPopupText = {}
InstanceAbandonPopupText["useScaleWeight"] = true

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/InstanceAbandon.xml#L64)
