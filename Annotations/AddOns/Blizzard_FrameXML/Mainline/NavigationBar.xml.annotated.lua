...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/NavigationBar.xml#L151)
--- child of NavButtonTemplate
--- @class NavButtonTemplate_MenuArrowButton : DropdownButton
--- @field Art Texture
--- @field NormalTexture Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/NavigationBar.xml#L123)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/NavigationBar.xml#L255)
--- child of NavBarTemplate
--- @class NavBarTemplate_overlay : Frame

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/NavigationBar.xml#L277)
--- child of NavBarTemplate
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/NavigationBar.xml#L336)
--- child of NavBarTemplate
--- @class NavBarTemplate_KioskOverlay : Frame

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/NavigationBar.xml#L241)
--- Template
