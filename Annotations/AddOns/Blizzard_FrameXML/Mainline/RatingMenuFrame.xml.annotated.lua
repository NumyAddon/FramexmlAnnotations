...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_FrameXML/Mainline/RatingMenuFrame.xml#L53)
--- child of RatingMenuFrame
--- @class RatingMenuFrame_Border : Frame, DialogBorderTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_FrameXML/Mainline/RatingMenuFrame.xml#L54)
--- child of RatingMenuFrame
