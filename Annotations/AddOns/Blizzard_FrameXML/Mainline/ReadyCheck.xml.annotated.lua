...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/ReadyCheck.xml#L3)
--- Template
--- @class ReadyCheckStatusTemplate : Frame
--- @field Texture Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/ReadyCheck.xml#L44)
--- child of ReadyCheckListenerFrame
--- @class ReadyCheckFrame_ReadyCheckListenerFrame_NineSlice : Frame, NineSlicePanelTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/ReadyCheck.xml#L53)
--- child of 
--- @class ReadyCheckFrame_ReadyCheckListenerFrame_TitleContainer_TitleText : FontString, GameFontNormal

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/ReadyCheck.xml#L45)
--- child of ReadyCheckListenerFrame
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/ReadyCheck.xml#L70)
--- child of 
--- @class ReadyCheckFrame_ReadyCheckListenerFrame_PortraitContainer_ReadyCheckPortrait : Texture
ReadyCheckPortrait = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/ReadyCheck.xml#L63)
--- child of ReadyCheckListenerFrame
--- @class ReadyCheckFrame_ReadyCheckListenerFrame_PortraitContainer : Frame

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/ReadyCheck.xml#L79)
--- child of ReadyCheckListenerFrame
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/ReadyCheck.xml#L92)
--- child of ReadyCheckListenerFrame
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/ReadyCheck.xml#L35)
--- child of ReadyCheckListenerFrame
--- @class ReadyCheckFrame_ReadyCheckListenerFrame_ReadyCheckFrameText : FontString, GameFontNormal
ReadyCheckFrameText = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/ReadyCheck.xml#L21)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/Mainline/ReadyCheck.xml#L15)
