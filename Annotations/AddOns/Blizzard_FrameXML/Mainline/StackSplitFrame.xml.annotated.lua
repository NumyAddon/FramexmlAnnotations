...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_FrameXML/Mainline/StackSplitFrame.xml#L58)
--- child of StackSplitFrame
--- @class StackSplitFrame_CancelButton : Button, UIPanelButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_FrameXML/Mainline/StackSplitFrame.xml#L12)
--- child of StackSplitFrame
--- @class StackSplitFrame_StackSplitText : FontString, GameFontHighlight

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_FrameXML/Mainline/StackSplitFrame.xml#L17)
--- child of StackSplitFrame
