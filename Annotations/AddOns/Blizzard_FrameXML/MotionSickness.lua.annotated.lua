...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/MotionSickness.lua#L1)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/MotionSickness.lua#L20)
function MotionSicknessMixin:OnLoad() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/MotionSickness.lua#L31)
function MotionSicknessMixin:ApplySettings() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/MotionSickness.lua#L41)
function MotionSicknessMixin:ApplyDarkening() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/MotionSickness.lua#L52)
function MotionSicknessMixin:SetLandscapeDarkeningUseOval(useOval) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/MotionSickness.lua#L57)
function MotionSicknessMixin:OnEvent(event, ...) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/MotionSickness.lua#L73)
function MotionSicknessMixin:FullUpdate(canGlide) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/MotionSickness.lua#L87)
function MotionSicknessMixin:UpdateScale() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/MotionSickness.lua#L98)
function MotionSicknessMixin:OnUpdate() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/MotionSickness.lua#L119)
