...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_FrameXML/MovieFrame.xml#L51)
--- child of MovieFrame_CloseDialog
--- @class MovieFrame_CloseDialog_Border : Frame, DialogBorderTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_FrameXML/MovieFrame.xml#L59)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_FrameXML/MovieFrame.xml#L65)
--- child of MovieFrame_CloseDialog_Buttons
--- @class MovieFrame_CloseDialog_Buttons_ResumeButton : Button, CinematicDialogButtonTemplate
--- @field layoutIndex number # 2
--- @field align string # center

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_FrameXML/MovieFrame.xml#L52)
--- child of MovieFrame_CloseDialog
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_FrameXML/MovieFrame.xml#L34)
--- child of MovieFrame_CloseDialog
--- @class MovieFrame_CloseDialog_Title : FontString, UserScaledFontGameHighlight, UserScaledFontStringTemplate
--- @field layoutIndex number # 1
--- @field align string # center

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_FrameXML/MovieFrame.xml#L41)
--- child of MovieFrame_CloseDialog
--- @class MovieFrame_CloseDialog_Summary : FontString, UserScaledFontGameNormal, UserScaledFontStringTemplate
--- @field layoutIndex number # 2
--- @field align string # center

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_FrameXML/MovieFrame.xml#L12)
--- child of MovieFrame
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_FrameXML/MovieFrame.xml#L3)
