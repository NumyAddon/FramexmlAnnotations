...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_FrameXML/MovieFrame.xml#L28)
--- child of MovieFrame_CloseDialog
--- @class MovieFrame_CloseDialog_Border : Frame, DialogBorderTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_FrameXML/MovieFrame.xml#L29)
--- child of MovieFrame_CloseDialog
--- @class MovieFrame_CloseDialog_ConfirmButton : Button, CinematicDialogButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_FrameXML/MovieFrame.xml#L39)
--- child of MovieFrame_CloseDialog
