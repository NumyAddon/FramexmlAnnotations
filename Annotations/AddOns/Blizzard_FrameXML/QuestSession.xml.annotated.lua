...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/QuestSession.xml#L14)
--- child of QuestSessionMemberTemplate
--- @class QuestSessionMemberTemplate_Name : FontString, GameFontNormal

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/QuestSession.xml#L29)
--- child of QuestSessionMemberTemplate
--- @class QuestSessionMemberTemplate_ShadowIcon : Texture
--- @field ignoreInLayout boolean # true

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/QuestSession.xml#L5)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/QuestSession.xml#L49)
--- Template
--- @class QuestSessionDialogButtonTemplate : Button, StaticPopupButtonTemplate, QuestSessionDialogButtonMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/QuestSession.xml#L59)
--- Template
--- @class QuestSessionDialogMinimizeButtonTemplate : Button, UIPanelHideButtonNoScripts, QuestSessionDialogMinimizeButtonMixin
--- @field ignoreInLayout boolean # true

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/QuestSession.xml#L73)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/QuestSession.xml#L81)
--- child of QuestSessionDialogButtonContainerTemplate
--- @class QuestSessionDialogButtonContainerTemplate_Decline : Button, QuestSessionDialogButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/QuestSession.xml#L68)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/QuestSession.xml#L97)
--- child of QuestSessionDialogTitleTemplate
--- @class QuestSessionDialogTitleTemplate_Text : FontString, GameFontHighlightLeft

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/QuestSession.xml#L89)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/QuestSession.xml#L143)
--- child of QuestSessionDialogTemplate
--- @class QuestSessionDialogTemplate_Border : Frame, DialogBorderTemplate
--- @field ignoreInLayout boolean # true

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/QuestSession.xml#L148)
--- child of QuestSessionDialogTemplate
--- @class QuestSessionDialogTemplate_Title : Frame, QuestSessionDialogTitleTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/QuestSession.xml#L153)
--- child of QuestSessionDialogTemplate
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_FrameXML/QuestSession.xml#L205)
