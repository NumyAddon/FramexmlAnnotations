...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_FrameXML/SpellActivationOverlay.lua#L139)
function SpellActivationOverlayMixin:GetOverlay(spellID, position) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_FrameXML/SpellActivationOverlay.lua#L155)
function SpellActivationOverlayMixin:HideOverlays(spellID) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_FrameXML/SpellActivationOverlay.lua#L165)
function SpellActivationOverlayMixin:HideAllOverlays() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_FrameXML/SpellActivationOverlay.lua#L171)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_FrameXML/SpellActivationOverlay.lua#L188)
function SpellActivationOverlayFadeInAnimMixin:OnFinished() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_FrameXML/SpellActivationOverlay.lua#L196)
