...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/SpellActivationOverlay.lua#L172)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/SpellActivationOverlay.lua#L190)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/SpellActivationOverlay.lua#L135)
function SpellActivationOverlayMixin:GetOverlay(spellID, position) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/SpellActivationOverlay.lua#L151)
function SpellActivationOverlayMixin:HideOverlays(spellID) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/SpellActivationOverlay.lua#L161)
function SpellActivationOverlayMixin:HideAllOverlays() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/SpellActivationOverlay.lua#L167)
function SpellActivationOverlayMixin:ReleaseOverlay(overlay) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/SpellActivationOverlay.lua#L174)
function SpellActivationOverlayTextureMixin:OnShow() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/SpellActivationOverlay.lua#L180)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/SpellActivationOverlay.lua#L192)
