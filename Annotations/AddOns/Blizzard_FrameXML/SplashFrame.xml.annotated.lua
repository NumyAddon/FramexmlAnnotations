...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/SplashFrame.xml#L9)
--- child of SplashFeatureFrameTemplate
--- @class SplashFeatureFrameTemplate_Description : FontString, GameFontHighlight

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/SplashFrame.xml#L15)
--- child of SplashFeatureFrameTemplate
--- @class SplashFeatureFrameTemplate_Title : FontString, GameFontNormalLarge2

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/SplashFrame.xml#L5)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/SplashFrame.xml#L72)
--- child of SplashFrame
--- @class SplashFrame_BottomCloseButton : Button, UIPanelButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/SplashFrame.xml#L83)
--- child of SplashFrame
--- @class SplashFrame_TopCloseButton : Button, UIPanelCloseButtonNoScripts

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/SplashFrame.xml#L93)
--- child of SplashFrame
--- @class SplashFrame_TopLeftFeature : Frame, SplashFeatureFrameTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/SplashFrame.xml#L98)
--- child of SplashFrame
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/SplashFrame.xml#L103)
--- child of SplashFrame
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/SplashFrame.xml#L57)
--- child of SplashFrame
--- @class SplashFrame_Header : FontString, SplashHeaderFont

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/SplashFrame.xml#L62)
--- child of SplashFrame
--- @class SplashFrame_Label : FontString, SystemFont_Large

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/SplashFrame.xml#L25)
