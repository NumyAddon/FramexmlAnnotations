...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_FrameXML/SplashFrame.xml#L72)
--- child of SplashFrame
--- @class SplashFrame_BottomCloseButton : Button, UIPanelButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_FrameXML/SplashFrame.xml#L83)
--- child of SplashFrame
--- @class SplashFrame_TopCloseButton : Button, UIPanelCloseButtonNoScripts

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_FrameXML/SplashFrame.xml#L93)
--- child of SplashFrame
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_FrameXML/SplashFrame.xml#L57)
--- child of SplashFrame
--- @class SplashFrame_Header : FontString, SplashHeaderFont

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_FrameXML/SplashFrame.xml#L62)
--- child of SplashFrame
--- @class SplashFrame_Label : FontString, SystemFont_Large

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_FrameXML/SplashFrame.xml#L25)
