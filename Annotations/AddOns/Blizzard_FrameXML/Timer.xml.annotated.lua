...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_FrameXML/Timer.xml#L18)
--- child of StartTimerBar
--- @class StartTimerBar_fadeBarOut : AnimationGroup

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_FrameXML/Timer.xml#L31)
--- child of StartTimerBar
--- @class StartTimerBar_startNumbers : AnimationGroup

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_FrameXML/Timer.xml#L66)
--- child of StartTimerBar
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_FrameXML/Timer.xml#L156)
