...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/WardrobeOutfits.xml#L5)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/WardrobeOutfits.xml#L69)
--- child of WardrobeOutfitEditFrame
--- @class WardrobeOutfitEditFrame_Border : Frame, DialogBorderTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/WardrobeOutfits.xml#L70)
--- child of WardrobeOutfitEditFrame
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/WardrobeOutfits.xml#L115)
--- child of WardrobeOutfitEditFrame
--- @class WardrobeOutfitEditFrame_AcceptButton : Button, UIPanelButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/WardrobeOutfits.xml#L127)
--- child of WardrobeOutfitEditFrame
--- @class WardrobeOutfitEditFrame_CancelButton : Button, UIPanelButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/WardrobeOutfits.xml#L138)
--- child of WardrobeOutfitEditFrame
--- @class WardrobeOutfitEditFrame_DeleteButton : Button, UIPanelButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/WardrobeOutfits.xml#L54)
--- child of WardrobeOutfitEditFrame
--- @class WardrobeOutfitEditFrame_Title : FontString, GameFontHighlight

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/WardrobeOutfits.xml#L47)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/WardrobeOutfits.xml#L166)
--- child of WardrobeOutfitCheckAppearancesFrame
--- @class WardrobeOutfitCheckAppearancesFrame_Spinner : Frame, SpinnerTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FrameXML/WardrobeOutfits.xml#L163)
