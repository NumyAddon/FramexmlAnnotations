...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FramerateFrame/FramerateFrame.lua#L26)
function FramerateFrameMixin:OnShow() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FramerateFrame/FramerateFrame.lua#L30)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FramerateFrame/FramerateFrame.lua#L44)
function FramerateFrameMixin:GetMicroMenuRelativeAnchoring(microMenuPosition, isMenuHorizontal) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_FramerateFrame/FramerateFrame.lua#L68)
