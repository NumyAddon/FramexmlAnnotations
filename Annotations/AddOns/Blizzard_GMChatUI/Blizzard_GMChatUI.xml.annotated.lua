...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L402)
--- child of GMChatFrame (created in template FloatingChatFrameTemplate)
--- @type Button
GMChatFrameClickAnywhereButton = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L415)
--- child of GMChatFrame (created in template FloatingChatFrameTemplate)
--- @type FloatingChatFrameTemplate_ResizeButton
GMChatFrameResizeButton = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L457)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L454)
--- child of GMChatFrame (created in template FloatingChatFrameTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L495)
--- child of GMChatFrame (created in template FloatingChatFrameTemplate)
