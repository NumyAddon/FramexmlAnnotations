...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L16)
--- child of GMChatTab
--- @class GMChatFrame_GMChatTab_GMChatTabBG : Texture
GMChatTabBG = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L25)
--- child of GMChatTab
--- @class GMChatFrame_GMChatTab_GMChatTabIcon : Texture
GMChatTabIcon = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L31)
--- child of GMChatTab
--- @class GMChatFrame_GMChatTab_GMChatTabText : FontString, GameFontHighlight
GMChatTabText = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L37)
--- child of GMChatTab
--- @class GMChatFrame_GMChatTab_GMChatTabBG : Texture
GMChatTabBG = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L47)
--- child of GMChatTab
--- @class GMChatFrame_GMChatTab_GMChatTabNubL : Texture
GMChatTabNubL = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L54)
--- child of GMChatTab
--- @class GMChatFrame_GMChatTab_GMChatTabNubR : Texture
GMChatTabNubR = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L9)
--- child of GMChatFrame
--- @class GMChatFrame_GMChatTab : Frame
GMChatTab = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L78)
--- child of GMChatFrame
--- @class GMChatFrame_GMChatFrameCloseButton : Button, UIPanelCloseButton
GMChatFrameCloseButton = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L91)
--- child of GMChatFrame
--- @class GMChatFrame_GMChatFrameTopLeft : Texture, Thin-BorderTopLeft
GMChatFrameTopLeft = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L96)
--- child of GMChatFrame
--- @class GMChatFrame_GMChatFrameTopRight : Texture, Thin-BorderTopRight
GMChatFrameTopRight = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L101)
--- child of GMChatFrame
--- @class GMChatFrame_GMChatFrameTop : Texture, _Thin-BorderTop
GMChatFrameTop = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L107)
--- child of GMChatFrame
--- @class GMChatFrame_GMChatFrameLeft : Texture, !Thin-BorderLeft
GMChatFrameLeft = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L113)
--- child of GMChatFrame
--- @class GMChatFrame_GMChatFrameRight : Texture, !Thin-BorderRight
GMChatFrameRight = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L6)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L22)
--- child of FloatingChatFrameTemplate (created in template FloatingBorderedFrame)
--- @type Texture
FloatingChatFrameTemplateBottomLeftTexture = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L29)
--- child of FloatingChatFrameTemplate (created in template FloatingBorderedFrame)
--- @type Texture
FloatingChatFrameTemplateTopRightTexture = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L36)
--- child of FloatingChatFrameTemplate (created in template FloatingBorderedFrame)
--- @type Texture
FloatingChatFrameTemplateBottomRightTexture = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L43)
--- child of FloatingChatFrameTemplate (created in template FloatingBorderedFrame)
--- @type Texture
FloatingChatFrameTemplateLeftTexture = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L50)
--- child of FloatingChatFrameTemplate (created in template FloatingBorderedFrame)
--- @type Texture
FloatingChatFrameTemplateRightTexture = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L58)
--- child of FloatingChatFrameTemplate (created in template FloatingBorderedFrame)
--- @type Texture
FloatingChatFrameTemplateBottomTexture = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L66)
--- child of FloatingChatFrameTemplate (created in template FloatingBorderedFrame)
--- @type Texture
FloatingChatFrameTemplateTopTexture = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L378)
--- child of GMChatFrame (created in template FloatingChatFrameTemplate)
--- @type Button
GMChatFrameClickAnywhereButton = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L391)
--- child of GMChatFrame (created in template FloatingChatFrameTemplate)
--- @type FloatingChatFrameTemplate_FloatingChatFrameTemplateResizeButton
GMChatFrameResizeButton = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L433)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L430)
--- child of GMChatFrame (created in template FloatingChatFrameTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L104)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L30)
--- child of GMChatFrameEditBox (created in template ChatFrameEditBoxTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L42)
--- child of GMChatFrameEditBox (created in template ChatFrameEditBoxTemplate)
--- @type Texture
GMChatFrameEditBoxMid = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L51)
--- child of GMChatFrameEditBox (created in template ChatFrameEditBoxTemplate)
--- @type Texture
GMChatFrameEditBoxFocusLeft = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L57)
--- child of GMChatFrameEditBox (created in template ChatFrameEditBoxTemplate)
--- @type Texture
GMChatFrameEditBoxFocusRight = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L63)
--- child of GMChatFrameEditBox (created in template ChatFrameEditBoxTemplate)
--- @type Texture
GMChatFrameEditBoxFocusMid = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L72)
--- child of GMChatFrameEditBox (created in template ChatFrameEditBoxTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L89)
--- child of GMChatFrameEditBox (created in template ChatFrameEditBoxTemplate)
--- @type ChatFrameEditBoxTemplate_ChatFrameEditBoxTemplateNewcomerHint
GMChatFrameEditBoxNewcomerHint = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L95)
--- child of GMChatFrameEditBox (created in template ChatFrameEditBoxTemplate)
--- @type ChatFrameEditBoxTemplate_ChatFrameEditBoxTemplatePrompt
GMChatFrameEditBoxPrompt = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L471)
--- child of GMChatFrame (created in template FloatingChatFrameTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L3)
