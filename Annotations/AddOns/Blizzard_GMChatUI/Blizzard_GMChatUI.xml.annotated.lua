...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L403)
--- child of GMChatFrame (created in template FloatingChatFrameTemplate)
--- @type Button
GMChatFrameClickAnywhereButton = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L416)
--- child of GMChatFrame (created in template FloatingChatFrameTemplate)
--- @type FloatingChatFrameTemplate_ResizeButton
GMChatFrameResizeButton = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L458)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L455)
--- child of GMChatFrame (created in template FloatingChatFrameTemplate)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L496)
--- child of GMChatFrame (created in template FloatingChatFrameTemplate)
