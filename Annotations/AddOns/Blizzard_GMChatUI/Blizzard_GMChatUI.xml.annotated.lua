...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L398)
--- child of GMChatFrame (created in template FloatingChatFrameTemplate)
--- @type Button
GMChatFrameClickAnywhereButton = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L411)
--- child of GMChatFrame (created in template FloatingChatFrameTemplate)
--- @type FloatingChatFrameTemplate_FloatingChatFrameTemplateResizeButton
GMChatFrameResizeButton = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L453)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L450)
--- child of GMChatFrame (created in template FloatingChatFrameTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GMChatUI/Blizzard_GMChatUI.xml#L491)
--- child of GMChatFrame (created in template FloatingChatFrameTemplate)
