...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_GameMenu/Shared/GameMenuFrame.xml#L18)
--- child of GameMenuFrame
--- @class GameMenuFrame_NewOptionsFrame : Frame, NewFeatureLabelTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_GameMenu/Shared/GameMenuFrame.xml#L23)
--- child of GameMenuFrame
--- @class GameMenuFrame_NewExternalEventFrame : Frame, NewFeatureLabelTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_GameMenu/Shared/GameMenuFrame.xml#L28)
--- child of GameMenuFrame
--- @class GameMenuFrame_EditModeNotification : Frame

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_GameMenu/Shared/GameMenuFrame.xml#L4)
