...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_GameMenu/Standard/GameMenuFrame.lua#L127)
function GameMenuFrameMixin:SetRatingsButtonShown(shown) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_GameMenu/Standard/GameMenuFrame.lua#L131)
