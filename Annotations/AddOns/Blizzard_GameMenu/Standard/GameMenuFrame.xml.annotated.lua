...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GameMenu/Standard/GameMenuFrame.xml#L23)
--- child of GameMenuFrame
...
GameMenuFrame["goldRedButtonTemplate"] = "SharedGoldRedButtonExtraLargeTemplate " -- inherited
