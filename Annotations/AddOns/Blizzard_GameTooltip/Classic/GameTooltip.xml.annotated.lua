...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L269)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L278)
--- child of ShoppingTooltip1 (created in template ShoppingTooltipTemplate)
--- @type ShoppingTooltipTemplate_TextRight1
ShoppingTooltip1TextRight1 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L287)
--- child of ShoppingTooltip1 (created in template ShoppingTooltipTemplate)
--- @type ShoppingTooltipTemplate_TextLeft2
ShoppingTooltip1TextLeft2 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L296)
--- child of ShoppingTooltip1 (created in template ShoppingTooltipTemplate)
--- @type ShoppingTooltipTemplate_TextRight2
ShoppingTooltip1TextRight2 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L305)
--- child of ShoppingTooltip1 (created in template ShoppingTooltipTemplate)
--- @type ShoppingTooltipTemplate_TextLeft3
ShoppingTooltip1TextLeft3 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L314)
--- child of ShoppingTooltip1 (created in template ShoppingTooltipTemplate)
--- @type ShoppingTooltipTemplate_TextRight3
ShoppingTooltip1TextRight3 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L323)
--- child of ShoppingTooltip1 (created in template ShoppingTooltipTemplate)
--- @type ShoppingTooltipTemplate_TextLeft4
ShoppingTooltip1TextLeft4 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L332)
--- child of ShoppingTooltip1 (created in template ShoppingTooltipTemplate)
--- @type ShoppingTooltipTemplate_TextRight4
ShoppingTooltip1TextRight4 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L341)
--- child of ShoppingTooltip1 (created in template ShoppingTooltipTemplate)
--- @type Texture
ShoppingTooltip1Texture1 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L346)
--- child of ShoppingTooltip1 (created in template ShoppingTooltipTemplate)
--- @type Texture
ShoppingTooltip1Texture2 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L351)
--- child of ShoppingTooltip1 (created in template ShoppingTooltipTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L34)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_TextRight1
GameTooltipTextRight1 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L43)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_TextLeft2
GameTooltipTextLeft2 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L52)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_TextRight2
GameTooltipTextRight2 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L61)
--- child of GameTooltip (created in template GameTooltipTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L79)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_TextLeft4
GameTooltipTextLeft4 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L88)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_TextRight4
GameTooltipTextRight4 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L97)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_TextLeft5
GameTooltipTextLeft5 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L106)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_TextRight5
GameTooltipTextRight5 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L115)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_TextLeft6
GameTooltipTextLeft6 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L124)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_TextRight6
GameTooltipTextRight6 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L133)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_TextLeft7
GameTooltipTextLeft7 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L142)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_TextRight7
GameTooltipTextRight7 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L151)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_TextLeft8
GameTooltipTextLeft8 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L160)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_TextRight8
GameTooltipTextRight8 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L169)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type Texture
GameTooltipTexture1 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L174)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type Texture
GameTooltipTexture2 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L179)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type Texture
GameTooltipTexture3 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L184)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type Texture
GameTooltipTexture4 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L189)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type Texture
GameTooltipTexture5 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L194)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type Texture
GameTooltipTexture6 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L199)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type Texture
GameTooltipTexture7 = {}
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L209)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type Texture
GameTooltipTexture9 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L214)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type Texture
