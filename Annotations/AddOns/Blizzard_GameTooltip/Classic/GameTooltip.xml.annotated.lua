...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L345)
--- child of ShoppingTooltip1 (created in template ShoppingTooltipTemplate)
--- @type Texture
ShoppingTooltip1Texture2 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L350)
--- child of ShoppingTooltip1 (created in template ShoppingTooltipTemplate)
--- @type Texture
