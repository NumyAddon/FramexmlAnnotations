...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L161)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L166)
--- child of ShoppingTooltip1 (created in template ShoppingTooltipTemplate)
--- @type ShoppingTooltipTemplate_TextRight1
ShoppingTooltip1TextRight1 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L171)
--- child of ShoppingTooltip1 (created in template ShoppingTooltipTemplate)
--- @type ShoppingTooltipTemplate_TextLeft2
ShoppingTooltip1TextLeft2 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L176)
--- child of ShoppingTooltip1 (created in template ShoppingTooltipTemplate)
--- @type ShoppingTooltipTemplate_TextRight2
ShoppingTooltip1TextRight2 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L181)
--- child of ShoppingTooltip1 (created in template ShoppingTooltipTemplate)
--- @type ShoppingTooltipTemplate_TextLeft3
ShoppingTooltip1TextLeft3 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L186)
--- child of ShoppingTooltip1 (created in template ShoppingTooltipTemplate)
--- @type ShoppingTooltipTemplate_TextRight3
ShoppingTooltip1TextRight3 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L191)
--- child of ShoppingTooltip1 (created in template ShoppingTooltipTemplate)
--- @type ShoppingTooltipTemplate_TextLeft4
ShoppingTooltip1TextLeft4 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L196)
--- child of ShoppingTooltip1 (created in template ShoppingTooltipTemplate)
--- @type ShoppingTooltipTemplate_TextRight4
ShoppingTooltip1TextRight4 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L201)
--- child of ShoppingTooltip1 (created in template ShoppingTooltipTemplate)
--- @type Texture
ShoppingTooltip1Texture1 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L204)
--- child of ShoppingTooltip1 (created in template ShoppingTooltipTemplate)
--- @type Texture
ShoppingTooltip1Texture2 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L207)
--- child of ShoppingTooltip1 (created in template ShoppingTooltipTemplate)
--- @type Texture
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L138)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_StatusBar
GameTooltipStatusBar = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L25)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_TextLeft1
GameTooltipTextLeft1 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L30)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_TextRight1
GameTooltipTextRight1 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L35)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_TextLeft2
GameTooltipTextLeft2 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L40)
--- child of GameTooltip (created in template GameTooltipTemplate)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L50)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_TextRight3
GameTooltipTextRight3 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L55)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_TextLeft4
GameTooltipTextLeft4 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L60)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_TextRight4
GameTooltipTextRight4 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L65)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_TextLeft5
GameTooltipTextLeft5 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L70)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_TextRight5
GameTooltipTextRight5 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L75)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_TextLeft6
GameTooltipTextLeft6 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L80)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_TextRight6
GameTooltipTextRight6 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L85)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_TextLeft7
GameTooltipTextLeft7 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L90)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_TextRight7
GameTooltipTextRight7 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L95)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_TextLeft8
GameTooltipTextLeft8 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L100)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type GameTooltipTemplate_TextRight8
GameTooltipTextRight8 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L105)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type Texture
GameTooltipTexture1 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L108)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type Texture
GameTooltipTexture2 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L111)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type Texture
GameTooltipTexture3 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L114)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type Texture
GameTooltipTexture4 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L117)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type Texture
GameTooltipTexture5 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L120)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type Texture
GameTooltipTexture6 = {}
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L126)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type Texture
GameTooltipTexture8 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L129)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type Texture
GameTooltipTexture9 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GameTooltip/Classic/GameTooltip.xml#L132)
--- child of GameTooltip (created in template GameTooltipTemplate)
--- @type Texture
