GamepadPetSpellFlyoutMixin = {}; --- @class GamepadPetSpellFlyoutMixin
...
local SingleSpellMixin = {}; --- @class SingleSpellMixin
...
local MultipleSpellsMixin = {}; --- @class MultipleSpellsMixin
...
local PetSpellFlyoutButtonMixin = {}; --- @class PetSpellFlyoutButtonMixin
