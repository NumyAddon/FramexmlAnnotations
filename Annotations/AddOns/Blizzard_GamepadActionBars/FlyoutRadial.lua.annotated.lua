...
GamepadFlyoutPopupButtonMixin = {}; --- @class GamepadFlyoutPopupButtonMixin
...
GamepadFlyoutMixin = CreateFromMixins(LayoutMixin, FlyoutPopupMixin); --- @class GamepadFlyoutMixin : LayoutMixin, FlyoutPopupMixin
