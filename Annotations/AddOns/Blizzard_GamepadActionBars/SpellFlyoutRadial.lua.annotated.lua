...
GamepadSpellFlyoutPopupButtonMixin = CreateFromMixins(SpellFlyoutPopupButtonMixin, GamepadFlyoutPopupButtonMixin); --- @class GamepadSpellFlyoutPopupButtonMixin : SpellFlyoutPopupButtonMixin, GamepadFlyoutPopupButtonMixin
...
GamepadSpellFlyoutMixin = CreateFromMixins(SpellFlyoutMixin, GamepadFlyoutMixin); --- @class GamepadSpellFlyoutMixin : SpellFlyoutMixin, GamepadFlyoutMixin
