...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_GamepadTargeting/RaidPartyTargeting/RaidTargetDPAD.lua#L6)
 --- @class RaidTargetingFreeSelectionMixin
RaidTargetingFreeSelectionMixin = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_GamepadTargeting/RaidPartyTargeting/RaidTargetDPAD.lua#L8)
function RaidTargetingFreeSelectionMixin:OnLoad() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_GamepadTargeting/RaidPartyTargeting/RaidTargetDPAD.lua#L13)
function RaidTargetingFreeSelectionMixin:OnGamepadMainMenuShown() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_GamepadTargeting/RaidPartyTargeting/RaidTargetDPAD.lua#L17)
function RaidTargetingFreeSelectionMixin:OnShow() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_GamepadTargeting/RaidPartyTargeting/RaidTargetDPAD.lua#L22)
