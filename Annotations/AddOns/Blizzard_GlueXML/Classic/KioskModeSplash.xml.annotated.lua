...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/Classic/KioskModeSplash.xml#L5)
--- child of KioskModeSplash
--- @class KioskModeSplash_KioskBackgroundModel : ModelFFX
KioskBackgroundModel = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/Classic/KioskModeSplash.xml#L10)
--- child of KioskModeSplash_UI
--- @class KioskModeSplash_UI_GameLogo : Frame, GlueGameLogoTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/Classic/KioskModeSplash.xml#L16)
--- child of KioskModeSplash_UI
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/Classic/KioskModeSplash.xml#L3)
