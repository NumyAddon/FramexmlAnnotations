...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_GlueXML/Classic/RealmWarning.xml#L67)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_GlueXML/Classic/RealmWarning.xml#L61)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_GlueXML/Classic/RealmWarning.xml#L76)
--- child of RealmWarningPopUpFrame
--- @class RealmWarningPopUpFrame_ScrollBar : EventFrame, MinimalScrollBar

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_GlueXML/Classic/RealmWarning.xml#L82)
--- child of RealmWarningPopUpFrame
--- @class RealmWarningPopUpFrame_AcceptButton : Button, UIPanelButtonTemplate, RealmWarningPopUpAcceptButtonMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_GlueXML/Classic/RealmWarning.xml#L91)
--- child of RealmWarningPopUpFrame
--- @class RealmWarningPopUpFrame_DeclineButton : Button, UIPanelButtonTemplate, RealmWarningPopUpDeclineButtonMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_GlueXML/Classic/RealmWarning.xml#L50)
--- child of RealmWarningPopUpFrame
--- @class RealmWarningPopUpFrame_TitleText : FontString, Game16Font

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_GlueXML/Classic/RealmWarning.xml#L4)
