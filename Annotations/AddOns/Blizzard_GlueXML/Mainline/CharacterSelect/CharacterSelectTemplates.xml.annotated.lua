...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GlueXML/Mainline/CharacterSelect/CharacterSelectTemplates.xml#L27)
--- child of CharacterSelectToolTrayTemplate
--- @class CharacterSelectToolTrayTemplate_Container : Frame, VerticalLayoutFrame

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GlueXML/Mainline/CharacterSelect/CharacterSelectTemplates.xml#L3)
--- Template
