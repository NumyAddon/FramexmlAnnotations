...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_GlueXML/Mainline/CharacterServicesPaidCharacterTransfer.xml#L3)
--- @class PCTCharacterSelect : Frame, CharacterServicesBlockTemplate
--- @field ControlsFrame Frame
PCTCharacterSelect = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_GlueXML/Mainline/CharacterServicesPaidCharacterTransfer.xml#L22)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_GlueXML/Mainline/CharacterServicesPaidCharacterTransfer.xml#L30)
--- child of PCTDestinationSelect_ControlsFrame
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_GlueXML/Mainline/CharacterServicesPaidCharacterTransfer.xml#L41)
--- child of PCTDestinationSelect_ControlsFrame
--- @class PCTDestinationSelect_ControlsFrame_TransferAccountContainer : Frame, AccountSelectorTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_GlueXML/Mainline/CharacterServicesPaidCharacterTransfer.xml#L50)
--- child of PCTDestinationSelect_ControlsFrame_LoadingSpinner
--- @class PCTDestinationSelect_ControlsFrame_LoadingSpinner_SearchingText : FontString, GameFontNormal

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_GlueXML/Mainline/CharacterServicesPaidCharacterTransfer.xml#L46)
--- child of PCTDestinationSelect_ControlsFrame
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_GlueXML/Mainline/CharacterServicesPaidCharacterTransfer.xml#L16)
--- child of PCTDestinationSelect_ControlsFrame
--- @class PCTDestinationSelect_ControlsFrame_TransferRealmLabel : FontString, GameFontNormalMed3

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_GlueXML/Mainline/CharacterServicesPaidCharacterTransfer.xml#L13)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_GlueXML/Mainline/CharacterServicesPaidCharacterTransfer.xml#L10)
