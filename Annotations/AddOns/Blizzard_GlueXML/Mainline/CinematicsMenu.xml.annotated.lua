...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_GlueXML/Mainline/CinematicsMenu.xml#L983)
--- child of CinematicsMenu (created in template DefaultPanelTemplate)
--- @type Texture
CinematicsMenuBg = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_GlueXML/Mainline/CinematicsMenu.xml#L991)
--- child of CinematicsMenu (created in template DefaultPanelTemplate)
