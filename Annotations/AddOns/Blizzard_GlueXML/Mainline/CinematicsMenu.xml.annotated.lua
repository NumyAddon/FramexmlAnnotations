...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GlueXML/Mainline/CinematicsMenu.xml#L103)
--- child of CinematicsMenu
--- @class CinematicsMenu_Inset : Frame, InsetFrameTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GlueXML/Mainline/CinematicsMenu.xml#L109)
--- child of CinematicsMenu
--- @class CinematicsMenu_ButtonList : Frame, PagedListTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GlueXML/Mainline/CinematicsMenu.xml#L115)
--- child of CinematicsMenu
--- @class CinematicsMenu_PageControl : Frame, PagedListHorizontalControlTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GlueXML/Mainline/CinematicsMenu.xml#L80)
--- child of CinematicsMenu
--- @class CinematicsMenu_SubtitlesLabel : FontString, GlueFontNormal

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GlueXML/Mainline/CinematicsMenu.xml#L983)
--- child of CinematicsMenu (created in template DefaultPanelTemplate)
--- @type Texture
CinematicsMenuBg = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GlueXML/Mainline/CinematicsMenu.xml#L991)
--- child of CinematicsMenu (created in template DefaultPanelTemplate)
