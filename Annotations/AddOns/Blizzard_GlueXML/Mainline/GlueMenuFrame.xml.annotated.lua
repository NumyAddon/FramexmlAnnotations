...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_GlueXML/Mainline/GlueMenuFrame.xml#L4)
--- Template
--- @class GlueMenuFrameButtonTemplate : Button, MainMenuFrameButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_GlueXML/Mainline/GlueMenuFrame.xml#L10)
