...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GlueXML/ServerAlert.xml#L7)
--- child of ServerAlertBackgroundTemplate
--- @class ServerAlertBackgroundTemplate_Border : Frame, DialogBorderTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GlueXML/ServerAlert.xml#L4)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GlueXML/ServerAlert.xml#L22)
--- child of ServerAlertBoxTemplate
--- @class ServerAlertBoxTemplate_Background : Frame, ServerAlertBackgroundTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GlueXML/ServerAlert.xml#L37)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GlueXML/ServerAlert.xml#L23)
--- child of ServerAlertBoxTemplate
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GlueXML/ServerAlert.xml#L11)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GlueXML/ServerAlert.xml#L58)
--- child of ServerAlertTemplate
--- @class ServerAlertTemplate_Box : Frame, ServerAlertBoxTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GlueXML/ServerAlert.xml#L56)
--- Template
--- @class ServerAlertTemplate : Frame, ServerAlertMixin
--- @field Box ServerAlertTemplate_Box

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GlueXML/ServerAlert.xml#L77)
--- child of 
--- @class CollapsibleServerAlertTemplate_ExpandBar_Text : FontString, GlueFontNormalLarge

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GlueXML/ServerAlert.xml#L69)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GlueXML/ServerAlert.xml#L66)
--- Template
