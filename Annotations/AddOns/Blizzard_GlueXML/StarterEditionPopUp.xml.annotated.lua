...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/StarterEditionPopUp.xml#L4)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/StarterEditionPopUp.xml#L78)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/StarterEditionPopUp.xml#L102)
--- child of StarterEditionPopUp
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/StarterEditionPopUp.xml#L56)
--- child of StarterEditionPopUp
--- @class StarterEditionPopUp_StarterEditionPopUpUpgradeText : FontString, GlueFontHighlightHuge
StarterEditionPopUpUpgradeText = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/StarterEditionPopUp.xml#L62)
--- child of StarterEditionPopUp
--- @class StarterEditionPopUp_StarterEditionPopUpUnlockText : FontString, GlueFontNormal
StarterEditionPopUpUnlockText = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/StarterEditionPopUp.xml#L68)
--- child of StarterEditionPopUp
--- @class StarterEditionPopUp_StarterEditionPopUpDivider : Texture
StarterEditionPopUpDivider = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/StarterEditionPopUp.xml#L33)
