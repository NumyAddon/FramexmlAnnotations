...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/TBC/CreditsFrame.lua#L408)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/TBC/CreditsFrame.lua#L119)
function CreditsFrameMixin:Switch(expansion, releaseType) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/TBC/CreditsFrame.lua#L144)
function CreditsFrameMixin:SetArtTextures(textureName, index, alpha) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/TBC/CreditsFrame.lua#L183)
function CreditsFrameMixin:CacheTextures(index) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/TBC/CreditsFrame.lua#L219)
function CreditsFrameMixin:UpdateArt(index, elapsed) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/TBC/CreditsFrame.lua#L268)
function CreditsFrameMixin:SetSpeed(speed) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/TBC/CreditsFrame.lua#L274)
function CreditsFrameMixin:SetSpeedButtonActive(button, active) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/TBC/CreditsFrame.lua#L284)
function CreditsFrameMixin:UpdateSpeedButtons() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/TBC/CreditsFrame.lua#L302)
function CreditsFrameMixin:OnUpdate(elapsed) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/TBC/CreditsFrame.lua#L388)
function CreditsFrameMixin:OnKeyDown(key) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/TBC/CreditsFrame.lua#L400)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/TBC/CreditsFrame.lua#L416)
function CreditsExpansionListMixin:OnCancelClicked() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/TBC/CreditsFrame.lua#L421)
function CreditsExpansionListMixin:SetSelectedExpansion(expansion, releaseType) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/TBC/CreditsFrame.lua#L429)
