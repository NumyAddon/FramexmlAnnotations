...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/Vanilla/RealmList.xml#L104)
--- child of RealmNameSort (created in template RealmSortButtonTemplate)
--- @type Texture
RealmNameSortLeft = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/Vanilla/RealmList.xml#L113)
--- child of RealmNameSort (created in template RealmSortButtonTemplate)
--- @type Texture
RealmNameSortRight = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/Vanilla/RealmList.xml#L122)
--- child of RealmNameSort (created in template RealmSortButtonTemplate)
--- @type Texture
RealmNameSortMiddle = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/Vanilla/RealmList.xml#L144)
--- child of RealmNameSort (created in template RealmSortButtonTemplate)
--- @type Texture
RealmNameSortArrow = {}
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/Vanilla/RealmList.xml#L9)
--- child of RealmListTab1 (created in template RealmListTabButtonTemplate)
--- @type Texture
RealmListTab1LeftDisabled = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/Vanilla/RealmList.xml#L22)
--- child of RealmListTab1 (created in template RealmListTabButtonTemplate)
--- @type Texture
RealmListTab1MiddleDisabled = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/Vanilla/RealmList.xml#L31)
--- child of RealmListTab1 (created in template RealmListTabButtonTemplate)
--- @type Texture
RealmListTab1RightDisabled = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/Vanilla/RealmList.xml#L40)
--- child of RealmListTab1 (created in template RealmListTabButtonTemplate)
--- @type Texture
RealmListTab1Left = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/Vanilla/RealmList.xml#L49)
--- child of RealmListTab1 (created in template RealmListTabButtonTemplate)
--- @type Texture
RealmListTab1Middle = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/Vanilla/RealmList.xml#L58)
--- child of RealmListTab1 (created in template RealmListTabButtonTemplate)
--- @type Texture
RealmListTab1Right = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/Vanilla/RealmList.xml#L86)
--- child of RealmListTab1 (created in template RealmListTabButtonTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/Vanilla/RealmList.xml#L108)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/Vanilla/RealmList.xml#L117)
--- child of RealmListScrollFrameScrollBar (created in template HybridScrollBarTrimTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/Vanilla/RealmList.xml#L79)
--- child of RealmListScrollFrameScrollBar (created in template HybridScrollBarTrimTemplate)
--- @type Texture
RealmListScrollFrameScrollBarBG = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/Vanilla/RealmList.xml#L84)
--- child of RealmListScrollFrameScrollBar (created in template HybridScrollBarTrimTemplate)
--- @type Texture
RealmListScrollFrameScrollBarTop = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/Vanilla/RealmList.xml#L91)
--- child of RealmListScrollFrameScrollBar (created in template HybridScrollBarTrimTemplate)
--- @type Texture
RealmListScrollFrameScrollBarBottom = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/Vanilla/RealmList.xml#L98)
--- child of RealmListScrollFrameScrollBar (created in template HybridScrollBarTrimTemplate)
--- @type Texture
RealmListScrollFrameScrollBarMiddle = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GlueXML/Vanilla/RealmList.xml#L130)
--- child of RealmListScrollFrameScrollBar (created in template HybridScrollBarTrimTemplate)
