...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GlueXML/WoWLabs/GluePartyPoseUI.xml#L5)
--- child of GluePartyPoseFrame
--- @class GluePartyPoseFrame_ModelScene : ModelScene, NonInteractableModelSceneMixinTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GlueXML/WoWLabs/GluePartyPoseUI.xml#L6)
--- child of GluePartyPoseFrame
--- @class GluePartyPoseFrame_PartyPoseDialogSpinner : Frame, LoadingSpinnerTemplate
PartyPoseDialogSpinner = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GlueXML/WoWLabs/GluePartyPoseUI.xml#L3)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GlueXML/WoWLabs/GluePartyPoseUI.xml#L39)
--- child of PartyMemberNameTemplate
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GlueXML/WoWLabs/GluePartyPoseUI.xml#L53)
--- child of PartyMemberFrameTemplate
--- @class PartyMemberFrameTemplate_MemberNameFrame : Frame, PartyMemberNameTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GlueXML/WoWLabs/GluePartyPoseUI.xml#L50)
--- Template
