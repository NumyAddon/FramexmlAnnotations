...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GlueXML/WoWLabs/MatchmakingQueueFrame.xml#L10)
--- child of GameModeSelectionButtonTemplate
--- @class GameModeSelectionButtonTemplate_ButtonName : FontString, GlueFontNormalLarge

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GlueXML/WoWLabs/MatchmakingQueueFrame.xml#L5)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GlueXML/WoWLabs/MatchmakingQueueFrame.xml#L84)
--- child of GameModeSettingsFrameTemplate
--- @class GameModeSettingsFrameTemplate_GameReadyButton : Button, GlueButtonTemplate, PlunderstormReadyButtonMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GlueXML/WoWLabs/MatchmakingQueueFrame.xml#L24)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GlueXML/WoWLabs/MatchmakingQueueFrame.xml#L117)
--- child of QueueSpinnerTemplate
--- @class QueueSpinnerTemplate_Anim : AnimationGroup

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GlueXML/WoWLabs/MatchmakingQueueFrame.xml#L108)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GlueXML/WoWLabs/MatchmakingQueueFrame.xml#L132)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GlueXML/WoWLabs/MatchmakingQueueFrame.xml#L144)
--- child of MatchmakingQueueFrameTemplate
--- @class MatchmakingQueueFrameTemplate_QueueTimerSpinner : Frame, QueueSpinnerTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GlueXML/WoWLabs/MatchmakingQueueFrame.xml#L159)
--- child of MatchmakingQueueFrameTemplate
--- @class MatchmakingQueueFrameTemplate_QueueSquadSize : FontString, GlueFontNormalHuge

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GlueXML/WoWLabs/MatchmakingQueueFrame.xml#L165)
--- child of MatchmakingQueueFrameTemplate
--- @class MatchmakingQueueFrameTemplate_TimerTimeText : FontString, GlueFontNormalHuge

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_GlueXML/WoWLabs/MatchmakingQueueFrame.xml#L129)
--- Template
