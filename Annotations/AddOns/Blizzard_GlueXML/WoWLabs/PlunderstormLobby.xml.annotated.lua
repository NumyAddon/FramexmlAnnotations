...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GlueXML/WoWLabs/PlunderstormLobby.xml#L13)
--- child of 
--- @class PlunderstormLobbyFrame_GameModeDescriptionFrame_GameModeHeader : FontString, Game58Font_Shadow2

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GlueXML/WoWLabs/PlunderstormLobby.xml#L20)
--- child of 
--- @class PlunderstormLobbyFrame_GameModeDescriptionFrame_GameModeDescription : FontString, SystemFont_Large2

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GlueXML/WoWLabs/PlunderstormLobby.xml#L9)
--- child of PlunderstormLobbyFrame
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GlueXML/WoWLabs/PlunderstormLobby.xml#L41)
--- child of 
--- @class PlunderstormLobbyFrame_PlunderstormLobbyFriendsButton_FriendsOnline : FontString, SystemFont_Large2

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GlueXML/WoWLabs/PlunderstormLobby.xml#L47)
--- child of 
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GlueXML/WoWLabs/PlunderstormLobby.xml#L55)
--- child of 
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GlueXML/WoWLabs/PlunderstormLobby.xml#L154)
--- child of 
--- @class PlunderstormLobbyFrame_SubNoticeFrame_SuscribeButton : Button, GlueButtonTemplate, WoWLabsSubscribeButtonMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GlueXML/WoWLabs/PlunderstormLobby.xml#L145)
--- child of 
--- @class PlunderstormLobbyFrame_SubNoticeFrame_SubRequiredText : FontString, GlueFontNormalLarge

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GlueXML/WoWLabs/PlunderstormLobby.xml#L138)
--- child of PlunderstormLobbyFrame
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GlueXML/WoWLabs/PlunderstormLobby.xml#L177)
--- child of FriendsToastFrame
--- @class PlunderstormLobbyFrame_FriendsToastFrame_ToastText : FontString, GlueFontNormal

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GlueXML/WoWLabs/PlunderstormLobby.xml#L184)
--- child of FriendsToastFrame
--- @class PlunderstormLobbyFrame_FriendsToastFrame_FriendsToastFrameIconTexture : Texture
FriendsToastFrameIconTexture = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_GlueXML/WoWLabs/PlunderstormLobby.xml#L194)
--- child of FriendsToastFrame
