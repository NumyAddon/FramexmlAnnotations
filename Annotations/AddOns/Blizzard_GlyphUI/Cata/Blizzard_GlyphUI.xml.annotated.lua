...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_GlyphUI/Cata/Blizzard_GlyphUI.xml#L195)
--- child of GlyphFrameGlyph2 (created in template GlyphTemplate)
--- @type Texture
GlyphFrameGlyph2Glyph = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_GlyphUI/Cata/Blizzard_GlyphUI.xml#L205)
--- child of GlyphFrameGlyph2 (created in template GlyphTemplate)
--- @type Texture
GlyphFrameGlyph2Highlight = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_GlyphUI/Cata/Blizzard_GlyphUI.xml#L214)
--- child of GlyphFrameGlyph2 (created in template GlyphTemplate)
--- @type Texture
