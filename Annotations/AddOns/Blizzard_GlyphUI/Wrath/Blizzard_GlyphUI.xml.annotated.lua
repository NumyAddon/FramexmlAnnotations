...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_GlyphUI/Wrath/Blizzard_GlyphUI.xml#L11)
--- child of GlyphTemplate
--- @class GlyphTemplate_GlyphTemplateSetting : Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_GlyphUI/Wrath/Blizzard_GlyphUI.xml#L22)
--- child of GlyphTemplate
--- @class GlyphTemplate_GlyphTemplateHighlight : Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_GlyphUI/Wrath/Blizzard_GlyphUI.xml#L32)
--- child of GlyphTemplate
--- @class GlyphTemplate_GlyphTemplateBackground : Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_GlyphUI/Wrath/Blizzard_GlyphUI.xml#L43)
--- child of GlyphTemplate
--- @class GlyphTemplate_GlyphTemplateGlyph : Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_GlyphUI/Wrath/Blizzard_GlyphUI.xml#L53)
--- child of GlyphTemplate
--- @class GlyphTemplate_GlyphTemplateRing : Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_GlyphUI/Wrath/Blizzard_GlyphUI.xml#L62)
--- child of GlyphTemplate
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_GlyphUI/Wrath/Blizzard_GlyphUI.xml#L102)
