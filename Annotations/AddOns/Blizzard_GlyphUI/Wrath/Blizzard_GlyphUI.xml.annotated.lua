...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_GlyphUI/Wrath/Blizzard_GlyphUI.xml#L205)
--- child of GlyphFrameGlyph1 (created in template GlyphTemplate)
--- @type Texture
GlyphFrameGlyph1Highlight = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_GlyphUI/Wrath/Blizzard_GlyphUI.xml#L214)
--- child of GlyphFrameGlyph1 (created in template GlyphTemplate)
--- @type Texture
