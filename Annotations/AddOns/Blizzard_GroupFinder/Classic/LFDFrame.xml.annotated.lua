...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_GroupFinder/Classic/LFDFrame.xml#L254)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_GroupFinder/Classic/LFDFrame.xml#L265)
--- child of LFDFrameDungeonChoiceTemplate (created in template LFGSpecificChoiceTemplate)
--- @type LFGSpecificChoiceTemplate_LFGSpecificChoiceTemplateExpandOrCollapseButton

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_GroupFinder/Classic/LFDFrame.xml#L225)
--- child of LFDFrameDungeonChoiceTemplate (created in template LFGSpecificChoiceTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_GroupFinder/Classic/LFDFrame.xml#L237)
--- child of LFDFrameDungeonChoiceTemplate (created in template LFGSpecificChoiceTemplate)
--- @type LFGSpecificChoiceTemplate_LFGSpecificChoiceTemplateInstanceName

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_GroupFinder/Classic/LFDFrame.xml#L244)
--- child of LFDFrameDungeonChoiceTemplate (created in template LFGSpecificChoiceTemplate)
--- @type Texture
