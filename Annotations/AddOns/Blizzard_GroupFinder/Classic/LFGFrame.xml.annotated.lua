...
--- child of LFGRewardsLootTemplateRoleIcon1 (created in template LFGRewardsLootShortageTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_GroupFinder/Classic/LFGFrame.xml#L654)
--- child of LFGRewardsLootTemplateRoleIcon2 (created in template LFGRewardsLootShortageTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_GroupFinder/Classic/LFGFrame.xml#L206)
--- child of LFGRewardsLootTemplate (created in template LargeItemButtonTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_GroupFinder/Classic/LFGFrame.xml#L212)
--- child of LFGRewardsLootTemplate (created in template LargeItemButtonTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_GroupFinder/Classic/LFGFrame.xml#L220)
--- child of LFGRewardsLootTemplate (created in template LargeItemButtonTemplate)
--- @type LargeItemButtonTemplate_LargeItemButtonTemplateName

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_GroupFinder/Classic/LFGFrame.xml#L228)
--- child of LFGRewardsLootTemplate (created in template LargeItemButtonTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_GroupFinder/Classic/LFGFrame.xml#L654)
--- child of LFGRewardFrameTemplateItem1RoleIcon1 (created in template LFGRewardsLootShortageTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_GroupFinder/Classic/LFGFrame.xml#L695)
--- child of LFGRewardFrameTemplateItem1 (created in template LFGRewardsLootTemplate)
--- @type LFGRewardsLootTemplate_LFGRewardsLootTemplateRoleIcon1

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_GroupFinder/Classic/LFGFrame.xml#L654)
--- child of LFGRewardFrameTemplateItem1RoleIcon2 (created in template LFGRewardsLootShortageTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_GroupFinder/Classic/LFGFrame.xml#L206)
--- child of LFGRewardFrameTemplateMoneyReward (created in template LargeItemButtonTemplate)
--- @type Texture
