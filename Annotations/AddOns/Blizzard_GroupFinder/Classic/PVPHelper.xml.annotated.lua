...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_GroupFinder/Classic/PVPHelper.xml#L3)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_GroupFinder/Classic/PVPHelper.xml#L150)
--- child of PVPReadyDialog
--- @class PVPReadyDialog_CoverFrame : Frame

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_GroupFinder/Classic/PVPHelper.xml#L167)
--- child of PVPReadyDialog
--- @class PVPReadyDialogExtraFrame : Frame
PVPReadyDialogExtraFrame = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_GroupFinder/Classic/PVPHelper.xml#L168)
--- child of PVPReadyDialog
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_GroupFinder/Classic/PVPHelper.xml#L184)
--- child of PVPReadyDialog
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_GroupFinder/Classic/PVPHelper.xml#L112)
--- child of PVPReadyDialog
--- @class PVPReadyDialogText : FontString, GameFontHighlight
PVPReadyDialogText = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_GroupFinder/Classic/PVPHelper.xml#L124)
--- child of PVPReadyDialog
--- @class PVPReadyDialog_SubText : FontString, GameFontNormalSmall

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_GroupFinder/Classic/PVPHelper.xml#L130)
--- child of PVPReadyDialog
