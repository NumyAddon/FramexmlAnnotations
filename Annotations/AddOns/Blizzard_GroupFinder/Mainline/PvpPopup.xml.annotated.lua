...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_GroupFinder/Mainline/PvpPopup.xml#L22)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_GroupFinder/Mainline/PvpPopup.xml#L51)
--- child of ReadyStatus
--- @class PVPReadyPopup_ReadyStatus_Border : Frame, DialogBorderTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_GroupFinder/Mainline/PvpPopup.xml#L52)
--- child of ReadyStatus
--- @class PVPReadyPopup_ReadyStatus_CloseButton : Button, UIPanelHideButtonNoScripts

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_GroupFinder/Mainline/PvpPopup.xml#L43)
--- child of ReadyStatus
--- @class PVPReadyPopup_ReadyStatus_ReadyCheck : FontString, GameFontHighlight

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_GroupFinder/Mainline/PvpPopup.xml#L36)
