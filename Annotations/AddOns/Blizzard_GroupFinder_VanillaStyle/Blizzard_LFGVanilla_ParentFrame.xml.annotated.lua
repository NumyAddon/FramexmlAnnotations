...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GroupFinder_VanillaStyle/Blizzard_LFGVanilla_ParentFrame.xml#L31)
--- child of LFGParentFrameTab1 (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
LFGParentFrameTab1RightDisabled = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GroupFinder_VanillaStyle/Blizzard_LFGVanilla_ParentFrame.xml#L40)
--- child of LFGParentFrameTab1 (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
LFGParentFrameTab1Left = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GroupFinder_VanillaStyle/Blizzard_LFGVanilla_ParentFrame.xml#L49)
--- child of LFGParentFrameTab1 (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
LFGParentFrameTab1Middle = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GroupFinder_VanillaStyle/Blizzard_LFGVanilla_ParentFrame.xml#L58)
--- child of LFGParentFrameTab1 (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
LFGParentFrameTab1Right = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GroupFinder_VanillaStyle/Blizzard_LFGVanilla_ParentFrame.xml#L113)
--- child of LFGParentFrameTab1 (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
