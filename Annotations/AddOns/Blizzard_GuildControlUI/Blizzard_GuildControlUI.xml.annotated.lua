...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L159)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L185)
--- child of BankTabPermissionTemplateBuyCostMoneyFrame (created in template SmallMoneyFrameTemplate)
--- @type SmallMoneyFrameTemplate_SmallMoneyFrameTemplateCopperButton

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L225)
--- child of BankTabPermissionTemplateBuyCostMoneyFrame (created in template SmallMoneyFrameTemplate)
