...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L429)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L159)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L185)
--- child of BankTabPermissionTemplateBuyCostMoneyFrame (created in template SmallMoneyFrameTemplate)
--- @type SmallMoneyFrameTemplate_SmallMoneyFrameTemplateCopperButton

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L225)
--- child of BankTabPermissionTemplateBuyCostMoneyFrame (created in template SmallMoneyFrameTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L1514)
--- child of GuildControlUIHbar (created in template HorizontalBarTemplate)
--- @type Texture
GuildControlUIHbarBg = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L1518)
--- child of GuildControlUIHbar (created in template HorizontalBarTemplate)
--- @type HorizontalBarTemplate_HorizontalBarTemplateTopLeftCorner
GuildControlUIHbarTopLeftCorner = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L1523)
--- child of GuildControlUIHbar (created in template HorizontalBarTemplate)
--- @type HorizontalBarTemplate_HorizontalBarTemplateTopRightCorner
GuildControlUIHbarTopRightCorner = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L1528)
--- child of GuildControlUIHbar (created in template HorizontalBarTemplate)
--- @type HorizontalBarTemplate_HorizontalBarTemplateBotLeftCorner
GuildControlUIHbarBotLeftCorner = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L1533)
--- child of GuildControlUIHbar (created in template HorizontalBarTemplate)
--- @type HorizontalBarTemplate_HorizontalBarTemplateBotRightCorner
GuildControlUIHbarBotRightCorner = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L1539)
--- child of GuildControlUIHbar (created in template HorizontalBarTemplate)
--- @type HorizontalBarTemplate_HorizontalBarTemplateTopBorder
GuildControlUIHbarTopBorder = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L1545)
--- child of GuildControlUIHbar (created in template HorizontalBarTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L284)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L226)
--- child of GuildControlUINavigationDropDown (created in template UIDropDownMenuTemplate)
--- @type Texture
GuildControlUINavigationDropDownLeft = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L239)
--- child of GuildControlUINavigationDropDown (created in template UIDropDownMenuTemplate)
--- @type Texture
GuildControlUINavigationDropDownMiddle = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L248)
--- child of GuildControlUINavigationDropDown (created in template UIDropDownMenuTemplate)
--- @type Texture
GuildControlUINavigationDropDownRight = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L257)
--- child of GuildControlUINavigationDropDown (created in template UIDropDownMenuTemplate)
--- @type UIDropDownMenuTemplate_UIDropDownMenuTemplateText
GuildControlUINavigationDropDownText = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L271)
--- child of GuildControlUINavigationDropDown (created in template UIDropDownMenuTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L1560)
--- child of GuildControlUI (created in template TranslucentFrameTemplate)
--- @type Texture
GuildControlUIBg = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L1569)
--- child of GuildControlUI (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_TranslucentFrameTemplateTopLeftCorner
GuildControlUITopLeftCorner = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L1574)
--- child of GuildControlUI (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_TranslucentFrameTemplateTopRightCorner
GuildControlUITopRightCorner = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L1579)
--- child of GuildControlUI (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_TranslucentFrameTemplateBottomLeftCorner
GuildControlUIBottomLeftCorner = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L1584)
--- child of GuildControlUI (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_TranslucentFrameTemplateBottomRightCorner
GuildControlUIBottomRightCorner = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L1589)
--- child of GuildControlUI (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_TranslucentFrameTemplateTopBorder
GuildControlUITopBorder = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L1595)
--- child of GuildControlUI (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_TranslucentFrameTemplateBottomBorder
GuildControlUIBottomBorder = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L1601)
--- child of GuildControlUI (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_TranslucentFrameTemplateLeftBorder
GuildControlUILeftBorder = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_GuildControlUI/Blizzard_GuildControlUI.xml#L1607)
--- child of GuildControlUI (created in template TranslucentFrameTemplate)
