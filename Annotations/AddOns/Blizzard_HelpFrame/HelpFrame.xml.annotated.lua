...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_HelpFrame/HelpFrame.xml#L1686)
--- child of HelpFrame (created in template DefaultPanelTemplate)
--- @type Texture
HelpFrameBg = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_HelpFrame/HelpFrame.xml#L1694)
--- child of HelpFrame (created in template DefaultPanelTemplate)
