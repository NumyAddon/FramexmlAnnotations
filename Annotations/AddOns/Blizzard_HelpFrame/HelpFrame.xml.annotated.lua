...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_HelpFrame/HelpFrame.xml#L1728)
--- child of HelpFrame (created in template DefaultPanelTemplate)
--- @type Texture
HelpFrameBg = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_HelpFrame/HelpFrame.xml#L1736)
--- child of HelpFrame (created in template DefaultPanelTemplate)
