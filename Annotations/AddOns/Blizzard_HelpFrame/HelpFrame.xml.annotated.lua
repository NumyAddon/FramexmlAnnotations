...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_HelpFrame/HelpFrame.xml#L1734)
--- child of HelpFrame (created in template DefaultPanelTemplate)
--- @type Texture
HelpFrameBg = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_HelpFrame/HelpFrame.xml#L1742)
--- child of HelpFrame (created in template DefaultPanelTemplate)
