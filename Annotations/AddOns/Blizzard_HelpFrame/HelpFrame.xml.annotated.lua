...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_HelpFrame/HelpFrame.xml#L1279)
--- child of HelpFrame (created in template DefaultPanelTemplate)
--- @type Texture
HelpFrameBg = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_HelpFrame/HelpFrame.xml#L1287)
--- child of HelpFrame (created in template DefaultPanelTemplate)
