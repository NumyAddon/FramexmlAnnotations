...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_HelpFrame/HelpFrame.xml#L983)
--- child of HelpFrame (created in template DefaultPanelTemplate)
--- @type Texture
HelpFrameBg = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_HelpFrame/HelpFrame.xml#L991)
--- child of HelpFrame (created in template DefaultPanelTemplate)
