...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_HouseEditor/Blizzard_HouseEditorPlacedDecorList.xml#L3)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_HouseEditor/Blizzard_HouseEditorPlacedDecorList.xml#L39)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_HouseEditor/Blizzard_HouseEditorPlacedDecorList.xml#L29)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_HouseEditor/Blizzard_HouseEditorPlacedDecorList.xml#L96)
--- child of HouseEditorPlacedDecorListTemplate
--- @class HouseEditorPlacedDecorListTemplate_InputBlocker : Button

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_HouseEditor/Blizzard_HouseEditorPlacedDecorList.xml#L105)
--- child of HouseEditorPlacedDecorListTemplate
--- @class HouseEditorPlacedDecorListTemplate_DragBar : Button, PanelDragBarTemplate
--- @field showCursorOnHover boolean # true

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_HouseEditor/Blizzard_HouseEditorPlacedDecorList.xml#L114)
--- child of HouseEditorPlacedDecorListTemplate
--- @class HouseEditorPlacedDecorListTemplate_CloseButton : Button, UIPanelCloseButtonNoScripts

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_HouseEditor/Blizzard_HouseEditorPlacedDecorList.xml#L119)
--- child of HouseEditorPlacedDecorListTemplate
--- @class HouseEditorPlacedDecorListTemplate_ScrollBox : Frame, WowScrollBoxList
--- @field wheelPanScalar number # 1

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_HouseEditor/Blizzard_HouseEditorPlacedDecorList.xml#L129)
--- child of HouseEditorPlacedDecorListTemplate
--- @class HouseEditorPlacedDecorListTemplate_ScrollBar : EventFrame, MinimalScrollBar
--- @field hideIfUnscrollable boolean # true

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_HouseEditor/Blizzard_HouseEditorPlacedDecorList.xml#L81)
--- child of HouseEditorPlacedDecorListTemplate
--- @class HouseEditorPlacedDecorListTemplate_HeaderText : FontString, GameFontHighlight

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_HouseEditor/Blizzard_HouseEditorPlacedDecorList.xml#L54)
--- Template
