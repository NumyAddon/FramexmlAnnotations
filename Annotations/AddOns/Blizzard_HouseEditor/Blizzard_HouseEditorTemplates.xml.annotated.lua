...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_HouseEditor/Blizzard_HouseEditorTemplates.xml#L4)
--- Template
--- @class BaseHouseEditorModeTemplate : Frame, BaseHouseEditorModeMixin

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_HouseEditor/Blizzard_HouseEditorTemplates.xml#L11)
--- Template
--- @class HouseEditorInstructionsContainerTemplate : Frame, VerticalLayoutFrame, HouseEditorInstructionsContainerMixin

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_HouseEditor/Blizzard_HouseEditorTemplates.xml#L70)
--- child of HouseEditorInstructionTemplate_Control
--- @class HouseEditorInstructionTemplate_Control_Text : FontString, Number16Font

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_HouseEditor/Blizzard_HouseEditorTemplates.xml#L49)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_HouseEditor/Blizzard_HouseEditorTemplates.xml#L39)
--- child of HouseEditorInstructionTemplate
--- @class HouseEditorInstructionTemplate_InstructionText : FontString, GameFontHighlightLarge
--- @field expand boolean # true
--- @field layoutIndex number # 1

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_HouseEditor/Blizzard_HouseEditorTemplates.xml#L21)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_HouseEditor/Blizzard_HouseEditorTemplates.xml#L93)
--- child of HouseEditorBudgetCountTemplate
--- @class HouseEditorBudgetCountTemplate_Text : FontString, GameFontHighlightHuge

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_HouseEditor/Blizzard_HouseEditorTemplates.xml#L86)
--- Template
