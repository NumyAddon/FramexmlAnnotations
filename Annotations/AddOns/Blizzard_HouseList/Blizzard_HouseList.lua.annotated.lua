...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_HouseList/Blizzard_HouseList.lua#L106)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_HouseList/Blizzard_HouseList.lua#L75)
function HouseListFrameMixin:OnHide() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_HouseList/Blizzard_HouseList.lua#L79)
function HouseListFrameMixin:OnHouseListUpdated(houseInfoList) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_HouseList/Blizzard_HouseList.lua#L94)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_HouseList/Blizzard_HouseList.lua#L131)
function HouseEntryTemplateMixin:OnVisitHouseClicked() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_HouseList/Blizzard_HouseList.lua#L135)
function HouseEntryTemplateMixin:SetSelected(selected) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_HouseList/Blizzard_HouseList.lua#L143)
function HouseEntryTemplateMixin:Expand(elementData) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_HouseList/Blizzard_HouseList.lua#L156)
function HouseEntryTemplateMixin:Collapse(elementData) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_HouseList/Blizzard_HouseList.lua#L169)
function HouseEntryTemplateMixin:OnClick() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_HouseList/Blizzard_HouseList.lua#L173)
