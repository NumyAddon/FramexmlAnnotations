...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_HousingBlueprint/Blizzard_HousingBlueprintContentSummary.xml#L3)
--- Template
--- @class HousingBlueprintContentSummaryScriptsTemplate : Frame, HousingBlueprintContentSummaryMixin

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_HousingBlueprint/Blizzard_HousingBlueprintContentSummary.xml#L37)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_HousingBlueprint/Blizzard_HousingBlueprintContentSummary.xml#L44)
--- child of HousingBlueprintContentSummaryTemplate
--- @class HousingBlueprintContentSummaryTemplate_ContentsListButton : Button, UIPanelDynamicResizeButtonTemplate
--- @field layoutIndex number # 3
--- @field align string # center

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_HousingBlueprint/Blizzard_HousingBlueprintContentSummary.xml#L51)
--- child of HousingBlueprintContentSummaryTemplate
--- @class HousingBlueprintContentSummaryTemplate_LoadingSpinner : Frame, SpinnerTemplate
--- @field ignoreInLayout boolean # true

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_HousingBlueprint/Blizzard_HousingBlueprintContentSummary.xml#L27)
--- child of HousingBlueprintContentSummaryTemplate
--- @class HousingBlueprintContentSummaryTemplate_CountText : FontString, GameFontHighlightMedium
--- @field layoutIndex number # 2
--- @field expand boolean # true

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_HousingBlueprint/Blizzard_HousingBlueprintContentSummary.xml#L12)
--- Template
