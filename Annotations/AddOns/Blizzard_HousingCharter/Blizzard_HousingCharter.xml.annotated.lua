...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingCharter/Blizzard_HousingCharter.xml#L988)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingCharter/Blizzard_HousingCharter.xml#L997)
--- child of HousingCharterRequestSignatureDialog (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_TopLeftCorner
HousingCharterRequestSignatureDialogTopLeftCorner = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingCharter/Blizzard_HousingCharter.xml#L1002)
--- child of HousingCharterRequestSignatureDialog (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_TopRightCorner
HousingCharterRequestSignatureDialogTopRightCorner = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingCharter/Blizzard_HousingCharter.xml#L1007)
--- child of HousingCharterRequestSignatureDialog (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_BottomLeftCorner
HousingCharterRequestSignatureDialogBottomLeftCorner = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingCharter/Blizzard_HousingCharter.xml#L1012)
--- child of HousingCharterRequestSignatureDialog (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_BottomRightCorner
HousingCharterRequestSignatureDialogBottomRightCorner = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingCharter/Blizzard_HousingCharter.xml#L1017)
--- child of HousingCharterRequestSignatureDialog (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_TopBorder
HousingCharterRequestSignatureDialogTopBorder = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingCharter/Blizzard_HousingCharter.xml#L1023)
--- child of HousingCharterRequestSignatureDialog (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_BottomBorder
HousingCharterRequestSignatureDialogBottomBorder = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingCharter/Blizzard_HousingCharter.xml#L1029)
--- child of HousingCharterRequestSignatureDialog (created in template TranslucentFrameTemplate)
--- @type TranslucentFrameTemplate_LeftBorder
HousingCharterRequestSignatureDialogLeftBorder = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingCharter/Blizzard_HousingCharter.xml#L1035)
--- child of HousingCharterRequestSignatureDialog (created in template TranslucentFrameTemplate)
