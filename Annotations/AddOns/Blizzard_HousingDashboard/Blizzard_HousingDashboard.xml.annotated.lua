...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_HousingDashboard/Blizzard_HousingDashboard.xml#L11)
--- child of HousingDashboardFrame
--- @class HousingDashboardFrame_HouseDropdown : Frame, HousingDashboardHouseDropdownTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_HousingDashboard/Blizzard_HousingDashboard.xml#L18)
--- child of HousingDashboardFrame
--- @class HousingDashboardFrame_HouseInfoContent : Frame, HousingDashboardHouseInfoTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_HousingDashboard/Blizzard_HousingDashboard.xml#L20)
--- child of HousingDashboardFrame
--- @class HousingDashboardFrame_CatalogContent : Frame, HousingCatalogFrameTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_HousingDashboard/Blizzard_HousingDashboard.xml#L22)
--- child of HousingDashboardFrame
--- @class HousingDashboardFrame_CollectionContent : Frame, HousingDashboardCollectionFrameTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_HousingDashboard/Blizzard_HousingDashboard.xml#L25)
--- child of HousingDashboardFrame
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_HousingDashboard/Blizzard_HousingDashboard.xml#L35)
--- child of HousingDashboardFrame
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_HousingDashboard/Blizzard_HousingDashboard.xml#L45)
--- child of HousingDashboardFrame
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_HousingDashboard/Blizzard_HousingDashboard.xml#L633)
--- child of HousingDashboardFrame (created in template PortraitFrameTemplate)
--- @type PortraitFrameTemplate_CloseButton
HousingDashboardFrameCloseButton = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_HousingDashboard/Blizzard_HousingDashboard.xml#L600)
--- child of HousingDashboardFrame (created in template PortraitFrameTexturedBaseTemplate)
--- @type Texture
HousingDashboardFrameBg = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_HousingDashboard/Blizzard_HousingDashboard.xml#L3)
