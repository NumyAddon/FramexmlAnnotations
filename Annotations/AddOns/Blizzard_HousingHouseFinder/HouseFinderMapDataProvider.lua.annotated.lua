...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingHouseFinder/HouseFinderMapDataProvider.lua#L129)
--- @class HouseFinderFriendsPlotPinMixin : MapCanvasPinMixin
HouseFinderFriendsPlotPinMixin = CreateFromMixins(MapCanvasPinMixin)

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingHouseFinder/HouseFinderMapDataProvider.lua#L157)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingHouseFinder/HouseFinderMapDataProvider.lua#L74)
function HouseFinderPlotForSalePinMixin:OnMouseLeave() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingHouseFinder/HouseFinderMapDataProvider.lua#L84)
function HouseFinderPlotForSalePinMixin:OnMouseDownAction(button) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingHouseFinder/HouseFinderMapDataProvider.lua#L88)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingHouseFinder/HouseFinderMapDataProvider.lua#L100)
function HouseFinderPlotForSalePinMixin:StartGlow(glowLoopCount) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingHouseFinder/HouseFinderMapDataProvider.lua#L119)
function HouseFinderPlotForSalePinMixin:StopGlow() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingHouseFinder/HouseFinderMapDataProvider.lua#L131)
function HouseFinderFriendsPlotPinMixin:OnLoad() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingHouseFinder/HouseFinderMapDataProvider.lua#L136)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingHouseFinder/HouseFinderMapDataProvider.lua#L153)
function HouseFinderFriendsPlotPinMixin:OnMouseLeave() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingHouseFinder/HouseFinderMapDataProvider.lua#L159)
function SelectedPlotTooltipMixin:OnLoad() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingHouseFinder/HouseFinderMapDataProvider.lua#L165)
