...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingHouseFinder/HouseFinderMapDataProvider.xml#L47)
--- child of SelectedPlotTooltipTemplate
--- @class SelectedPlotTooltipTemplate_PriceMoneyFrame : Frame, SmallMoneyFrameTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingHouseFinder/HouseFinderMapDataProvider.xml#L24)
--- child of SelectedPlotTooltipTemplate
--- @class SelectedPlotTooltipTemplate_HeaderText : FontString, SystemFont_Shadow_Large

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingHouseFinder/HouseFinderMapDataProvider.xml#L30)
--- child of SelectedPlotTooltipTemplate
--- @class SelectedPlotTooltipTemplate_SubText : FontString, Game13FontShadow

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingHouseFinder/HouseFinderMapDataProvider.xml#L37)
--- child of SelectedPlotTooltipTemplate
--- @class SelectedPlotTooltipTemplate_FooterText : FontString, Game13FontShadow

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingHouseFinder/HouseFinderMapDataProvider.xml#L4)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingHouseFinder/HouseFinderMapDataProvider.xml#L55)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingHouseFinder/HouseFinderMapDataProvider.xml#L76)
--- child of HouseFinderPlotForSalePinTemplate
--- @class HouseFinderPlotForSalePinTemplate_GlowAnim : AnimationGroup

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingHouseFinder/HouseFinderMapDataProvider.xml#L57)
--- Template
