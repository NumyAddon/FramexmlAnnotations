...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingMarketCart/Blizzard_HousingMarketCartServices.lua#L10)
function HousingMarketShowCartServiceMixin:GetEventData() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingMarketCart/Blizzard_HousingMarketCartServices.lua#L17)
