...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_HousingModelPreview/Blizzard_HousingModelPreview.lua#L78)
function HousingModelPreviewMixin:ClearPreviewData() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_HousingModelPreview/Blizzard_HousingModelPreview.lua#L87)
function HousingModelPreviewMixin:HasValidData() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_HousingModelPreview/Blizzard_HousingModelPreview.lua#L91)
function HousingModelPreviewMixin:SetupTextTooltip(fontString, textSetFunc, shouldShowFunc, overrideAnchor) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_HousingModelPreview/Blizzard_HousingModelPreview.lua#L105)
function HousingModelPreviewMixin:SetTextOrHide(fontString, text) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_HousingModelPreview/Blizzard_HousingModelPreview.lua#L118)
function HousingModelPreviewFrameMixin:OnLoad() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_HousingModelPreview/Blizzard_HousingModelPreview.lua#L125)
function HousingModelPreviewFrameMixin:ShowCatalogEntryInfo(catalogEntryInfo) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_HousingModelPreview/Blizzard_HousingModelPreview.lua#L132)
function HousingModelPreviewFrameMixin:OnShow() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_HousingModelPreview/Blizzard_HousingModelPreview.lua#L136)
