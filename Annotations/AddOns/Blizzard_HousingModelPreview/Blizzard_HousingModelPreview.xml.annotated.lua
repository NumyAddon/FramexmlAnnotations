...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_HousingModelPreview/Blizzard_HousingModelPreview.xml#L89)
--- child of HousingModelPreviewTemplate
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_HousingModelPreview/Blizzard_HousingModelPreview.xml#L112)
--- child of HousingModelPreviewFrame
--- @class HousingModelPreviewFrame_ModelPreview : Frame, HousingModelPreviewTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_HousingModelPreview/Blizzard_HousingModelPreview.xml#L680)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_HousingModelPreview/Blizzard_HousingModelPreview.xml#L702)
--- child of HousingModelPreviewFrame (created in template ButtonFrameTemplate)
--- @type ButtonFrameTemplate_BtnCornerLeft
HousingModelPreviewFrameBtnCornerLeft = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_HousingModelPreview/Blizzard_HousingModelPreview.xml#L707)
--- child of HousingModelPreviewFrame (created in template ButtonFrameTemplate)
--- @type ButtonFrameTemplate_BtnCornerRight
HousingModelPreviewFrameBtnCornerRight = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_HousingModelPreview/Blizzard_HousingModelPreview.xml#L712)
--- child of HousingModelPreviewFrame (created in template ButtonFrameTemplate)
--- @type ButtonFrameTemplate_ButtonBottomBorder
HousingModelPreviewFrameButtonBottomBorder = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_HousingModelPreview/Blizzard_HousingModelPreview.xml#L538)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_HousingModelPreview/Blizzard_HousingModelPreview.xml#L466)
--- child of HousingModelPreviewFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type PortraitFrameTemplateNoCloseButton_PortraitFrame
HousingModelPreviewFramePortraitFrame = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_HousingModelPreview/Blizzard_HousingModelPreview.xml#L471)
--- child of HousingModelPreviewFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type PortraitFrameTemplateNoCloseButton_TopRightCorner
HousingModelPreviewFrameTopRightCorner = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_HousingModelPreview/Blizzard_HousingModelPreview.xml#L476)
--- child of HousingModelPreviewFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type PortraitFrameTemplateNoCloseButton_TopLeftCorner
HousingModelPreviewFrameTopLeftCorner = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_HousingModelPreview/Blizzard_HousingModelPreview.xml#L481)
--- child of HousingModelPreviewFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type PortraitFrameTemplateNoCloseButton_TopBorder
HousingModelPreviewFrameTopBorder = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_HousingModelPreview/Blizzard_HousingModelPreview.xml#L487)
--- child of HousingModelPreviewFrame (created in template PortraitFrameTemplateNoCloseButton)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_HousingModelPreview/Blizzard_HousingModelPreview.xml#L502)
--- child of HousingModelPreviewFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type PortraitFrameTemplateNoCloseButton_BotLeftCorner
HousingModelPreviewFrameBotLeftCorner = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_HousingModelPreview/Blizzard_HousingModelPreview.xml#L507)
--- child of HousingModelPreviewFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type PortraitFrameTemplateNoCloseButton_BotRightCorner
HousingModelPreviewFrameBotRightCorner = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_HousingModelPreview/Blizzard_HousingModelPreview.xml#L512)
--- child of HousingModelPreviewFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type PortraitFrameTemplateNoCloseButton_BottomBorder
HousingModelPreviewFrameBottomBorder = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_HousingModelPreview/Blizzard_HousingModelPreview.xml#L518)
--- child of HousingModelPreviewFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type PortraitFrameTemplateNoCloseButton_LeftBorder
HousingModelPreviewFrameLeftBorder = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_HousingModelPreview/Blizzard_HousingModelPreview.xml#L524)
--- child of HousingModelPreviewFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type PortraitFrameTemplateNoCloseButton_RightBorder
HousingModelPreviewFrameRightBorder = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_HousingModelPreview/Blizzard_HousingModelPreview.xml#L106)
