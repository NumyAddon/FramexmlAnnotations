...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingTemplates/Blizzard_HousingModelPreview.xml#L39)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingTemplates/Blizzard_HousingModelPreview.xml#L45)
--- child of HousingModelPreviewTemplate_NameContainer
--- @class HousingModelPreviewTemplate_NameContainer_Name : FontString, GameFontHighlightLarge

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingTemplates/Blizzard_HousingModelPreview.xml#L31)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingTemplates/Blizzard_HousingModelPreview.xml#L65)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingTemplates/Blizzard_HousingModelPreview.xml#L79)
--- child of HousingModelPreviewTemplate_TextContainer
--- @class HousingModelPreviewTemplate_TextContainer_NumOwned : FontString, GameFontHighlight
--- @field layoutIndex number # 3
--- @field expand boolean # true

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingTemplates/Blizzard_HousingModelPreview.xml#L55)
--- child of HousingModelPreviewTemplate
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingTemplates/Blizzard_HousingModelPreview.xml#L89)
--- child of HousingModelPreviewTemplate
--- @class HousingModelPreviewTemplate_ModelScene : ModelScene, PanningModelSceneMixinTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingTemplates/Blizzard_HousingModelPreview.xml#L95)
--- child of HousingModelPreviewTemplate
--- @class HousingModelPreviewTemplate_ModelSceneControls : Frame, ModelSceneControlFrameTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingTemplates/Blizzard_HousingModelPreview.xml#L9)
--- child of HousingModelPreviewTemplate
--- @class HousingModelPreviewTemplate_PreviewUnavailableText : FontString, GameFontHighlight

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_HousingTemplates/Blizzard_HousingModelPreview.xml#L3)
--- Template
