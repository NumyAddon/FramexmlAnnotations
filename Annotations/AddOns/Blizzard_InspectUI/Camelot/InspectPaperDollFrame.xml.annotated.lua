...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_InspectUI/Camelot/InspectPaperDollFrame.xml#L5)
--- child of InspectPaperDollItemSlotButtonTemplate
--- @class InspectPaperDollItemSlotButtonTemplate_BorderFrame : Frame

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_InspectUI/Camelot/InspectPaperDollFrame.xml#L3)
--- Template
--- @class InspectPaperDollItemSlotButtonTemplate : ItemButton
--- @field BorderFrame InspectPaperDollItemSlotButtonTemplate_BorderFrame

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_InspectUI/Camelot/InspectPaperDollFrame.xml#L45)
--- Template
--- Adds itself to the parent inside the array `LeftEquipmentSlots`
--- @class InspectPaperDollItemSlotButtonLeftTemplate : ItemButton, InspectPaperDollItemSlotButtonTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_InspectUI/Camelot/InspectPaperDollFrame.xml#L49)
--- Template
--- Adds itself to the parent inside the array `RightEquipmentSlots`
--- @class InspectPaperDollItemSlotButtonRightTemplate : ItemButton, InspectPaperDollItemSlotButtonTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_InspectUI/Camelot/InspectPaperDollFrame.xml#L53)
--- Template
...
--- @field RightEquipmentSlots table<number, InspectHandsSlot | InspectWaistSlot | InspectLegsSlot | InspectFeetSlot | InspectFinger0Slot | InspectFinger1Slot | InspectTrinket0Slot | InspectTrinket1Slot>
