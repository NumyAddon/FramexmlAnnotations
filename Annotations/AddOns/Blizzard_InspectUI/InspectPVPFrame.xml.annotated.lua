...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_InspectUI/InspectPVPFrame.xml#L39)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_InspectUI/InspectPVPFrame.xml#L129)
--- child of InspectPVPFrame
--- @class InspectPVPFrame_TalentSlot1 : Button, InspectPvpTalentSlotTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_InspectUI/InspectPVPFrame.xml#L134)
--- child of InspectPVPFrame
--- @class InspectPVPFrame_TalentSlot2 : Button, InspectPvpTalentSlotTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_InspectUI/InspectPVPFrame.xml#L139)
--- child of InspectPVPFrame
--- @class InspectPVPFrame_TalentSlot3 : Button, InspectPvpTalentSlotTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_InspectUI/InspectPVPFrame.xml#L58)
--- child of InspectPVPFrame
--- @class InspectPVPFrame_HKs : FontString, GameFontHighlight

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_InspectUI/InspectPVPFrame.xml#L63)
--- child of InspectPVPFrame
--- @class InspectPVPFrame_HonorLevel : FontString, GameFontNormalLarge

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_InspectUI/InspectPVPFrame.xml#L46)
