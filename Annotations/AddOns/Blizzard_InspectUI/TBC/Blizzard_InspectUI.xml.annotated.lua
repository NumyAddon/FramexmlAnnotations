...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_InspectUI/TBC/Blizzard_InspectUI.xml#L30)
--- child of InspectNameFrame
--- @class InspectNameText : FontString, GameFontHighlight
InspectNameText = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_InspectUI/TBC/Blizzard_InspectUI.xml#L21)
--- child of InspectFrame
--- @class InspectNameFrame : Frame
InspectNameFrame = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_InspectUI/TBC/Blizzard_InspectUI.xml#L9)
--- child of InspectFrameTab1 (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
InspectFrameTab1LeftDisabled = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_InspectUI/TBC/Blizzard_InspectUI.xml#L22)
--- child of InspectFrameTab1 (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
InspectFrameTab1MiddleDisabled = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_InspectUI/TBC/Blizzard_InspectUI.xml#L31)
--- child of InspectFrameTab1 (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
InspectFrameTab1RightDisabled = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_InspectUI/TBC/Blizzard_InspectUI.xml#L40)
--- child of InspectFrameTab1 (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
InspectFrameTab1Left = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_InspectUI/TBC/Blizzard_InspectUI.xml#L49)
--- child of InspectFrameTab1 (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
InspectFrameTab1Middle = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_InspectUI/TBC/Blizzard_InspectUI.xml#L58)
--- child of InspectFrameTab1 (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
InspectFrameTab1Right = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_InspectUI/TBC/Blizzard_InspectUI.xml#L114)
--- child of InspectFrameTab1 (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
InspectFrameTab1HighlightTexture = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_InspectUI/TBC/Blizzard_InspectUI.xml#L46)
--- child of InspectFrame
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_InspectUI/TBC/Blizzard_InspectUI.xml#L59)
--- child of InspectFrame
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_InspectUI/TBC/Blizzard_InspectUI.xml#L72)
--- child of InspectFrame
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_InspectUI/TBC/Blizzard_InspectUI.xml#L85)
--- child of InspectFrame
--- @class InspectFrameTab4 : Button, CharacterFrameTabButtonTemplate
InspectFrameTab4 = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_InspectUI/TBC/Blizzard_InspectUI.xml#L6)
--- child of InspectFrame
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_InspectUI/TBC/Blizzard_InspectUI.xml#L444)
--- child of InspectFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type Texture
InspectFrameBg = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_InspectUI/TBC/Blizzard_InspectUI.xml#L450)
--- child of InspectFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type PortraitFrameTemplateNoCloseButton_TitleBg
InspectFrameTitleBg = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_InspectUI/TBC/Blizzard_InspectUI.xml#L458)
--- child of InspectFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type Texture
InspectFramePortrait = {}
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_InspectUI/TBC/Blizzard_InspectUI.xml#L3)
