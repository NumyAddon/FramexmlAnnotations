...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_InspectUI/Vanilla/InspectPaperDollFrame.xml#L85)
--- child of InspectHeadSlot (created in template ItemButtonTemplate)
--- @type Texture
InspectHeadSlotIconTexture = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_InspectUI/Vanilla/InspectPaperDollFrame.xml#L88)
--- child of InspectHeadSlot (created in template ItemButtonTemplate)
--- @type ItemButtonTemplate_ItemButtonTemplateCount
InspectHeadSlotCount = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_InspectUI/Vanilla/InspectPaperDollFrame.xml#L97)
--- child of InspectHeadSlot (created in template ItemButtonTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_InspectUI/Vanilla/InspectPaperDollFrame.xml#L135)
--- child of InspectHeadSlot (created in template ItemButtonTemplate)
--- @type Texture
