...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_InspectUI/Vanilla/InspectPaperDollFrame.xml#L85)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_InspectUI/Vanilla/InspectPaperDollFrame.xml#L88)
--- child of InspectPaperDollItemSlotButtonTemplate (created in template ItemButtonTemplate)
--- @type ItemButtonTemplate_ItemButtonTemplateCount
InspectPaperDollItemSlotButtonTemplateCount = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_InspectUI/Vanilla/InspectPaperDollFrame.xml#L97)
--- child of InspectPaperDollItemSlotButtonTemplate (created in template ItemButtonTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_InspectUI/Vanilla/InspectPaperDollFrame.xml#L135)
--- child of InspectPaperDollItemSlotButtonTemplate (created in template ItemButtonTemplate)
--- @type Texture
