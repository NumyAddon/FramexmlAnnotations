...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_IslandsPartyPoseUI/Blizzard_IslandsPartyPoseUI.xml#L8)
--- child of IslandsPartyPoseFrame
--- @class IslandsPartyPoseFrame_OverlayElements : Frame
--- @field Topper Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_IslandsPartyPoseUI/Blizzard_IslandsPartyPoseUI.xml#L19)
--- child of IslandsPartyPoseFrame
--- @class IslandsPartyPoseFrame_ModelScene : ModelScene, PartyPoseModelFrameTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_IslandsPartyPoseUI/Blizzard_IslandsPartyPoseUI.xml#L24)
--- child of IslandsPartyPoseFrame
--- @class IslandsPartyPoseFrame_Score : Frame, UIWidgetContainerTemplate
--- @field showAndHideOnWidgetSetRegistration boolean # false

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_IslandsPartyPoseUI/Blizzard_IslandsPartyPoseUI.xml#L37)
--- child of IslandsPartyPoseFrame
--- @class IslandsPartyPoseFrame_LeaveButton : Button, UIPanelButtonNoTooltipResizeToFitTemplate
--- @field minimumWidth number # 164

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_IslandsPartyPoseUI/Blizzard_IslandsPartyPoseUI.xml#L3)
