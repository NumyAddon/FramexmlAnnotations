...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_Kiosk/Blizzard_Kiosk.lua#L13)
function KioskFrameMixin:HasWhitelistedMaps() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_Kiosk/Blizzard_Kiosk.lua#L17)
function KioskFrameMixin:GetWhitelistedMapIDs() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_Kiosk/Blizzard_Kiosk.lua#L21)
function KioskFrameMixin:OnEvent(event, ...) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_Kiosk/Blizzard_Kiosk.lua#L42)
function KioskSessionStartedDialogButtonMixin:OnClick() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_Kiosk/Blizzard_Kiosk.lua#L48)
function KioskSessionFinishedDialogMixin:OnLoad() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_Kiosk/Blizzard_Kiosk.lua#L53)
