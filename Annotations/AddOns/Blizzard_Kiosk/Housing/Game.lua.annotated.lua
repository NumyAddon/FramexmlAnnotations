...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Kiosk/Housing/Game.lua#L9)
function GameKioskModeSplashMixin:OnResetFailed() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Kiosk/Housing/Game.lua#L16)
function GameKioskModeSplashMixin:OnLoad() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Kiosk/Housing/Game.lua#L44)
function GameKioskModeSplashMixin:OnShow() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Kiosk/Housing/Game.lua#L49)
function GameKioskModeSplashMixin:SetButtonEnabled(enabled) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Kiosk/Housing/Game.lua#L57)
function GameKioskSessionStartedDialogMixin:OnLoad() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Kiosk/Housing/Game.lua#L79)
function GameKioskModeSplashEndMixin:OnLoad() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Kiosk/Housing/Game.lua#L94)
function GameKioskFrameMixin:OnLoad() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Kiosk/Housing/Game.lua#L100)
function GameKioskFrameMixin:OnEvent(event, ...) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Kiosk/Housing/Game.lua#L141)
function GameKioskFrameMixin:DisplayExpireState() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Kiosk/Housing/Game.lua#L145)
function GameKioskFrameMixin:DisplayLobbyState() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Kiosk/Housing/Game.lua#L153)
