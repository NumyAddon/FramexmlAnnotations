...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_MajorFactions/Blizzard_MajorFactionUnlockToast.xml#L18)
--- child of MajorFactionUnlockToast
--- @class MajorFactionUnlockToast_HeaderText : FontString, SystemFont_Shadow_Med1

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_MajorFactions/Blizzard_MajorFactionUnlockToast.xml#L30)
--- child of MajorFactionUnlockToast
