...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_MapCanvas/Blizzard_MapCanvas.xml#L7)
--- Template
--- @class MapCanvasDetailLayerTemplate : Frame, MapCanvasDetailLayerMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_MapCanvas/Blizzard_MapCanvas.xml#L14)
--- Template
--- @class MapCanvasDetailTileTemplate : Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_MapCanvas/Blizzard_MapCanvas.xml#L18)
--- Template
--- @class MapCanvasDebugTriggerAreaTemplate : Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_MapCanvas/Blizzard_MapCanvas.xml#L27)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_MapCanvas/Blizzard_MapCanvas.xml#L21)
--- Template
