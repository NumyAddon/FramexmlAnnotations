...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Menu/Classic/MenuTemplates.xml#L80)
--- child of WowStyle1FilterDropdownTemplate
--- @class WowStyle1FilterDropdownTemplate_ResetButton : Button, UIResetButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Menu/Classic/MenuTemplates.xml#L96)
--- child of WowStyle1FilterDropdownTemplate
--- @class WowStyle1FilterDropdownTemplate_Text : FontString, GameFontHighlight

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Menu/Classic/MenuTemplates.xml#L67)
--- Template
