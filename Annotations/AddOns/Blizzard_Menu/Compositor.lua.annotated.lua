...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Menu/Compositor.lua#L341)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Menu/Compositor.lua#L390)
function CompositorMixin:NewTicker(parent, timeSeconds, callback) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Menu/Compositor.lua#L402)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Menu/Compositor.lua#L423)
function CompositorMixin:AttachFontString(parent) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Menu/Compositor.lua#L427)
function CompositorMixin:AttachFrame(parent, frameType) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Menu/Compositor.lua#L438)
function CompositorMixin:AttachTemplate(parent, template) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Menu/Compositor.lua#L452)
function CompositorMixin:Clear() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Menu/Compositor.lua#L467)
