...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Menu/DropdownButton.lua#L391)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Menu/DropdownButton.lua#L366)
function DropdownButtonMixin:Decrement() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Menu/DropdownButton.lua#L371)
function DropdownButtonMixin:CollectSelectionData() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Menu/DropdownButton.lua#L375)
function DropdownButtonMixin:GetSelectionData() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Menu/DropdownButton.lua#L380)
function DropdownButtonMixin:HasStickyFocus() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Menu/DropdownButton.lua#L393)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Menu/DropdownButton.lua#L402)
function DropdownButtonProxyMixin:OnEnter(...) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Menu/DropdownButton.lua#L406)
function DropdownButtonProxyMixin:OnLeave(...) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Menu/DropdownButton.lua#L410)
function DropdownButtonProxyMixin:OnMouseDown(...) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Menu/DropdownButton.lua#L415)
