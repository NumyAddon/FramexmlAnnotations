...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_Menu/DropdownButton.xml#L3)
--- Intrinsic
--- @class DropdownButton : Button, DropdownButtonMixin
--- @field intrinsic string # DropdownButton
--- @field menuPoint string # TOPLEFT
