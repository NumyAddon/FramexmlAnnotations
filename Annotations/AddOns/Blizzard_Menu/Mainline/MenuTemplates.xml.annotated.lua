...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Menu/Mainline/MenuTemplates.xml#L20)
--- child of WowStyle1DropdownTemplate
--- @class WowStyle1DropdownTemplate_Text : FontString, GameFontHighlight

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_Menu/Mainline/MenuTemplates.xml#L3)
--- Template
