...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Menu/Mainline/MenuTemplates.xml#L20)
--- child of WowStyle1DropdownTemplate
--- @class WowStyle1DropdownTemplate_Text : FontString, GameFontHighlight

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Menu/Mainline/MenuTemplates.xml#L3)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Menu/Mainline/MenuTemplates.xml#L41)
--- Template
--- @class WowStyle1ArrowDropdownTemplate : DropdownButton, WowStyle1ArrowDropdownMixin
--- @field hasShadow boolean # true
--- @field Arrow Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Menu/Mainline/MenuTemplates.xml#L77)
--- child of WowStyle1FilterDropdownTemplate
--- @class WowStyle1FilterDropdownTemplate_ResetButton : Button, UIResetButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Menu/Mainline/MenuTemplates.xml#L93)
--- child of WowStyle1FilterDropdownTemplate
--- @class WowStyle1FilterDropdownTemplate_Text : FontString, GameFontNormal

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Menu/Mainline/MenuTemplates.xml#L66)
--- Template
