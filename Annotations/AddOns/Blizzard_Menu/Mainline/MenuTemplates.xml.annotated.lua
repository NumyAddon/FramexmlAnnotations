...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_Menu/Mainline/MenuTemplates.xml#L52)
--- child of WowStyle1FilterDropdownTemplate
--- @class WowStyle1FilterDropdownTemplate_ResetButton : Button, UIResetButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_Menu/Mainline/MenuTemplates.xml#L68)
--- child of WowStyle1FilterDropdownTemplate
