...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Minimap/Mainline/AddonCompartment.lua#L130)
function AddonCompartmentMixin:RegisterAddon(addonData) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Minimap/Mainline/AddonCompartment.lua#L135)
