...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MirrorTimer/MirrorTimer.lua#L91)
function MirrorTimerContainerMixin:HasAnyTimersShowing() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MirrorTimer/MirrorTimer.lua#L102)
function MirrorTimerMixin:OnUpdate(elapsed) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MirrorTimer/MirrorTimer.lua#L110)
function MirrorTimerMixin:OnShow() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MirrorTimer/MirrorTimer.lua#L114)
function MirrorTimerMixin:OnHide() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MirrorTimer/MirrorTimer.lua#L118)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MirrorTimer/MirrorTimer.lua#L138)
function MirrorTimerMixin:SetPaused(paused) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MirrorTimer/MirrorTimer.lua#L146)
function MirrorTimerMixin:UpdateStatusBarValue(value) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MirrorTimer/MirrorTimer.lua#L150)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MirrorTimer/MirrorTimer.lua#L159)
