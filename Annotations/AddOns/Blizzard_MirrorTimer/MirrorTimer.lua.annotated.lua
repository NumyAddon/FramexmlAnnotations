...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_MirrorTimer/MirrorTimer.lua#L10)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_MirrorTimer/MirrorTimer.lua#L12)
function MirrorTimerContainerMixin:OnLoad() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_MirrorTimer/MirrorTimer.lua#L21)
function MirrorTimerContainerMixin:OnEvent(event, ...) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_MirrorTimer/MirrorTimer.lua#L44)
function MirrorTimerContainerMixin:SetupTimer(timer, value, maxvalue, paused, label) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_MirrorTimer/MirrorTimer.lua#L54)
function MirrorTimerContainerMixin:ClearTimer(timer) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_MirrorTimer/MirrorTimer.lua#L62)
function MirrorTimerContainerMixin:GetActiveTimer(timer) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_MirrorTimer/MirrorTimer.lua#L66)
function MirrorTimerContainerMixin:GetAvailableTimer(timer) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_MirrorTimer/MirrorTimer.lua#L79)
