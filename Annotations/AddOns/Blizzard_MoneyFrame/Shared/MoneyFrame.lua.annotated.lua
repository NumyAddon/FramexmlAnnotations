...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MoneyFrame/Shared/MoneyFrame.lua#L290)
--- @class MoneyDenominationDisplayMixin
MoneyDenominationDisplayMixin = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MoneyFrame/Shared/MoneyFrame.lua#L395)
--- @class MoneyDisplayFrameMixin
MoneyDisplayFrameMixin = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MoneyFrame/Shared/MoneyFrame.lua#L292)
function MoneyDenominationDisplayMixin:OnLoad() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MoneyFrame/Shared/MoneyFrame.lua#L303)
function MoneyDenominationDisplayMixin:SetDisplayType(displayType) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MoneyFrame/Shared/MoneyFrame.lua#L308)
function MoneyDenominationDisplayMixin:UpdateDisplayType() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MoneyFrame/Shared/MoneyFrame.lua#L323)
function MoneyDenominationDisplayMixin:SetFontObject(fontObject) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MoneyFrame/Shared/MoneyFrame.lua#L328)
function MoneyDenominationDisplayMixin:GetFontObject() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MoneyFrame/Shared/MoneyFrame.lua#L332)
function MoneyDenominationDisplayMixin:SetFontAndIconDisabled(disabled) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MoneyFrame/Shared/MoneyFrame.lua#L337)
function MoneyDenominationDisplayMixin:SetFormatter(formatter) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MoneyFrame/Shared/MoneyFrame.lua#L341)
function MoneyDenominationDisplayMixin:SetForcedHidden(forcedHidden) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MoneyFrame/Shared/MoneyFrame.lua#L346)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MoneyFrame/Shared/MoneyFrame.lua#L355)
function MoneyDenominationDisplayMixin:ShowsZeroAmount() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MoneyFrame/Shared/MoneyFrame.lua#L359)
