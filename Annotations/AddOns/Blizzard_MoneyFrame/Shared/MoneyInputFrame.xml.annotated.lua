...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_MoneyFrame/Shared/MoneyInputFrame.xml#L17)
--- child of LargeMoneyInputBoxTemplate
--- @class LargeMoneyInputBoxTemplate_Text : FontString, PriceFont

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_MoneyFrame/Shared/MoneyInputFrame.xml#L3)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_MoneyFrame/Shared/MoneyInputFrame.xml#L42)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_MoneyFrame/Shared/MoneyInputFrame.xml#L52)
--- child of LargeMoneyInputFrameTemplate
--- @class LargeMoneyInputFrameTemplate_SilverBox : EditBox, LargeMoneyInputBoxTemplate
--- @field iconAtlas string # "coin-silver"

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_MoneyFrame/Shared/MoneyInputFrame.xml#L62)
--- child of LargeMoneyInputFrameTemplate
--- @class LargeMoneyInputFrameTemplate_GoldBox : EditBox, LargeMoneyInputBoxTemplate
--- @field iconAtlas string # "coin-gold"

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_MoneyFrame/Shared/MoneyInputFrame.xml#L33)
--- Template
