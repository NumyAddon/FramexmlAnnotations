...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_MovePad/Blizzard_MovePad.lua#L13)
function MovePadMixin:OnDragStart() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_MovePad/Blizzard_MovePad.lua#L20)
