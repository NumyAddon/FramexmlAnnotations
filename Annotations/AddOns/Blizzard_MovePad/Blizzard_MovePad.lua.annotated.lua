...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MovePad/Blizzard_MovePad.lua#L38)
function MovePadMixin:SetPressAndHoldMode(pressAndHoldMode) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MovePad/Blizzard_MovePad.lua#L47)
function MovePadMixin:SetupDropdownMenu() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MovePad/Blizzard_MovePad.lua#L85)
function MovePadMixin:OnDragStart() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MovePad/Blizzard_MovePad.lua#L92)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MovePad/Blizzard_MovePad.lua#L110)
function MovePadCheckboxMixin:ResetButton() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MovePad/Blizzard_MovePad.lua#L115)
function MovePadCheckboxMixin:OnMovePadCheckboxClick() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MovePad/Blizzard_MovePad.lua#L129)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MovePad/Blizzard_MovePad.lua#L143)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MovePad/Blizzard_MovePad.lua#L194)
function MovePadJumpMixin:OnLoad() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MovePad/Blizzard_MovePad.lua#L200)
function MovePadJumpMixin:OnMovePadJumpMouseDown() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_MovePad/Blizzard_MovePad.lua#L208)
