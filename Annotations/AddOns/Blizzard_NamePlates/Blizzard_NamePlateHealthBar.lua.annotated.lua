...
NamePlateHealthBarMixin = CreateFromMixins(TextStatusBarMixin, NamePlateComponentMixin);--- @class NamePlateHealthBarMixin : TextStatusBarMixin, NamePlateComponentMixin
