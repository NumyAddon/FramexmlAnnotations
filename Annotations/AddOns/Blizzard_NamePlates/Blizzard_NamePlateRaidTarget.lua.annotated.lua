...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_NamePlates/Blizzard_NamePlateRaidTarget.lua#L19)
function NamePlateRaidTargetMixin:ShouldBeShown() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_NamePlates/Blizzard_NamePlateRaidTarget.lua#L36)
