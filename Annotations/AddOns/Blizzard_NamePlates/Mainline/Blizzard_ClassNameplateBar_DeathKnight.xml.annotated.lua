...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_NamePlates/Mainline/Blizzard_ClassNameplateBar_DeathKnight.xml#L4)
...
DeathKnightResourceOverlayFrame["layoutParent"] = PlayerBottomManagedFrameContainer -- inherited
