...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_NamePlates/Mainline/Blizzard_ClassNameplateBar_Druid.xml#L4)
...
ClassNameplateBarFeralDruidFrame["layoutParent"] = PlayerBottomManagedFrameContainer -- inherited
