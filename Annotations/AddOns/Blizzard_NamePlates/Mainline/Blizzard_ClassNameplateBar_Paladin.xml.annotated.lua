...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_NamePlates/Mainline/Blizzard_ClassNameplateBar_Paladin.xml#L165)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_NamePlates/Mainline/Blizzard_ClassNameplateBar_Paladin.xml#L177)
--- child of ClassNameplateBarPaladinFrame (created in template PaladinPowerBarFrameTemplate)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_NamePlates/Mainline/Blizzard_ClassNameplateBar_Paladin.xml#L189)
--- child of ClassNameplateBarPaladinFrame (created in template PaladinPowerBarFrameTemplate)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_NamePlates/Mainline/Blizzard_ClassNameplateBar_Paladin.xml#L201)
--- child of ClassNameplateBarPaladinFrame (created in template PaladinPowerBarFrameTemplate)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_NamePlates/Mainline/Blizzard_ClassNameplateBar_Paladin.xml#L213)
--- child of ClassNameplateBarPaladinFrame (created in template PaladinPowerBarFrameTemplate)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_NamePlates/Mainline/Blizzard_ClassNameplateBar_Paladin.xml#L4)
