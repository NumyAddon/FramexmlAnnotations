...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_NamePlates/TBC/Blizzard_NamePlates.xml#L222)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_NamePlates/TBC/Blizzard_NamePlates.xml#L174)
--- child of NamePlateTooltip (created in template GameTooltipTemplate)
--- @type Texture
NamePlateTooltipTexture2 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_NamePlates/TBC/Blizzard_NamePlates.xml#L179)
--- child of NamePlateTooltip (created in template GameTooltipTemplate)
--- @type Texture
NamePlateTooltipTexture3 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_NamePlates/TBC/Blizzard_NamePlates.xml#L184)
--- child of NamePlateTooltip (created in template GameTooltipTemplate)
--- @type Texture
NamePlateTooltipTexture4 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_NamePlates/TBC/Blizzard_NamePlates.xml#L189)
--- child of NamePlateTooltip (created in template GameTooltipTemplate)
--- @type Texture
NamePlateTooltipTexture5 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_NamePlates/TBC/Blizzard_NamePlates.xml#L194)
--- child of NamePlateTooltip (created in template GameTooltipTemplate)
--- @type Texture
NamePlateTooltipTexture6 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_NamePlates/TBC/Blizzard_NamePlates.xml#L199)
--- child of NamePlateTooltip (created in template GameTooltipTemplate)
--- @type Texture
NamePlateTooltipTexture7 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_NamePlates/TBC/Blizzard_NamePlates.xml#L204)
--- child of NamePlateTooltip (created in template GameTooltipTemplate)
--- @type Texture
NamePlateTooltipTexture8 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_NamePlates/TBC/Blizzard_NamePlates.xml#L209)
--- child of NamePlateTooltip (created in template GameTooltipTemplate)
--- @type Texture
NamePlateTooltipTexture9 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_NamePlates/TBC/Blizzard_NamePlates.xml#L214)
--- child of NamePlateTooltip (created in template GameTooltipTemplate)
--- @type Texture
