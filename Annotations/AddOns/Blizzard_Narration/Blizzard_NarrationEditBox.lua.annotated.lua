...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Narration/Blizzard_NarrationEditBox.lua#L75)
function NarrationEditBoxMixin:NarrationGetName() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Narration/Blizzard_NarrationEditBox.lua#L79)
function NarrationEditBoxMixin:NarrationGetContext() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Narration/Blizzard_NarrationEditBox.lua#L87)
function NarrationEditBoxMixin:NarrationGetDescription() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Narration/Blizzard_NarrationEditBox.lua#L111)
function NarrationSearchBoxMixin:NarrationGetName() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Narration/Blizzard_NarrationEditBox.lua#L120)
function NarrationSearchBoxMixin:NarrationGetContext() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Narration/Blizzard_NarrationEditBox.lua#L128)
