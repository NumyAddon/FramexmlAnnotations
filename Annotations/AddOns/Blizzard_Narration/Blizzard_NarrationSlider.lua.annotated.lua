...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Narration/Blizzard_NarrationSlider.lua#L19)
function NarrationSliderMixin:SetNarrationValueFormatter(formatter) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Narration/Blizzard_NarrationSlider.lua#L23)
function NarrationSliderMixin:NarrationGetName() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Narration/Blizzard_NarrationSlider.lua#L38)
function NarrationSliderMixin:NarrationGetContext() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_Narration/Blizzard_NarrationSlider.lua#L46)
