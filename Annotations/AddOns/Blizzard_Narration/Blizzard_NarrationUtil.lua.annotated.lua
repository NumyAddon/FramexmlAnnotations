...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_Narration/Blizzard_NarrationUtil.lua#L248)
function NarrationStaticNameMixin:SetNarrationName(name) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_Narration/Blizzard_NarrationUtil.lua#L252)
function NarrationStaticNameMixin:NarrationGetName() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_Narration/Blizzard_NarrationUtil.lua#L265)
function NarrationStaticDescriptionMixin:SetNarrationDescription(description) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_Narration/Blizzard_NarrationUtil.lua#L269)
function NarrationStaticDescriptionMixin:NarrationGetDescription() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_Narration/Blizzard_NarrationUtil.lua#L282)
function NarrationSkipTooltipsMixin:NarrationNavigationShouldSkipTooltips() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_Narration/Blizzard_NarrationUtil.lua#L290)
function NarrationForwardNameToParentMixin:NarrationGetName() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_Narration/Blizzard_NarrationUtil.lua#L298)
