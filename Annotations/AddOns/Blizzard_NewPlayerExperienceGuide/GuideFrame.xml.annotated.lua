...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_NewPlayerExperienceGuide/GuideFrame.xml#L50)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_NewPlayerExperienceGuide/GuideFrame.xml#L40)
--- child of GuideFrame_ScrollFrame_Child
--- @class GuideFrame_ScrollFrame_Child_Text : FontString, QuestFont

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_NewPlayerExperienceGuide/GuideFrame.xml#L36)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_NewPlayerExperienceGuide/GuideFrame.xml#L64)
--- child of GuideFrame_ScrollFrame
--- @class GuideFrame_ScrollFrame_ConfirmationButton : Button, UIPanelButtonTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_NewPlayerExperienceGuide/GuideFrame.xml#L29)
--- child of GuideFrame
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_NewPlayerExperienceGuide/GuideFrame.xml#L16)
--- child of GuideFrame
--- @class GuideFrame_Title : FontString, Fancy30Font, AutoScalingFontStringMixin
--- @field minLineHeight number # 16

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_NewPlayerExperienceGuide/GuideFrame.xml#L660)
--- child of GuideFrame (created in template PortraitFrameTemplate)
--- @type PortraitFrameTemplate_CloseButton
GuideFrameCloseButton = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_NewPlayerExperienceGuide/GuideFrame.xml#L627)
--- child of GuideFrame (created in template PortraitFrameTexturedBaseTemplate)
--- @type Texture
GuideFrameBg = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_NewPlayerExperienceGuide/GuideFrame.xml#L5)
