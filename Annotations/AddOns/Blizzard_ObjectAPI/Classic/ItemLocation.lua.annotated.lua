...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ObjectAPI/Classic/ItemLocation.lua#L64)
function ItemLocationMixin:IsEqualToBagAndSlot(otherBagID, otherSlotIndex) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ObjectAPI/Classic/ItemLocation.lua#L72)
function ItemLocationMixin:IsEqualToEquipmentSlot(otherEquipmentSlotIndex) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_ObjectAPI/Classic/ItemLocation.lua#L80)
