...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ObjectiveTracker/Blizzard_ObjectiveTrackerUIWidgetContainer.xml#L6)
--- child of UIWidgetObjectiveTracker
--- @class UIWidgetObjectiveTracker_Block : Frame, ResizeLayoutFrame
--- @field fixedWidth number # 212

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_ObjectiveTracker/Blizzard_ObjectiveTrackerUIWidgetContainer.xml#L4)
