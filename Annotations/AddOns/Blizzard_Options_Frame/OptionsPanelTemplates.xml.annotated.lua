...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame/OptionsPanelTemplates.xml#L6)
--- Template
--- @class OptionsButtonTemplate : Button, UIPanelButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame/OptionsPanelTemplates.xml#L11)
--- Template
--- @class OptionsBaseCheckButtonTemplate : CheckButton

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame/OptionsPanelTemplates.xml#L50)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame/OptionsPanelTemplates.xml#L47)
--- Template
--- @class OptionsCheckButtonTemplate : CheckButton, OptionsBaseCheckButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame/OptionsPanelTemplates.xml#L65)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame/OptionsPanelTemplates.xml#L62)
--- Template
--- @class OptionsSmallCheckButtonTemplate : CheckButton, OptionsBaseCheckButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame/OptionsPanelTemplates.xml#L84)
--- child of OptionsSliderTemplate
--- @class OptionsSliderTemplate_OptionsSliderTemplateText : FontString, GameFontHighlight

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame/OptionsPanelTemplates.xml#L89)
--- child of OptionsSliderTemplate
--- @class OptionsSliderTemplate_OptionsSliderTemplateLow : FontString, GameFontHighlightSmall

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame/OptionsPanelTemplates.xml#L98)
--- child of OptionsSliderTemplate
