...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame/VideoOptionsFrame.xml#L9)
--- child of VideoOptionsFrame
--- @class VideoOptionsFrame_VideoOptionsFrameApply : Button, UIPanelButtonTemplate
VideoOptionsFrameApply = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame/VideoOptionsFrame.xml#L31)
--- child of VideoOptionsFrame
--- @class VideoOptionsFrame_VideoOptionsFrameCancel : Button, UIPanelButtonTemplate
VideoOptionsFrameCancel = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame/VideoOptionsFrame.xml#L46)
--- child of VideoOptionsFrame
--- @class VideoOptionsFrame_VideoOptionsFrameOkay : Button, UIPanelButtonTemplate
VideoOptionsFrameOkay = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame/VideoOptionsFrame.xml#L57)
--- child of VideoOptionsFrame
--- @class VideoOptionsFrame_VideoOptionsFrameDefaults : Button, UIPanelButtonTemplate
VideoOptionsFrameDefaults = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame/VideoOptionsFrame.xml#L75)
--- child of VideoOptionsFrame
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame/VideoOptionsFrame.xml#L116)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame/VideoOptionsFrame.xml#L266)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame/VideoOptionsFrame.xml#L284)
--- child of VideoOptionsFrame (created in template OptionsFrameTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame/VideoOptionsFrame.xml#L242)
--- child of VideoOptionsFrame (created in template OptionsFrameTemplate)
--- @type Texture
VideoOptionsFrameHeader = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame/VideoOptionsFrame.xml#L254)
--- child of VideoOptionsFrame (created in template OptionsFrameTemplate)
--- @type OptionsFrameTemplate_OptionsFrameTemplateHeaderText
VideoOptionsFrameHeaderText = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame/VideoOptionsFrame.xml#L7)
