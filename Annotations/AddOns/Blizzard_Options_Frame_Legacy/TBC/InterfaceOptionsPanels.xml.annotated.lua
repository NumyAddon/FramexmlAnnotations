...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame_Legacy/TBC/InterfaceOptionsPanels.xml#L20)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame_Legacy/TBC/InterfaceOptionsPanels.xml#L284)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame_Legacy/TBC/InterfaceOptionsPanels.xml#L226)
--- child of InterfaceOptionsControlsPanelAutoLootKeyDropDown (created in template UIDropDownMenuTemplate)
--- @type Texture
InterfaceOptionsControlsPanelAutoLootKeyDropDownLeft = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame_Legacy/TBC/InterfaceOptionsPanels.xml#L239)
--- child of InterfaceOptionsControlsPanelAutoLootKeyDropDown (created in template UIDropDownMenuTemplate)
--- @type Texture
InterfaceOptionsControlsPanelAutoLootKeyDropDownMiddle = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame_Legacy/TBC/InterfaceOptionsPanels.xml#L248)
--- child of InterfaceOptionsControlsPanelAutoLootKeyDropDown (created in template UIDropDownMenuTemplate)
--- @type Texture
InterfaceOptionsControlsPanelAutoLootKeyDropDownRight = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame_Legacy/TBC/InterfaceOptionsPanels.xml#L257)
--- child of InterfaceOptionsControlsPanelAutoLootKeyDropDown (created in template UIDropDownMenuTemplate)
--- @type UIDropDownMenuTemplate_UIDropDownMenuTemplateText
InterfaceOptionsControlsPanelAutoLootKeyDropDownText = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame_Legacy/TBC/InterfaceOptionsPanels.xml#L271)
--- child of InterfaceOptionsControlsPanelAutoLootKeyDropDown (created in template UIDropDownMenuTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame_Legacy/TBC/InterfaceOptionsPanels.xml#L35)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame_Legacy/TBC/InterfaceOptionsPanels.xml#L1119)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame_Legacy/TBC/InterfaceOptionsPanels.xml#L89)
--- child of InterfaceOptionsNamesPanelUnitNameplatesNameplateMaxDistanceSlider (created in template OptionsSliderTemplate)
--- @type OptionsSliderTemplate_OptionsSliderTemplateLow
InterfaceOptionsNamesPanelUnitNameplatesNameplateMaxDistanceSliderLow = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Options_Frame_Legacy/TBC/InterfaceOptionsPanels.xml#L98)
--- child of InterfaceOptionsNamesPanelUnitNameplatesNameplateMaxDistanceSlider (created in template OptionsSliderTemplate)
