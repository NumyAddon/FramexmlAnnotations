...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_OverrideActionBar/OverrideActionBar.xml#L436)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_OverrideActionBar/OverrideActionBar.xml#L349)
--- child of OverrideActionBarButton1 (created in template ActionButtonTemplate)
--- @type Texture
OverrideActionBarButton1Icon = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_OverrideActionBar/OverrideActionBar.xml#L362)
--- child of OverrideActionBarButton1 (created in template ActionButtonTemplate)
--- @type Texture
OverrideActionBarButton1Flash = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_OverrideActionBar/OverrideActionBar.xml#L369)
--- child of OverrideActionBarButton1 (created in template ActionButtonTemplate)
--- @type ActionButtonTemplate_Name
OverrideActionBarButton1Name = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_OverrideActionBar/OverrideActionBar.xml#L375)
--- child of OverrideActionBarButton1 (created in template ActionButtonTemplate)
--- @type Texture
OverrideActionBarButton1Border = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_OverrideActionBar/OverrideActionBar.xml#L455)
--- child of OverrideActionBarButton1 (created in template ActionButtonTemplate)
--- @type Texture
