...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_OverrideActionBar/OverrideActionBar.xml#L111)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_OverrideActionBar/OverrideActionBar.xml#L23)
--- child of OverrideActionBarButton1 (created in template ActionButtonTemplate)
--- @type Texture
OverrideActionBarButton1Icon = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_OverrideActionBar/OverrideActionBar.xml#L36)
--- child of OverrideActionBarButton1 (created in template ActionButtonTemplate)
--- @type Texture
OverrideActionBarButton1Flash = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_OverrideActionBar/OverrideActionBar.xml#L43)
--- child of OverrideActionBarButton1 (created in template ActionButtonTemplate)
--- @type ActionButtonTemplate_Name
OverrideActionBarButton1Name = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_OverrideActionBar/OverrideActionBar.xml#L49)
--- child of OverrideActionBarButton1 (created in template ActionButtonTemplate)
--- @type Texture
OverrideActionBarButton1Border = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_OverrideActionBar/OverrideActionBar.xml#L146)
--- child of OverrideActionBarButton1 (created in template ActionButtonTemplate)
--- @type Texture
