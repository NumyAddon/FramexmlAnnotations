...
PagedCondensedVerticalGridContentFrameMixin = CreateFromMixins(PagedContentFrameBaseMixin);--- @class PagedCondensedVerticalGridContentFrameMixin : PagedContentFrameBaseMixin
