...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagedCondensedGridContentFrame.xml#L6)
--- Template
