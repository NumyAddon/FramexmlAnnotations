...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagedCondensedGridContentFrame.xml#L6)
--- Template
