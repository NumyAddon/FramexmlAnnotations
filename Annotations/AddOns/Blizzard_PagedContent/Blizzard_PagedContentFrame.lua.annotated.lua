...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagedContentFrame.lua#L153)
function PagedContentFrameBaseMixin:UpdateElementViewDistribution() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagedContentFrame.lua#L161)
function PagedContentFrameBaseMixin:GetViewDataIndexForPage(pageNumber, viewFrameIndex) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagedContentFrame.lua#L167)
function PagedContentFrameBaseMixin:GetPageForViewDataIndex(viewIndex) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagedContentFrame.lua#L171)
function PagedContentFrameBaseMixin:GetFrames() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagedContentFrame.lua#L175)
function PagedContentFrameBaseMixin:EnumerateFrames() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagedContentFrame.lua#L179)
function PagedContentFrameBaseMixin:ForEachFrame(func) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagedContentFrame.lua#L188)
function PagedContentFrameBaseMixin:GoToElementByPredicate(predicateFunc) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagedContentFrame.lua#L210)
function PagedContentFrameBaseMixin:GetElementFrameByPredicate(predicateFunc) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagedContentFrame.lua#L222)
function PagedContentFrameBaseMixin:GetElementFrameByPredicateAndTemplate(predicateFunc, template, templateKey) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagedContentFrame.lua#L231)
function PagedContentFrameBaseMixin:OnMouseWheel(delta) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagedContentFrame.lua#L235)
function PagedContentFrameBaseMixin:OnDataProviderSizeChanged(pendingSort) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagedContentFrame.lua#L242)
function PagedContentFrameBaseMixin:OnDataProviderSort() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagedContentFrame.lua#L246)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagedContentFrame.lua#L255)
function PagedContentFrameBaseMixin:InternalGetTemplateInfo(templateKey) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagedContentFrame.lua#L291)
