...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagingControls.lua#L24)
function PagingControlsMixin:GetMaxPages() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagingControls.lua#L28)
function PagingControlsMixin:SetMaxPages(maxPages) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagingControls.lua#L41)
