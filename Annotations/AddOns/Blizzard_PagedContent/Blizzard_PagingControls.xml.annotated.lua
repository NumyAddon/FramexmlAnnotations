...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagingControls.xml#L27)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagingControls.xml#L74)
--- child of PagingControlsHorizontalTemplate
--- @class PagingControlsHorizontalTemplate_NextPageButton : Button, PagingControlsNextPageButtonTemplate
--- @field layoutIndex number # 3

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagingControls.xml#L61)
--- child of PagingControlsHorizontalTemplate
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagingControls.xml#L97)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagingControls.xml#L102)
--- child of PagingControlsCenteredTemplate
--- @class PagingControlsCenteredTemplate_NextPageButton : Button, PagingControlsNextPageButtonTemplate
--- @field layoutIndex number # 3

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagingControls.xml#L89)
--- child of PagingControlsCenteredTemplate
--- @class PagingControlsCenteredTemplate_PageText : FontString, PageTextTemplate
--- @field layoutIndex number # 2

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagingControls.xml#L82)
--- Template
