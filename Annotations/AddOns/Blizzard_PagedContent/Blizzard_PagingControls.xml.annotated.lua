...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagingControls.xml#L4)
--- Template
--- @class PagingControlsPrevPageButtonTemplate : Button

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagingControls.xml#L12)
--- Template
--- @class PagingControlsNextPageButtonTemplate : Button

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagingControls.xml#L20)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagingControls.xml#L64)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagingControls.xml#L69)
--- child of PagingControlsHorizontalTemplate
--- @class PagingControlsHorizontalTemplate_NextPageButton : Button, PagingControlsNextPageButtonTemplate
--- @field layoutIndex number # 3

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagingControls.xml#L54)
--- child of PagingControlsHorizontalTemplate
--- @class PagingControlsHorizontalTemplate_PageText : FontString, GameFontHighlight
--- @field layoutIndex number # 1
--- @field align string # center

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_PagedContent/Blizzard_PagingControls.xml#L47)
--- Template
