...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_PersonalResourceDisplay/AlternatePowerBars/ManaAlternatePower.lua#L31)
function ManaAlternatePowerMixin:UpdatePower() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_PersonalResourceDisplay/AlternatePowerBars/ManaAlternatePower.lua#L38)
function ManaAlternatePowerMixin:UpdateMinMaxPower() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_PersonalResourceDisplay/AlternatePowerBars/ManaAlternatePower.lua#L43)
