...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_PersonalResourceDisplay/AlternatePowerBars/ManaAlternatePower.lua#L18)
function ManaAlternatePowerMixin:EvaluateUnit() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_PersonalResourceDisplay/AlternatePowerBars/ManaAlternatePower.lua#L31)
function ManaAlternatePowerMixin:UpdatePower() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_PersonalResourceDisplay/AlternatePowerBars/ManaAlternatePower.lua#L38)
function ManaAlternatePowerMixin:UpdateMinMaxPower() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_PersonalResourceDisplay/AlternatePowerBars/ManaAlternatePower.lua#L43)
function ManaAlternatePowerMixin:GetCurrentPower() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_PersonalResourceDisplay/AlternatePowerBars/ManaAlternatePower.lua#L47)
