...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_PhotoSharing/Blizzard_PhotoSharing.lua#L28)
function PhotoSharingMixin:UpdatePublishButton(showNotification) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_PhotoSharing/Blizzard_PhotoSharing.lua#L45)
function PhotoSharingMixin:OnLoad() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_PhotoSharing/Blizzard_PhotoSharing.lua#L55)
function PhotoSharingMixin:OnShow() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_PhotoSharing/Blizzard_PhotoSharing.lua#L59)
function PhotoSharingMixin:OnHide(noSound) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_PhotoSharing/Blizzard_PhotoSharing.lua#L69)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_PhotoSharing/Blizzard_PhotoSharing.lua#L119)
