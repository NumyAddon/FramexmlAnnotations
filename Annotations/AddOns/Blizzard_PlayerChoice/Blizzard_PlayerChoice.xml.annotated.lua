...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_PlayerChoice/Blizzard_PlayerChoice.xml#L62)
--- child of PlayerChoiceFrame
--- @class PlayerChoiceFrame_NineSlice : Frame, NineSlicePanelTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_PlayerChoice/Blizzard_PlayerChoice.xml#L69)
--- child of PlayerChoiceFrame
--- @class PlayerChoiceFrame_BlackBackground : Frame

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_PlayerChoice/Blizzard_PlayerChoice.xml#L78)
--- child of PlayerChoiceFrame
--- @class PlayerChoiceFrame_Header : Frame, ResizeLayoutFrame
--- @field Texture Texture

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_PlayerChoice/Blizzard_PlayerChoice.xml#L92)
--- child of PlayerChoiceFrame
--- @class PlayerChoiceFrame_Background : Frame
--- @field BackgroundTile Texture

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_PlayerChoice/Blizzard_PlayerChoice.xml#L131)
--- child of PlayerChoiceFrame_Title
--- @class PlayerChoiceFrame_Title_Text : FontString, SystemFont_Shadow_Large

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_PlayerChoice/Blizzard_PlayerChoice.xml#L103)
--- child of PlayerChoiceFrame
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_PlayerChoice/Blizzard_PlayerChoice.xml#L139)
--- child of PlayerChoiceFrame
--- @class PlayerChoiceFrame_CloseButton : Button, UIPanelCloseButton

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_PlayerChoice/Blizzard_PlayerChoice.xml#L144)
--- child of PlayerChoiceFrame
--- @class PlayerChoiceFrame_BorderLayerModelScene : ModelScene, ScriptAnimatedModelSceneTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_PlayerChoice/Blizzard_PlayerChoice.xml#L147)
--- child of PlayerChoiceFrame
--- @class PlayerChoiceFrame_PagingControls : Frame, PagingControlsHorizontalTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_PlayerChoice/Blizzard_PlayerChoice.xml#L152)
--- child of PlayerChoiceFrame
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_PlayerChoice/Blizzard_PlayerChoice.xml#L160)
--- child of PlayerChoiceFrame
