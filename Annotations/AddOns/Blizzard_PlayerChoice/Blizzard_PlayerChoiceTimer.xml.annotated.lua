...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_PlayerChoice/Blizzard_PlayerChoiceTimer.xml#L18)
--- child of PlayerChoiceTimeRemaining
--- @class PlayerChoiceTimeRemaining_TimerText : FontString, GameFontNormalLarge

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_PlayerChoice/Blizzard_PlayerChoiceTimer.xml#L4)
