...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_PlayerChoice/Blizzard_PlayerChoiceTorghastOptionTemplate.xml#L89)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_PlayerChoice/Blizzard_PlayerChoiceTorghastOptionTemplate.xml#L82)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_PlayerChoice/Blizzard_PlayerChoiceTorghastOptionTemplate.xml#L19)
--- child of PlayerChoiceTorghastOptionTemplate
--- @class PlayerChoiceTorghastOptionTemplate_SwirlBG : Texture, PlayerChoiceBaseCenteredFrame

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_PlayerChoice/Blizzard_PlayerChoiceTorghastOptionTemplate.xml#L24)
--- child of PlayerChoiceTorghastOptionTemplate
--- @class PlayerChoiceTorghastOptionTemplate_TypeIcon : Texture, PlayerChoiceBaseCenteredFrame
--- @field layoutIndex number # 1
--- @field topPadding number # 3

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_PlayerChoice/Blizzard_PlayerChoiceTorghastOptionTemplate.xml#L100)
--- child of PlayerChoiceTorghastOptionTemplate
--- @class PlayerChoiceTorghastOptionTemplate_SwirlAndGlowAnimations : AnimationGroup

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_PlayerChoice/Blizzard_PlayerChoiceTorghastOptionTemplate.xml#L108)
--- child of PlayerChoiceTorghastOptionTemplate
--- @class PlayerChoiceTorghastOptionTemplate_ChoiceSelectedAnimation : AnimationGroup

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_PlayerChoice/Blizzard_PlayerChoiceTorghastOptionTemplate.xml#L4)
--- Template
...
--- @field TypeIcon PlayerChoiceTorghastOptionTemplate_TypeIcon
