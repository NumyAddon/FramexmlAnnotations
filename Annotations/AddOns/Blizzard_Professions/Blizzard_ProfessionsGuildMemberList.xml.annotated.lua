...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_Professions/Blizzard_ProfessionsGuildMemberList.xml#L5)
--- Template
--- @class ProfessionsGuildCrafterButtonTemplate : Button, ProfessionsGuildCrafterButtonMixin

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_Professions/Blizzard_ProfessionsGuildMemberList.xml#L42)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_Professions/Blizzard_ProfessionsGuildMemberList.xml#L48)
--- child of ProfessionsGuildListingTemplate_Container
--- @class ProfessionsGuildListingTemplate_Container_ScrollBar : EventFrame, MinimalScrollBar

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_Professions/Blizzard_ProfessionsGuildMemberList.xml#L54)
--- child of ProfessionsGuildListingTemplate_Container
--- @class ProfessionsGuildListingTemplate_Container_Spinner : Frame, SpinnerTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_Professions/Blizzard_ProfessionsGuildMemberList.xml#L31)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_Professions/Blizzard_ProfessionsGuildMemberList.xml#L23)
--- child of ProfessionsGuildListingTemplate
--- @class ProfessionsGuildListingTemplate_Title : FontString, GameFontNormal

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_Professions/Blizzard_ProfessionsGuildMemberList.xml#L19)
--- Template
