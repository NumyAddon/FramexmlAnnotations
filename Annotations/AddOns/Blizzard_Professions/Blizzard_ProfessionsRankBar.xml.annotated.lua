...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_Professions/Blizzard_ProfessionsRankBar.xml#L97)
--- child of ProfessionsRankBarTemplate
--- @class ProfessionsRankBarTemplate_FlareFadeOut : AnimationGroup

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_Professions/Blizzard_ProfessionsRankBar.xml#L5)
--- Template
