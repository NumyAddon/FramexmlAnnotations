...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_ProfessionsTemplates/Blizzard_ProfessionsRecipeRecraftSlot.xml#L41)
--- child of 
--- @class ProfessionsRecraftSlotTemplate_InputSlot_Glow_PulseEmptySlotGlow : AnimationGroup

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_ProfessionsTemplates/Blizzard_ProfessionsRecipeRecraftSlot.xml#L28)
--- child of 
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_ProfessionsTemplates/Blizzard_ProfessionsRecipeRecraftSlot.xml#L20)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_ProfessionsTemplates/Blizzard_ProfessionsRecipeRecraftSlot.xml#L67)
--- child of 
--- @class ProfessionsRecraftSlotTemplate_AnimatedArrow_Anim : AnimationGroup

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_ProfessionsTemplates/Blizzard_ProfessionsRecipeRecraftSlot.xml#L52)
--- child of ProfessionsRecraftSlotTemplate
--- @class ProfessionsRecraftSlotTemplate_AnimatedArrow : Frame
--- @field arrow Texture
--- @field Anim ProfessionsRecraftSlotTemplate_AnimatedArrow_Anim

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_ProfessionsTemplates/Blizzard_ProfessionsRecipeRecraftSlot.xml#L74)
--- child of ProfessionsRecraftSlotTemplate
--- @class ProfessionsRecraftSlotTemplate_DimArrow : Frame
--- @field arrow Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_ProfessionsTemplates/Blizzard_ProfessionsRecipeRecraftSlot.xml#L89)
--- child of ProfessionsRecraftSlotTemplate
--- @class ProfessionsRecraftSlotTemplate_OutputSlot : ItemButton, ProfessionsRecraftOutputSlotMixin
--- @field alwaysShowProfessionsQuality boolean # true
--- @field ItemFrame Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_ProfessionsTemplates/Blizzard_ProfessionsRecipeRecraftSlot.xml#L5)
--- Template
