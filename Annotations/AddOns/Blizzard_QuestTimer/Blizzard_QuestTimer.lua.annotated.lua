...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_QuestTimer/Blizzard_QuestTimer.lua#L1)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_QuestTimer/Blizzard_QuestTimer.lua#L3)
function QuestTimerMixin:OnLoad() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_QuestTimer/Blizzard_QuestTimer.lua#L10)
function QuestTimerMixin:OnEvent(event, ...) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_QuestTimer/Blizzard_QuestTimer.lua#L18)
function QuestTimerMixin:Update(elapsed) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_QuestTimer/Blizzard_QuestTimer.lua#L24)
