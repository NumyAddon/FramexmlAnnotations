...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_QuestTimer/Mainline/Blizzard_QuestTimerOverrides.lua#L9)
function QuestTimerButtonMixin:OnEnter() end
