...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_QueueStatusFrame/Classic/QueueStatusFrame.xml#L98)
--- child of QueueStatusEntryTemplate
--- @class QueueStatusEntryTemplate_AssignedSpec : Frame
--- @field Icon Texture
--- @field Border Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_QueueStatusFrame/Classic/QueueStatusFrame.xml#L20)
--- child of QueueStatusEntryTemplate
--- @class QueueStatusEntryTemplate_Title : FontString, GameFontHighlightLarge

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_QueueStatusFrame/Classic/QueueStatusFrame.xml#L26)
--- child of QueueStatusEntryTemplate
--- @class QueueStatusEntryTemplate_Status : FontString, GameFontNormal

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_QueueStatusFrame/Classic/QueueStatusFrame.xml#L32)
--- child of QueueStatusEntryTemplate
--- @class QueueStatusEntryTemplate_SubTitle : FontString, GameFontNormal

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_QueueStatusFrame/Classic/QueueStatusFrame.xml#L56)
--- child of QueueStatusEntryTemplate
--- @class QueueStatusEntryTemplate_TimeInQueue : FontString, GameFontNormal

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_QueueStatusFrame/Classic/QueueStatusFrame.xml#L61)
--- child of QueueStatusEntryTemplate
--- @class QueueStatusEntryTemplate_AverageWait : FontString, GameFontNormal

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_QueueStatusFrame/Classic/QueueStatusFrame.xml#L66)
--- child of QueueStatusEntryTemplate
