...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_QuickJoin/QuickJoin.xml#L5)
--- Template
--- @class QuickJoinButtonMemberTemplate : FontString, UserScaledFontGameNormalLarge

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_QuickJoin/QuickJoin.xml#L8)
--- Template
--- @class QuickJoinButtonQueueTemplate : FontString, UserScaledFontGameNormalLarge

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_QuickJoin/QuickJoin.xml#L24)
--- child of QuickJoinButtonTemplate
--- @class QuickJoinButtonTemplate_MemberName : FontString, QuickJoinButtonMemberTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_QuickJoin/QuickJoin.xml#L35)
--- child of QuickJoinButtonTemplate
--- @class QuickJoinButtonTemplate_QueueName : FontString, QuickJoinButtonQueueTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_QuickJoin/QuickJoin.xml#L11)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_QuickJoin/QuickJoin.xml#L70)
--- child of QuickJoinFrame
--- @class QuickJoinFrame_ScrollBox : Frame, WowScrollBoxList

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_QuickJoin/QuickJoin.xml#L76)
--- child of QuickJoinFrame
--- @class QuickJoinFrame_ScrollBar : EventFrame, MinimalScrollBar

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_QuickJoin/QuickJoin.xml#L82)
--- child of QuickJoinFrame
--- @class QuickJoinFrame_JoinQueueButton : Button, MagicButtonTemplate, JoinQueueButtonMixin

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_QuickJoin/QuickJoin.xml#L68)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_QuickJoin/QuickJoin.xml#L101)
