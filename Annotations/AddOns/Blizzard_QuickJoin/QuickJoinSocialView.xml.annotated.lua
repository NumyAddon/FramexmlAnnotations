...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_QuickJoin/QuickJoinSocialView.xml#L9)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_QuickJoin/QuickJoinSocialView.xml#L21)
--- child of QuickJoinSocialViewButtonTemplate
--- @class QuickJoinSocialViewButtonTemplate_QueueName : FontString, UserScaledFontGameNormalLarge

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_QuickJoin/QuickJoinSocialView.xml#L3)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_QuickJoin/QuickJoinSocialView.xml#L41)
--- Template
