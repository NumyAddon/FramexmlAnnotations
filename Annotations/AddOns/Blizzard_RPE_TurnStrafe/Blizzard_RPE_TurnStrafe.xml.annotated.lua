...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_RPE_TurnStrafe/Blizzard_RPE_TurnStrafe.xml#L18)
--- child of RPETurnStrafeStyleTypeTemplate
--- @class RPETurnStrafeStyleTypeTemplate_SubTitle : FontString, GameFontNormal

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_RPE_TurnStrafe/Blizzard_RPE_TurnStrafe.xml#L24)
--- child of RPETurnStrafeStyleTypeTemplate
--- @class RPETurnStrafeStyleTypeTemplate_ActiveLabel : FontString, GameFontGreenLarge

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_RPE_TurnStrafe/Blizzard_RPE_TurnStrafe.xml#L3)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_RPE_TurnStrafe/Blizzard_RPE_TurnStrafe.xml#L75)
--- child of RPETurnStrafeStyleFrameTemplate
--- @class RPETurnStrafeStyleFrameTemplate_ModernFrame : Frame, RPETurnStrafeStyleTypeTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_RPE_TurnStrafe/Blizzard_RPE_TurnStrafe.xml#L49)
--- child of RPETurnStrafeStyleFrameTemplate
--- @class RPETurnStrafeStyleFrameTemplate_Title : FontString, SystemFont_Huge1

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_RPE_TurnStrafe/Blizzard_RPE_TurnStrafe.xml#L55)
--- child of RPETurnStrafeStyleFrameTemplate
--- @class RPETurnStrafeStyleFrameTemplate_SubTitle : FontString, GameFontNormal

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_RPE_TurnStrafe/Blizzard_RPE_TurnStrafe.xml#L42)
--- Template
