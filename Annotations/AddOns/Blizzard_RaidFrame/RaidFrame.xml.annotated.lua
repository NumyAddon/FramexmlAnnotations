...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_RaidFrame/RaidFrame.xml#L1142)
--- child of RaidParentFrame (created in template ButtonFrameBaseTemplate)
--- @type ButtonFrameBaseTemplate_ButtonFrameBaseTemplateCloseButton
RaidParentFrameCloseButton = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_RaidFrame/RaidFrame.xml#L1125)
--- child of RaidParentFrame (created in template ButtonFrameBaseTemplate)
--- @type Texture
RaidParentFrameBg = {}
