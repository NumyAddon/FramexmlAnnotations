...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ReadyCheck/Classic/ReadyCheck.xml#L44)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ReadyCheck/Classic/ReadyCheck.xml#L35)
--- child of ReadyCheckListenerFrame
--- @class ReadyCheckFrame_ReadyCheckListenerFrame_ReadyCheckFrameText : FontString, GameFontNormal
ReadyCheckFrameText = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ReadyCheck/Classic/ReadyCheck.xml#L17)
--- child of ReadyCheckFrame
--- @class ReadyCheckFrame_ReadyCheckListenerFrame : Frame
ReadyCheckListenerFrame = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_ReadyCheck/Classic/ReadyCheck.xml#L11)
