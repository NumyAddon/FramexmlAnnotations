...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_ScriptErrors/Blizzard_ScriptErrors.lua#L8)
function ScriptErrorsMixin:GetUnhandledErrors() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_ScriptErrors/Blizzard_ScriptErrors.lua#L12)
function ScriptErrorsMixin:AddUnhandledError(errorMessage, stack, locals) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_ScriptErrors/Blizzard_ScriptErrors.lua#L16)
