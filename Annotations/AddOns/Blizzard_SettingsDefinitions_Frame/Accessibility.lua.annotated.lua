...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_SettingsDefinitions_Frame/Accessibility.lua#L7)
function QuestTextPreviewMixin:UpdatePreview(value) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_SettingsDefinitions_Frame/Accessibility.lua#L23)
