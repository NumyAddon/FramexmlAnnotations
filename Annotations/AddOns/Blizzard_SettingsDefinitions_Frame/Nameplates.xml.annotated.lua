...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SettingsDefinitions_Frame/Nameplates.xml#L6)
--- child of NamePlatePreviewTemplate
--- @class NamePlatePreviewTemplate_NamePlate : Button, NamePlatePreviewMixin

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SettingsDefinitions_Frame/Nameplates.xml#L26)
--- child of NamePlatePreviewTemplate
--- @class NamePlatePreviewTemplate_Preview : FontString, GameFontHighlightSmall

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SettingsDefinitions_Frame/Nameplates.xml#L3)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SettingsDefinitions_Frame/Nameplates.xml#L122)
--- child of NamePlatesTutorial
--- @class NamePlatesTutorial_DragBar : Frame, PanelDragBarTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SettingsDefinitions_Frame/Nameplates.xml#L686)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SettingsDefinitions_Frame/Nameplates.xml#L680)
--- child of NamePlatesTutorial (created in template ButtonFrameBaseTemplate)
--- @type ButtonFrameBaseTemplate_CloseButton
NamePlatesTutorialCloseButton = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SettingsDefinitions_Frame/Nameplates.xml#L663)
--- child of NamePlatesTutorial (created in template ButtonFrameBaseTemplate)
--- @type Texture
NamePlatesTutorialBg = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SettingsDefinitions_Frame/Nameplates.xml#L35)
