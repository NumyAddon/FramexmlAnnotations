...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SettingsDefinitions_Frame/Nameplates.xml#L6)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SettingsDefinitions_Frame/Nameplates.xml#L26)
--- child of NamePlatePreviewTemplate
--- @class NamePlatePreviewTemplate_Preview : FontString, GameFontHighlightSmall

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SettingsDefinitions_Frame/Nameplates.xml#L3)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SettingsDefinitions_Frame/Nameplates.xml#L122)
--- child of NamePlatesTutorial
--- @class NamePlatesTutorial_DragBar : Frame, PanelDragBarTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SettingsDefinitions_Frame/Nameplates.xml#L713)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SettingsDefinitions_Frame/Nameplates.xml#L707)
--- child of NamePlatesTutorial (created in template ButtonFrameBaseTemplate)
--- @type ButtonFrameBaseTemplate_CloseButton
NamePlatesTutorialCloseButton = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SettingsDefinitions_Frame/Nameplates.xml#L690)
--- child of NamePlatesTutorial (created in template ButtonFrameBaseTemplate)
--- @type Texture
NamePlatesTutorialBg = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SettingsDefinitions_Frame/Nameplates.xml#L35)
