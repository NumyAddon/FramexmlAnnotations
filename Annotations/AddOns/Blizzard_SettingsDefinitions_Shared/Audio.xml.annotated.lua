...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SettingsDefinitions_Shared/Audio.xml#L8)
--- child of VoiceTestMicrophoneTemplate
--- @class VoiceTestMicrophoneTemplate_ToggleTest : Button, UIPanelButtonTemplate
--- @field Texture Texture

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SettingsDefinitions_Shared/Audio.xml#L42)
--- child of VoiceTestMicrophoneTemplate_VUMeter
--- @class VoiceTestMicrophoneTemplate_VUMeter_Status : StatusBar, TextStatusBar

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SettingsDefinitions_Shared/Audio.xml#L34)
--- child of VoiceTestMicrophoneTemplate_VUMeter
--- @class VoiceTestMicrophoneTemplate_VUMeter_Title : FontString, GameFontHighlightSmall

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SettingsDefinitions_Shared/Audio.xml#L24)
--- child of VoiceTestMicrophoneTemplate
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SettingsDefinitions_Shared/Audio.xml#L5)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SettingsDefinitions_Shared/Audio.xml#L58)
--- Template
--- @class VoicePushToTalkTemplate : Frame, SettingsListElementTemplate, VoicePushToTalkMixin

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SettingsDefinitions_Shared/Audio.xml#L79)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SettingsDefinitions_Shared/Audio.xml#L69)
--- child of MacMicrophoneAccessWarningTemplate
--- @class MacMicrophoneAccessWarningTemplate_Label : FontString, GameFontNormalSmall

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SettingsDefinitions_Shared/Audio.xml#L65)
--- Template
