...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SettingsDefinitions_Shared/Languages.xml#L19)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SettingsDefinitions_Shared/Languages.xml#L17)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SettingsDefinitions_Shared/Languages.xml#L40)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SettingsDefinitions_Shared/Languages.xml#L46)
--- Template
--- @class SettingsLanguageTemplate : Frame, SettingsLanguageBaseTemplate, SettingsLanguageDropdownControlMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SettingsDefinitions_Shared/Languages.xml#L47)
--- Template
--- @class SettingsAudioLocaleTemplate : Frame, SettingsLanguageBaseTemplate, SettingsAudioLocaleDropdownMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SettingsDefinitions_Shared/Languages.xml#L49)
--- Template
