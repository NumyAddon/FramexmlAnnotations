...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Settings_Shared/Blizzard_CategoryList.xml#L58)
--- child of 
--- @class SettingsCategoryListButtonTemplate_Toggle_NormalTexture : Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Settings_Shared/Blizzard_CategoryList.xml#L60)
--- child of 
--- @class SettingsCategoryListButtonTemplate_Toggle_HighlightTexture : Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_Settings_Shared/Blizzard_CategoryList.xml#L53)
