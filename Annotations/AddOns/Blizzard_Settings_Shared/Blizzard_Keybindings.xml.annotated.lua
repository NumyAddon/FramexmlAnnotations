...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_Settings_Shared/Blizzard_Keybindings.xml#L5)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_Settings_Shared/Blizzard_Keybindings.xml#L33)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_Settings_Shared/Blizzard_Keybindings.xml#L30)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_Settings_Shared/Blizzard_Keybindings.xml#L59)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_Settings_Shared/Blizzard_Keybindings.xml#L68)
--- child of KeyBindingFrameBindingTemplate
--- @class KeyBindingFrameBindingTemplate_Button2 : Button, KeyBindingFrameBindingButtonTemplate
--- @field SlotIndex number # 2

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_Settings_Shared/Blizzard_Keybindings.xml#L46)
--- child of KeyBindingFrameBindingTemplate
--- @class KeyBindingFrameBindingTemplate_Label : FontString, GameFontNormal

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_Settings_Shared/Blizzard_Keybindings.xml#L42)
--- Template
