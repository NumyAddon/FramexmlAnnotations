...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_Settings_Shared/Blizzard_SettingsList.xml#L48)
--- child of SettingsListTemplate
--- @class SettingsListTemplate_ScrollBox : Frame, WowScrollBoxList
--- @field InputBlocker Button

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_Settings_Shared/Blizzard_SettingsList.xml#L53)
--- child of SettingsListTemplate
--- @class SettingsListTemplate_ScrollBar : EventFrame, MinimalScrollBar

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_Settings_Shared/Blizzard_SettingsList.xml#L5)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_Settings_Shared/Blizzard_SettingsList.xml#L74)
--- child of SettingsListSearchCategoryTemplate
--- @class SettingsListSearchCategoryTemplate_Title : FontString, GameFontNormalLarge

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_Settings_Shared/Blizzard_SettingsList.xml#L65)
--- Template
