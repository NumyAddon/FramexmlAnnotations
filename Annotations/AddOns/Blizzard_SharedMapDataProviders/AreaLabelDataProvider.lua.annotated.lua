...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SharedMapDataProviders/AreaLabelDataProvider.lua#L2)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SharedMapDataProviders/AreaLabelDataProvider.lua#L65)
--- @class AreaLabelFrameMixin
AreaLabelFrameMixin = { }

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SharedMapDataProviders/AreaLabelDataProvider.lua#L4)
function AreaLabelDataProviderMixin:OnAdded(mapCanvas) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SharedMapDataProviders/AreaLabelDataProvider.lua#L23)
function AreaLabelDataProviderMixin:OnSetAreaLabel(...) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SharedMapDataProviders/AreaLabelDataProvider.lua#L27)
function AreaLabelDataProviderMixin:OnClearAreaLabel(...) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SharedMapDataProviders/AreaLabelDataProvider.lua#L31)
function AreaLabelDataProviderMixin:OnRemoved(mapCanvas) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SharedMapDataProviders/AreaLabelDataProvider.lua#L42)
function AreaLabelDataProviderMixin:GetOffsetY() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SharedMapDataProviders/AreaLabelDataProvider.lua#L46)
function AreaLabelDataProviderMixin:SetOffsetY(offsetY) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SharedMapDataProviders/AreaLabelDataProvider.lua#L53)
function AreaLabelDataProviderMixin:RemoveAllData() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SharedMapDataProviders/AreaLabelDataProvider.lua#L67)
