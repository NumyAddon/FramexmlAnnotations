...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SharedMapDataProviders/BattlefieldFlagDataProvider.lua#L7)
function BattlefieldFlagDataProviderMixin:OnHide() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SharedMapDataProviders/BattlefieldFlagDataProvider.lua#L11)
function BattlefieldFlagDataProviderMixin:OnEvent(event, ...) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SharedMapDataProviders/BattlefieldFlagDataProvider.lua#L17)
function BattlefieldFlagDataProviderMixin:RemoveAllData() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SharedMapDataProviders/BattlefieldFlagDataProvider.lua#L21)
function BattlefieldFlagDataProviderMixin:RefreshAllData(fromOnShow) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SharedMapDataProviders/BattlefieldFlagDataProvider.lua#L32)
function BattlefieldFlagMixin:OnLoad() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SharedMapDataProviders/BattlefieldFlagDataProvider.lua#L37)
function BattlefieldFlagMixin:OnAcquired(flagIndex) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SharedMapDataProviders/BattlefieldFlagDataProvider.lua#L42)
function BattlefieldFlagMixin:Refresh() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SharedMapDataProviders/BattlefieldFlagDataProvider.lua#L50)
