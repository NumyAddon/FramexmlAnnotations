MapIndicatorQuestDataProviderMixin = CreateFromMixins(MapCanvasDataProviderMixin);--- @class MapIndicatorQuestDataProviderMixin : MapCanvasDataProviderMixin
...
MapIndicatorQuestPinMixin = CreateFromMixins(MapCanvasPinMixin);--- @class MapIndicatorQuestPinMixin : MapCanvasPinMixin
