...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L867)
--- @class QuestHubPinGlowMixin
QuestHubPinGlowMixin = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L917)
--- @class SuppressedPinTooltipMixin
SuppressedPinTooltipMixin = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L938)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L595)
function QuestHubPinMixin:AddCustomTooltipData(tooltip) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L609)
function QuestHubPinMixin:AddSuppressedPinsToTooltip(tooltip, allSuppressedPins, formatData) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L637)
function QuestHubPinMixin:ShouldAddSuppressedPinToTooltip(pin) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L642)
function QuestHubPinMixin:AddSuppressedPinToTooltipContainer(container, pin) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L646)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L661)
function QuestHubPinMixin:ResetSuppressedPinTooltipPool() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L667)
function QuestHubPinMixin:GetSuppressedPinTooltipContainer(formatData) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L681)
function QuestHubPinMixin:OnMouseClickAction(button) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L686)
function QuestHubPinMixin:IsPinSuppressor() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L690)
function QuestHubPinMixin:GetSuppressedPins() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L776)
function QuestHubPinMixin:GetSuppressedPinsSorted() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L804)
function QuestHubPinMixin:ShouldSuppressPin(pin) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L827)
function QuestHubPinMixin:IsRelatedQuestOfferPin(pin) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L835)
function QuestHubPinMixin:ResetSuppression() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L847)
function QuestHubPinMixin:TrackSuppressedPin(pin) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L855)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L874)
function QuestHubPinGlowMixin:OnReleased() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L881)
function QuestHubPinGlowMixin:GetHighlightType() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L895)
function QuestHubPinGlowMixin:GetHighlightAnimType() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L904)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L940)
function SuppressedPinTooltipContainerMixin:Reset() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L950)
