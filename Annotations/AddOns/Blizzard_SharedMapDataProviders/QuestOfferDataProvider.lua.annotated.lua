...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L932)
--- @class SuppressedPinTooltipMixin
SuppressedPinTooltipMixin = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L953)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L456)
function QuestHubPinMixin:BuildRelatedQuests() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L473)
function QuestHubPinMixin:GetRelatedQuests() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L477)
function QuestHubPinMixin:SetIsQuestHubForCityMap(isForCity) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L481)
function QuestHubPinMixin:IsQuestHubForCityMap() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L529)
function QuestHubPinMixin:UpdatePriorityQuestDisplay() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L560)
function QuestHubPinMixin:ShouldMouseButtonBePassthrough(button) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L564)
function QuestHubPinMixin:GetLinkedUIMapID() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L597)
function QuestHubPinMixin:AddCustomTooltipData(tooltip) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L611)
function QuestHubPinMixin:AddSuppressedPinsToTooltip(tooltip, allSuppressedPins, formatData) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L639)
function QuestHubPinMixin:ShouldAddSuppressedPinToTooltip(pin) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L644)
function QuestHubPinMixin:AddSuppressedPinToTooltipContainer(container, pin) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L648)
function QuestHubPinMixin:CreatePinTooltipFrame(pin) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L655)
function QuestHubPinMixin:GetOrCreateSuppressedPinTooltipPool() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L663)
function QuestHubPinMixin:ResetSuppressedPinTooltipPool() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L669)
function QuestHubPinMixin:GetSuppressedPinTooltipContainer(formatData) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L683)
function QuestHubPinMixin:OnMouseClickAction(button) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L688)
function QuestHubPinMixin:IsPinSuppressor() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L692)
function QuestHubPinMixin:GetSuppressedPins() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L778)
function QuestHubPinMixin:GetSuppressedPinsSorted() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L806)
function QuestHubPinMixin:ShouldSuppressPin(pin) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L829)
function QuestHubPinMixin:IsLinkedPin(pin) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L850)
function QuestHubPinMixin:ResetSuppression() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L862)
function QuestHubPinMixin:TrackSuppressedPin(pin) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L870)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L889)
function QuestHubPinGlowMixin:OnReleased() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L896)
function QuestHubPinGlowMixin:GetHighlightType() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L910)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L934)
function SuppressedPinTooltipMixin:SetupFromPin(pin) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L955)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.lua#L980)
