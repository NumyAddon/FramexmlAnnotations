...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.xml#L3)
--- Template
--- @class HeightIndicatorMapPinTemplate : Frame, IconWithHeightIndicatorMapPinMixin
--- @field HeightIndicator Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.xml#L15)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.xml#L32)
--- child of SuppressedPinTooltipTemplate
--- @class SuppressedPinTooltipTemplate_Title : FontString, GameFontNormal

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.xml#L23)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.xml#L45)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.xml#L42)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedMapDataProviders/QuestOfferDataProvider.xml#L52)
--- Template
