...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_SharedXML/AnimationTemplates.lua#L101)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_SharedXML/AnimationTemplates.lua#L103)
function PointsOffsetAnimationMixin:OnUpdate() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_SharedXML/AnimationTemplates.lua#L107)
function PointsOffsetAnimationMixin:GetCustomEasingFunction() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_SharedXML/AnimationTemplates.lua#L111)
function PointsOffsetAnimationMixin:GetOffsetFrom() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_SharedXML/AnimationTemplates.lua#L115)
function PointsOffsetAnimationMixin:GetOffsetTo() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_SharedXML/AnimationTemplates.lua#L119)
function PointsOffsetAnimationMixin:SetCustomEasingFunction(easingFunction) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_SharedXML/AnimationTemplates.lua#L123)
function PointsOffsetAnimationMixin:SetOffsetFrom(offsetX, offsetY) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_SharedXML/AnimationTemplates.lua#L127)
function PointsOffsetAnimationMixin:SetOffsetTo(offsetX, offsetY) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_SharedXML/AnimationTemplates.lua#L131)
