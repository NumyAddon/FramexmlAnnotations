...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/AnimationTemplates.lua#L71)
--- @class AnimateWhileShownMixin
AnimateWhileShownMixin = { }

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/AnimationTemplates.lua#L101)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/AnimationTemplates.lua#L85)
function AnimateWhileShownMixin:PlayAnims() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/AnimationTemplates.lua#L95)
function AnimateWhileShownMixin:StopAnims() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/AnimationTemplates.lua#L103)
function PointsOffsetAnimationMixin:OnUpdate() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/AnimationTemplates.lua#L107)
function PointsOffsetAnimationMixin:GetCustomEasingFunction() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/AnimationTemplates.lua#L111)
function PointsOffsetAnimationMixin:GetOffsetFrom() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/AnimationTemplates.lua#L115)
function PointsOffsetAnimationMixin:GetOffsetTo() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/AnimationTemplates.lua#L119)
function PointsOffsetAnimationMixin:SetCustomEasingFunction(easingFunction) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/AnimationTemplates.lua#L123)
function PointsOffsetAnimationMixin:SetOffsetFrom(offsetX, offsetY) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/AnimationTemplates.lua#L127)
function PointsOffsetAnimationMixin:SetOffsetTo(offsetX, offsetY) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/AnimationTemplates.lua#L131)
