...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_SharedXML/AnimationTemplates.lua#L76)
function AnimateWhileShownMixin:PlayAnims() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_SharedXML/AnimationTemplates.lua#L86)
