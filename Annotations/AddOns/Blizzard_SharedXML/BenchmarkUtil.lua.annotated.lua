...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/BenchmarkUtil.lua#L23)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/BenchmarkUtil.lua#L25)
function ScriptBenchmarkGarbageCollectorControlMixin:OnIterationStart(_iteration, _iterationCount) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/BenchmarkUtil.lua#L30)
