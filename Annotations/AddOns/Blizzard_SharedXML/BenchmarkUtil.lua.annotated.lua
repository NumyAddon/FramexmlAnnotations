...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_SharedXML/BenchmarkUtil.lua#L7)
function ScriptBenchmarkMixin:OnIterationStart(_iteration, _iterationCount) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_SharedXML/BenchmarkUtil.lua#L11)
function ScriptBenchmarkMixin:OnIterationFinish(_iteration, _iterationCount, _iterationResults) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_SharedXML/BenchmarkUtil.lua#L15)
function ScriptBenchmarkMixin:OnFinish(_iterationCount, _benchmarkResults) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_SharedXML/BenchmarkUtil.lua#L19)
