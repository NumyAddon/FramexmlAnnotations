...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/CircularBuffer.lua#L77)
function CircularBufferMixin:RemoveIf(predicateFunction, transformFunction) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/CircularBuffer.lua#L95)
function CircularBufferMixin:TransformIf(predicateFunction, transformFunction, entryTransform) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/CircularBuffer.lua#L112)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/CircularBuffer.lua#L155)
function CircularBufferMixin:OnLoad(maxElements) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/CircularBuffer.lua#L161)
function CircularBufferMixin:CalculateElementIndex(index) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/CircularBuffer.lua#L166)
function CircularBufferMixin:CalculateElementIndexFromGlobalIndex(globalIndex) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/CircularBuffer.lua#L175)
