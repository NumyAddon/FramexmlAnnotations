...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/CircularBuffer.lua#L171)
function CircularBufferMixin:CalculateElementIndexFromGlobalIndex(globalIndex) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/CircularBuffer.lua#L180)
