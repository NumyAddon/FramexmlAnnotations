...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/CircularBuffer.lua#L15)
--- @class CircularBufferMixin
CircularBufferMixin = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/CircularBuffer.lua#L24)
function CircularBufferMixin:Clear() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/CircularBuffer.lua#L29)
function CircularBufferMixin:SetMaxNumElements(maxElements) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/CircularBuffer.lua#L42)
function CircularBufferMixin:GetMaxNumElements() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/CircularBuffer.lua#L46)
function CircularBufferMixin:PushFront(element) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/CircularBuffer.lua#L57)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/CircularBuffer.lua#L171)
function CircularBufferMixin:CalculateElementIndexFromGlobalIndex(globalIndex) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/CircularBuffer.lua#L180)
