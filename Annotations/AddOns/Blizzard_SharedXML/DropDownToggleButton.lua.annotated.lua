...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_SharedXML/DropDownToggleButton.lua#L1)
--- @class DropDownToggleButtonMixin
DropDownToggleButtonMixin = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_SharedXML/DropDownToggleButton.lua#L3)
