...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/EventUtil.lua#L108)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/EventUtil.lua#L29)
function ContinueAfterAllEventsMixin:HaveReceivedAllEvents() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/EventUtil.lua#L110)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/EventUtil.lua#L119)
function CallbackHandleContainerMixin:AddHandle(handle) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/EventUtil.lua#L123)
function CallbackHandleContainerMixin:Unregister() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/EventUtil.lua#L130)
