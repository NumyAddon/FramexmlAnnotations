...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L201)
--- @class LayoutMixin : BaseLayoutMixin
LayoutMixin = CreateFromMixins(BaseLayoutMixin)

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L446)
--- @class ResizeLayoutMixin : BaseLayoutMixin
ResizeLayoutMixin = CreateFromMixins(BaseLayoutMixin)

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L623)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L268)
--- @class VerticalLayoutMixin
VerticalLayoutMixin = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L365)
--- @class HorizontalLayoutMixin
HorizontalLayoutMixin = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L532)
--- @class GridLayoutFrameMixin
GridLayoutFrameMixin = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L726)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L164)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L188)
function BaseLayoutMixin:GetChildHeight(child, ignoreRect) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L203)
function LayoutMixin:GetPadding() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L212)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L248)
function LayoutMixin:Layout() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L270)
function VerticalLayoutMixin:LayoutChildren(children, expandToWidth) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L367)
function HorizontalLayoutMixin:LayoutChildren(children, ignored, expandToHeight) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L461)
function ResizeLayoutMixin:IgnoreLayoutIndex() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L465)
function ResizeLayoutMixin:SetMinimumWidth(minimumWidth) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L469)
function ResizeLayoutMixin:GetMinimumWidth() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L473)
function ResizeLayoutMixin:SetMaximumWidth(maximumWidth) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L477)
function ResizeLayoutMixin:GetMaximumWidth() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L481)
function ResizeLayoutMixin:Layout() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L534)
function GridLayoutFrameMixin:Layout() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L568)
function GridLayoutFrameMixin:CacheLayoutSettings(layoutChildren) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L580)
function GridLayoutFrameMixin:ShouldUpdateLayout(layoutChildren) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L612)
function GridLayoutFrameMixin:IgnoreLayoutIndex() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L625)
function StaticGridLayoutFrameMixin:Layout() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L720)
function StaticGridLayoutFrameMixin:IgnoreLayoutIndex() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L729)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L738)
function OverrideLayoutFrameOnUpdateMixin:UpdateOnUpdateRegistration() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/LayoutFrame.lua#L749)
