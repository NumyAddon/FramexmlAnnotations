...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/ListTemplates.xml#L3)
--- Template
--- @class CollapseButtonTemplate : Button, CollapseButtonMixin
--- @field Icon Texture

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/ListTemplates.xml#L24)
--- child of ListHeaderVisualTemplate
--- @class ListHeaderVisualTemplate_CollapseButton : Button, CollapseButtonTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/ListTemplates.xml#L22)
--- Template
--- @class ListHeaderVisualTemplate : Button, ListHeaderVisualMixin
--- @field CollapseButton ListHeaderVisualTemplate_CollapseButton

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/ListTemplates.xml#L42)
--- Template
--- @class ListHeaderCodeTemplate : Button, ListHeaderMixin

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/ListTemplates.xml#L75)
--- child of ListHeaderThreeSliceTemplate
--- @class ListHeaderThreeSliceTemplate_Name : FontString, GameFontNormalLeft

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/ListTemplates.xml#L53)
--- Template
