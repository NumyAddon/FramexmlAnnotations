...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/Mainline/TabSystem/TabSystemTemplates.xml#L3)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/Mainline/TabSystem/TabSystemTemplates.xml#L74)
--- Template
--- @class TabSystemButtonTemplate : Button, TabSystemButtonArtTemplate, TabSystemButtonMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/Mainline/TabSystem/TabSystemTemplates.xml#L83)
--- Template
--- @class TabSystemTopButtonTemplate : Button, TabSystemButtonArtTemplate, TabSystemButtonMixin
--- @field isTabOnTop boolean # true

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/Mainline/TabSystem/TabSystemTemplates.xml#L95)
--- Template
