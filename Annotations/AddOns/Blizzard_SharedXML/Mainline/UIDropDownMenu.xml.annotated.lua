...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/Mainline/UIDropDownMenu.xml#L7)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/Mainline/UIDropDownMenu.xml#L9)
--- child of DropDownList1Button1 (created in template UIDropDownMenuButtonTemplate)
--- @type Texture
DropDownList1Button1Highlight = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/Mainline/UIDropDownMenu.xml#L12)
--- child of DropDownList1Button1 (created in template UIDropDownMenuButtonTemplate)
--- @type Texture
DropDownList1Button1Check = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/Mainline/UIDropDownMenu.xml#L21)
--- child of DropDownList1Button1 (created in template UIDropDownMenuButtonTemplate)
--- @type Texture
DropDownList1Button1UnCheck = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/Mainline/UIDropDownMenu.xml#L30)
--- child of DropDownList1Button1 (created in template UIDropDownMenuButtonTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/Mainline/UIDropDownMenu.xml#L3)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/Mainline/UIDropDownMenu.xml#L15)
