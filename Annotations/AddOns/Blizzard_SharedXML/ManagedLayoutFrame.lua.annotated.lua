...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_SharedXML/ManagedLayoutFrame.lua#L10)
function ManagedLayoutFrameMixin:SetTemplate(frameType, template) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_SharedXML/ManagedLayoutFrame.lua#L21)
function ManagedLayoutFrameMixin:SetContents(contents) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_SharedXML/ManagedLayoutFrame.lua#L33)
function ManagedLayoutFrameMixin:EnumerateActive() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_SharedXML/ManagedLayoutFrame.lua#L39)
