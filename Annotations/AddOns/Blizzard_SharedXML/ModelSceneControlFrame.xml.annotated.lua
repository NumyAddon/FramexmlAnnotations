...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/ModelSceneControlFrame.xml#L3)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/ModelSceneControlFrame.xml#L49)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/ModelSceneControlFrame.xml#L50)
--- child of ModelSceneControlFrameTemplate
--- @class ModelSceneControlFrameTemplate_zoomOutButton : Button, ModelSceneControlButtonTemplate, ModelSceneZoomButtonMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/ModelSceneControlFrame.xml#L51)
--- child of ModelSceneControlFrameTemplate
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/ModelSceneControlFrame.xml#L52)
--- child of ModelSceneControlFrameTemplate
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/ModelSceneControlFrame.xml#L53)
--- child of ModelSceneControlFrameTemplate
--- @class ModelSceneControlFrameTemplate_resetButton : Button, ModelSceneControlButtonTemplate, ModelSceneResetButtonMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/ModelSceneControlFrame.xml#L38)
--- Template
