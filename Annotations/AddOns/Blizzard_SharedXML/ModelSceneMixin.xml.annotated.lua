...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_SharedXML/ModelSceneMixin.xml#L3)
--- Template
--- @class NonInteractableModelSceneMixinTemplate : ModelScene, ModelSceneMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_SharedXML/ModelSceneMixin.xml#L9)
--- Template
