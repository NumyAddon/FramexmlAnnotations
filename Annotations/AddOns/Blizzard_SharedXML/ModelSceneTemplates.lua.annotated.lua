...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/ModelSceneTemplates.lua#L8)
function ModifyOrbitCameraButtonMixin:OnMouseUp() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/ModelSceneTemplates.lua#L12)
function ModifyOrbitCameraButtonMixin:OnUpdate(elapsed) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/ModelSceneTemplates.lua#L19)
function ModifyOrbitCameraButtonMixin:GetActiveOrbitCamera() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/ModelSceneTemplates.lua#L32)
function WrappedModelSceneMixin:IsUnwrapAnimating() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/ModelSceneTemplates.lua#L36)
function WrappedModelSceneMixin:NeedsFanfare() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/ModelSceneTemplates.lua#L40)
function WrappedModelSceneMixin:OnShow() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/ModelSceneTemplates.lua#L44)
function WrappedModelSceneMixin:OnMouseEnter() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/ModelSceneTemplates.lua#L52)
function WrappedModelSceneMixin:OnMouseLeave() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/ModelSceneTemplates.lua#L56)
function WrappedModelSceneMixin:PrepareForFanfare(needsFanFare) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/ModelSceneTemplates.lua#L74)
function WrappedModelSceneMixin:StartUnwrapAnimation(OnFinishedCallback) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/ModelSceneTemplates.lua#L109)
function WrappedAndUnwrappedModelSceneMixin:PrepareForFanfare(needsFanFare) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/ModelSceneTemplates.lua#L132)
