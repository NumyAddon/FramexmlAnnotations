...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_SharedXML/ModelSceneTemplates.xml#L3)
--- Template
--- @class ModifyOrbitCameraBaseButtonTemplate : Button, ModifyOrbitCameraButtonMixin
--- @field interpolationEnabled boolean # false

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_SharedXML/ModelSceneTemplates.xml#L15)
--- Template
...
--- @field amountPerSecond number # -3

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_SharedXML/ModelSceneTemplates.xml#L30)
--- Template
--- @class RotateOrbitCameraRightButtonTemplate : Button, ModifyOrbitCameraBaseButtonTemplate
--- @field cameraMode any # ORBIT_CAMERA_MOUSE_MODE_YAW_ROTATION
--- @field amountPerSecond number # 3

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_SharedXML/ModelSceneTemplates.xml#L60)
--- child of WrappedModelSceneTemplate
--- @class WrappedModelSceneTemplate_UnwrapAnim : AnimationGroup
--- @field WrappedAnim Alpha

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_SharedXML/ModelSceneTemplates.xml#L45)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_SharedXML/ModelSceneTemplates.xml#L81)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_SharedXML/ModelSceneTemplates.xml#L66)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_SharedXML/ModelSceneTemplates.xml#L89)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_SharedXML/ModelSceneTemplates.xml#L87)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_SharedXML/ModelSceneTemplates.xml#L98)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_SharedXML/ModelSceneTemplates.xml#L96)
--- Template
