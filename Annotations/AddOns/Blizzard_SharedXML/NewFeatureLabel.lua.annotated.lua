...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/NewFeatureLabel.lua#L1)
--- @class NewFeatureLabelMixin
NewFeatureLabelMixin = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/NewFeatureLabel.lua#L3)
function NewFeatureLabelMixin:OnLoad() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/NewFeatureLabel.lua#L10)
