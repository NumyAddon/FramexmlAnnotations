...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/PagedList.xml#L5)
--- Template
--- @class PagedListTemplate : Frame, TemplatedListTemplate, PagedListMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/PagedList.xml#L12)
--- Template
--- @class PagedListControlButtonTemplate : Button, PagedListControlButtonMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/PagedList.xml#L41)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/PagedList.xml#L51)
--- child of PagedListHorizontalControlTemplate
--- @class PagedListHorizontalControlTemplate_ForwardButton : Button, PagedListControlButtonTemplate
--- @field layoutIndex number # 3

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/PagedList.xml#L31)
--- child of PagedListHorizontalControlTemplate
--- @class PagedListHorizontalControlTemplate_PageText : FontString
--- @field layoutIndex number # 1

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/PagedList.xml#L20)
--- Template
