...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/PagedList.xml#L5)
--- Template
--- @class PagedListTemplate : Frame, TemplatedListTemplate, PagedListMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/PagedList.xml#L12)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/PagedList.xml#L31)
--- child of PagedListHorizontalControlTemplate
