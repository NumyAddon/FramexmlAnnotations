...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/PingableType.lua#L11)
function PingableTypeMixin:GetIsPingable() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/PingableType.lua#L16)
function PingableTypeMixin:GetAllowRadialWheel() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/PingableType.lua#L21)
function PingableTypeMixin:GetTargetInfo() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/PingableType.lua#L34)
function PingableType_UnitFrameMixin:GetTargetInfo() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/PingableType.lua#L45)
function PingableType_PlayerUnitFrameMixin:GetAllowRadialWheel() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/PingableType.lua#L50)
function PingableType_PlayerUnitFrameMixin:GetTargetInfo() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/PingableType.lua#L63)
function PingableType_ActionButtonMixin:UpdatePingAttributes() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/PingableType.lua#L72)
function PingableType_ActionButtonMixin:GetIsPingable() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/PingableType.lua#L93)
function PingableType_ActionButtonMixin:GetAllowRadialWheel() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/PingableType.lua#L97)
function PingableType_ActionButtonMixin:GetTargetInfo() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/PingableType.lua#L117)
function PingableType_CooldownViewerItemMixin:GetAllowRadialWheel() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/PingableType.lua#L121)
