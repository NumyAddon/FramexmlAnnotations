...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_SharedXML/PortraitFrame.lua#L35)
--- @class DefaultPanelMixin : TitledPanelMixin
DefaultPanelMixin = CreateFromMixins(TitledPanelMixin)

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_SharedXML/PortraitFrame.lua#L37)
--- @class PortraitFrameMixin : TitledPanelMixin
PortraitFrameMixin = CreateFromMixins(TitledPanelMixin)

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_SharedXML/PortraitFrame.lua#L2)
--- @class TitledPanelMixin
TitledPanelMixin = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_SharedXML/PortraitFrame.lua#L104)
--- @class PortraitFrameFlatBaseMixin
PortraitFrameFlatBaseMixin = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_SharedXML/PortraitFrame.lua#L4)
function TitledPanelMixin:GetTitleText() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_SharedXML/PortraitFrame.lua#L8)
function TitledPanelMixin:SetTitleColor(color) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_SharedXML/PortraitFrame.lua#L12)
function TitledPanelMixin:SetTitle(title) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_SharedXML/PortraitFrame.lua#L16)
function TitledPanelMixin:SetTitleFormatted(fmt, ...) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_SharedXML/PortraitFrame.lua#L25)
function TitledPanelMixin:SetTitleMaxLinesAndHeight(maxLines, height) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_SharedXML/PortraitFrame.lua#L30)
function TitledPanelMixin:SetTitleOffsets(leftOffset, rightOffset) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_SharedXML/PortraitFrame.lua#L39)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_SharedXML/PortraitFrame.lua#L82)
