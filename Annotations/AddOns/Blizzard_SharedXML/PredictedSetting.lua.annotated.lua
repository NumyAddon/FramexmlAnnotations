...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/PredictedSetting.lua#L12)
function PredictedSettingBaseMixin:Clear() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/PredictedSetting.lua#L16)
function PredictedSettingBaseMixin:Get() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/PredictedSetting.lua#L25)
function PredictedSettingMixin:Set(value) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/PredictedSetting.lua#L40)
function PredictedToggleMixin:SetUp(wrapTable) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/PredictedSetting.lua#L45)
function PredictedToggleMixin:Toggle() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_SharedXML/PredictedSetting.lua#L50)
