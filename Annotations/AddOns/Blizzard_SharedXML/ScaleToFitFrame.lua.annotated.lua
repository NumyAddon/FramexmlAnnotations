...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXML/ScaleToFitFrame.lua#L8)
function ScaleToFitFrameMixin:OnScaleToFitFrameEvent(event, ...) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXML/ScaleToFitFrame.lua#L15)
function ScaleToFitFrameMixin:SetRefreshCallback(callback) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXML/ScaleToFitFrame.lua#L19)
function ScaleToFitFrameMixin:Refresh() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXML/ScaleToFitFrame.lua#L25)
function ScaleToFitFrameMixin:SetMaxWidth(maxWidth) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXML/ScaleToFitFrame.lua#L30)
function ScaleToFitFrameMixin:SetMaxHeight(maxHeight) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXML/ScaleToFitFrame.lua#L35)
function ScaleToFitFrameMixin:UpdateScaleToFit() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXML/ScaleToFitFrame.lua#L56)
