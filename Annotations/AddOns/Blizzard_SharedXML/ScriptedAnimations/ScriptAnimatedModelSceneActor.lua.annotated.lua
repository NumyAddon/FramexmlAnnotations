...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_SharedXML/ScriptedAnimations/ScriptAnimatedModelSceneActor.lua#L2)
--- @class ScriptAnimatedModelSceneActorMixin
ScriptAnimatedModelSceneActorMixin = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_SharedXML/ScriptedAnimations/ScriptAnimatedModelSceneActor.lua#L4)
function ScriptAnimatedModelSceneActorMixin:IsActive() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_SharedXML/ScriptedAnimations/ScriptAnimatedModelSceneActor.lua#L9)
function ScriptAnimatedModelSceneActorMixin:GetModelScene() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_SharedXML/ScriptedAnimations/ScriptAnimatedModelSceneActor.lua#L13)
function ScriptAnimatedModelSceneActorMixin:OnFinish() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_SharedXML/ScriptedAnimations/ScriptAnimatedModelSceneActor.lua#L18)
