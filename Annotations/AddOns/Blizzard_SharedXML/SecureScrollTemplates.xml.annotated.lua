...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/SecureScrollTemplates.xml#L10)
--- child of UIPanelScrollFrameTemplateScrollBar (created in template UIPanelScrollBarTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/SecureScrollTemplates.xml#L10)
--- child of UIPanelInputScrollFrameTemplateScrollBar (created in template UIPanelScrollBarTemplate)
--- @type UIPanelScrollBarTemplate_UIPanelScrollBarTemplateScrollUpButton
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/SecureScrollTemplates.xml#L46)
--- child of UIPanelInputScrollFrameTemplate (created in template UIPanelScrollFrameTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/SecureScrollTemplates.xml#L10)
--- child of UIPanelStretchableArtScrollBarTemplate (created in template UIPanelScrollBarTemplate)
--- @type UIPanelScrollBarTemplate_UIPanelScrollBarTemplateScrollUpButton
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/SecureScrollTemplates.xml#L364)
--- child of MinimalScrollFrameTemplateScrollBar (created in template MinimalScrollBarTemplate)
--- @type MinimalScrollBarTemplate_MinimalScrollBarTemplateScrollUpButton

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/SecureScrollTemplates.xml#L377)
--- child of MinimalScrollFrameTemplateScrollBar (created in template MinimalScrollBarTemplate)
--- @type MinimalScrollBarTemplate_MinimalScrollBarTemplateScrollDownButton
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/SecureScrollTemplates.xml#L396)
--- child of MinimalScrollFrameTemplateScrollBar (created in template MinimalScrollBarTemplate)
--- @type MinimalScrollBarTemplate_MinimalScrollBarTemplateThumbTexture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_SharedXML/SecureScrollTemplates.xml#L305)
--- child of FauxScrollFrameTemplateLightScrollBar (created in template UIPanelScrollBarTemplateLightBorder)
