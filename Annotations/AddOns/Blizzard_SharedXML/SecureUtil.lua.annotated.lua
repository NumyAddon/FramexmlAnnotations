...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXML/SecureUtil.lua#L12)
function ShrinkUntilTruncateFontStringMixin:ApplyFontObjects() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXML/SecureUtil.lua#L25)
function ShrinkUntilTruncateFontStringMixin:SetText(text) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXML/SecureUtil.lua#L37)
