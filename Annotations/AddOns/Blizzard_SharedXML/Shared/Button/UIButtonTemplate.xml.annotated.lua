...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SharedXML/Shared/Button/UIButtonTemplate.xml#L40)
--- child of UIButtonTemplate
--- @class UIButtonTemplate_Controller : Frame, ButtonControllerMixin

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SharedXML/Shared/Button/UIButtonTemplate.xml#L4)
--- Template
--- @class UIButtonTemplate : Button, UIButtonMixin
--- @field Controller UIButtonTemplate_Controller

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SharedXML/Shared/Button/UIButtonTemplate.xml#L54)
--- Template
