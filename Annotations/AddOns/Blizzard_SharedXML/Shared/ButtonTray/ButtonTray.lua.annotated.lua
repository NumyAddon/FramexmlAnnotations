...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_SharedXML/Shared/ButtonTray/ButtonTray.lua#L114)
function GridButtonTrayMixin:AddControlsExternal(...) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_SharedXML/Shared/ButtonTray/ButtonTray.lua#L122)
function GridButtonTrayMixin:RemoveControl(control) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_SharedXML/Shared/ButtonTray/ButtonTray.lua#L132)
function GridButtonTrayMixin:RemoveControls(...) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_SharedXML/Shared/ButtonTray/ButtonTray.lua#L140)
function GridButtonTrayMixin:RemoveAllControls() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_SharedXML/Shared/ButtonTray/ButtonTray.lua#L149)
