...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXML/Shared/Dialog/DialogTemplates.lua#L10)
function DialogHeaderMixin:Setup(text) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXML/Shared/Dialog/DialogTemplates.lua#L15)
function DialogHeaderMixin:SetHeaderFont(font) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXML/Shared/Dialog/DialogTemplates.lua#L20)
