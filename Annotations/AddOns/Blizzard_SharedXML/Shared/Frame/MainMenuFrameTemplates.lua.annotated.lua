...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SharedXML/Shared/Frame/MainMenuFrameTemplates.lua#L2)
--- @class MainMenuFrameMixin
MainMenuFrameMixin = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SharedXML/Shared/Frame/MainMenuFrameTemplates.lua#L9)
