ScrollingEditBoxMixin = CreateFromMixins(CallbackRegistryMixin);--- @class ScrollingEditBoxMixin : CallbackRegistryMixin
...
ScrollingFontMixin = {};--- @class ScrollingFontMixin
