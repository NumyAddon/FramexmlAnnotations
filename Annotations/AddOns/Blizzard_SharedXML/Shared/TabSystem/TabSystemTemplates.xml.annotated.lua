...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/Shared/TabSystem/TabSystemTemplates.xml#L3)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/Shared/TabSystem/TabSystemTemplates.xml#L89)
--- Template
--- @class TabSystemButtonTemplate : Button, TabSystemButtonArtTemplate, TabSystemButtonMixin

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/Shared/TabSystem/TabSystemTemplates.xml#L98)
--- Template
--- @class TabSystemTopButtonTemplate : Button, TabSystemButtonArtTemplate, TabSystemButtonMixin
--- @field isTabOnTop boolean # true

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/Shared/TabSystem/TabSystemTemplates.xml#L110)
--- Template
