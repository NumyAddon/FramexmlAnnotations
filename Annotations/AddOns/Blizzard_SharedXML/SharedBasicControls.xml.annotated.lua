...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/SharedBasicControls.xml#L198)
--- Template
--- @class BaseTextTimer : Frame, BaseTextTimerMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/SharedBasicControls.xml#L231)
--- child of BaseExpandableDialog
--- @class BaseExpandableDialog_CloseButton : Button, UIPanelCloseButtonNoScripts

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/SharedBasicControls.xml#L200)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/SharedBasicControls.xml#L260)
--- child of BaseNineSliceDialog
--- @class BaseNineSliceDialog_Underlay : Frame
--- @field ignoreInLayout boolean # true
--- @field Tex Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/SharedBasicControls.xml#L326)
--- child of BaseNineSliceDialog_Contents
--- @class BaseNineSliceDialog_Contents_CloseButton : Button, SharedButtonLargeTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/SharedBasicControls.xml#L289)
--- child of BaseNineSliceDialog_Contents
--- @class BaseNineSliceDialog_Contents_Title : FontString, Game30Font

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/SharedBasicControls.xml#L301)
--- child of BaseNineSliceDialog_Contents
--- @class BaseNineSliceDialog_Contents_Description : FontString, System15Font

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/SharedBasicControls.xml#L308)
--- child of BaseNineSliceDialog_Contents
--- @class BaseNineSliceDialog_Contents_DescriptionDuplicate : FontString, System15Font

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/SharedBasicControls.xml#L276)
--- child of BaseNineSliceDialog
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/SharedBasicControls.xml#L242)
--- Template
...
--- Scripts:
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/SharedBasicControls.xml#L4)
do
		--FrameXML_Debug(1);
end
