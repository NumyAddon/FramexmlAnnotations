...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/SharedBasicControls.xml#L330)
--- child of BaseNineSliceDialog_Contents
--- @class BaseNineSliceDialog_Contents_CloseButton : Button, SharedButtonLargeTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/SharedBasicControls.xml#L293)
--- child of BaseNineSliceDialog_Contents
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/SharedBasicControls.xml#L312)
--- child of BaseNineSliceDialog_Contents
--- @class BaseNineSliceDialog_Contents_DescriptionDuplicate : FontString, System15Font

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXML/SharedBasicControls.xml#L280)
--- child of BaseNineSliceDialog
