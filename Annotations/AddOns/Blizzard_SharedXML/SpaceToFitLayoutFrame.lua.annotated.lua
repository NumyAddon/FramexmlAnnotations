...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/SpaceToFitLayoutFrame.lua#L7)
--- @class SpaceToFitDirectionalLayoutMixin
SpaceToFitDirectionalLayoutMixin = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/SpaceToFitLayoutFrame.lua#L9)
function SpaceToFitDirectionalLayoutMixin:SetFixedMaxSpace(maxSpace) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SharedXML/SpaceToFitLayoutFrame.lua#L13)
