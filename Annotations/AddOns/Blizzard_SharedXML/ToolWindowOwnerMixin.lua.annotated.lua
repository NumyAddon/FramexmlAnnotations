...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SharedXML/ToolWindowOwnerMixin.lua#L61)
function ToolWindowOwnerMixin:SetMinSize(minWidth, minHeight) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SharedXML/ToolWindowOwnerMixin.lua#L72)
function ToolWindowOwnerMixin:SetWindowFocus() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SharedXML/ToolWindowOwnerMixin.lua#L81)
function ToolWindowOwnerMixin:IsTopmost() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SharedXML/ToolWindowOwnerMixin.lua#L90)
function ToolWindowOwnerMixin:SetTopmost(topmost) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_SharedXML/ToolWindowOwnerMixin.lua#L99)
