...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXMLBase/ColorSwatch.lua#L1)
--- @class ColorSwatchMixin
ColorSwatchMixin = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXMLBase/ColorSwatch.lua#L3)
function ColorSwatchMixin:SetColor(color) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXMLBase/ColorSwatch.lua#L7)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SharedXMLBase/ColorSwatch.lua#L23)
