...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SharedXMLBase/ExportUtil.lua#L97)
function ExportDataStreamMixin:AddValue(bitWidth, value) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SharedXMLBase/ExportUtil.lua#L101)
function ExportDataStreamMixin:GetExportString() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SharedXMLBase/ExportUtil.lua#L107)
function ImportDataStreamMixin:Init(exportString) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SharedXMLBase/ExportUtil.lua#L114)
function ImportDataStreamMixin:ExtractValue(bitWidth) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SharedXMLBase/ExportUtil.lua#L145)
