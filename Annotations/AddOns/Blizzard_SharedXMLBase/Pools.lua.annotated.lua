...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLBase/Pools.lua#L78)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLBase/Pools.lua#L309)
function PoolCollectionBaseMixin:GetPool(template, specialization) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLBase/Pools.lua#L314)
function PoolCollectionBaseMixin:HasPool(poolKey) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLBase/Pools.lua#L318)
function PoolCollectionBaseMixin:Acquire(template, specialization) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLBase/Pools.lua#L323)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLBase/Pools.lua#L343)
function PoolCollectionBaseMixin:CreatePool(...) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLBase/Pools.lua#L347)
function PoolCollectionBaseMixin:CreatePoolWithArgs(args) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLBase/Pools.lua#L356)
function PoolCollectionBaseMixin:GetOrCreatePoolWithArgs(args) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLBase/Pools.lua#L366)
function PoolCollectionBaseMixin:Dump() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLBase/Pools.lua#L643)
function FramePoolCollectionConverterMixin:CreatePoolKeyFromPoolArgs(args) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLBase/Pools.lua#L647)
function FramePoolCollectionConverterMixin:GetOrCreatePool(...) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLBase/Pools.lua#L652)
