...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLGame/DressUpModelFrameMixin.lua#L283)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLGame/DressUpModelFrameMixin.lua#L340)
--- @class DressUpFrameSetSelectionLabelMixin
DressUpFrameSetSelectionLabelMixin = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLGame/DressUpModelFrameMixin.lua#L360)
--- @class DressUpFrameTransmogSetMixin
DressUpFrameTransmogSetMixin = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLGame/DressUpModelFrameMixin.lua#L708)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLGame/DressUpModelFrameMixin.lua#L255)
function DressUpModelFrameMixin:ShowCustomSet(customSetID) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLGame/DressUpModelFrameMixin.lua#L264)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLGame/DressUpModelFrameMixin.lua#L275)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLGame/DressUpModelFrameMixin.lua#L294)
function TransmogAndMountDressupFrameMixin:OnHide() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLGame/DressUpModelFrameMixin.lua#L305)
function TransmogAndMountDressupFrameMixin:RemoveWeapons() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLGame/DressUpModelFrameMixin.lua#L314)
function TransmogAndMountDressupFrameMixin:CheckButtonOnClick() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLGame/DressUpModelFrameMixin.lua#L325)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLGame/DressUpModelFrameMixin.lua#L342)
function DressUpFrameSetSelectionLabelMixin:OnEnter() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLGame/DressUpModelFrameMixin.lua#L356)
function DressUpFrameSetSelectionLabelMixin:OnLeave() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLGame/DressUpModelFrameMixin.lua#L402)
function DressUpFrameTransmogSetMixin:OnLoad() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLGame/DressUpModelFrameMixin.lua#L428)
function DressUpFrameTransmogSetMixin:OnShow() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLGame/DressUpModelFrameMixin.lua#L439)
function DressUpFrameTransmogSetMixin:OnHide() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLGame/DressUpModelFrameMixin.lua#L455)
function DressUpFrameTransmogSetMixin:SetData(setID, setLink, setItems) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLGame/DressUpModelFrameMixin.lua#L487)
function DressUpFrameTransmogSetMixin:UpdateTransmogSlot(itemModifiedAppearanceID, invSlot, removed) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLGame/DressUpModelFrameMixin.lua#L578)
function DressUpFrameTransmogSetMixin:Init() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLGame/DressUpModelFrameMixin.lua#L606)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLGame/DressUpModelFrameMixin.lua#L656)
function DressUpFrameTransmogSetMixin:UpdateSelectedAppearance(elementData) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLGame/DressUpModelFrameMixin.lua#L710)
function DressUpFrameTransmogSetButtonMixin:InitItem(elementData) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLGame/DressUpModelFrameMixin.lua#L729)
function DressUpFrameTransmogSetButtonMixin:Refresh() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLGame/DressUpModelFrameMixin.lua#L745)
function DressUpFrameTransmogSetButtonMixin:SetSelected(selected) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLGame/DressUpModelFrameMixin.lua#L750)
function DressUpFrameTransmogSetButtonMixin:OnEnter() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SharedXMLGame/DressUpModelFrameMixin.lua#L758)
