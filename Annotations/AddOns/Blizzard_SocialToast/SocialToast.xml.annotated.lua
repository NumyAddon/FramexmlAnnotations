...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_SocialToast/SocialToast.xml#L3)
--- Template
--- Adds itself to the parent with key `animIn`
--- @class SocialToastAnimInTemplate : AnimationGroup

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_SocialToast/SocialToast.xml#L8)
--- Template
--- Adds itself to the parent with key `waitAndAnimOut`
--- @class SocialToastAnimOutTemplate : AnimationGroup, DefaultAnimOutMixin
--- @field animOut Alpha

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_SocialToast/SocialToast.xml#L17)
--- child of SocialToastGlowTemplate
--- @class SocialToastGlowTemplate_AnimIn : AnimationGroup

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_SocialToast/SocialToast.xml#L15)
--- Template
--- Adds itself to the parent with key `glow`
--- @class SocialToastGlowTemplate : Texture
--- @field animIn SocialToastGlowTemplate_AnimIn

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_SocialToast/SocialToast.xml#L29)
--- Template
--- Adds itself to the parent with key `CloseButton`
--- @class SocialToastCloseButtonTemplate : Button, SocialToastCloseButtonMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_SocialToast/SocialToast.xml#L55)
--- child of SocialToastTemplate
--- @class SocialToastTemplate_GlowFrame : Texture, SocialToastGlowTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_SocialToast/SocialToast.xml#L44)
--- Template
