...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SocialUI/Mainline/SocialUI.xml#L12)
--- child of SocialUIFrame
--- @class SocialUIFrame_BattleNetBar : Frame, SocialUIBattleNetBarTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SocialUI/Mainline/SocialUI.xml#L33)
--- child of SocialUIFrame
--- @class SocialUIFrame_BattleNetUnavailableNoticeFrame : Frame, SocialUIBattleNetUnavailableNoticeFrameTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SocialUI/Mainline/SocialUI.xml#L39)
--- child of SocialUIFrame
--- @class SocialUIFrame_BattleNetBroadcastFrame : Frame, SocialUIBattleNetBroadcastFrameTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SocialUI/Mainline/SocialUI.xml#L686)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SocialUI/Mainline/SocialUI.xml#L680)
--- child of SocialUIFrame_IgnoreListFrame (created in template ButtonFrameBaseTemplate)
--- @type ButtonFrameBaseTemplate_CloseButton
SocialUIFrameCloseButton = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SocialUI/Mainline/SocialUI.xml#L663)
--- child of SocialUIFrame_IgnoreListFrame (created in template ButtonFrameBaseTemplate)
--- @type Texture
SocialUIFrameBg = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SocialUI/Mainline/SocialUI.xml#L45)
--- child of SocialUIFrame
--- @class SocialUIFrame_IgnoreListFrame : Frame, SocialUIIgnoreListFrameTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SocialUI/Mainline/SocialUI.xml#L633)
--- child of SocialUIFrame (created in template PortraitFrameTemplate)
--- @type PortraitFrameTemplate_CloseButton
SocialUIFrameCloseButton = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SocialUI/Mainline/SocialUI.xml#L600)
--- child of SocialUIFrame (created in template PortraitFrameTexturedBaseTemplate)
--- @type Texture
SocialUIFrameBg = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SocialUI/Mainline/SocialUI.xml#L3)
