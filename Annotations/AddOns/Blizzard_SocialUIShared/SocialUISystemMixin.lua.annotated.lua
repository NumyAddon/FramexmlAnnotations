...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SocialUIShared/SocialUISystemMixin.lua#L7)
function SocialUISystemMixin:TriggerSocialUIEvent(event, ...) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SocialUIShared/SocialUISystemMixin.lua#L16)
function SocialUISystemMixin:SocialUIRequestToggleSideWindow(sideWindowType) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SocialUIShared/SocialUISystemMixin.lua#L30)
