...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SpectateFrame/SpectateFrame.xml#L39)
--- child of SpectateFrameArrowLeft
--- @class SpectateFrame_SpectateFrameArrowLeft_Text : FontString, Game16Font

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SpectateFrame/SpectateFrame.xml#L47)
--- child of SpectateFrameArrowLeft
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SpectateFrame/SpectateFrame.xml#L80)
--- child of SpectateFrameArrowRight
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SpectateFrame/SpectateFrame.xml#L20)
--- child of SpectateFrame
--- @class SpectateFrame_PlayerName : FontString, GameFontHighlightHuge

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_SpectateFrame/SpectateFrame.xml#L3)
