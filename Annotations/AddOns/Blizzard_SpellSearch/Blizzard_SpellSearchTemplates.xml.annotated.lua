...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SpellSearch/Blizzard_SpellSearchTemplates.xml#L1504)
--- child of SpellSearchBoxTemplate (created in template SearchBoxTemplate)
--- @type SearchBoxTemplate_SearchBoxTemplateClearButton
--- @field texture Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_SpellSearch/Blizzard_SpellSearchTemplates.xml#L1495)
--- child of SpellSearchBoxTemplate (created in template SearchBoxTemplate)
--- @type Texture
