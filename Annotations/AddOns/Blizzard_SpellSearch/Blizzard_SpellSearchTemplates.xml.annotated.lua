...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SpellSearch/Blizzard_SpellSearchTemplates.xml#L95)
--- child of SpellSearchPreviewContainerTemplate
--- @class SpellSearchPreviewContainerTemplate_ScrollBox : Frame, WowScrollBoxList

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SpellSearch/Blizzard_SpellSearchTemplates.xml#L110)
--- child of 
--- @class SpellSearchPreviewContainerTemplate_OverflowCount_Text : FontString, GameFontDisableSmall

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SpellSearch/Blizzard_SpellSearchTemplates.xml#L102)
--- child of SpellSearchPreviewContainerTemplate
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SpellSearch/Blizzard_SpellSearchTemplates.xml#L143)
--- child of 
--- @class SpellSearchPreviewContainerTemplate_DefaultResultButton_Text : FontString, GameFontHighlightSmall

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SpellSearch/Blizzard_SpellSearchTemplates.xml#L121)
--- child of SpellSearchPreviewContainerTemplate
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SpellSearch/Blizzard_SpellSearchTemplates.xml#L1504)
--- child of SpellSearchBoxTemplate (created in template SearchBoxTemplate)
--- @type SearchBoxTemplate_SearchBoxTemplateClearButton
--- @field texture Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SpellSearch/Blizzard_SpellSearchTemplates.xml#L1495)
--- child of SpellSearchBoxTemplate (created in template SearchBoxTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_SpellSearch/Blizzard_SpellSearchTemplates.xml#L162)
--- Template
