...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_StableUI/Blizzard_StableUI.xml#L166)
--- child of StableFrame_PetModelScene_PetModelSceneShadow (created in template ShadowOverlayTemplate)
--- @type Texture
StableFrameTopLeft = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_StableUI/Blizzard_StableUI.xml#L171)
--- child of StableFrame_PetModelScene_PetModelSceneShadow (created in template ShadowOverlayTemplate)
--- @type Texture
StableFrameTopRight = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_StableUI/Blizzard_StableUI.xml#L179)
--- child of StableFrame_PetModelScene_PetModelSceneShadow (created in template ShadowOverlayTemplate)
--- @type Texture
StableFrameBottomLeft = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_StableUI/Blizzard_StableUI.xml#L187)
--- child of StableFrame_PetModelScene_PetModelSceneShadow (created in template ShadowOverlayTemplate)
--- @type Texture
StableFrameBottomRight = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_StableUI/Blizzard_StableUI.xml#L195)
--- child of StableFrame_PetModelScene_PetModelSceneShadow (created in template ShadowOverlayTemplate)
--- @type Texture
StableFrameTop = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_StableUI/Blizzard_StableUI.xml#L201)
--- child of StableFrame_PetModelScene_PetModelSceneShadow (created in template ShadowOverlayTemplate)
--- @type Texture
StableFrameBottom = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_StableUI/Blizzard_StableUI.xml#L207)
--- child of StableFrame_PetModelScene_PetModelSceneShadow (created in template ShadowOverlayTemplate)
--- @type Texture
StableFrameLeft = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_StableUI/Blizzard_StableUI.xml#L213)
--- child of StableFrame_PetModelScene_PetModelSceneShadow (created in template ShadowOverlayTemplate)
--- @type Texture
StableFrameRight = {}
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_StableUI/Blizzard_StableUI.xml#L1243)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_StableUI/Blizzard_StableUI.xml#L1234)
--- child of StableFrame_StabledPetList_FilterBar_SearchBox (created in template SearchBoxTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_StableUI/Blizzard_StableUI.xml#L834)
--- child of StableFrame (created in template PortraitFrameTemplate)
--- @type PortraitFrameTemplate_CloseButton
StableFrameCloseButton = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_StableUI/Blizzard_StableUI.xml#L801)
