...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_StaticPopup/Classic/StaticPopup.xml#L159)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_StaticPopup/Classic/StaticPopup.xml#L185)
--- child of StaticPopupTemplateMoneyFrame (created in template SmallMoneyFrameTemplate)
--- @type SmallMoneyFrameTemplate_SmallMoneyFrameTemplateCopperButton

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_StaticPopup/Classic/StaticPopup.xml#L225)
--- child of StaticPopupTemplateMoneyFrame (created in template SmallMoneyFrameTemplate)
--- @type SmallMoneyFrameTemplate_SmallMoneyFrameTemplateSilverButton

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_StaticPopup/Classic/StaticPopup.xml#L265)
--- child of StaticPopupTemplateMoneyFrame (created in template SmallMoneyFrameTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_StaticPopup/Classic/StaticPopup.xml#L8)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_StaticPopup/Classic/StaticPopup.xml#L105)
--- child of StaticPopupTemplateMoneyInputFrame (created in template MoneyInputFrameTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_StaticPopup/Classic/StaticPopup.xml#L115)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_StaticPopup/Classic/StaticPopup.xml#L78)
--- child of StaticPopup1 (created in template StaticPopupTemplate)
--- @type Texture
