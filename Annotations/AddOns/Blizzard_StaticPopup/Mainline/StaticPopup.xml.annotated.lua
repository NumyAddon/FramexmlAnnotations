...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_StaticPopup/Mainline/StaticPopup.xml#L110)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_StaticPopup/Mainline/StaticPopup.xml#L138)
--- child of StaticPopupTemplateMoneyFrame (created in template SmallMoneyFrameTemplate)
--- @type SmallMoneyFrameTemplate_SmallMoneyFrameTemplateCopperButton

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_StaticPopup/Mainline/StaticPopup.xml#L162)
--- child of StaticPopupTemplateMoneyFrame (created in template SmallMoneyFrameTemplate)
--- @type SmallMoneyFrameTemplate_SmallMoneyFrameTemplateSilverButton

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_StaticPopup/Mainline/StaticPopup.xml#L186)
--- child of StaticPopupTemplateMoneyFrame (created in template SmallMoneyFrameTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_StaticPopup/Mainline/StaticPopup.xml#L80)
--- child of StaticPopupTemplateMoneyInputFrame (created in template MoneyInputFrameTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_StaticPopup/Mainline/StaticPopup.xml#L155)
--- child of StaticPopupTemplateMoneyInputFrame (created in template MoneyInputFrameTemplate)
