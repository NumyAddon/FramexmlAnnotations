...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_StaticPopup_Game/GameDialog.xml#L11)
--- child of StaticPopupButtonTemplate
--- @class StaticPopupButtonTemplate_PulseAnim : AnimationGroup

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_StaticPopup_Game/GameDialog.xml#L3)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_StaticPopup_Game/GameDialog.xml#L159)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_StaticPopup_Game/GameDialog.xml#L185)
--- child of StaticPopup1MoneyFrame (created in template SmallMoneyFrameTemplate)
--- @type SmallMoneyFrameTemplate_CopperButton
StaticPopup1MoneyFrameCopperButton = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_StaticPopup_Game/GameDialog.xml#L225)
--- child of StaticPopup1MoneyFrame (created in template SmallMoneyFrameTemplate)
--- @type SmallMoneyFrameTemplate_SilverButton
StaticPopup1MoneyFrameSilverButton = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_StaticPopup_Game/GameDialog.xml#L265)
--- child of StaticPopup1MoneyFrame (created in template SmallMoneyFrameTemplate)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_StaticPopup_Game/GameDialog.xml#L8)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_StaticPopup_Game/GameDialog.xml#L105)
--- child of StaticPopup1MoneyInputFrame (created in template MoneyInputFrameTemplate)
--- @type MoneyInputFrameTemplate_Silver
StaticPopup1MoneyInputFrameSilver = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_StaticPopup_Game/GameDialog.xml#L205)
--- child of StaticPopup1MoneyInputFrame (created in template MoneyInputFrameTemplate)
