...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_StoreUI/Blizzard_Shared_ProductCardMagnifierTemplates.lua#L9)
function DefaultStoreCardMagnifierMixin:OnLeave() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_StoreUI/Blizzard_Shared_ProductCardMagnifierTemplates.lua#L13)
function DefaultStoreCardMagnifierMixin:OnClick() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_StoreUI/Blizzard_Shared_ProductCardMagnifierTemplates.lua#L20)
