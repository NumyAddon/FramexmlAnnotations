...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_StoreUI/Blizzard_Shared_StoreUITemplates.lua#L13)
function StoreBulletPointMixin:OnLoad() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_StoreUI/Blizzard_Shared_StoreUITemplates.lua#L19)
function StoreBulletPointMixin:OnHyperlinkEnter() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_StoreUI/Blizzard_Shared_StoreUITemplates.lua#L27)
function StoreBulletPointMixin:OnHyperlinkLeave() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_StoreUI/Blizzard_Shared_StoreUITemplates.lua#L35)
function StoreBulletPointMixin:OnHyperlinkClick(link) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_StoreUI/Blizzard_Shared_StoreUITemplates.lua#L52)
function CategoryTreeScrollContainerMixin:OnLoad() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_StoreUI/Blizzard_Shared_StoreUITemplates.lua#L215)
function CategoryTreeScrollContainerMixin:ExpandSelectFirstChild(node, dataProvider) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_StoreUI/Blizzard_Shared_StoreUITemplates.lua#L228)
function CategoryTreeScrollContainerMixin:OnHide() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_StoreUI/Blizzard_Shared_StoreUITemplates.lua#L234)
function CategoryTreeScrollContainerMixin:OnEvent(event, ...) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_StoreUI/Blizzard_Shared_StoreUITemplates.lua#L280)
