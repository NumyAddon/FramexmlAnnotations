...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SubscriptionInterstitialUI/Blizzard_SubscriptionInterstitialUI.xml#L710)
--- child of SubscriptionInterstitialFrame (created in template DefaultPanelTemplate)
--- @type Texture
SubscriptionInterstitialFrameBg = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_SubscriptionInterstitialUI/Blizzard_SubscriptionInterstitialUI.xml#L718)
--- child of SubscriptionInterstitialFrame (created in template DefaultPanelTemplate)
