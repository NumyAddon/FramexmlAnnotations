...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Subtitles/Blizzard_Subtitles.lua#L23)
function SubtitlesFrameMixin:OnMovieCinematicPlay(frame) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_Subtitles/Blizzard_Subtitles.lua#L32)
