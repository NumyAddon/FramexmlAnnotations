...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L47)
--- child of PlayerTalentFrameTalent1 (created in template TalentButtonTemplate)
--- @type Texture
PlayerTalentFrameTalent1Slot = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L61)
--- child of PlayerTalentFrameTalent1 (created in template TalentButtonTemplate)
--- @type Texture
PlayerTalentFrameTalent1RankBorder = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L73)
--- child of PlayerTalentFrameTalent1 (created in template TalentButtonTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L114)
--- child of PlayerTalentFrameTab1 (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L7)
