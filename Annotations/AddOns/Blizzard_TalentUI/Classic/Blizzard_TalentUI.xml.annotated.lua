...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L75)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L80)
--- child of PlayerTalentFrameTalent1 (created in template PlayerTalentButtonTemplate)
--- @type PlayerTalentButtonTemplate_PlayerTalentButtonTemplateGoldBorderGlow
PlayerTalentFrameTalent1GoldBorderGlow = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L87)
--- child of PlayerTalentFrameTalent1 (created in template PlayerTalentButtonTemplate)
--- @type PlayerTalentButtonTemplate_PlayerTalentButtonTemplateRankBorderGreen
PlayerTalentFrameTalent1RankBorderGreen = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L28)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L45)
--- child of PlayerTalentFrameTalent1 (created in template TalentButtonTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L88)
--- child of PlayerTalentFrameTalent1 (created in template ItemButtonTemplate)
--- @type ItemButtonTemplate_ItemButtonTemplateCount
PlayerTalentFrameTalent1Count = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L97)
--- child of PlayerTalentFrameTalent1 (created in template ItemButtonTemplate)
--- @type ItemButtonTemplate_ItemButtonTemplateStock
PlayerTalentFrameTalent1Stock = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L108)
--- child of PlayerTalentFrameTalent1 (created in template ItemButtonTemplate)
--- @type Texture
PlayerTalentFrameTalent1SearchOverlay = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L127)
--- child of PlayerTalentFrameTalent1 (created in template ItemButtonTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L8)
