...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L4)
--- Template
--- @class PlayerTalentButtonTemplate : Button, TalentButtonTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L66)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L47)
--- child of PlayerTalentFrameTalent1 (created in template TalentButtonTemplate)
--- @type Texture
PlayerTalentFrameTalent1Slot = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L61)
--- child of PlayerTalentFrameTalent1 (created in template TalentButtonTemplate)
--- @type Texture
PlayerTalentFrameTalent1RankBorder = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L73)
--- child of PlayerTalentFrameTalent1 (created in template TalentButtonTemplate)
--- @type TalentButtonTemplate_Rank
PlayerTalentFrameTalent1Rank = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L10)
--- child of PlayerTalentFrameTalent1 (created in template ItemButtonTemplate)
--- @type Texture
PlayerTalentFrameTalent1IconTexture = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L13)
--- child of PlayerTalentFrameTalent1 (created in template ItemButtonTemplate)
--- @type ItemButtonTemplate_Count
PlayerTalentFrameTalent1Count = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L22)
--- child of PlayerTalentFrameTalent1 (created in template ItemButtonTemplate)
--- @type ItemButtonTemplate_Stock
PlayerTalentFrameTalent1Stock = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L33)
--- child of PlayerTalentFrameTalent1 (created in template ItemButtonTemplate)
--- @type Texture
PlayerTalentFrameTalent1SearchOverlay = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L52)
--- child of PlayerTalentFrameTalent1 (created in template ItemButtonTemplate)
--- @type Texture
PlayerTalentFrameTalent1SubIconTexture = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L60)
--- child of PlayerTalentFrameTalent1 (created in template ItemButtonTemplate)
--- @type Texture
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L18)
--- child of PlayerTalentFrameScrollFrameScrollBar (created in template UIPanelScrollBarTemplate)
--- @type UIPanelScrollBarTemplate_ScrollDownButton
PlayerTalentFrameScrollFrameScrollBarScrollDownButton = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L30)
--- child of PlayerTalentFrameScrollFrameScrollBar (created in template UIPanelScrollBarTemplate)
--- @type UIPanelScrollBarTemplate_ThumbTexture
PlayerTalentFrameScrollFrameScrollBarThumbTexture = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L46)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L9)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L31)
--- child of PlayerTalentFrameTab1 (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
PlayerTalentFrameTab1RightDisabled = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L40)
--- child of PlayerTalentFrameTab1 (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
PlayerTalentFrameTab1Left = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L49)
--- child of PlayerTalentFrameTab1 (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
PlayerTalentFrameTab1Middle = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L58)
--- child of PlayerTalentFrameTab1 (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
PlayerTalentFrameTab1Right = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L114)
--- child of PlayerTalentFrameTab1 (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L7)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L24)
--- child of PlayerTalentFrame
--- @class PlayerTalentFramePortrait : Texture
PlayerTalentFramePortrait = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L32)
--- child of PlayerTalentFrame
--- @class PlayerTalentFrameTopLeft : Texture
PlayerTalentFrameTopLeft = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L38)
--- child of PlayerTalentFrame
--- @class PlayerTalentFrameTopRight : Texture
PlayerTalentFrameTopRight = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L44)
--- child of PlayerTalentFrame
--- @class PlayerTalentFrameBottomLeft : Texture
PlayerTalentFrameBottomLeft = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L50)
--- child of PlayerTalentFrame
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_TalentUI/Classic/Blizzard_TalentUI.xml#L16)
