...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_TieredEntranceTraits/Blizzard_TieredEntranceTraits.xml#L4)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_TieredEntranceTraits/Blizzard_TieredEntranceTraits.xml#L25)
--- Template
--- @class TieredEntranceTraitSpellTemplate : Frame, TieredEntranceTraitSpellMixin
--- @field Icon Texture
--- @field IconMask MaskTexture

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_TieredEntranceTraits/Blizzard_TieredEntranceTraits.xml#L97)
--- child of TieredEntranceTraitsContainer
--- @class TieredEntranceTraitsContainer_List : Frame, TieredEntranceTraitsList

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_TieredEntranceTraits/Blizzard_TieredEntranceTraits.xml#L62)
--- Template
