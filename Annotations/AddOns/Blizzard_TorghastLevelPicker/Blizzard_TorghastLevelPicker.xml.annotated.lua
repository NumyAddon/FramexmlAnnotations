...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_TorghastLevelPicker/Blizzard_TorghastLevelPicker.xml#L218)
--- child of TorghastLevelPickerFrame
--- @class TorghastLevelPickerFrame_Pager : Frame, TorghastPagingContainerTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_TorghastLevelPicker/Blizzard_TorghastLevelPicker.xml#L223)
--- child of TorghastLevelPickerFrame
--- @class TorghastLevelPickerFrame_OpenPortalButton : Button, UIPanelButtonTemplate, TorghastLevelPickerOpenPortalButtonMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_TorghastLevelPicker/Blizzard_TorghastLevelPicker.xml#L234)
--- child of TorghastLevelPickerFrame
--- @class TorghastLevelPickerFrame_CloseButton : Button, UIPanelCloseButton
--- @field CloseButtonBorder Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_TorghastLevelPicker/Blizzard_TorghastLevelPicker.xml#L197)
--- child of TorghastLevelPickerFrame
--- @class TorghastLevelPickerFrame_Title : FontString, Game32Font

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_TorghastLevelPicker/Blizzard_TorghastLevelPicker.xml#L204)
--- child of TorghastLevelPickerFrame
--- @class TorghastLevelPickerFrame_SubTitle : FontString, GameFontHighlightMedium

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_TorghastLevelPicker/Blizzard_TorghastLevelPicker.xml#L209)
--- child of TorghastLevelPickerFrame
--- @class TorghastLevelPickerFrame_Description : FontString, GameFontHighlight

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_TorghastLevelPicker/Blizzard_TorghastLevelPicker.xml#L187)
