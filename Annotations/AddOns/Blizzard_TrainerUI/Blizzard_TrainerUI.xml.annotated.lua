...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_TrainerUI/Blizzard_TrainerUI.xml#L105)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_TrainerUI/Blizzard_TrainerUI.xml#L124)
--- child of ClassTrainerFrameMoneyFrame (created in template SmallMoneyFrameTemplate)
--- @type SmallMoneyFrameTemplate_SilverButton
ClassTrainerFrameMoneyFrameSilverButton = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_TrainerUI/Blizzard_TrainerUI.xml#L143)
--- child of ClassTrainerFrameMoneyFrame (created in template SmallMoneyFrameTemplate)
--- @type SmallMoneyFrameTemplate_GoldButton
ClassTrainerFrameMoneyFrameGoldButton = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_TrainerUI/Blizzard_TrainerUI.xml#L85)
--- child of ClassTrainerFrameMoneyFrame (created in template SmallMoneyFrameTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_TrainerUI/Blizzard_TrainerUI.xml#L887)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_TrainerUI/Blizzard_TrainerUI.xml#L881)
--- child of ClassTrainerFrame (created in template ButtonFrameBaseTemplate)
--- @type ButtonFrameBaseTemplate_CloseButton
ClassTrainerFrameCloseButton = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_TrainerUI/Blizzard_TrainerUI.xml#L864)
--- child of ClassTrainerFrame (created in template ButtonFrameBaseTemplate)
--- @type Texture
ClassTrainerFrameBg = {}
