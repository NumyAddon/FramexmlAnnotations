...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UIFrameManager/Blizzard_UIFrameManager.lua#L11)
function UIFrameManagerMixin:OnEvent(event, ...) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UIFrameManager/Blizzard_UIFrameManager.lua#L30)
function UIFrameManagerMixin:RegisterFrameForFrameType(frame, frameType) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UIFrameManager/Blizzard_UIFrameManager.lua#L48)
function UIFrameManager_ManagedFrameMixin:OnLoad() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UIFrameManager/Blizzard_UIFrameManager.lua#L52)
