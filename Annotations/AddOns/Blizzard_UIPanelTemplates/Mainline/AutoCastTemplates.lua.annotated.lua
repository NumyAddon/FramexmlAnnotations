...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UIPanelTemplates/Mainline/AutoCastTemplates.lua#L8)
function AutoCastOverlayMixin:OnShow() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UIPanelTemplates/Mainline/AutoCastTemplates.lua#L12)
function AutoCastOverlayMixin:OnHide() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UIPanelTemplates/Mainline/AutoCastTemplates.lua#L16)
