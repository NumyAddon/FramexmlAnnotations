...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Cata/QuestLogFrame.xml#L740)
--- child of QuestLogFrameInset (created in template InsetFrameTemplate)
--- @type Texture
QuestLogFrameInsetBg = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Cata/QuestLogFrame.xml#L781)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Cata/QuestLogFrame.xml#L762)
--- child of QuestLogFrame (created in template ButtonFrameTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Cata/QuestLogFrame.xml#L772)
--- child of QuestLogFrame (created in template ButtonFrameTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Cata/QuestLogFrame.xml#L504)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Cata/QuestLogFrame.xml#L518)
--- child of QuestLogFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type Texture
QuestLogFramePortrait = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Cata/QuestLogFrame.xml#L526)
--- child of QuestLogFrame (created in template PortraitFrameTemplateNoCloseButton)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Cata/QuestLogFrame.xml#L536)
--- child of QuestLogFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type PortraitFrameTemplateNoCloseButton_TopLeftCorner
QuestLogFrameTopLeftCorner = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Cata/QuestLogFrame.xml#L541)
--- child of QuestLogFrame (created in template PortraitFrameTemplateNoCloseButton)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Cata/QuestLogFrame.xml#L567)
--- child of QuestLogFrame (created in template PortraitFrameTemplateNoCloseButton)
--- @type PortraitFrameTemplateNoCloseButton_BotRightCorner
QuestLogFrameBotRightCorner = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Cata/QuestLogFrame.xml#L572)
--- child of QuestLogFrame (created in template PortraitFrameTemplateNoCloseButton)
