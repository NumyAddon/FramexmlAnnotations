...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UIPanels_Game/Classic/FriendshipStatusBar.lua#L10)
function NPCFriendshipStatusBarMixin:Update(factionID) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UIPanels_Game/Classic/FriendshipStatusBar.lua#L32)
