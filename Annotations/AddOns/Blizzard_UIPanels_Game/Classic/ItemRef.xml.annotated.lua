...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Classic/ItemRef.xml#L345)
--- child of ItemRefShoppingTooltip1 (created in template ShoppingTooltipTemplate)
--- @type Texture
ItemRefShoppingTooltip1Texture2 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Classic/ItemRef.xml#L350)
--- child of ItemRefShoppingTooltip1 (created in template ShoppingTooltipTemplate)
--- @type Texture
