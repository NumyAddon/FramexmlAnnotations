...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Classic/ProductChoice.xml#L802)
--- child of ProductChoiceFrame_Inset (created in template InsetFrameTemplate)
--- @type Texture
ProductChoiceFrameBg = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Classic/ProductChoice.xml#L810)
--- child of ProductChoiceFrame_Inset (created in template InsetFrameTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Classic/ProductChoice.xml#L851)
--- child of ProductChoiceFrame_Inset (created in template InsetFrameTemplate)
