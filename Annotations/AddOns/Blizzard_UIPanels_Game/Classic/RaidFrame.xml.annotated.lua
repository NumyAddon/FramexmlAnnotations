...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Classic/RaidFrame.xml#L6)
--- child of RaidInfoHeaderTemplate
--- @class RaidInfoHeaderTemplate_RaidInfoHeaderTemplateLeft : Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Classic/RaidFrame.xml#L14)
--- child of RaidInfoHeaderTemplate
