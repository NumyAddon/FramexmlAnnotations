...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L9)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L31)
--- child of SpellBookFrameTabButtonTemplate (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
SpellBookFrameTabButtonTemplateRightDisabled = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L40)
--- child of SpellBookFrameTabButtonTemplate (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
SpellBookFrameTabButtonTemplateLeft = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L49)
--- child of SpellBookFrameTabButtonTemplate (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
SpellBookFrameTabButtonTemplateMiddle = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L58)
--- child of SpellBookFrameTabButtonTemplate (created in template CharacterFrameTabButtonTemplate)
--- @type Texture
