...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L106)
--- child of SpellBookShineTemplate (created in template AutoCastShineTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L119)
--- child of SpellBookShineTemplate (created in template AutoCastShineTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L132)
--- child of SpellBookShineTemplate (created in template AutoCastShineTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L145)
--- child of SpellBookShineTemplate (created in template AutoCastShineTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L158)
--- child of SpellBookShineTemplate (created in template AutoCastShineTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L171)
--- child of SpellBookShineTemplate (created in template AutoCastShineTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L184)
--- child of SpellBookShineTemplate (created in template AutoCastShineTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L197)
--- child of SpellBookShineTemplate (created in template AutoCastShineTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L210)
--- child of SpellBookShineTemplate (created in template AutoCastShineTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L223)
--- child of SpellBookShineTemplate (created in template AutoCastShineTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L236)
--- child of SpellBookShineTemplate (created in template AutoCastShineTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L249)
--- child of SpellBookShineTemplate (created in template AutoCastShineTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L262)
--- child of SpellBookShineTemplate (created in template AutoCastShineTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L275)
--- child of SpellBookShineTemplate (created in template AutoCastShineTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L288)
--- child of SpellBookShineTemplate (created in template AutoCastShineTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L195)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L199)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L196)
--- child of SpellButton1 (created in template SpellButtonTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L99)
--- child of SpellButton1 (created in template SpellButtonTemplate)
--- @type SpellButtonTemplate_SpellButtonTemplateBackground
SpellButton1Background = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L104)
--- child of SpellButton1 (created in template SpellButtonTemplate)
--- @type SpellButtonTemplate_SpellButtonTemplateTextBackground
SpellButton1TextBackground = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L109)
--- child of SpellButton1 (created in template SpellButtonTemplate)
--- @type SpellButtonTemplate_SpellButtonTemplateTextBackground2
SpellButton1TextBackground2 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L116)
--- child of SpellButton1 (created in template SpellButtonTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L122)
--- child of SpellButton1 (created in template SpellButtonTemplate)
--- @type SpellButtonTemplate_SpellButtonTemplateSpellName
SpellButton1SpellName = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L128)
--- child of SpellButton1 (created in template SpellButtonTemplate)
--- @type SpellButtonTemplate_SpellButtonTemplateSubSpellName
SpellButton1SubSpellName = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L134)
--- child of SpellButton1 (created in template SpellButtonTemplate)
--- @type SpellButtonTemplate_SpellButtonTemplateRequiredLevelString
SpellButton1RequiredLevelString = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L141)
--- child of SpellButton1 (created in template SpellButtonTemplate)
--- @type SpellButtonTemplate_SpellButtonTemplateSeeTrainerString
SpellButton1SeeTrainerString = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L149)
--- child of SpellButton1 (created in template SpellButtonTemplate)
--- @type SpellButtonTemplate_SpellButtonTemplateSlotFrame
SpellButton1SlotFrame = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L154)
--- child of SpellButton1 (created in template SpellButtonTemplate)
--- @type SpellButtonTemplate_SpellButtonTemplateUnlearnedSlotFrame
SpellButton1UnlearnedSlotFrame = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L159)
--- child of SpellButton1 (created in template SpellButtonTemplate)
--- @type SpellButtonTemplate_SpellButtonTemplateTrainSlotFrame
SpellButton1TrainSlotFrame = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L164)
--- child of SpellButton1 (created in template SpellButtonTemplate)
--- @type Texture
SpellButton1AutoCastable = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L178)
--- child of SpellButton1 (created in template SpellButtonTemplate)
--- @type Texture
SpellButton1FlyoutArrow = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Classic/SpellBookFrame.xml#L187)
--- child of SpellButton1 (created in template SpellButtonTemplate)
