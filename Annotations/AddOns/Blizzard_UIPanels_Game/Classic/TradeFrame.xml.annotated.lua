...
--- child of RecipientTradeItemTemplateItemButton (created in template ItemButtonTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Classic/TradeFrame.xml#L85)
--- child of PlayerTradeItemTemplateItemButton (created in template ItemButtonTemplate)
--- @type Texture
