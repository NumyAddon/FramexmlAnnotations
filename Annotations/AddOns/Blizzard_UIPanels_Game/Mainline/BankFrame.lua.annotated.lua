...
BankItemButtonMixin = {};--- @class BankItemButtonMixin
...
BankFrameMixin = CreateFromMixins(BaseContainerFrameMixin);--- @class BankFrameMixin : BaseContainerFrameMixin
...
BankPanelPurchaseTabMixin = {};--- @class BankPanelPurchaseTabMixin
...
BankPanelItemDepositFrameMixin = {};--- @class BankPanelItemDepositFrameMixin
