...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/BankFrame.xml#L83)
--- child of  (created in template BankTabDepositSettingsMenuTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/BankFrame.xml#L594)
--- child of ReagentBankItemButtonGenericTemplate (created in template BankItemButtonGenericTemplate)
