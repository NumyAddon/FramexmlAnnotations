...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/CampaignOverview.xml#L6)
--- child of CampaignOverviewTemplate
--- @class CampaignOverviewTemplate_BorderFrame : Frame, QuestLogBorderFrameTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/CampaignOverview.xml#L15)
--- child of CampaignOverviewTemplate_Header
--- @class CampaignOverviewTemplate_Header_BackButton : Button, LoreButtonTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/CampaignOverview.xml#L7)
--- child of CampaignOverviewTemplate
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/CampaignOverview.xml#L22)
--- child of CampaignOverviewTemplate
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/CampaignOverview.xml#L4)
--- Template
