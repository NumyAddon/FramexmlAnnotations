...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/ItemRef.xml#L35)
--- child of ItemRefTooltip (created in template SharedTooltipArtTemplate)
--- @type SharedTooltipArtTemplate_TextLeft1
...
ItemRefTooltip["textRight1Font"] = "GameTooltipHeaderText" -- inherited
ItemRefTooltip["textLeft2Font"] = "GameTooltipText" -- inherited
ItemRefTooltip["textRight2Font"] = "GameTooltipText" -- inherited
