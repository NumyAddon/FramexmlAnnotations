...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/ItemTextFrame.xml#L686)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/ItemTextFrame.xml#L680)
--- child of ItemTextFrame (created in template ButtonFrameBaseTemplate)
--- @type ButtonFrameBaseTemplate_CloseButton
ItemTextFrameCloseButton = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/ItemTextFrame.xml#L663)
--- child of ItemTextFrame (created in template ButtonFrameBaseTemplate)
--- @type Texture
ItemTextFrameBg = {}
