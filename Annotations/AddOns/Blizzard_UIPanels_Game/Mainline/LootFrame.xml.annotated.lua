...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/LootFrame.xml#L58)
--- child of LootFrameElementTemplate
--- @class LootFrameElementTemplate_ShowAnim : AnimationGroup

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/LootFrame.xml#L61)
--- child of LootFrameElementTemplate
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/LootFrame.xml#L82)
--- child of LootFrameItemElementTemplate
--- @class LootFrameItemElementTemplate_QualityText : FontString, GameFontWhiteTiny2

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/LootFrame.xml#L87)
--- child of LootFrameItemElementTemplate
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/LootFrame.xml#L103)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/LootFrame.xml#L529)
--- child of LootFrame (created in template DefaultPanelFlatTemplate)
--- @type DefaultPanelFlatTemplate_Bg
LootFrameBg = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/LootFrame.xml#L113)
