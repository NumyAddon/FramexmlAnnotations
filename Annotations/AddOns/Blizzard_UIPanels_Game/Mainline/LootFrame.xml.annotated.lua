...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/LootFrame.xml#L3)
--- Template
--- @class LootFrameBaseElementTemplate : Frame, LootFrameBaseElementMixin

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/LootFrame.xml#L58)
--- child of LootFrameElementTemplate
--- @class LootFrameElementTemplate_ShowAnim : AnimationGroup

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/LootFrame.xml#L61)
--- child of LootFrameElementTemplate
--- @class LootFrameElementTemplate_SlideOutRightAnim : AnimationGroup, LootFrameElementSlideOutRightAnimMixin

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/LootFrame.xml#L7)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/LootFrame.xml#L85)
--- child of LootFrameItemElementTemplate
--- @class LootFrameItemElementTemplate_QualityText : FontString, GameFontWhiteTiny2

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/LootFrame.xml#L90)
--- child of LootFrameItemElementTemplate
--- @class LootFrameItemElementTemplate_Text : FontString, GameFontNormal

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/LootFrame.xml#L74)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/LootFrame.xml#L106)
--- child of LootFrameMoneyElementTemplate
--- @class LootFrameMoneyElementTemplate_Text : FontString, GameFontNormal

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/LootFrame.xml#L100)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/LootFrame.xml#L551)
--- child of LootFrame (created in template DefaultPanelFlatTemplate)
--- @type DefaultPanelFlatTemplate_Bg
LootFrameBg = {}

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/LootFrame.xml#L116)
