...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/MapLegendFrame.xml#L17)
--- child of MapLegendFrameTemplate
--- @class MapLegendFrameTemplate_BorderFrame : Frame, QuestLogBorderFrameTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/MapLegendFrame.xml#L18)
--- child of MapLegendFrameTemplate
--- @class MapLegendFrameTemplate_BackButton : Button, UIPanelButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/MapLegendFrame.xml#L45)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/MapLegendFrame.xml#L24)
--- child of MapLegendFrameTemplate
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/MapLegendFrame.xml#L64)
--- child of MapLegendCategoryTemplate
--- @class MapLegendCategoryTemplate_TitleText : FontString, Game12Font

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/MapLegendFrame.xml#L60)
--- Template
--- @class MapLegendCategoryTemplate : Frame, ResizeLayoutFrame
--- @field TitleText MapLegendCategoryTemplate_TitleText

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/MapLegendFrame.xml#L74)
--- Template
