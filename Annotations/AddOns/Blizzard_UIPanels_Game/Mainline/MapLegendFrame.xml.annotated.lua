...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/MapLegendFrame.xml#L7)
--- child of MapLegendFrameTemplate
--- @class MapLegendFrameTemplate_BorderFrame : Frame, QuestLogBorderFrameTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/MapLegendFrame.xml#L29)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/MapLegendFrame.xml#L41)
--- child of MapLegendFrameTemplate
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/MapLegendFrame.xml#L57)
--- child of MapLegendCategoryTemplate
--- @class MapLegendCategoryTemplate_TitleText : FontString, Game12Font

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/MapLegendFrame.xml#L53)
--- Template
--- @class MapLegendCategoryTemplate : Frame, ResizeLayoutFrame
--- @field TitleText MapLegendCategoryTemplate_TitleText

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/MapLegendFrame.xml#L67)
--- Template
