...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UIPanels_Game/Mainline/PaperDollFrame.xml#L224)
--- child of GearSetPopupButtonTemplate (created in template SimplePopupButtonTemplate)
