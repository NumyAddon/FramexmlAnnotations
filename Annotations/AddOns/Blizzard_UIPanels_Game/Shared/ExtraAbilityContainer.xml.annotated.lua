...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_UIPanels_Game/Shared/ExtraAbilityContainer.xml#L3)
--- @class ExtraAbilityContainer : Frame, HorizontalLayoutFrame, BottomManagedFrameTemplate, EditModeExtraAbilitiesSystemTemplate, ExtraAbilityContainerMixin
...
ExtraAbilityContainer["layoutIndex"] = 15
ExtraAbilityContainer["hideWhenActionBarIsOverriden"] = false
ExtraAbilityContainer["layoutParent"] = BottomManagedFrameContainer -- inherited
