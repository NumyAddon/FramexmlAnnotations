...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UIPanels_Game/Shared/GossipFrameShared.xml#L3)
--- Template
--- @class GossipTitleActiveQuestButtonTemplate : Button, GossipTitleButtonTemplate, GossipActiveQuestButtonMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UIPanels_Game/Shared/GossipFrameShared.xml#L8)
--- Template
--- @class GossipTitleAvailableQuestButtonTemplate : Button, GossipTitleButtonTemplate, GossipAvailableQuestButtonMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UIPanels_Game/Shared/GossipFrameShared.xml#L13)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UIPanels_Game/Shared/GossipFrameShared.xml#L31)
--- Template
