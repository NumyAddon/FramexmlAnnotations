...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/TBC/QuestLogFrame.xml#L77)
--- child of QuestLogCollapseAllButton (created in template QuestLogTitleButtonTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/TBC/QuestLogFrame.xml#L236)
--- child of QuestLogPlayerTitleFrame (created in template QuestPlayerTitleFrameTemplate)
--- @type Texture
QuestLogPlayerTitleFrameTitleFrameLeft = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/TBC/QuestLogFrame.xml#L245)
--- child of QuestLogPlayerTitleFrame (created in template QuestPlayerTitleFrameTemplate)
--- @type Texture
