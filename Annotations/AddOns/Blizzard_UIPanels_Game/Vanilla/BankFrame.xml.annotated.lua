...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Vanilla/BankFrame.xml#L85)
--- child of BankItemButtonGenericTemplate (created in template ItemButtonTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Vanilla/BankFrame.xml#L88)
--- child of BankItemButtonGenericTemplate (created in template ItemButtonTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Vanilla/BankFrame.xml#L108)
--- child of BankItemButtonGenericTemplate (created in template ItemButtonTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Vanilla/BankFrame.xml#L127)
--- child of BankItemButtonGenericTemplate (created in template ItemButtonTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Vanilla/BankFrame.xml#L135)
--- child of BankItemButtonGenericTemplate (created in template ItemButtonTemplate)
--- @type Texture
