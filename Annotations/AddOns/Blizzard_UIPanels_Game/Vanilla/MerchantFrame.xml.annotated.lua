...
--- child of MerchantItemTemplateItemButton (created in template ItemButtonTemplate)
--- @type Texture
...
--- child of MerchantItemTemplateMoneyFrame (created in template SmallMoneyFrameTemplate)
...
--- child of MerchantItemTemplateAltCurrencyFrameItem1 (created in template SmallDenominationTemplate)
--- @type Texture
...
--- child of MerchantItemTemplateAltCurrencyFrame (created in template SmallAlternateCurrencyFrameTemplate)
--- @type SmallAlternateCurrencyFrameTemplate_SmallAlternateCurrencyFrameTemplateItem1

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Vanilla/MerchantFrame.xml#L347)
--- child of MerchantItemTemplateAltCurrencyFrameItem2 (created in template SmallDenominationTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Vanilla/MerchantFrame.xml#L347)
--- child of MerchantItemTemplateAltCurrencyFrameItem3 (created in template SmallDenominationTemplate)
--- @type Texture
