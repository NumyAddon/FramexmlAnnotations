...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Vanilla/QuestLogFrame.xml#L131)
--- child of QuestLogItem1 (created in template LargeItemButtonTemplate)
--- @type Texture
QuestLogItem1IconTexture = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Vanilla/QuestLogFrame.xml#L137)
--- child of QuestLogItem1 (created in template LargeItemButtonTemplate)
--- @type Texture
QuestLogItem1NameFrame = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Vanilla/QuestLogFrame.xml#L145)
--- child of QuestLogItem1 (created in template LargeItemButtonTemplate)
--- @type LargeItemButtonTemplate_LargeItemButtonTemplateName
QuestLogItem1Name = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Vanilla/QuestLogFrame.xml#L153)
--- child of QuestLogItem1 (created in template LargeItemButtonTemplate)
