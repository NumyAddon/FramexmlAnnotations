...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Vanilla/ReputationFrame.xml#L62)
--- child of ReputationBar1 (created in template ReputationBarTemplate)
--- @type Texture
ReputationBar1ReputationBarLeft = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Vanilla/ReputationFrame.xml#L75)
--- child of ReputationBar1 (created in template ReputationBarTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Vanilla/ReputationFrame.xml#L109)
--- child of ReputationBar1 (created in template ReputationBarTemplate)
--- @type Texture
ReputationBar1Highlight1 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Vanilla/ReputationFrame.xml#L122)
--- child of ReputationBar1 (created in template ReputationBarTemplate)
--- @type Texture
ReputationBar1Highlight2 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Vanilla/ReputationFrame.xml#L131)
--- child of ReputationBar1 (created in template ReputationBarTemplate)
--- @type Texture
ReputationBar1Check = {}
