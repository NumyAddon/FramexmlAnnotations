...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/FriendsFrame.xml#L15)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/FriendsFrame.xml#L29)
--- child of FriendsFrameButtonTemplateSummonButtonShine (created in template AutoCastShineTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/FriendsFrame.xml#L43)
--- child of FriendsFrameButtonTemplateSummonButtonShine (created in template AutoCastShineTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/FriendsFrame.xml#L50)
--- child of FriendsFrameButtonTemplateSummonButtonShine (created in template AutoCastShineTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/FriendsFrame.xml#L64)
--- child of FriendsFrameButtonTemplateSummonButtonShine (created in template AutoCastShineTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/FriendsFrame.xml#L71)
--- child of FriendsFrameButtonTemplateSummonButtonShine (created in template AutoCastShineTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/FriendsFrame.xml#L78)
--- child of FriendsFrameButtonTemplateSummonButtonShine (created in template AutoCastShineTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/FriendsFrame.xml#L85)
--- child of FriendsFrameButtonTemplateSummonButtonShine (created in template AutoCastShineTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/FriendsFrame.xml#L92)
--- child of FriendsFrameButtonTemplateSummonButtonShine (created in template AutoCastShineTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/FriendsFrame.xml#L99)
--- child of FriendsFrameButtonTemplateSummonButtonShine (created in template AutoCastShineTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/FriendsFrame.xml#L106)
--- child of FriendsFrameButtonTemplateSummonButtonShine (created in template AutoCastShineTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/FriendsFrame.xml#L120)
--- child of FriendsFrameButtonTemplateSummonButtonShine (created in template AutoCastShineTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/FriendsFrame.xml#L94)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/FriendsFrame.xml#L100)
--- child of FriendsFrameButtonTemplateSummonButton (created in template ActionButtonTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/FriendsFrame.xml#L26)
--- child of FriendsFrameButtonTemplateSummonButton (created in template ActionButtonTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/FriendsFrame.xml#L32)
--- child of FriendsFrameButtonTemplateSummonButton (created in template ActionButtonTemplate)
--- @type ActionButtonTemplate_ActionButtonTemplateFlyoutBorderShadow

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/FriendsFrame.xml#L39)
--- child of FriendsFrameButtonTemplateSummonButton (created in template ActionButtonTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/FriendsFrame.xml#L53)
--- child of FriendsFrameButtonTemplateSummonButton (created in template ActionButtonTemplate)
--- @type ActionButtonTemplate_ActionButtonTemplateName

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/FriendsFrame.xml#L59)
--- child of FriendsFrameButtonTemplateSummonButton (created in template ActionButtonTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/FriendsFrame.xml#L110)
--- child of FriendsFrameButtonTemplateSummonButton (created in template ActionButtonTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/FriendsFrame.xml#L361)
--- child of WhoFrameColumnHeader1 (created in template WhoFrameColumnHeaderTemplate)
--- @type Texture
WhoFrameColumnHeader1Left = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/FriendsFrame.xml#L368)
--- child of WhoFrameColumnHeader1 (created in template WhoFrameColumnHeaderTemplate)
--- @type Texture
WhoFrameColumnHeader1Middle = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/FriendsFrame.xml#L375)
--- child of WhoFrameColumnHeader1 (created in template WhoFrameColumnHeaderTemplate)
--- @type Texture
WhoFrameColumnHeader1Right = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/FriendsFrame.xml#L398)
--- child of WhoFrameColumnHeader1 (created in template WhoFrameColumnHeaderTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/FriendsFrame.xml#L579)
--- child of GuildFrameColumnHeader1 (created in template GuildFrameColumnHeaderTemplate)
--- @type Texture
GuildFrameColumnHeader1Left = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/FriendsFrame.xml#L588)
--- child of GuildFrameColumnHeader1 (created in template GuildFrameColumnHeaderTemplate)
--- @type Texture
GuildFrameColumnHeader1Middle = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/FriendsFrame.xml#L597)
--- child of GuildFrameColumnHeader1 (created in template GuildFrameColumnHeaderTemplate)
--- @type Texture
