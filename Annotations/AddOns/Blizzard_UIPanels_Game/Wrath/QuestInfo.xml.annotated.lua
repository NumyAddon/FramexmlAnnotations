...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/QuestInfo.xml#L236)
--- child of QuestInfoPlayerTitleFrame (created in template QuestPlayerTitleFrameTemplate)
--- @type Texture
QuestInfoPlayerTitleFrameTitleFrameLeft = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era_ptr/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/QuestInfo.xml#L245)
--- child of QuestInfoPlayerTitleFrame (created in template QuestPlayerTitleFrameTemplate)
--- @type Texture
