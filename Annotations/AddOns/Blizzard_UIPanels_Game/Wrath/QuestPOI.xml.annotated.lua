...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/QuestPOI.xml#L33)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/QuestPOI.xml#L80)
--- child of QuestPOICompletedTemplate
--- Template
--- Adds itself to the parent with key `Display`
--- @class QuestPOICompletedTemplate_Display : Frame, QuestPOIDisplayLayerTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/QuestPOI.xml#L67)
--- Template
