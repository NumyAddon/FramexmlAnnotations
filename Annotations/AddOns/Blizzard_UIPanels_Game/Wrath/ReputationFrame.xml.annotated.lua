...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/ReputationFrame.xml#L146)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/ReputationFrame.xml#L62)
--- child of ReputationBar1 (created in template ReputationBarTemplate)
--- @type Texture
ReputationBar1ReputationBarLeft = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/ReputationFrame.xml#L75)
--- child of ReputationBar1 (created in template ReputationBarTemplate)
--- @type Texture
ReputationBar1ReputationBarRight = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/ReputationFrame.xml#L88)
--- child of ReputationBar1 (created in template ReputationBarTemplate)
--- @type ReputationBarTemplate_ReputationBarTemplateFactionName
ReputationBar1FactionName = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/ReputationFrame.xml#L98)
--- child of ReputationBar1 (created in template ReputationBarTemplate)
--- @type ReputationBarTemplate_ReputationBarTemplateFactionStanding
ReputationBar1FactionStanding = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/ReputationFrame.xml#L109)
--- child of ReputationBar1 (created in template ReputationBarTemplate)
--- @type Texture
ReputationBar1Highlight1 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/ReputationFrame.xml#L122)
--- child of ReputationBar1 (created in template ReputationBarTemplate)
--- @type Texture
ReputationBar1Highlight2 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/ReputationFrame.xml#L131)
--- child of ReputationBar1 (created in template ReputationBarTemplate)
--- @type Texture
ReputationBar1Check = {}
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/ReputationFrame.xml#L163)
--- child of ReputationListScrollFrame (created in template FauxScrollFrameTemplate)
--- @type Frame
ReputationListScrollFrameScrollChildFrame = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/ReputationFrame.xml#L10)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/ReputationFrame.xml#L18)
--- child of ReputationListScrollFrameScrollBar (created in template UIPanelScrollBarTemplate)
--- @type UIPanelScrollBarTemplate_UIPanelScrollBarTemplateScrollDownButton
ReputationListScrollFrameScrollBarScrollDownButton = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/ReputationFrame.xml#L30)
--- child of ReputationListScrollFrameScrollBar (created in template UIPanelScrollBarTemplate)
--- @type UIPanelScrollBarTemplate_UIPanelScrollBarTemplateThumbTexture
ReputationListScrollFrameScrollBarThumbTexture = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/ReputationFrame.xml#L46)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UIPanels_Game/Wrath/ReputationFrame.xml#L21)
