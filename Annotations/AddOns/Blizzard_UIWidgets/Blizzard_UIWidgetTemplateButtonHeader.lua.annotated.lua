...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UIWidgets/Blizzard_UIWidgetTemplateButtonHeader.lua#L40)
function UIWidgetTemplateButtonHeaderMixin:OnLoad() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UIWidgets/Blizzard_UIWidgetTemplateButtonHeader.lua#L44)
