...
UIWidgetTemplateDoubleStateIconRowMixin = CreateFromMixins(UIWidgetBaseTemplateMixin);--- @class UIWidgetTemplateDoubleStateIconRowMixin : UIWidgetBaseTemplateMixin
