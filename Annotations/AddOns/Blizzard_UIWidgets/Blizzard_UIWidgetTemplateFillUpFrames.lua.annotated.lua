...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UIWidgets/Blizzard_UIWidgetTemplateFillUpFrames.lua#L41)
function UIWidgetTemplateFillUpFramesMixin:Setup(widgetInfo, widgetContainer) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UIWidgets/Blizzard_UIWidgetTemplateFillUpFrames.lua#L139)
function UIWidgetTemplateFillUpFramesMixin:ApplyEffects(widgetInfo) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UIWidgets/Blizzard_UIWidgetTemplateFillUpFrames.lua#L180)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UIWidgets/Blizzard_UIWidgetTemplateFillUpFrames.lua#L316)
function DecorFlipbookAnimMixin:OnAnimFinished() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UIWidgets/Blizzard_UIWidgetTemplateFillUpFrames.lua#L323)
function FilledFlipbookAnimMixin:OnAnimFinished() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UIWidgets/Blizzard_UIWidgetTemplateFillUpFrames.lua#L329)
