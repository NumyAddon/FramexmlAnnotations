...
UIWidgetTemplateIconTextAndBackgroundMixin = CreateFromMixins(UIWidgetBaseTemplateMixin);--- @class UIWidgetTemplateIconTextAndBackgroundMixin : UIWidgetBaseTemplateMixin
