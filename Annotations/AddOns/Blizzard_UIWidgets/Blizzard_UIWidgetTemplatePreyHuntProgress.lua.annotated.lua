...
UIWidgetTemplatePreyHuntProgressMixin = CreateFromMixins(UIWidgetBaseTemplateMixin);--- @class UIWidgetTemplatePreyHuntProgressMixin : UIWidgetBaseTemplateMixin
