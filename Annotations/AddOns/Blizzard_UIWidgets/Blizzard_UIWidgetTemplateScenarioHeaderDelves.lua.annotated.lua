...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIWidgets/Blizzard_UIWidgetTemplateScenarioHeaderDelves.lua#L78)
function UIWidgetTemplateScenarioHeaderDelvesMixin:ApplyEffects(widgetInfo) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIWidgets/Blizzard_UIWidgetTemplateScenarioHeaderDelves.lua#L82)
function UIWidgetTemplateScenarioHeaderDelvesMixin:UpdateSpellFrameEffects(widgetInfo, spellInfo, spellFrame) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIWidgets/Blizzard_UIWidgetTemplateScenarioHeaderDelves.lua#L93)
function UIWidgetTemplateScenarioHeaderDelvesMixin:CustomDebugSetup(color) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIWidgets/Blizzard_UIWidgetTemplateScenarioHeaderDelves.lua#L111)
function UIWidgetTemplateScenarioHeaderDelvesMixin:OnLoad() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIWidgets/Blizzard_UIWidgetTemplateScenarioHeaderDelves.lua#L116)
function UIWidgetTemplateScenarioHeaderDelvesMixin:OnReset() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIWidgets/Blizzard_UIWidgetTemplateScenarioHeaderDelves.lua#L124)
function UIWidgetTemplateScenarioHeaderDelvesTierFrameMixin:OnEnter() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UIWidgets/Blizzard_UIWidgetTemplateScenarioHeaderDelves.lua#L131)
