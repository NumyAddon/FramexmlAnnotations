...
UIWidgetTemplateTextureWithAnimationMixin = CreateFromMixins(UIWidgetBaseTemplateMixin);--- @class UIWidgetTemplateTextureWithAnimationMixin : UIWidgetBaseTemplateMixin
