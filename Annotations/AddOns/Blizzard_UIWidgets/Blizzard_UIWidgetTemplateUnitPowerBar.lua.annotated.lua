...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIWidgets/Blizzard_UIWidgetTemplateUnitPowerBar.lua#L41)
function UIWidgetTemplateUnitPowerBarMixin:SetMinMaxValues(barMin, barMax) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_UIWidgets/Blizzard_UIWidgetTemplateUnitPowerBar.lua#L51)
