...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UIWidgets/Classic/Blizzard_UIWidgetTemplateBase.lua#L15)
function UIWidgetTemplateTooltipFrameMixin:SetTooltipOwner() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UIWidgets/Classic/Blizzard_UIWidgetTemplateBase.lua#L19)
function UIWidgetTemplateTooltipFrameMixin:OnEnter() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UIWidgets/Classic/Blizzard_UIWidgetTemplateBase.lua#L36)
function UIWidgetTemplateTooltipFrameMixin:OnLeave() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UIWidgets/Classic/Blizzard_UIWidgetTemplateBase.lua#L42)
function UIWidgetBaseTemplateMixin:OnLoad() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UIWidgets/Classic/Blizzard_UIWidgetTemplateBase.lua#L45)
function UIWidgetBaseTemplateMixin:Setup(widgetInfo) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UIWidgets/Classic/Blizzard_UIWidgetTemplateBase.lua#L52)
function UIWidgetBaseTemplateMixin:OnReset() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UIWidgets/Classic/Blizzard_UIWidgetTemplateBase.lua#L59)
function UIWidgetBaseResourceTemplateMixin:Setup(resourceInfo) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UIWidgets/Classic/Blizzard_UIWidgetTemplateBase.lua#L70)
function UIWidgetBaseResourceTemplateMixin:SetFontColor(color) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UIWidgets/Classic/Blizzard_UIWidgetTemplateBase.lua#L88)
function UIWidgetBaseCurrencyTemplateMixin:Setup(currencyInfo, enabledState) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UIWidgets/Classic/Blizzard_UIWidgetTemplateBase.lua#L113)
function UIWidgetBaseCurrencyTemplateMixin:SetFontColor(color) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UIWidgets/Classic/Blizzard_UIWidgetTemplateBase.lua#L120)
