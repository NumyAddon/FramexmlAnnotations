...
UIWidgetTemplateScenarioHeaderCurrenciesAndBackgroundMixin = CreateFromMixins(UIWidgetBaseTemplateMixin);--- @class UIWidgetTemplateScenarioHeaderCurrenciesAndBackgroundMixin : UIWidgetBaseTemplateMixin
