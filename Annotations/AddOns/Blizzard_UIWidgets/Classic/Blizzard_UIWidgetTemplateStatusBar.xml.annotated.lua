...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UIWidgets/Classic/Blizzard_UIWidgetTemplateStatusBar.xml#L61)
--- child of UIWidgetTemplateStatusBar
--- @class UIWidgetTemplateStatusBar_Label : FontString, GameFontHighlight

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UIWidgets/Classic/Blizzard_UIWidgetTemplateStatusBar.xml#L3)
--- Template
