...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UnitFrame/Cata/RuneFrame.xml#L8)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UnitFrame/Cata/RuneFrame.xml#L18)
--- child of Rune1 (created in template RuneButtonIndividualTemplate)
--- @type RuneButtonIndividualTemplate_RuneButtonIndividualTemplateBorder
Rune1Border = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UnitFrame/Cata/RuneFrame.xml#L38)
--- child of Rune1 (created in template RuneButtonIndividualTemplate)
--- @type RuneButtonIndividualTemplate_RuneButtonIndividualTemplateShine
Rune1Shine = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UnitFrame/Cata/RuneFrame.xml#L56)
--- child of Rune1 (created in template RuneButtonIndividualTemplate)
--- @type Texture
Rune1Rune = {}
