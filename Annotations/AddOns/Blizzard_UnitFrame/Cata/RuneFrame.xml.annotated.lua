...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_UnitFrame/Cata/RuneFrame.xml#L36)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_UnitFrame/Cata/RuneFrame.xml#L50)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_UnitFrame/Cata/RuneFrame.xml#L65)
--- child of 
--- @class RuneWhiteGlow : Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_UnitFrame/Cata/RuneFrame.xml#L73)
--- child of 
--- @class RuneColorGlow : Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_UnitFrame/Cata/RuneFrame.xml#L62)
--- child of RuneButtonIndividualTemplate
--- @class  : Frame

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_UnitFrame/Cata/RuneFrame.xml#L85)
--- child of RuneButtonIndividualTemplate
