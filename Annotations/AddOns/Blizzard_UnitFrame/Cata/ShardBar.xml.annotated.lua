...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_UnitFrame/Cata/ShardBar.xml#L41)
--- child of ShardTemplate
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_UnitFrame/Cata/ShardBar.xml#L136)
--- child of ShardBarFrame
--- @class ShardBarFrame_ShardBarFrameShard1 : Frame, ShardTemplate
ShardBarFrameShard1 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_UnitFrame/Cata/ShardBar.xml#L141)
--- child of ShardBarFrame
--- @class ShardBarFrame_ShardBarFrameShard2 : Frame, ShardTemplate
ShardBarFrameShard2 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_UnitFrame/Cata/ShardBar.xml#L146)
--- child of ShardBarFrame
--- @class ShardBarFrame_ShardBarFrameShard3 : Frame, ShardTemplate
ShardBarFrameShard3 = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_UnitFrame/Cata/ShardBar.xml#L116)
--- child of ShardBarFrame
--- @class ShardBarFrame_showAnim : AnimationGroup

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_UnitFrame/Cata/ShardBar.xml#L114)
