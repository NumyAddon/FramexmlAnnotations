...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UnitFrame/Cata/TargetFrame.xml#L28)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UnitFrame/Cata/TargetFrame.xml#L14)
--- child of TargetofTargetFrameTemplateDebuff1 (created in template TargetofTargetDebuffFrameTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UnitFrame/Cata/TargetFrame.xml#L17)
--- child of TargetofTargetFrameTemplateDebuff1 (created in template TargetofTargetDebuffFrameTemplate)
--- @type Texture
