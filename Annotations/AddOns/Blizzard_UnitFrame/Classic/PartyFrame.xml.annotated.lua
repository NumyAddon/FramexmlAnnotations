...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UnitFrame/Classic/PartyFrame.xml#L10)
--- child of UnitPowerBarAltTemplate (created in template UnitPowerBarAltTexturableTemplate)
--- @type Texture
UnitPowerBarAltTemplateFill = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UnitFrame/Classic/PartyFrame.xml#L16)
--- child of UnitPowerBarAltTemplate (created in template UnitPowerBarAltTexturableTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UnitFrame/Classic/PartyFrame.xml#L291)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UnitFrame/Classic/PartyFrame.xml#L292)
--- child of PartyMemberFrameTemplateHealthBar
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UnitFrame/Classic/PartyFrame.xml#L285)
--- child of PartyMemberFrame1 (created in template PartyMemberFrameTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UnitFrame/Classic/PartyFrame.xml#L314)
--- child of PartyMemberFrame1 (created in template PartyMemberFrameTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UnitFrame/Classic/PartyFrame.xml#L333)
--- child of PartyMemberFrame1 (created in template PartyMemberFrameTemplate)
--- @type PartyMemberFrameTemplate_PartyMemberFrameTemplateReadyCheck
PartyMemberFrame1ReadyCheck = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UnitFrame/Classic/PartyFrame.xml#L343)
--- child of PartyMemberFrame1 (created in template PartyMemberFrameTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UnitFrame/Classic/PartyFrame.xml#L365)
--- child of PartyMemberFrame1 (created in template PartyMemberFrameTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UnitFrame/Classic/PartyFrame.xml#L370)
--- child of PartyMemberFrame1 (created in template PartyMemberFrameTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UnitFrame/Classic/PartyFrame.xml#L375)
--- child of PartyMemberFrame1 (created in template PartyMemberFrameTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UnitFrame/Classic/PartyFrame.xml#L380)
--- child of PartyMemberFrame1 (created in template PartyMemberFrameTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UnitFrame/Classic/PartyFrame.xml#L385)
--- child of PartyMemberFrame1 (created in template PartyMemberFrameTemplate)
