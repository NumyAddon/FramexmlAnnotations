...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UnitFrame/Classic/TotemFrame.xml#L22)
--- child of TotemButtonTemplate
--- @class TotemButtonTemplate_Icon : Frame
--- @field Texture Texture

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UnitFrame/Classic/TotemFrame.xml#L33)
--- child of TotemButtonTemplate
--- @class TotemButtonTemplate_Border : Frame

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UnitFrame/Classic/TotemFrame.xml#L14)
--- child of TotemButtonTemplate
--- @class TotemButtonTemplate_Duration : FontString, GameFontNormalSmall

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UnitFrame/Classic/TotemFrame.xml#L3)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UnitFrame/Classic/TotemFrame.xml#L52)
