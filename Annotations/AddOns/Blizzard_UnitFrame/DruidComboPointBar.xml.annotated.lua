...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/DruidComboPointBar.xml#L64)
--- child of DruidComboPointTemplate
--- @class DruidComboPointTemplate_activateAnim : AnimationGroup

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/DruidComboPointBar.xml#L78)
--- child of DruidComboPointTemplate
