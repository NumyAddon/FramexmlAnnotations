...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/Mainline/AlternatePowerBarBase.xml#L17)
--- child of AlternatePowerBarBaseTemplate
--- @class AlternatePowerBarBaseTemplate_Text : FontString, TextStatusBarText

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/Mainline/AlternatePowerBarBase.xml#L22)
--- child of AlternatePowerBarBaseTemplate
--- @class AlternatePowerBarBaseTemplate_LeftText : FontString, TextStatusBarText

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/Mainline/AlternatePowerBarBase.xml#L27)
--- child of AlternatePowerBarBaseTemplate
--- @class AlternatePowerBarBaseTemplate_RightText : FontString, TextStatusBarText

--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/Mainline/AlternatePowerBarBase.xml#L5)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/Mainline/AlternatePowerBarBase.xml#L57)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/Mainline/AlternatePowerBarBase.xml#L47)
--- Template
