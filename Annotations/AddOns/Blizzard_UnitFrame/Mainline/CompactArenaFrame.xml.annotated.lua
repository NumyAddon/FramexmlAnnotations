...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UnitFrame/Mainline/CompactArenaFrame.xml#L15)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UnitFrame/Mainline/CompactArenaFrame.xml#L20)
--- child of CompactArenaFrameTemplate (created in template CompactPartyFrameTemplate)
--- @type CompactPartyFrameTemplate_CompactPartyFrameTemplatePet2

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UnitFrame/Mainline/CompactArenaFrame.xml#L25)
--- child of CompactArenaFrameTemplate (created in template CompactPartyFrameTemplate)
--- @type CompactPartyFrameTemplate_CompactPartyFrameTemplatePet3

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UnitFrame/Mainline/CompactArenaFrame.xml#L30)
--- child of CompactArenaFrameTemplate (created in template CompactPartyFrameTemplate)
--- @type CompactPartyFrameTemplate_CompactPartyFrameTemplatePet4

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UnitFrame/Mainline/CompactArenaFrame.xml#L35)
--- child of CompactArenaFrameTemplate (created in template CompactPartyFrameTemplate)
