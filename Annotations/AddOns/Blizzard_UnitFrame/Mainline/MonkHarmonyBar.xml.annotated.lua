...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/Mainline/MonkHarmonyBar.xml#L70)
--- child of MonkLightEnergyTemplate
--- @class MonkLightEnergyTemplate_activate : AnimationGroup

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/Mainline/MonkHarmonyBar.xml#L89)
--- child of MonkLightEnergyTemplate
--- @class MonkLightEnergyTemplate_deactivate : AnimationGroup

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/Mainline/MonkHarmonyBar.xml#L4)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/Mainline/MonkHarmonyBar.xml#L104)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/Mainline/MonkHarmonyBar.xml#L120)
...
MonkHarmonyBarFrame["powerType"] = Enum.PowerType.Chi -- inherited
MonkHarmonyBarFrame["resourcePointTemplate"] = "MonkLightEnergyTemplate" -- inherited
MonkHarmonyBarFrame["resourcePointSetupFunc"] = MonkLightEnergyMixin.Setup -- inherited
MonkHarmonyBarFrame["resourcePointReleaseFunc"] = MonkLightEnergyMixin.OnRelease -- inherited
