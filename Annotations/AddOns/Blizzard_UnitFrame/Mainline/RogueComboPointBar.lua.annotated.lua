...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UnitFrame/Mainline/RogueComboPointBar.lua#L19)
function RogueComboPointBarMixin:UpdateChargedPowerPoints() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UnitFrame/Mainline/RogueComboPointBar.lua#L23)
function RogueComboPointBarMixin:UpdateMaxPower() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UnitFrame/Mainline/RogueComboPointBar.lua#L38)
function RogueComboPointMixin:Setup() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UnitFrame/Mainline/RogueComboPointBar.lua#L50)
function RogueComboPointMixin:Update(isFull, isCharged) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UnitFrame/Mainline/RogueComboPointBar.lua#L68)
