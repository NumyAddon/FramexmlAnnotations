...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_UnitFrame/Mainline/ShardBar.xml#L98)
--- child of ShardTemplate_FillIncrement
--- @class ShardTemplate_FillIncrement_FillAnim : AnimationGroup

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_UnitFrame/Mainline/ShardBar.xml#L80)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_UnitFrame/Mainline/ShardBar.xml#L106)
--- child of ShardTemplate
--- @class ShardTemplate_emptyToFullAnim : AnimationGroup

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_UnitFrame/Mainline/ShardBar.xml#L119)
--- child of ShardTemplate
--- @class ShardTemplate_fillDoneAnim : AnimationGroup

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_UnitFrame/Mainline/ShardBar.xml#L131)
--- child of ShardTemplate
--- @class ShardTemplate_readyLoopAnim : AnimationGroup

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_UnitFrame/Mainline/ShardBar.xml#L135)
--- child of ShardTemplate
--- @class ShardTemplate_depleteAnimA : AnimationGroup

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_UnitFrame/Mainline/ShardBar.xml#L139)
--- child of ShardTemplate
--- @class ShardTemplate_depleteAnimB : AnimationGroup

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_UnitFrame/Mainline/ShardBar.xml#L143)
--- child of ShardTemplate
--- @class ShardTemplate_depleteAnimC : AnimationGroup

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_UnitFrame/Mainline/ShardBar.xml#L5)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_UnitFrame/Mainline/ShardBar.xml#L150)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_UnitFrame/Mainline/ShardBar.xml#L167)
...
WarlockPowerFrame["layoutParent"] = PlayerBottomManagedFrameContainer -- inherited
