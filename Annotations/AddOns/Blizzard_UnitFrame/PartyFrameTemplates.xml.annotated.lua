...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/PartyFrameTemplates.xml#L38)
--- child of PartyPetDebuffFrameTemplate (created in template PartyDebuffFrameTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/PartyFrameTemplates.xml#L96)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/PartyFrameTemplates.xml#L101)
--- child of CounterBar (created in template UnitPowerBarAltCounterTemplate)
--- @type UnitPowerBarAltCounterTemplate_UnitPowerBarAltCounterTemplateDigit2

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/PartyFrameTemplates.xml#L106)
--- child of CounterBar (created in template UnitPowerBarAltCounterTemplate)
--- @type UnitPowerBarAltCounterTemplate_UnitPowerBarAltCounterTemplateDigit3

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/PartyFrameTemplates.xml#L111)
--- child of CounterBar (created in template UnitPowerBarAltCounterTemplate)
--- @type UnitPowerBarAltCounterTemplate_UnitPowerBarAltCounterTemplateDigit4

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/PartyFrameTemplates.xml#L116)
--- child of CounterBar (created in template UnitPowerBarAltCounterTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/PartyFrameTemplates.xml#L126)
--- child of CounterBar (created in template UnitPowerBarAltCounterTemplate)
--- @type UnitPowerBarAltCounterTemplate_UnitPowerBarAltCounterTemplateDigit7

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/PartyFrameTemplates.xml#L150)
--- child of  (created in template UnitPowerBarAltTemplate)
--- @type UnitPowerBarAltTemplate_UnitPowerBarAltTemplateCounterBar

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/PartyFrameTemplates.xml#L162)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/PartyFrameTemplates.xml#L155)
--- child of  (created in template UnitPowerBarAltTemplate)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/PartyFrameTemplates.xml#L122)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/PartyFrameTemplates.xml#L134)
--- child of  (created in template PartyMemberPetFrameTemplate)
--- @type PartyMemberPetFrameTemplate_PartyMemberPetFrameTemplateDebuff1

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/PartyFrameTemplates.xml#L139)
--- child of  (created in template PartyMemberPetFrameTemplate)
--- @type PartyMemberPetFrameTemplate_PartyMemberPetFrameTemplateDebuff2

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/PartyFrameTemplates.xml#L144)
--- child of  (created in template PartyMemberPetFrameTemplate)
--- @type PartyMemberPetFrameTemplate_PartyMemberPetFrameTemplateDebuff3

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/PartyFrameTemplates.xml#L149)
--- child of  (created in template PartyMemberPetFrameTemplate)
--- @type PartyMemberPetFrameTemplate_PartyMemberPetFrameTemplateDebuff4

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/PartyFrameTemplates.xml#L86)
--- child of  (created in template PartyMemberPetFrameTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_UnitFrame/PartyFrameTemplates.xml#L92)
--- child of  (created in template PartyMemberPetFrameTemplate)
--- @type Texture
