...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_UnitFrame/RuneFrame.xml#L17)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_UnitFrame/RuneFrame.xml#L27)
--- child of  (created in template RuneButtonIndividualTemplate)
--- @type RuneButtonIndividualTemplate_RuneButtonIndividualTemplateBorder

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_UnitFrame/RuneFrame.xml#L47)
--- child of  (created in template RuneButtonIndividualTemplate)
--- @type RuneButtonIndividualTemplate_RuneButtonIndividualTemplateShine

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/ptr2/Interface/AddOns/Blizzard_UnitFrame/RuneFrame.xml#L85)
--- child of  (created in template RuneButtonIndividualTemplate)
--- @type Texture
