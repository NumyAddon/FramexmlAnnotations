...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_UnitFrame/Shared/CompactRaidGroup.xml#L4)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_UnitFrame/Shared/CompactRaidGroup.xml#L23)
--- Explicitly protected
--- child of CompactRaidGroupTemplate
--- @class CompactRaidGroupTemplate_Member2 : Button, CompactRaidGroupUnitFrameTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_UnitFrame/Shared/CompactRaidGroup.xml#L30)
--- Explicitly protected
--- child of CompactRaidGroupTemplate
--- @class CompactRaidGroupTemplate_Member3 : Button, CompactRaidGroupUnitFrameTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_UnitFrame/Shared/CompactRaidGroup.xml#L37)
--- Explicitly protected
--- child of CompactRaidGroupTemplate
--- @class CompactRaidGroupTemplate_Member4 : Button, CompactRaidGroupUnitFrameTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/classic_anniversary/Interface/AddOns/Blizzard_UnitFrame/Shared/CompactRaidGroup.xml#L44)
--- Explicitly protected
--- child of CompactRaidGroupTemplate
