...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UnitFrame/Shared/CompactUnitFrame.xml#L126)
--- child of CompactUnitFrameTemplate
--- @class CompactUnitFrameTemplate_TempMaxHealthLoss : StatusBar, TempMaxHealthLossMixin

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UnitFrame/Shared/CompactUnitFrame.xml#L133)
--- child of CompactUnitFrameTemplate
--- @class CompactUnitFrameTemplate_PowerBar : StatusBar
--- @field background Texture

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UnitFrame/Shared/CompactUnitFrame.xml#L142)
--- child of CompactUnitFrameTemplate
--- @class CompactUnitFrameTemplate_DispelOverlay : Frame, CompactUnitFrameDispelOverlayTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UnitFrame/Shared/CompactUnitFrame.xml#L148)
--- child of CompactUnitFrameTemplate
--- @class CompactUnitFrameTemplate_Buff1 : Button, CompactBuffTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UnitFrame/Shared/CompactUnitFrame.xml#L149)
--- child of CompactUnitFrameTemplate
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UnitFrame/Shared/CompactUnitFrame.xml#L170)
--- child of CompactUnitFrameTemplate
--- @class CompactUnitFrameTemplate_DispelDebuff1 : Button, CompactDispelDebuffTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UnitFrame/Shared/CompactUnitFrame.xml#L171)
--- child of CompactUnitFrameTemplate
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UnitFrame/Shared/CompactUnitFrame.xml#L187)
--- child of CompactUnitFrameTemplate
--- @class CompactUnitFrameTemplate_CenterDefensiveBuff : Button, CompactBuffBaseTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/ptr/Interface/AddOns/Blizzard_UnitFrame/Shared/CompactUnitFrame.xml#L192)
--- child of CompactUnitFrameTemplate
