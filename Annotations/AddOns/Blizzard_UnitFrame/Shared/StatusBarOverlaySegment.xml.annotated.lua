...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_UnitFrame/Shared/StatusBarOverlaySegment.xml#L3)
--- Template
--- @class StatusBarOverlaySegmentTemplate : Frame, StatusBarOverlaySegmentMixin
--- @field Fill Texture
--- @field FillMask MaskTexture

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_UnitFrame/Shared/StatusBarOverlaySegment.xml#L40)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_UnitFrame/Shared/StatusBarOverlaySegment.xml#L60)
--- Template
