...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UnitFrame/Shared/TargetFrameAuraButton.lua#L7)
function TargetFrameAuraButtonSharedMixin:GetCount() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UnitFrame/Shared/TargetFrameAuraButton.lua#L11)
function TargetFrameAuraButtonSharedMixin:GetCooldown() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UnitFrame/Shared/TargetFrameAuraButton.lua#L15)
function TargetFrameAuraButtonSharedMixin:ShouldShowAuraCount() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UnitFrame/Shared/TargetFrameAuraButton.lua#L19)
function TargetFrameAuraButtonSharedMixin:SetShowAuraCount(showAuraCount) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UnitFrame/Shared/TargetFrameAuraButton.lua#L31)
function TargetFrameAuraButtonPrivateMixin:OnClick(mouseButtonName, isDownClick) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UnitFrame/Shared/TargetFrameAuraButton.lua#L56)
function TargetFrameAuraButtonPrivateMixin:ApplyAuraBorder(_unitToken, _auraData) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UnitFrame/Shared/TargetFrameAuraButton.lua#L60)
function TargetFrameAuraButtonPrivateMixin:ApplyAuraCooldown(_unitToken, auraData) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UnitFrame/Shared/TargetFrameAuraButton.lua#L70)
function TargetFrameAuraButtonPrivateMixin:ApplyAuraCount(_unitToken, auraData) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UnitFrame/Shared/TargetFrameAuraButton.lua#L79)
function TargetFrameAuraButtonPrivateMixin:ApplyAuraIcon(_unitToken, auraData) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UnitFrame/Shared/TargetFrameAuraButton.lua#L83)
function TargetFrameAuraButtonPrivateMixin:ApplyAuraInstance(unitToken, auraData) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UnitFrame/Shared/TargetFrameAuraButton.lua#L92)
function TargetFrameBuffButtonSharedMixin:GetStealableBorder() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UnitFrame/Shared/TargetFrameAuraButton.lua#L96)
function TargetFrameBuffButtonSharedMixin:IsStealableBorderEnabled() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UnitFrame/Shared/TargetFrameAuraButton.lua#L100)
function TargetFrameBuffButtonSharedMixin:SetStealableBorderEnabled(enabled) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UnitFrame/Shared/TargetFrameAuraButton.lua#L125)
