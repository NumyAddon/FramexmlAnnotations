...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UnitFrame/Shared/TargetFrameAuraButton.xml#L23)
--- child of TargetFrameAuraButtonTemplate
--- @class TargetFrameAuraButtonTemplate_Cooldown : Cooldown, CooldownFrameTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UnitFrame/Shared/TargetFrameAuraButton.xml#L15)
--- child of TargetFrameAuraButtonTemplate
--- @class TargetFrameAuraButtonTemplate_Count : FontString, NumberFontNormalSmall

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UnitFrame/Shared/TargetFrameAuraButton.xml#L5)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UnitFrame/Shared/TargetFrameAuraButton.xml#L34)
--- Template
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UnitFrame/Shared/TargetFrameAuraButton.xml#L51)
--- Template
