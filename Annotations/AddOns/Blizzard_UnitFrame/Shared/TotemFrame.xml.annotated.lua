...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UnitFrame/Shared/TotemFrame.xml#L41)
--- child of TotemButtonTemplateIcon
--- @class TotemButtonTemplate_Icon_Cooldown : Cooldown, CooldownFrameTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UnitFrame/Shared/TotemFrame.xml#L28)
--- child of TotemButtonTemplate
--- @class TotemButtonTemplate_Icon : Frame
--- @field cooldown TotemButtonTemplate_Icon_Cooldown
--- @field texture Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UnitFrame/Shared/TotemFrame.xml#L18)
--- child of TotemButtonTemplate
--- @class TotemButtonTemplate_Duration : FontString, GameFontNormalSmall

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UnitFrame/Shared/TotemFrame.xml#L3)
--- Template
...
--- @type TotemButtonTemplate_Icon
TotemFrameTotem1Icon = {}
TotemFrameTotem1Icon["cooldown"] = TotemButtonTemplateIconCooldown

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UnitFrame/Shared/TotemFrame.xml#L9)
--- child of TotemFrameTotem1 (created in template TotemButtonTemplate)
--- @type Texture
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UnitFrame/Shared/TotemFrame.xml#L18)
--- child of TotemFrameTotem1 (created in template TotemButtonTemplate)
--- @type TotemButtonTemplate_Duration
TotemFrameTotem1Duration = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UnitFrame/Shared/TotemFrame.xml#L82)
--- child of TotemFrame
--- @class TotemFrameTotem1 : Button, TotemButtonTemplate
TotemFrameTotem1 = {}
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UnitFrame/Shared/TotemFrame.xml#L91)
--- child of TotemFrame
--- @class TotemFrameTotem2 : Button, TotemButtonTemplate
TotemFrameTotem2 = {}
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UnitFrame/Shared/TotemFrame.xml#L100)
--- child of TotemFrame
--- @class TotemFrameTotem3 : Button, TotemButtonTemplate
TotemFrameTotem3 = {}
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UnitFrame/Shared/TotemFrame.xml#L109)
--- child of TotemFrame
--- @class TotemFrameTotem4 : Button, TotemButtonTemplate
TotemFrameTotem4 = {}
TotemFrameTotem4["icon"] = TotemFrameTotem4Icon -- inherited
TotemFrameTotem4["duration"] = TotemFrameTotem4Duration -- inherited

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UnitFrame/Shared/TotemFrame.xml#L70)
