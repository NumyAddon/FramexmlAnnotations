...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UnitFrame/StatusBarOverlaySegment.lua#L18)
function StatusBarOverlaySegmentMixin:Initialize() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UnitFrame/StatusBarOverlaySegment.lua#L45)
function StatusBarOverlaySegmentMixin:SetStatusBar(statusBar) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UnitFrame/StatusBarOverlaySegment.lua#L50)
function StatusBarOverlaySegmentMixin:SetFillColor(color) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UnitFrame/StatusBarOverlaySegment.lua#L58)
