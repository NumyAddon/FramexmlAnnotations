...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UnitFrame/StatusBarOverlaySegment.xml#L3)
--- Template
--- @class StatusBarOverlaySegmentTemplate : Frame, StatusBarOverlaySegmentMixin
--- @field Fill Texture
--- @field FillMask MaskTexture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UnitFrame/StatusBarOverlaySegment.xml#L40)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_beta/Interface/AddOns/Blizzard_UnitFrame/StatusBarOverlaySegment.xml#L60)
--- Template
