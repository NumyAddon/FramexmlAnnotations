...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UnitFrame/TargetFrame.xml#L14)
--- child of TargetofTargetFrameTemplateDebuff1 (created in template TargetofTargetDebuffFrameTemplate)
--- @type Texture

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_UnitFrame/TargetFrame.xml#L17)
--- child of TargetofTargetFrameTemplateDebuff1 (created in template TargetofTargetDebuffFrameTemplate)
--- @type Texture
