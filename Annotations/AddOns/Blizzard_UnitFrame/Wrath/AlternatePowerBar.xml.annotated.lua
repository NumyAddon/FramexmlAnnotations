...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UnitFrame/Wrath/AlternatePowerBar.xml#L9)
--- child of PlayerFrameAlternateManaBar (created in template AlternatePowerBarTemplate)
--- @type Texture
PlayerFrameAlternateManaBarBackground = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_UnitFrame/Wrath/AlternatePowerBar.xml#L24)
--- child of PlayerFrameAlternateManaBar (created in template AlternatePowerBarTemplate)
--- @type Texture
