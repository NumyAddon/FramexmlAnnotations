...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UnitPopup/UnitPopupCustomControls.xml#L3)
--- Template
--- @class UnitPopupVoiceToggleButtonTemplate : Button, VoiceToggleButtonTemplate, UnitPopupVoiceToggleButtonMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UnitPopup/UnitPopupCustomControls.xml#L29)
--- Template
--- @class UnitPopupVoiceSliderTemplate : Slider, UnitPopupSliderTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UnitPopup/UnitPopupCustomControls.xml#L40)
--- Template
--- @class UnitPopupVoiceTextTemplate : Frame, PropertyFontStringTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_UnitPopup/UnitPopupCustomControls.xml#L48)
--- Template
