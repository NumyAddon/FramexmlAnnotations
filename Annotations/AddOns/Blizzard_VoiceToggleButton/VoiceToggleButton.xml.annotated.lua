...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_VoiceToggleButton/VoiceToggleButton.xml#L3)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_VoiceToggleButton/VoiceToggleButton.xml#L25)
--- Template
--- @class ToggleVoiceDeafenButtonTemplate : Button, VoiceToggleButtonTemplate, VoiceToggleDeafenMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_VoiceToggleButton/VoiceToggleButton.xml#L26)
--- Template
--- @class ToggleVoiceMuteButtonTemplate : Button, VoiceToggleButtonTemplate, VoiceToggleMuteMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_VoiceToggleButton/VoiceToggleButton.xml#L28)
--- Template
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_VoiceToggleButton/VoiceToggleButton.xml#L50)
--- Template
--- @class RosterSelfDeafenButtonTemplate : Button, RosterVoiceToggleButtonTemplate, RosterSelfDeafenButtonMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_VoiceToggleButton/VoiceToggleButton.xml#L51)
--- Template
--- @class RosterSelfMuteButtonTemplate : Button, RosterVoiceToggleButtonTemplate, RosterSelfMuteButtonMixin

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/beta/Interface/AddOns/Blizzard_VoiceToggleButton/VoiceToggleButton.xml#L52)
--- Template
