...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_WorldMap/Blizzard_WorldMap.xml#L284)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_WorldMap/Blizzard_WorldMap.xml#L226)
--- child of WorldMapTitleDropDown (created in template UIDropDownMenuTemplate)
--- @type Texture
WorldMapTitleDropDownLeft = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_WorldMap/Blizzard_WorldMap.xml#L239)
--- child of WorldMapTitleDropDown (created in template UIDropDownMenuTemplate)
--- @type Texture
WorldMapTitleDropDownMiddle = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_WorldMap/Blizzard_WorldMap.xml#L248)
--- child of WorldMapTitleDropDown (created in template UIDropDownMenuTemplate)
--- @type Texture
WorldMapTitleDropDownRight = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_WorldMap/Blizzard_WorldMap.xml#L257)
--- child of WorldMapTitleDropDown (created in template UIDropDownMenuTemplate)
--- @type UIDropDownMenuTemplate_UIDropDownMenuTemplateText
WorldMapTitleDropDownText = {}

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_era/Interface/AddOns/Blizzard_WorldMap/Blizzard_WorldMap.xml#L271)
--- child of WorldMapTitleDropDown (created in template UIDropDownMenuTemplate)
--- @type Texture
