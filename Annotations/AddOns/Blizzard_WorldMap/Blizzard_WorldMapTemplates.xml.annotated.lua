...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_WorldMap/Blizzard_WorldMapTemplates.xml#L210)
--- child of WorldMapCoordsPanelTemplate
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_WorldMap/Blizzard_WorldMapTemplates.xml#L231)
...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_WorldMap/Blizzard_WorldMapTemplates.xml#L296)
--- child of WorldMapZoneTimerTemplate
--- @class WorldMapZoneTimerTemplate_TimeLabel : FontString, SystemFont_OutlineThick_Huge2

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_WorldMap/Blizzard_WorldMapTemplates.xml#L292)
--- Template
--- @class WorldMapZoneTimerTemplate : Frame, WorldMapZoneTimerMixin
--- @field TimeLabel WorldMapZoneTimerTemplate_TimeLabel

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_WorldMap/Blizzard_WorldMapTemplates.xml#L321)
--- child of WorldMapThreatFrameTemplate
--- @class WorldMapThreatFrameTemplate_Eye : Frame, WorldMapThreatEyeMixin
--- @field Eye Texture
--- @field Highlight Texture

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_WorldMap/Blizzard_WorldMapTemplates.xml#L351)
--- child of WorldMapThreatFrameTemplate
--- @class WorldMapThreatFrameTemplate_ModelSceneBottom : ModelScene, NonInteractableModelSceneMixinTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_WorldMap/Blizzard_WorldMapTemplates.xml#L357)
--- child of WorldMapThreatFrameTemplate
--- @class WorldMapThreatFrameTemplate_ModelSceneTop : ModelScene, NonInteractableModelSceneMixinTemplate

--- [Source](https://github.com/Gethe/wow-ui-source/blob/live/Interface/AddOns/Blizzard_WorldMap/Blizzard_WorldMapTemplates.xml#L308)
--- Template
