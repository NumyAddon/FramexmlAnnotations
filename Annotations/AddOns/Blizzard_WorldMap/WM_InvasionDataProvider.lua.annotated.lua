...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_WorldMap/WM_InvasionDataProvider.lua#L7)
function WorldMap_InvasionDataProviderMixin:HideOverlay() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_WorldMap/WM_InvasionDataProvider.lua#L11)
function WorldMap_InvasionDataProviderMixin:RemoveAllData() end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_WorldMap/WM_InvasionDataProvider.lua#L15)
function WorldMap_InvasionDataProviderMixin:RefreshAllData(fromOnShow) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_WorldMap/WM_InvasionDataProvider.lua#L27)
function WorldMap_InvasionDataProviderMixin:OnAdded(owningMap) end

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic/Interface/AddOns/Blizzard_WorldMap/WM_InvasionDataProvider.lua#L36)
