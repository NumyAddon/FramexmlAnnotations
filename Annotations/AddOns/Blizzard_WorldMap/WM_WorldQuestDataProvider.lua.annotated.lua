...
--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_WorldMap/WM_WorldQuestDataProvider.lua#L7)
function WorldMap_WorldQuestDataProviderMixin:ShouldShowQuest(info) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_WorldMap/WM_WorldQuestDataProvider.lua#L15)
function WorldMap_WorldQuestDataProviderMixin:OnAdded(canvas) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_WorldMap/WM_WorldQuestDataProvider.lua#L25)
function WorldMap_WorldQuestDataProviderMixin:RefreshAllData(fromOnShow) end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_WorldMap/WM_WorldQuestDataProvider.lua#L35)
function WorldMap_WorldQuestDataProviderMixin:OnCanvasSizeChanged() end

--- [Source](https://github.com/Gethe/wow-ui-source/blob/forever/Interface/AddOns/Blizzard_WorldMap/WM_WorldQuestDataProvider.lua#L42)
