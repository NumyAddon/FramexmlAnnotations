...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_WorldMap/Wrath/Blizzard_WorldMap.xml#L278)
--- @class WorldMapFrame_WorldMapContinentDropDown : Frame, UIDropDownMenuTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_WorldMap/Wrath/Blizzard_WorldMap.xml#L308)
--- @class WorldMapFrame_WorldMapZoneDropDown : Frame, UIDropDownMenuTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_WorldMap/Wrath/Blizzard_WorldMap.xml#L338)
...
--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_WorldMap/Wrath/Blizzard_WorldMap.xml#L426)
--- @class WorldMapFrame_WorldMapFrameCloseButton : Button, UIPanelCloseButton

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_WorldMap/Wrath/Blizzard_WorldMap.xml#L435)
--- @class WorldMapFrame_WorldMapTrackQuest : CheckButton, OptionsCheckButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_WorldMap/Wrath/Blizzard_WorldMap.xml#L455)
--- @class WorldMapFrame_WorldMapQuestShowObjectives : CheckButton, OptionsCheckButtonTemplate

--- [Source](https:/github.com/Gethe/wow-ui-source/blob/classic_ptr/Interface/AddOns/Blizzard_WorldMap/Wrath/Blizzard_WorldMap.xml#L475)
